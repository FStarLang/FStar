...
let uu___is_Inlining : step -> Prims.bool =
  fun projectee -> match projectee with Inlining -> true | uu____62 -> false
...
let uu___is_Simplify : step -> Prims.bool =
  fun projectee -> match projectee with Simplify -> true | uu____122 -> false
...
let cases:
      'Auu____162 'Auu____163. ('Auu____163 -> 'Auu____162) -> 'Auu____162
...
let __proj__Mkfsteps__item__beta : fsteps -> Prims.bool =
  fun projectee ->
    ...
    | { beta= __fname__beta
      ...
      ; weak= __fname__weak
      ; hnf= __fname__hnf
      ; primops= __fname__primops
      ; eager_unfolding= __fname__eager_unfolding
      ; inlining= __fname__inlining
      ; no_delta_steps= __fname__no_delta_steps
      ; unfold_until= __fname__unfold_until
      ; unfold_only= __fname__unfold_only
      ; unfold_attr= __fname__unfold_attr
      ; unfold_tac= __fname__unfold_tac
      ; pure_subterms_within_computations=
          __fname__pure_subterms_within_computations
      ; simplify= __fname__simplify
      ; erase_universes= __fname__erase_universes
      ; allow_unbound_universes= __fname__allow_unbound_universes
      ; reify_= __fname__reify_
      ; compress_uvars= __fname__compress_uvars
      ; no_full_norm= __fname__no_full_norm
      ; check_no_uvars= __fname__check_no_uvars
      ; unmeta= __fname__unmeta
...
type psc =
  ...
  ; psc_subst: Prims.unit -> FStar_Syntax_Syntax.subst_t }
  [@@deriving show]
...
let __proj__Mkprimitive_step__item__interpretation
    : primitive_step -> psc -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.term FStar_Pervasives_Native.option =
  fun projectee ->
    match projectee
    with
...
let uu___is_Clos : closure -> Prims.bool =
  fun projectee -> match projectee with Clos _0 -> true | uu____1454 -> false
...
let uu___is_Univ : closure -> Prims.bool =
  fun projectee -> match projectee with Univ _0 -> true | uu____1556 -> false
...
let uu___is_Dummy : closure -> Prims.bool =
  fun projectee -> match projectee with Dummy -> true | uu____1567 -> false
...
let __proj__Mkdebug_switches__item__norm_delayed : debug_switches -> Prims.bool =
  fun projectee ->
    match projectee
    with
    | { gen= __fname__gen
...
let add_steps
    : primitive_step FStar_Util.psmap -> primitive_step Prims.list
      -> primitive_step FStar_Util.psmap =
  fun m l ->
    FStar_List.fold_right
      (fun p m1 -> FStar_Util.psmap_add m1 (FStar_Ident.text_of_lid p.name) p)
      l m
...
let prim_from_list
  ...
  fun l ->
    let uu____1897 = FStar_Util.psmap_empty () in
    add_steps uu____1897 l
...
let uu___is_Arg : stack_elt -> Prims.bool =
  fun projectee -> match projectee with Arg _0 -> true | uu____2041 -> false
...
let uu___is_Abs : stack_elt -> Prims.bool =
  fun projectee -> match projectee with Abs _0 -> true | uu____2224 -> false
...
let uu___is_App : stack_elt -> Prims.bool =
  fun projectee -> match projectee with App _0 -> true | uu____2280 -> false
...
let uu___is_Meta : stack_elt -> Prims.bool =
  fun projectee -> match projectee with Meta _0 -> true | uu____2320 -> false
...
let uu___is_Let : stack_elt -> Prims.bool =
  fun projectee -> match projectee with Let _0 -> true | uu____2352 -> false
...
let uu___is_Cfg : stack_elt -> Prims.bool =
  fun projectee -> match projectee with Cfg _0 -> true | uu____2388 -> false
...
let mk:
      'Auu____2429. 'Auu____2429 -> FStar_Range.range
      -> 'Auu____2429 FStar_Syntax_Syntax.syntax =
  fun t r -> FStar_Syntax_Syntax.mk t FStar_Pervasives_Native.None r
...
let log : cfg -> (Prims.unit -> Prims.unit) -> Prims.unit =
  fun cfg f -> if cfg.debug.gen then f () else ()


let log_primops : cfg -> (Prims.unit -> Prims.unit) -> Prims.unit =
  fun cfg f -> if cfg.debug.primop then f () else ()
...
let downgrade_ghost_effect_name
  ...
  fun l ->
    if FStar_Ident.lid_equals l FStar_Parser_Const.effect_Ghost_lid then
      FStar_Pervasives_Native.Some FStar_Parser_Const.effect_Pure_lid
    else if FStar_Ident.lid_equals l FStar_Parser_Const.effect_GTot_lid then
      FStar_Pervasives_Native.Some FStar_Parser_Const.effect_Tot_lid
    else if FStar_Ident.lid_equals l FStar_Parser_Const.effect_GHOST_lid then
      FStar_Pervasives_Native.Some FStar_Parser_Const.effect_PURE_lid
    else FStar_Pervasives_Native.None


let norm_universe
    : cfg -> env -> FStar_Syntax_Syntax.universe
    ...
    let norm_univs us =
      ...
      let uu____2783 =
        FStar_List.fold_left
          (fun uu____2809 u1 ->
            match uu____2809 with cur_kernel, cur_max, out ->
              let uu____2834 = FStar_Syntax_Util.univ_kernel u1 in
              match uu____2834 with k_u, n1 ->
                let uu____2849 = FStar_Syntax_Util.eq_univs cur_kernel k_u in
                if uu____2849 then (cur_kernel, u1, out)
                else (k_u, u1, cur_max :: out) )
          (FStar_Syntax_Syntax.U_zero, FStar_Syntax_Syntax.U_zero, []) us1
      in
      match uu____2783 with uu____2867, u1, out -> FStar_List.rev (u1 :: out)
    in
    let rec aux u1 =
      ...
      | FStar_Syntax_Syntax.U_bvar x -> (
        try
          let uu____2892 =
            ...
            FStar_Pervasives_Native.snd uu____2893
          in
        ...
        with uu____2919 ->
          if cfg.steps.allow_unbound_universes then
            [FStar_Syntax_Syntax.U_unknown]
          else failwith "Universe variable not found" )
      | FStar_Syntax_Syntax.U_unif uu____2925 when cfg.steps.check_no_uvars ->
      ...
      | FStar_Syntax_Syntax.U_max us -> (
          let us1 =
            ...
            FStar_All.pipe_right uu____2950 norm_univs
          in
          match us1 with
          | u_k :: hd1 :: rest -> (
              ...
              | FStar_Syntax_Syntax.U_zero, n1 ->
                  let uu____2975 =
                    FStar_All.pipe_right rest1
                      (FStar_List.for_all (fun u3 ->
                           let uu____2983 = FStar_Syntax_Util.univ_kernel u3 in
                           match uu____2983 with uu____2988, m -> n1 <= m ))
                  in
      ...
      | FStar_Syntax_Syntax.U_succ u3 ->
          ...
          FStar_List.map
            (fun _0_40 -> FStar_Syntax_Syntax.U_succ _0_40)
            uu____3002
    in
    if cfg.steps.erase_universes then FStar_Syntax_Syntax.U_unknown
    else
...
let rec closure_as_term
  ...
  fun cfg env t ->
    ...
    match env with
    | [] when FStar_All.pipe_left Prims.op_Negation cfg.steps.compress_uvars ->
        t
    | uu____3119 ->
        let t1 = FStar_Syntax_Subst.compress t in
        match t1.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_delayed uu____3121 -> failwith "Impossible"
        ...
        | FStar_Syntax_Syntax.Tm_type u ->
            let uu____3171 =
              ...
              FStar_Syntax_Syntax.Tm_type uu____3172
            in
        ...
        | FStar_Syntax_Syntax.Tm_refine (x, phi) -> (
            let uu____3419 =
              let uu____3430 =
                ...
                [uu____3437]
              in
              closures_as_binders_delayed cfg env uu____3430
            in
            match uu____3419 with x1, env1 ->
              let phi1 = closure_as_term_delayed cfg env1 phi in
              let uu____3455 =
                let uu____3456 =
                  let uu____3463 =
                    let uu____3464 = FStar_List.hd x1 in
                    FStar_All.pipe_right uu____3464 FStar_Pervasives_Native.fst
                  in
                  (uu____3463, phi1)
                in
                FStar_Syntax_Syntax.Tm_refine uu____3456
              in
        ...
        | FStar_Syntax_Syntax.Tm_ascribed (t11, (annot, tacopt), lopt) ->
            ...
            in
            let tacopt1 =
              FStar_Util.map_opt tacopt (closure_as_term_delayed cfg env)
            in
            let uu____3585 =
              let uu____3586 =
                let uu____3613 = closure_as_term_delayed cfg env t11 in
                (uu____3613, (annot1, tacopt1), lopt)
              in
              FStar_Syntax_Syntax.Tm_ascribed uu____3586
            in
                ...
                let uu____3675 =
                  let uu____3676 =
                    FStar_All.pipe_right args
                      (FStar_List.map (closures_as_args_delayed cfg env))
                  in
                  FStar_Syntax_Syntax.Meta_pattern uu____3676
                in
                (uu____3672, uu____3675)
              in
              FStar_Syntax_Syntax.Tm_meta uu____3665
            in
        ...
        | FStar_Syntax_Syntax.Tm_meta
            ...
            let uu____3736 =
              let uu____3737 =
                ...
                let uu____3747 =
                  let uu____3748 =
                    let uu____3755 = closure_as_term_delayed cfg env tbody in
                    (m, uu____3755)
                  in
                  FStar_Syntax_Syntax.Meta_monadic uu____3748
                in
                (uu____3744, uu____3747)
              in
              FStar_Syntax_Syntax.Tm_meta uu____3737
            in
        ...
        | FStar_Syntax_Syntax.Tm_meta
            ...
            let uu____3774 =
              let uu____3775 =
                ...
                let uu____3785 =
                  let uu____3786 =
                    let uu____3795 = closure_as_term_delayed cfg env tbody in
                    (m1, m2, uu____3795)
                  in
                  FStar_Syntax_Syntax.Meta_monadic_lift uu____3786
                in
                (uu____3782, uu____3785)
              in
              FStar_Syntax_Syntax.Tm_meta uu____3775
            in
        ...
        | FStar_Syntax_Syntax.Tm_meta (t', m) ->
            let uu____3808 =
              let uu____3809 =
                ...
                (uu____3816, m)
              in
              FStar_Syntax_Syntax.Tm_meta uu____3809
            in
        ...
        | FStar_Syntax_Syntax.Tm_let ((false, [lb]), body) -> (
            ...
            let env1 =
              FStar_List.fold_left
                (fun env1 uu____3856 -> dummy :: env1)
                env lb.FStar_Syntax_Syntax.lbunivs
            in
            let typ =
              closure_as_term_delayed cfg env1 lb.FStar_Syntax_Syntax.lbtyp
            in
            let def = closure_as_term cfg env1 lb.FStar_Syntax_Syntax.lbdef in
            let uu____3875 =
              let uu____3886 = FStar_Syntax_Syntax.is_top_level [lb] in
              if uu____3886 then (lb.FStar_Syntax_Syntax.lbname, body)
              else
                let x = FStar_Util.left lb.FStar_Syntax_Syntax.lbname in
                let uu____3905 = closure_as_term cfg (dummy :: env0) body in
                ( FStar_Util.Inl
                ...
                , uu____3905 )
            in
            match uu____3875 with nm, body1 ->
              let lb1 =
        ...
        | FStar_Syntax_Syntax.Tm_let ((uu____3944, lbs), body) ->
            let norm_one_lb env1 lb =
              let env_univs =
                FStar_List.fold_right
                  (fun uu____4003 env2 -> dummy :: env2)
                  lb.FStar_Syntax_Syntax.lbunivs env1
              in
              let env2 =
                let uu____4028 = FStar_Syntax_Syntax.is_top_level lbs in
                if uu____4028 then env_univs
                else
                  FStar_List.fold_right
                    (fun uu____4048 env2 -> dummy :: env2)
                    lbs env_univs
              in
              let ty =
                closure_as_term cfg env_univs lb.FStar_Syntax_Syntax.lbtyp
              in
              let nm =
                let uu____4070 = FStar_Syntax_Syntax.is_top_level lbs in
                if uu____4070 then lb.FStar_Syntax_Syntax.lbname
                else
                  let x = FStar_Util.left lb.FStar_Syntax_Syntax.lbname in
            ...
            in
            let lbs1 =
              FStar_All.pipe_right lbs (FStar_List.map (norm_one_lb env))
            in
            let body1 =
              let body_env =
                FStar_List.fold_right
                  (fun uu____4114 env1 -> dummy :: env1)
                  lbs1 env
              in
              closure_as_term cfg body_env body
            in
        ...
        | FStar_Syntax_Syntax.Tm_match (head1, branches) ->
            ...
            let norm_one_branch env1 uu____4203 =
              match uu____4203 with pat, w_opt, tm ->
                let rec norm_pat env2 p =
                  match p.FStar_Syntax_Syntax.v with
                  | FStar_Syntax_Syntax.Pat_constant uu____4258 -> (p, env2)
                  | FStar_Syntax_Syntax.Pat_cons (fv, pats) -> (
                      let uu____4279 =
                        FStar_All.pipe_right pats
                          (FStar_List.fold_left
                             (fun uu____4339 uu____4340 ->
                               match (uu____4339, uu____4340)
                               with (pats1, env3), (p1, b) ->
                                 let uu____4431 = norm_pat env3 p1 in
                                 match uu____4431 with p2, env4 ->
                                   ((p2, b) :: pats1, env4) )
                             ([], env2))
                      in
                      match uu____4279 with pats1, env3 ->
                  ...
                  | FStar_Syntax_Syntax.Pat_var x ->
                      let x1 =
                        ...
                        let uu____4533 =
                          closure_as_term cfg env2 x.FStar_Syntax_Syntax.sort
                        in
                        { FStar_Syntax_Syntax.ppname=
                ...
                match uu____4600 with pat1, env2 ->
                  let w_opt1 =
                    match w_opt with
                    | FStar_Pervasives_Native.None ->
                        FStar_Pervasives_Native.None
                    | FStar_Pervasives_Native.Some w ->
                        let uu____4629 = closure_as_term cfg env2 w in
            ...
            let uu____4635 =
              let uu____4636 =
                ...
                (head2, uu____4659)
              in
              FStar_Syntax_Syntax.Tm_match uu____4636
            in
            mk uu____4635 t1.FStar_Syntax_Syntax.pos


and closure_as_term_delayed
    : cfg -> env -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  ...
  fun cfg env bs ->
    let uu____4821 =
      FStar_All.pipe_right bs
        (FStar_List.fold_left
           (fun uu____4870 uu____4871 ->
             match (uu____4870, uu____4871) with (env1, out), (b, imp) ->
               let b1 =
                 let uu___135_4941 = b in
                 let uu____4942 =
                   closure_as_term_delayed cfg env1 b.FStar_Syntax_Syntax.sort
                 in
                 { FStar_Syntax_Syntax.ppname=
...
and close_comp
    : cfg -> env -> FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax
  ...
  fun cfg env c ->
    ...
    | uu____5035 ->
      ...
      | FStar_Syntax_Syntax.Total (t, uopt) ->
          ...
          let uu____5049 = FStar_Option.map (norm_universe cfg env) uopt in
          FStar_Syntax_Syntax.mk_Total' uu____5048 uu____5049
      | FStar_Syntax_Syntax.GTotal (t, uopt) ->
          let uu____5062 = closure_as_term_delayed cfg env t in
          let uu____5063 = FStar_Option.map (norm_universe cfg env) uopt in
          FStar_Syntax_Syntax.mk_GTotal' uu____5062 uu____5063
      | FStar_Syntax_Syntax.Comp c1 ->
          let rt =
            closure_as_term_delayed cfg env c1.FStar_Syntax_Syntax.result_typ
          in
          let args =
            closures_as_args_delayed cfg env c1.FStar_Syntax_Syntax.effect_args
          in
          let flags1 =
            FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
              (FStar_List.map (fun uu___80_5089 ->
                   match uu___80_5089 with
                   | FStar_Syntax_Syntax.DECREASES t ->
                       let uu____5093 = closure_as_term_delayed cfg env t in
...
and filter_out_lcomp_cflags
  ...
  fun flags1 ->
    FStar_All.pipe_right flags1
      (FStar_List.filter (fun uu___81_5109 ->
    ...
    | FStar_Pervasives_Native.Some rc ->
        let flags1 =
          FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
            (FStar_List.filter (fun uu___82_5131 ->
...
let built_in_primitive_steps : primitive_step FStar_Util.psmap =
  ...
  let arg_as_list a u a =
    ...
    FStar_All.pipe_right (FStar_Pervasives_Native.fst a) uu____5230
  in
  let arg_as_bounded_int uu____5258 =
    match uu____5258 with a, uu____5270 ->
      let uu____5277 =
  ...
  let unary_int_op f =
    unary_op ()
      (fun a428 -> (Obj.magic arg_as_int) a428)
      (fun a429 a430 ->
        (Obj.magic (fun r x ->
             let uu____5595 = f x in
             FStar_Syntax_Embeddings.embed_int r uu____5595 ))
          a429 a430 )
  in
  let binary_int_op f =
    binary_op ()
      (fun a431 -> (Obj.magic arg_as_int) a431)
      (fun a432 a433 a434 ->
        (Obj.magic (fun r x y ->
             let uu____5623 = f x y in
             FStar_Syntax_Embeddings.embed_int r uu____5623 ))
          a432 a433 a434 )
  in
  let unary_bool_op f =
    unary_op ()
      (fun a435 -> (Obj.magic arg_as_bool) a435)
      (fun a436 a437 ->
        (Obj.magic (fun r x ->
             let uu____5644 = f x in
             FStar_Syntax_Embeddings.embed_bool r uu____5644 ))
          a436 a437 )
  in
  let binary_bool_op f =
    binary_op ()
      (fun a438 -> (Obj.magic arg_as_bool) a438)
      (fun a439 a440 a441 ->
        (Obj.magic (fun r x y ->
             let uu____5672 = f x y in
             FStar_Syntax_Embeddings.embed_bool r uu____5672 ))
          a439 a440 a441 )
  in
  let binary_string_op f =
    binary_op ()
      (fun a442 -> (Obj.magic arg_as_string) a442)
      (fun a443 a444 a445 ->
        (Obj.magic (fun r x y ->
      ...
      let uu____5860 =
        let uu____5861 =
          FStar_Syntax_Syntax.lid_as_fv l FStar_Syntax_Syntax.Delta_constant
            FStar_Pervasives_Native.None
        in
        FStar_Syntax_Syntax.Tm_fvar uu____5861
      in
      mk uu____5860 rng
    in
    let char_t = name FStar_Parser_Const.char_lid in
    let charterm c =
      mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_char c)) rng
    in
    let uu____5871 =
      let uu____5874 = FStar_String.list_of_string s in
      FStar_List.map charterm uu____5874
    in
    FStar_All.pipe_left (FStar_Syntax_Util.mk_list char_t rng) uu____5871
  in
  let string_of_list' rng l =
    let s = FStar_String.string_of_list l in
    FStar_Syntax_Util.exp_string s
  in
  let string_compare' rng s1 s2 =
    let r = FStar_String.compare s1 s2 in
    let uu____5906 =
      let uu____5907 = FStar_Util.string_of_int r in
      FStar_BigInt.big_int_of_string uu____5907
    in
    FStar_Syntax_Embeddings.embed_int rng uu____5906
  in
    ...
    | [a1; a2] -> (
        ...
        | FStar_Pervasives_Native.Some s1 -> (
            ...
            | FStar_Pervasives_Native.Some s2 ->
                ...
                let uu____5944 =
                  FStar_Syntax_Embeddings.embed_string psc.psc_range r
                in
  ...
  let string_of_int1 rng i =
    ...
    FStar_Syntax_Embeddings.embed_string rng uu____5963
  in
  ...
  let mk_range1 uu____5987 args =
    ...
    | [fn; from_line; from_col; to_line; to_col] -> (
        let uu____5998 =
          ...
          (uu____6019, uu____6022, uu____6025, uu____6028, uu____6031)
        in
        match uu____5998 with
        | ( FStar_Pervasives_Native.Some fn1
          , FStar_Pervasives_Native.Some from_l
          , FStar_Pervasives_Native.Some from_c
          , FStar_Pervasives_Native.Some to_l
          , FStar_Pervasives_Native.Some to_c ) ->
            let r =
              let uu____6062 =
                let uu____6063 = FStar_BigInt.to_int_fs from_l in
                let uu____6064 = FStar_BigInt.to_int_fs from_c in
                FStar_Range.mk_pos uu____6063 uu____6064
              in
              let uu____6065 =
                let uu____6066 = FStar_BigInt.to_int_fs to_l in
                let uu____6067 = FStar_BigInt.to_int_fs to_c in
                FStar_Range.mk_pos uu____6066 uu____6067
              in
              FStar_Range.mk_range fn1 uu____6062 uu____6065
            in
  ...
  let decidable_eq neg psc args =
    ...
    | uu____6176 -> failwith "Unexpected number of arguments"
  in
  let idstep psc args =
    match args with
    | [(a1, uu____6203)] -> FStar_Pervasives_Native.Some a1
    | uu____6212 -> failwith "Unexpected number of arguments"
  in
  let basic_ops =
    let uu____6236 =
      let uu____6251 =
          ...
          let uu____6281 =
            let uu____6296 =
              let uu____6311 =
                let uu____6326 =
                  let uu____6341 =
                    let uu____6356 =
                            ...
                            let uu____6416 =
                              let uu____6431 =
                                let uu____6446 =
                                  let uu____6461 =
                                    let uu____6476 =
                                      let uu____6491 =
                                          ...
                                          let uu____6521 =
                                            let uu____6536 =
                                              ...
                                              let uu____6571 =
                                                ...
                                                in
                                                uu____6586 :: uu____6606
                                              in
                                              uu____6551 :: uu____6571
                                            in
                                        ...
                                        , binary_op ()
                                            (fun a452 ->
                                              (Obj.magic arg_as_string) a452 )
                                            (fun a453 a454 a455 ->
                                              (Obj.magic string_compare')
                                                a453 a454 a455 ) )
                                        :: uu____6506
                                      in
                                    ...
                                    , unary_op ()
                                        ...
                                        (fun a460 a461 ->
                                          (Obj.magic string_of_int1) a460 a461
                                          ) )
                                    :: uu____6476
                                  in
                                  ...
                                  , Prims.parse_int "2"
                                  , mixed_binary_op () () ()
                                      (fun a462 -> (Obj.magic arg_as_int) a462)
                                      (fun a463 -> (Obj.magic arg_as_char) a463)
                                      (fun a464 a465 ->
                                        (Obj.magic
                                      ...
                                      (fun a466 a467 a468 ->
                                        (Obj.magic (fun r x y ->
                                             ...
                                             in
                                             FStar_String.make uu____6939 y ))
                                          a466 a467 a468 ) )
                                  :: uu____6461
                                in
                                ( FStar_Parser_Const.strcat_lid'
                                , Prims.parse_int "2"
                                , binary_string_op (fun x y -> Prims.strcat x y)
                                )
                                :: uu____6446
                              in
                              ( FStar_Parser_Const.strcat_lid
                      ...
                      , Prims.parse_int "2"
                      , binary_int_op (fun x y -> FStar_BigInt.mod_big_int x y)
                      )
                      :: uu____6371
                    in
                    ...
                    , binary_op ()
                        ...
                        (fun a470 a471 a472 ->
                          (Obj.magic (fun r x y ->
                               let uu____7106 = FStar_BigInt.ge_big_int x y in
                               FStar_Syntax_Embeddings.embed_bool r uu____7106
                           ))
                            a470 a471 a472 ) )
                    :: uu____6356
                  in
                  ...
                  , Prims.parse_int "2"
                  , binary_op ()
                      (fun a473 -> (Obj.magic arg_as_int) a473)
                      (fun a474 a475 a476 ->
                        (Obj.magic (fun r x y ->
                             let uu____7132 = FStar_BigInt.gt_big_int x y in
                             FStar_Syntax_Embeddings.embed_bool r uu____7132 ))
                          a474 a475 a476 ) )
                  :: uu____6341
                in
                ...
                , Prims.parse_int "2"
                , binary_op ()
                    (fun a477 -> (Obj.magic arg_as_int) a477)
                    (fun a478 a479 a480 ->
                      (Obj.magic (fun r x y ->
                           let uu____7158 = FStar_BigInt.le_big_int x y in
                           FStar_Syntax_Embeddings.embed_bool r uu____7158 ))
                        a478 a479 a480 ) )
                :: uu____6326
              in
              ...
              , Prims.parse_int "2"
              , binary_op ()
                  (fun a481 -> (Obj.magic arg_as_int) a481)
                  (fun a482 a483 a484 ->
                    (Obj.magic (fun r x y ->
                         let uu____7184 = FStar_BigInt.lt_big_int x y in
                         FStar_Syntax_Embeddings.embed_bool r uu____7184 ))
                      a482 a483 a484 ) )
              :: uu____6311
            in
            ( FStar_Parser_Const.op_Division
            , Prims.parse_int "2"
            , binary_int_op (fun x y -> FStar_BigInt.div_big_int x y) )
            :: uu____6296
          in
          ( FStar_Parser_Const.op_Multiply
          , Prims.parse_int "2"
          , binary_int_op (fun x y -> FStar_BigInt.mult_big_int x y) )
          :: uu____6281
        in
        ( FStar_Parser_Const.op_Subtraction
        , Prims.parse_int "2"
        , binary_int_op (fun x y -> FStar_BigInt.sub_big_int x y) )
        :: uu____6266
      in
      ( FStar_Parser_Const.op_Addition
      , Prims.parse_int "2"
      , binary_int_op (fun x y -> FStar_BigInt.add_big_int x y) )
      :: uu____6251
    in
  ...
  let bounded_arith_ops =
    ...
    let int_as_bounded r int_to_t1 n1 =
      ...
      let uu____7337 =
        let uu____7338 =
          let uu____7339 = FStar_Syntax_Syntax.as_arg c in
          [uu____7339]
        in
        FStar_Syntax_Syntax.mk_Tm_app int_to_t2 uu____7338
      in
      uu____7337 FStar_Pervasives_Native.None r
    in
    let add_sub_mul_v =
      FStar_All.pipe_right
        (FStar_List.append bounded_signed_int_types bounded_unsigned_int_types)
        (FStar_List.collect (fun m ->
             let uu____7389 =
               ...
               , binary_op ()
                   ...
                   (fun a486 a487 a488 ->
                     (Obj.magic (fun r uu____7418 uu____7419 ->
                          match (uu____7418, uu____7419)
                          with (int_to_t1, x), (uu____7438, y) ->
                            let uu____7448 = FStar_BigInt.add_big_int x y in
                            int_as_bounded r int_to_t1 uu____7448 ))
                       a486 a487 a488 ) )
             in
             let uu____7449 =
               let uu____7464 =
                 ...
                 , binary_op ()
                     ...
                     (fun a490 a491 a492 ->
                       (Obj.magic (fun r uu____7493 uu____7494 ->
                            match (uu____7493, uu____7494)
                            with (int_to_t1, x), (uu____7513, y) ->
                              let uu____7523 = FStar_BigInt.sub_big_int x y in
                              int_as_bounded r int_to_t1 uu____7523 ))
                         a490 a491 a492 ) )
               in
               let uu____7524 =
                 let uu____7539 =
                   let uu____7552 =
                     FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                   in
                   ( uu____7552
                   , Prims.parse_int "2"
                   , binary_op ()
                       ...
                       (fun a494 a495 a496 ->
                         (Obj.magic (fun r uu____7568 uu____7569 ->
                              match (uu____7568, uu____7569)
                              with (int_to_t1, x), (uu____7588, y) ->
                                let uu____7598 =
                                  FStar_BigInt.mult_big_int x y
                                in
                                int_as_bounded r int_to_t1 uu____7598 ))
                           a494 a495 a496 ) )
                 in
                 let uu____7599 =
                   let uu____7614 =
                     let uu____7627 =
                       FStar_Parser_Const.p2l ["FStar"; m; "v"]
                     in
                     ( uu____7627
                     , Prims.parse_int "1"
                     , unary_op ()
                         ...
                         (fun a498 a499 ->
                           (Obj.magic (fun r uu____7639 ->
                                match uu____7639 with int_to_t1, x ->
                                  FStar_Syntax_Embeddings.embed_int r x ))
                             a498 a499 ) )
                   in
                   [uu____7614]
                 in
                 uu____7539 :: uu____7599
               in
               uu____7464 :: uu____7524
             in
        ...
        (FStar_List.collect (fun m ->
             let uu____7753 =
               ...
               , binary_op ()
                   ...
                   (fun a501 a502 a503 ->
                     (Obj.magic (fun r uu____7782 uu____7783 ->
                          match (uu____7782, uu____7783)
                          with (int_to_t1, x), (uu____7802, y) ->
                            let uu____7812 = FStar_BigInt.div_big_int x y in
                            int_as_bounded r int_to_t1 uu____7812 ))
                       a501 a502 a503 ) )
             in
             let uu____7813 =
               let uu____7828 =
                 ...
                 , binary_op ()
                     ...
                     (fun a505 a506 a507 ->
                       (Obj.magic (fun r uu____7857 uu____7858 ->
                            match (uu____7857, uu____7858)
                            with (int_to_t1, x), (uu____7877, y) ->
                              let uu____7887 = FStar_BigInt.mod_big_int x y in
                              int_as_bounded r int_to_t1 uu____7887 ))
                         a505 a506 a507 ) )
               in
               [uu____7828]
             in
    ...
    in
    FStar_List.append add_sub_mul_v div_mod_unsigned
  in
  let uu____7936 =
        ...
        | FStar_Syntax_Util.Equal ->
            FStar_Pervasives_Native.Some
              (let uu___138_8031 = FStar_Syntax_Util.t_true in
               { FStar_Syntax_Syntax.n= uu___138_8031.FStar_Syntax_Syntax.n
        ...
        | FStar_Syntax_Util.NotEqual ->
            FStar_Pervasives_Native.Some
              (let uu___139_8035 = FStar_Syntax_Util.t_false in
               { FStar_Syntax_Syntax.n= uu___139_8035.FStar_Syntax_Syntax.n
               ; FStar_Syntax_Syntax.pos= r
               ; FStar_Syntax_Syntax.vars=
        ...
        | FStar_Syntax_Util.Equal ->
            FStar_Pervasives_Native.Some
              (let uu___138_8098 = FStar_Syntax_Util.t_true in
               { FStar_Syntax_Syntax.n= uu___138_8098.FStar_Syntax_Syntax.n
               ; FStar_Syntax_Syntax.pos= r
               ; FStar_Syntax_Syntax.vars=
        ...
        | FStar_Syntax_Util.NotEqual ->
            FStar_Pervasives_Native.Some
              (let uu___139_8102 = FStar_Syntax_Util.t_false in
               { FStar_Syntax_Syntax.n= uu___139_8102.FStar_Syntax_Syntax.n
               ; FStar_Syntax_Syntax.pos= r
               ; FStar_Syntax_Syntax.vars=
                   uu___139_8102.FStar_Syntax_Syntax.vars })
        | uu____8103 -> FStar_Pervasives_Native.None )
    | uu____8104 -> failwith "Unexpected number of arguments"
  in
  ...
  fun t ->
    try
      let uu____8123 =
        ...
        FStar_All.pipe_right uu____8124 FStar_Dyn.undyn
      in
...
let mk_psc_subst:
  ...
  fun cfg env ->
    FStar_List.fold_right
      (fun uu____8194 subst1 ->
        match uu____8194 with binder_opt, closure ->
          match (binder_opt, closure) with
          | ( FStar_Pervasives_Native.Some b
            , Clos (env1, term, uu____8235, uu____8236) )
            -> (
              let uu____8295 = b in
              match uu____8295 with bv, uu____8303 ->
                let uu____8304 =
                  let uu____8305 =
                ...
                if uu____8304 then subst1
                  ...
                  | FStar_Pervasives_Native.Some x ->
                      ...
                      let b_for_x =
                        let uu____8323 =
                          let uu____8330 = FStar_Syntax_Syntax.bv_to_name b1 in
                          (FStar_Pervasives_Native.fst x, uu____8330)
                        in
                        FStar_Syntax_Syntax.NT uu____8323
                      in
                      let subst2 =
                        FStar_List.filter
                          (fun uu___83_8339 ->
                            ...
                            | FStar_Syntax_Syntax.NT
                                ...
                                , { FStar_Syntax_Syntax.n=
                                  ...
                                  ; FStar_Syntax_Syntax.pos= uu____8342
                                  ; FStar_Syntax_Syntax.vars= uu____8343; _ } ) ->
                                Prims.op_Negation
...
let reduce_primops:
      'Auu____8366 'Auu____8367. cfg
      -> ( (FStar_Syntax_Syntax.bv, 'Auu____8367) FStar_Pervasives_Native.tuple2
           FStar_Pervasives_Native.option
         , closure )
         FStar_Pervasives_Native.tuple2
         Prims.list -> 'Auu____8366 -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack tm ->
    if Prims.op_Negation cfg.steps.primops then tm
    else
      let uu____8409 = FStar_Syntax_Util.head_and_args tm in
      match uu____8409 with head1, args ->
        let uu____8446 =
          let uu____8447 = FStar_Syntax_Util.un_uinst head1 in
          uu____8447.FStar_Syntax_Syntax.n
        in
        ...
        | FStar_Syntax_Syntax.Tm_fvar fv -> (
            ...
            | FStar_Pervasives_Native.Some prim_step
              when prim_step.strong_reduction_ok
                   || Prims.op_Negation cfg.strong ->
                if FStar_List.length args < prim_step.arity then (
                  log_primops cfg (fun uu____8466 ->
                      let uu____8467 =
                        FStar_Syntax_Print.lid_to_string prim_step.name
                      in
                      let uu____8468 =
                        FStar_Util.string_of_int (FStar_List.length args)
                      in
                      let uu____8475 =
                  ...
                  log_primops cfg (fun uu____8480 ->
                      let uu____8481 = FStar_Syntax_Print.term_to_string tm in
                      FStar_Util.print1 "primop: trying to reduce <%s>\n"
                        uu____8481 ) ;
                  let psc =
                    { psc_range= head1.FStar_Syntax_Syntax.pos
                    ; psc_subst=
                        (fun uu____8484 ->
                          if prim_step.requires_binder_substitution then
                            mk_psc_subst cfg env
                          else [] ) }
                  in
                  let uu____8486 = prim_step.interpretation psc args in
                  match uu____8486 with
                  | FStar_Pervasives_Native.None ->
                      log_primops cfg (fun uu____8492 ->
                          let uu____8493 =
                            FStar_Syntax_Print.term_to_string tm
                          in
                          FStar_Util.print1 "primop: <%s> did not reduce\n"
                            uu____8493 ) ;
                      tm
                  | FStar_Pervasives_Native.Some reduced ->
                      log_primops cfg (fun uu____8499 ->
                          let uu____8500 =
                            FStar_Syntax_Print.term_to_string tm
                          in
                          let uu____8501 =
                            FStar_Syntax_Print.term_to_string reduced
                          in
                          FStar_Util.print2 "primop: <%s> reduced to <%s>\n"
                            uu____8500 uu____8501 ) ;
                      reduced )
            | FStar_Pervasives_Native.Some uu____8502 ->
                log_primops cfg (fun uu____8506 ->
                    let uu____8507 = FStar_Syntax_Print.term_to_string tm in
                    FStar_Util.print1
        ...
        | FStar_Syntax_Syntax.Tm_constant FStar_Const.Const_range_of
          when Prims.op_Negation cfg.strong
          -> (
            log_primops cfg (fun uu____8511 ->
                let uu____8512 = FStar_Syntax_Print.term_to_string tm in
                FStar_Util.print1 "primop: reducing <%s>\n" uu____8512 ) ;
            match args with
            | [(a1, uu____8514)] ->
                FStar_Syntax_Embeddings.embed_range tm.FStar_Syntax_Syntax.pos
                  a1.FStar_Syntax_Syntax.pos
            | uu____8531 -> tm )
        | FStar_Syntax_Syntax.Tm_constant FStar_Const.Const_set_range_of
          when Prims.op_Negation cfg.strong
          -> (
            log_primops cfg (fun uu____8543 ->
                let uu____8544 = FStar_Syntax_Print.term_to_string tm in
                FStar_Util.print1 "primop: reducing <%s>\n" uu____8544 ) ;
            match args with
            | [(t, uu____8546); (r, uu____8548)] -> (
                let uu____8575 = FStar_Syntax_Embeddings.unembed_range r in
                match uu____8575 with
                | FStar_Pervasives_Native.Some rng ->
                    let uu___143_8579 = t in
                    { FStar_Syntax_Syntax.n= uu___143_8579.FStar_Syntax_Syntax.n
...
let reduce_equality:
      'Auu____8596 'Auu____8597. cfg
      -> ( (FStar_Syntax_Syntax.bv, 'Auu____8597) FStar_Pervasives_Native.tuple2
           FStar_Pervasives_Native.option
         , closure )
         FStar_Pervasives_Native.tuple2
         Prims.list -> 'Auu____8596 -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun cfg tm ->
    reduce_primops
      (let uu___144_8635 = cfg in
       { steps=
           (let uu___145_8638 = default_steps in
            ...
            ; allow_unbound_universes= uu___145_8638.allow_unbound_universes
...
let maybe_simplify_aux:
      'Auu____8645 'Auu____8646. cfg
      -> ( (FStar_Syntax_Syntax.bv, 'Auu____8646) FStar_Pervasives_Native.tuple2
           FStar_Pervasives_Native.option
         , closure )
         FStar_Pervasives_Native.tuple2
         Prims.list -> 'Auu____8645 -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack tm ->
    let tm1 = reduce_primops cfg env stack tm in
    let uu____8688 =
      FStar_All.pipe_left Prims.op_Negation cfg.steps.simplify
    in
    if uu____8688 then tm1
    else
      let w t =
        let uu___146_8700 = t in
        { FStar_Syntax_Syntax.n= uu___146_8700.FStar_Syntax_Syntax.n
        ; FStar_Syntax_Syntax.pos= tm1.FStar_Syntax_Syntax.pos
        ; FStar_Syntax_Syntax.vars= uu___146_8700.FStar_Syntax_Syntax.vars }
      in
      let simp_t t =
        ...
        | FStar_Syntax_Syntax.Tm_meta
            ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
              ...
              ; FStar_Syntax_Syntax.vars= uu____8717; _ }
            , uu____8718 )
          when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.true_lid ->
          ...
          ( { FStar_Syntax_Syntax.n=
                FStar_Syntax_Syntax.Tm_uinst
                  ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
                    ...
                    ; FStar_Syntax_Syntax.vars= uu____8907; _ }
                  , uu____8908 )
            ; FStar_Syntax_Syntax.pos= uu____8909
            ; FStar_Syntax_Syntax.vars= uu____8910; _ }
          , args )
        -> (
          let uu____8936 =
          ...
          if uu____8936 then
            ...
            | [ (uu____9060, (arg, uu____9062))
              ; (FStar_Pervasives_Native.Some true, uu____9063) ] ->
                maybe_auto_squash arg
            | [(FStar_Pervasives_Native.Some false, uu____9128); uu____9129] ->
                w FStar_Syntax_Util.t_false
            | [uu____9192; (FStar_Pervasives_Native.Some false, uu____9193)] ->
                w FStar_Syntax_Util.t_false
            ...
            if uu____9272 then
              ...
              | [uu____9392; (FStar_Pervasives_Native.Some true, uu____9393)] ->
                  w FStar_Syntax_Util.t_true
              | [ (FStar_Pervasives_Native.Some false, uu____9456)
                ; (uu____9457, (arg, uu____9459)) ] ->
                  maybe_auto_squash arg
              | [ (uu____9524, (arg, uu____9526))
                ; (FStar_Pervasives_Native.Some false, uu____9527) ] ->
                  maybe_auto_squash arg
              ...
              if uu____9608 then
                ...
                | [uu____9664; (FStar_Pervasives_Native.Some true, uu____9665)] ->
                    w FStar_Syntax_Util.t_true
                ...
                | [(uu____9860, (p, uu____9862)); (uu____9863, (q, uu____9865))] ->
                    ...
                    if uu____9930 then w FStar_Syntax_Util.t_true
                    else squashed_head_un_auto_squash_args tm1
                | uu____9932 -> squashed_head_un_auto_squash_args tm1
              else
                let uu____9948 =
                  FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.not_lid
                in
                if uu____9948 then
                  let uu____9949 =
                    FStar_All.pipe_right args (FStar_List.map simplify1)
                  ...
                  | [(FStar_Pervasives_Native.Some true, uu____10004)] ->
                      w FStar_Syntax_Util.t_false
                  | [(FStar_Pervasives_Native.Some false, uu____10043)] ->
                      w FStar_Syntax_Util.t_true
                  | uu____10082 -> squashed_head_un_auto_squash_args tm1
                else
                  let uu____10098 =
                  ...
                  if uu____10098 then
                    ...
                    | [(t, uu____10100)] -> (
                        let uu____10117 =
                          let uu____10118 = FStar_Syntax_Subst.compress t in
                          uu____10118.FStar_Syntax_Syntax.n
                        in
                    ...
                    | [ ( uu____10154
                      ...
                      -> (
                        let uu____10196 =
                          let uu____10197 = FStar_Syntax_Subst.compress t in
                          uu____10197.FStar_Syntax_Syntax.n
                        in
                    ...
                    if uu____10243 then
                      ...
                      | [(t, uu____10245)] -> (
                          let uu____10262 =
                            let uu____10263 = FStar_Syntax_Subst.compress t in
                            uu____10263.FStar_Syntax_Syntax.n
                          in
                      ...
                      | [ ( uu____10299
                        ...
                        -> (
                          let uu____10341 =
                            let uu____10342 = FStar_Syntax_Subst.compress t in
                      ...
                      if uu____10388 then
                        ...
                        | [ ( { FStar_Syntax_Syntax.n=
                              ...
                              ; FStar_Syntax_Syntax.vars= uu____10409; _ }
                            , uu____10410 ) ] ->
                            w FStar_Syntax_Util.t_false
                        | uu____10427 -> tm1
                      else
                        ...
                        | FStar_Pervasives_Native.Some
                          ...
                          when FStar_Syntax_Util.is_sub_singleton t ->
                            t
                        | uu____10457 -> reduce_equality cfg env stack tm1 )
      | FStar_Syntax_Syntax.Tm_app
          ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
            ; FStar_Syntax_Syntax.pos= uu____10467
            ; FStar_Syntax_Syntax.vars= uu____10468; _ }
          , args )
        -> (
          let uu____10490 =
            FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.and_lid
          ...
          if uu____10490 then
            ...
            | [ (FStar_Pervasives_Native.Some true, uu____10546)
              ; (uu____10547, (arg, uu____10549)) ] ->
                maybe_auto_squash arg
            | [ (uu____10614, (arg, uu____10616))
              ; (FStar_Pervasives_Native.Some true, uu____10617) ] ->
                maybe_auto_squash arg
            | [(FStar_Pervasives_Native.Some false, uu____10682); uu____10683] ->
                w FStar_Syntax_Util.t_false
            | [uu____10746; (FStar_Pervasives_Native.Some false, uu____10747)] ->
                w FStar_Syntax_Util.t_false
            ...
            if uu____10826 then
              ...
              | [(FStar_Pervasives_Native.Some true, uu____10882); uu____10883] ->
                  w FStar_Syntax_Util.t_true
              | [uu____10946; (FStar_Pervasives_Native.Some true, uu____10947)] ->
                  w FStar_Syntax_Util.t_true
              | [ (FStar_Pervasives_Native.Some false, uu____11010)
                ; (uu____11011, (arg, uu____11013)) ] ->
                  maybe_auto_squash arg
              | [ (uu____11078, (arg, uu____11080))
                ; (FStar_Pervasives_Native.Some false, uu____11081) ] ->
                  maybe_auto_squash arg
              ...
              if uu____11162 then
                ...
                | [ uu____11218
                  ; (FStar_Pervasives_Native.Some true, uu____11219) ] ->
                    w FStar_Syntax_Util.t_true
                | [ (FStar_Pervasives_Native.Some false, uu____11282)
                  ; uu____11283 ] ->
                    w FStar_Syntax_Util.t_true
                | [ (FStar_Pervasives_Native.Some true, uu____11346)
                  ; (uu____11347, (arg, uu____11349)) ] ->
                    maybe_auto_squash arg
                | [ (uu____11414, (p, uu____11416))
                  ; (uu____11417, (q, uu____11419)) ] ->
                    let uu____11484 = FStar_Syntax_Util.term_eq p q in
                    if uu____11484 then w FStar_Syntax_Util.t_true
                    else squashed_head_un_auto_squash_args tm1
                | uu____11486 -> squashed_head_un_auto_squash_args tm1
              else
                let uu____11502 =
                  FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.not_lid
                in
                if uu____11502 then
                  ...
                  | [(FStar_Pervasives_Native.Some true, uu____11558)] ->
                      w FStar_Syntax_Util.t_false
                  | [(FStar_Pervasives_Native.Some false, uu____11597)] ->
                      w FStar_Syntax_Util.t_true
                  | uu____11636 -> squashed_head_un_auto_squash_args tm1
                else
                  let uu____11652 =
                    FStar_Syntax_Syntax.fv_eq_lid fv
                      FStar_Parser_Const.forall_lid
                  ...
                  if uu____11652 then
                    ...
                    | [(t, uu____11654)] -> (
                        let uu____11671 =
                          let uu____11672 = FStar_Syntax_Subst.compress t in
                          uu____11672.FStar_Syntax_Syntax.n
                        in
                    ...
                    | [ ( uu____11708
                      ...
                      -> (
                        let uu____11750 =
                          let uu____11751 = FStar_Syntax_Subst.compress t in
                          uu____11751.FStar_Syntax_Syntax.n
                        in
                    ...
                    if uu____11797 then
                      ...
                      | [(t, uu____11799)] -> (
                          let uu____11816 =
                            let uu____11817 = FStar_Syntax_Subst.compress t in
                            uu____11817.FStar_Syntax_Syntax.n
                          in
                      ...
                      | [ ( uu____11853
                          , FStar_Pervasives_Native.Some
                              FStar_Syntax_Syntax.Implicit uu____11854 )
                        ; (t, uu____11856) ]
                        -> (
                          let uu____11895 =
                            let uu____11896 = FStar_Syntax_Subst.compress t in
                            uu____11896.FStar_Syntax_Syntax.n
                          in
                      ...
                      if uu____11942 then
                        ...
                        | [ ( { FStar_Syntax_Syntax.n=
                              ...
                              ; FStar_Syntax_Syntax.vars= uu____11944; _ }
                            , uu____11945 ) ] ->
                            w FStar_Syntax_Util.t_true
                        | [ ( { FStar_Syntax_Syntax.n=
                                  FStar_Syntax_Syntax.Tm_constant
                              ...
                              ; FStar_Syntax_Syntax.vars= uu____11963; _ }
                            , uu____11964 ) ] ->
                            w FStar_Syntax_Util.t_false
                        | uu____11981 -> tm1
                      else
                        ...
                        | FStar_Pervasives_Native.Some
                          ...
                          when FStar_Syntax_Util.is_sub_singleton t ->
                            t
                        | uu____12011 -> reduce_equality cfg env stack tm1 )
      | FStar_Syntax_Syntax.Tm_refine (bv, t) -> (
        match simp_t t with
        | FStar_Pervasives_Native.Some true -> bv.FStar_Syntax_Syntax.sort
...
let maybe_simplify:
      ...
      -> ( ( FStar_Syntax_Syntax.bv
         ...
         , closure )
         FStar_Pervasives_Native.tuple2
         Prims.list -> 'Auu____12033 -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack tm ->
    let tm' = maybe_simplify_aux cfg env stack tm in
    if cfg.debug.b380 then
      ...
      FStar_Util.print3 "%sSimplified\n\t%s to\n\t%s\n"
        ...
        uu____12077 uu____12078
    else () ;
    tm'


let is_norm_request:
      'Auu____12084. FStar_Syntax_Syntax.term -> 'Auu____12084 Prims.list
      -> Prims.bool =
  fun hd1 args ->
    let uu____12097 =
      let uu____12104 =
        let uu____12105 = FStar_Syntax_Util.un_uinst hd1 in
        uu____12105.FStar_Syntax_Syntax.n
      in
      (uu____12104, args)
    in
...
let get_norm_request:
      'Auu____12162. (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
      -> ( FStar_Syntax_Syntax.term
         , 'Auu____12162 )
         FStar_Pervasives_Native.tuple2
         Prims.list
  ...
  fun full_norm args ->
        ...
        let uu____12215 =
          let uu____12218 =
            let uu____12221 =
              ...
              uu____12226 s
            in
            FStar_All.pipe_right uu____12221 FStar_Util.must
          in
          FStar_All.pipe_right uu____12218 tr_norm_steps
        in
        FStar_Pervasives_Native.Some uu____12215
      with uu____12254 -> FStar_Pervasives_Native.None
    in
    match args with
    ...
    | [(steps, uu____12317); uu____12318; (tm, uu____12320)] -> (
        let add_exclude s z =
          if Prims.op_Negation (FStar_List.contains z s) then Exclude z :: s
          else s
        in
        let uu____12357 =
          let uu____12362 = full_norm steps in
          parse_steps uu____12362
        in
  ...
  fun uu___85_12418 ->
    ...
    | (App
        ...
        , { FStar_Syntax_Syntax.n=
          ...
          ; FStar_Syntax_Syntax.vars= uu____12423; _ }
        , uu____12424
        , uu____12425 ))
      :: uu____12426 ->
        true
...
let firstn:
      'Auu____12439. Prims.int -> 'Auu____12439 Prims.list
  ...
  fun cfg stack ->
    ...
    | (App
        ...
        , { FStar_Syntax_Syntax.n=
          ...
          ; FStar_Syntax_Syntax.vars= uu____12477; _ }
        , uu____12478
        , uu____12479 ))
      :: uu____12480 ->
        cfg.steps.reify_
...
let rec norm
    : cfg -> env -> stack -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack t ->
    let t1 =
      if cfg.debug.norm_delayed then
        match t.FStar_Syntax_Syntax.n with
    ...
    in
    log cfg (fun uu____12674 ->
        let uu____12675 = FStar_Syntax_Print.tag_of_term t1 in
        let uu____12676 = FStar_Syntax_Print.term_to_string t1 in
        let uu____12677 = FStar_Util.string_of_int (FStar_List.length env) in
        let uu____12684 =
          let uu____12685 =
            let uu____12688 = firstn (Prims.parse_int "4") stack in
            FStar_All.pipe_left FStar_Pervasives_Native.fst uu____12688
          in
          stack_to_string uu____12685
        in
        FStar_Util.print4
    ...
    | FStar_Syntax_Syntax.Tm_constant uu____12711 -> rebuild cfg env stack t1
    | FStar_Syntax_Syntax.Tm_name uu____12712 -> rebuild cfg env stack t1
    | FStar_Syntax_Syntax.Tm_fvar
        { FStar_Syntax_Syntax.fv_name= uu____12713
        ; FStar_Syntax_Syntax.fv_delta= FStar_Syntax_Syntax.Delta_constant
    ...
    | FStar_Syntax_Syntax.Tm_app (hd1, args)
      when ( FStar_Syntax_Util.is_fstar_tactics_embed hd1
        ...
        let t2 =
          ...
          { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_app (hd2, args1)
          ; FStar_Syntax_Syntax.pos= uu___149_12763.FStar_Syntax_Syntax.pos
          ; FStar_Syntax_Syntax.vars= uu___149_12763.FStar_Syntax_Syntax.vars
          }
        in
        rebuild cfg env stack t2
    | FStar_Syntax_Syntax.Tm_app (hd1, args)
      when ( Prims.op_Negation cfg.steps.no_full_norm
        ...
        | FStar_Pervasives_Native.None ->
            let stack1 =
              FStar_All.pipe_right stack
                (FStar_List.fold_right
                   (fun uu____12838 stack1 ->
                     match uu____12838 with a, aq ->
                       let uu____12850 =
                         let uu____12851 =
                           let uu____12858 =
                             let uu____12859 =
                               ...
                               in
                               (env, a, uu____12890, false)
                             in
                             Clos uu____12859
                           in
                           (uu____12858, aq, t1.FStar_Syntax_Syntax.pos)
                         in
                         Arg uu____12851
                       in
                       uu____12850 :: stack1 )
            ...
            let delta_level =
              let uu____12997 =
                FStar_All.pipe_right s
                  (FStar_Util.for_some (fun uu___86_13002 ->
              ...
              else [FStar_TypeChecker_Env.NoDelta]
            in
            let cfg'1 =
    ...
    | FStar_Syntax_Syntax.Tm_type u ->
        ...
        let uu____13032 =
          mk (FStar_Syntax_Syntax.Tm_type u1) t1.FStar_Syntax_Syntax.pos
        in
        rebuild cfg env stack uu____13032
    | FStar_Syntax_Syntax.Tm_uinst (t', us) ->
        if cfg.steps.erase_universes then norm cfg env stack t'
        else
          let us1 =
            let uu____13041 =
              let uu____13048 = FStar_List.map (norm_universe cfg env) us in
              (uu____13048, t1.FStar_Syntax_Syntax.pos)
            in
            UnivArgs uu____13041
          in
          let stack1 = us1 :: stack in
          norm cfg env stack1 t'
    | FStar_Syntax_Syntax.Tm_fvar fv ->
        let qninfo =
          let uu____13058 = FStar_Syntax_Syntax.lid_of_fv fv in
          FStar_TypeChecker_Env.lookup_qname cfg.tcenv uu____13058
        in
        let uu____13059 = FStar_TypeChecker_Env.qninfo_is_action qninfo in
        if uu____13059 then
          let b = should_reify cfg stack in
          log cfg (fun uu____13065 ->
              let uu____13066 = FStar_Syntax_Print.term_to_string t1 in
              let uu____13067 = FStar_Util.string_of_bool b in
              FStar_Util.print2 ">>> For DM4F action %s, should_reify = %s\n"
          ...
          let should_delta =
            FStar_All.pipe_right cfg.delta_level
              (FStar_Util.for_some (fun uu___87_13077 ->
          ...
          in
          let should_delta1 =
            if Prims.op_Negation should_delta then false
            else
              let attrs = FStar_TypeChecker_Env.attrs_of_qninfo qninfo in
              ...
              && ( ( match cfg.steps.unfold_only with
                 ...
                 | ( FStar_Pervasives_Native.Some ats
                   , FStar_Pervasives_Native.Some ats' ) ->
                     FStar_Util.for_some
                       (fun at -> FStar_Util.for_some (attr_eq at) ats')
                       ats
                 | uu____13141, uu____13142 -> false )
          in
          log cfg (fun uu____13164 ->
              let uu____13165 = FStar_Syntax_Print.term_to_string t1 in
              let uu____13166 =
                FStar_Range.string_of_range t1.FStar_Syntax_Syntax.pos
              in
              let uu____13167 = FStar_Util.string_of_bool should_delta1 in
              FStar_Util.print3 ">>> For %s (%s), should_delta = %s\n"
                uu____13165 uu____13166 uu____13167 ) ;
          if should_delta1 then do_unfold_fv cfg env stack t1 qninfo fv
          else rebuild cfg env stack t1
    | FStar_Syntax_Syntax.Tm_bvar x -> (
        ...
        | Clos (env1, t0, r, fix) ->
            if Prims.op_Negation fix || cfg.steps.zeta then
              let uu____13222 = FStar_ST.op_Bang r in
              match uu____13222 with
              | FStar_Pervasives_Native.Some (env2, t') -> (
                  log cfg (fun uu____13340 ->
                      let uu____13341 = FStar_Syntax_Print.term_to_string t1 in
                      let uu____13342 = FStar_Syntax_Print.term_to_string t' in
                      FStar_Util.print2 "Lazy hit: %s cached to %s\n"
                        uu____13341 uu____13342 ) ;
                  let uu____13343 =
                    let uu____13344 = FStar_Syntax_Subst.compress t' in
                    uu____13344.FStar_Syntax_Syntax.n
                  in
    ...
    | FStar_Syntax_Syntax.Tm_abs (bs, body, lopt) -> (
      ...
      | (Arg (c, uu____13455, uu____13456)) :: stack_rest -> (
        ...
        | uu____13469 ->
          ...
          | [] -> failwith "Impossible"
          | [b] ->
              log cfg (fun uu____13490 ->
                  let uu____13491 = closure_to_string c in
                  FStar_Util.print1 "\tShifted %s\n" uu____13491 ) ;
              norm cfg ((FStar_Pervasives_Native.Some b, c) :: env) stack_rest
                body
          | b :: tl1 ->
              log cfg (fun uu____13531 ->
                  let uu____13532 = closure_to_string c in
                  FStar_Util.print1 "\tShifted %s\n" uu____13532 ) ;
              let body1 =
                mk (FStar_Syntax_Syntax.Tm_abs (tl1, body, lopt))
                  t1.FStar_Syntax_Syntax.pos
              in
              norm cfg ((FStar_Pervasives_Native.Some b, c) :: env) stack_rest
                body1 )
      ...
      | (MemoLazy r) :: stack1 ->
          ...
          log cfg (fun uu____13610 ->
              let uu____13611 = FStar_Syntax_Print.term_to_string t1 in
              FStar_Util.print1 "\tSet memo %s\n" uu____13611 ) ;
          norm cfg env stack1 t1
      | (Debug uu____13612) :: uu____13613 -> (
          if cfg.steps.weak then
            let uu____13620 = closure_as_term cfg env t1 in
            rebuild cfg env stack uu____13620
          else
            let uu____13622 = FStar_Syntax_Subst.open_term' bs body in
            match uu____13622 with bs1, body1, opening ->
              let env' =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____13664 -> dummy :: env1)
                     env)
              in
              let lopt1 =
                match lopt with
                    ...
                    let rct =
                      if cfg.steps.check_no_uvars then
                        FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                          (fun t2 ->
                            let uu____13701 =
                              FStar_Syntax_Subst.subst opening t2
                            in
              ...
              let cfg1 =
                ...
                ; primitive_steps= uu___154_13723.primitive_steps
                ; strong= true
                ; memoize_lazy= uu___154_13723.memoize_lazy
                ; normalize_pure_lets= uu___154_13723.normalize_pure_lets }
              in
              norm cfg1 env'
                ( Abs (env, bs1, env', lopt1, t1.FStar_Syntax_Syntax.pos)
                :: stack1 ) body1 )
      | (Meta uu____13734) :: uu____13735 -> (
          if cfg.steps.weak then
            ...
            let uu____13744 = FStar_Syntax_Subst.open_term' bs body in
            match uu____13744 with bs1, body1, opening ->
              let env' =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____13786 -> dummy :: env1)
                     env)
              in
              let lopt1 =
                match lopt with
              ...
              let cfg1 =
                ...
                ; primitive_steps= uu___154_13845.primitive_steps
                ; strong= true
                ; memoize_lazy= uu___154_13845.memoize_lazy
                ; normalize_pure_lets= uu___154_13845.normalize_pure_lets }
              in
              norm cfg1 env'
                ( Abs (env, bs1, env', lopt1, t1.FStar_Syntax_Syntax.pos)
                :: stack1 ) body1 )
      | (Let uu____13856) :: uu____13857 -> (
          if cfg.steps.weak then
            ...
            let uu____13870 = FStar_Syntax_Subst.open_term' bs body in
            match uu____13870 with bs1, body1, opening ->
              let env' =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____13912 -> dummy :: env1)
                     env)
              in
              let lopt1 =
                match lopt with
              ...
              let cfg1 =
                ...
                ; primitive_steps= uu___154_13971.primitive_steps
                ; strong= true
                ; memoize_lazy= uu___154_13971.memoize_lazy
                ; normalize_pure_lets= uu___154_13971.normalize_pure_lets }
              in
              norm cfg1 env'
                ( Abs (env, bs1, env', lopt1, t1.FStar_Syntax_Syntax.pos)
                :: stack1 ) body1 )
      | (App uu____13982) :: uu____13983 -> (
          if cfg.steps.weak then
            ...
            let uu____13996 = FStar_Syntax_Subst.open_term' bs body in
            match uu____13996 with bs1, body1, opening ->
              let env' =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____14038 -> dummy :: env1)
                     env)
              in
              let lopt1 =
                match lopt with
              ...
              let cfg1 =
                ...
                ; primitive_steps= uu___154_14097.primitive_steps
                ; strong= true
                ; memoize_lazy= uu___154_14097.memoize_lazy
                ; normalize_pure_lets= uu___154_14097.normalize_pure_lets }
              in
              norm cfg1 env'
                ( Abs (env, bs1, env', lopt1, t1.FStar_Syntax_Syntax.pos)
                :: stack1 ) body1 )
      | (Abs uu____14108) :: uu____14109 -> (
          if cfg.steps.weak then
            ...
            let uu____14126 = FStar_Syntax_Subst.open_term' bs body in
            match uu____14126 with bs1, body1, opening ->
              let env' =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____14168 -> dummy :: env1)
                     env)
              in
              let lopt1 =
                match lopt with
              ...
              let cfg1 =
                ...
                ; primitive_steps= uu___154_14227.primitive_steps
                ; strong= true
                ; memoize_lazy= uu___154_14227.memoize_lazy
                ; normalize_pure_lets= uu___154_14227.normalize_pure_lets }
              in
              norm cfg1 env'
                ( Abs (env, bs1, env', lopt1, t1.FStar_Syntax_Syntax.pos)
                :: stack1 ) body1 )
      | [] ->
          if cfg.steps.weak then
            ...
            let uu____14240 = FStar_Syntax_Subst.open_term' bs body in
            match uu____14240 with bs1, body1, opening ->
              let env' =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____14282 -> dummy :: env1)
                     env)
              in
              let lopt1 =
                match lopt with
              ...
              let cfg1 =
                ...
                ; primitive_steps= uu___154_14341.primitive_steps
                ; strong= true
                ; memoize_lazy= uu___154_14341.memoize_lazy
                ; normalize_pure_lets= uu___154_14341.normalize_pure_lets }
              in
              norm cfg1 env'
                ( Abs (env, bs1, env', lopt1, t1.FStar_Syntax_Syntax.pos)
                :: stack1 ) body1 )
    | FStar_Syntax_Syntax.Tm_app (head1, args) ->
        let stack1 =
          FStar_All.pipe_right stack
            (FStar_List.fold_right
               (fun uu____14390 stack1 ->
                 match uu____14390 with a, aq ->
                   let uu____14402 =
                     let uu____14403 =
                       let uu____14410 =
                         let uu____14411 =
                           let uu____14442 =
                             FStar_Util.mk_ref FStar_Pervasives_Native.None
                           in
                           (env, a, uu____14442, false)
                         in
                         Clos uu____14411
                       in
                       (uu____14410, aq, t1.FStar_Syntax_Syntax.pos)
                     in
                     Arg uu____14403
                   in
                   uu____14402 :: stack1 )
    ...
    | FStar_Syntax_Syntax.Tm_refine (x, f) -> (
        if cfg.steps.weak then
          ...
          let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort in
          let uu____14572 =
            FStar_Syntax_Subst.open_term [(x, FStar_Pervasives_Native.None)] f
          in
          match uu____14572 with closing, f1 ->
            let f2 = norm cfg (dummy :: env) [] f1 in
            let t2 =
              let uu____14603 =
                let uu____14604 =
                  let uu____14611 = FStar_Syntax_Subst.close closing f2 in
                  ...
                  , uu____14611 )
                in
                FStar_Syntax_Syntax.Tm_refine uu____14604
              in
              mk uu____14603 t1.FStar_Syntax_Syntax.pos
            in
            rebuild cfg env stack t2 )
    | FStar_Syntax_Syntax.Tm_arrow (bs, c) -> (
        if cfg.steps.weak then
          ...
          match uu____14634 with bs1, c1 ->
            let c2 =
              let uu____14642 =
                FStar_All.pipe_right bs1
                  (FStar_List.fold_left
                     (fun env1 uu____14666 -> dummy :: env1)
                     env)
              in
              norm_comp cfg uu____14642 c1
            in
            let t2 =
              let uu____14688 = norm_binders cfg env bs1 in
              FStar_Syntax_Util.arrow uu____14688 c2
            in
            rebuild cfg env stack t2 )
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (t11, (tc, tacopt), l) -> (
      ...
      | (App
          ...
          , { FStar_Syntax_Syntax.n=
            ...
            ; FStar_Syntax_Syntax.vars= uu____14827; _ }
          , uu____14828
          , uu____14829 ))
        :: uu____14830 ->
          log cfg (fun uu____14839 ->
              FStar_Util.print_string "+++ Dropping ascription \n" ) ;
          norm cfg env stack t11
      | (MemoLazy uu____14840) :: uu____14841 ->
          log cfg (fun uu____14852 ->
              FStar_Util.print_string "+++ Dropping ascription \n" ) ;
          norm cfg env stack t11
      | uu____14853 ->
          log cfg (fun uu____14856 ->
              FStar_Util.print_string "+++ Keeping ascription \n" ) ;
          let t12 = norm cfg env [] t11 in
          log cfg (fun uu____14860 ->
          ...
          | (Cfg cfg1) :: stack1 ->
              let t2 =
                let uu____14898 =
                  let uu____14899 =
                    let uu____14926 = FStar_Syntax_Util.unascribe t12 in
                    (uu____14926, (tc1, tacopt1), l)
                  in
                  FStar_Syntax_Syntax.Tm_ascribed uu____14899
                in
                mk uu____14898 t1.FStar_Syntax_Syntax.pos
              in
          ...
          | uu____14945 ->
              let uu____14946 =
                let uu____14947 =
                  let uu____14948 =
                    let uu____14975 = FStar_Syntax_Util.unascribe t12 in
                    (uu____14975, (tc1, tacopt1), l)
                  in
                  FStar_Syntax_Syntax.Tm_ascribed uu____14948
                in
                mk uu____14947 t1.FStar_Syntax_Syntax.pos
              in
              rebuild cfg env stack uu____14946 )
    | FStar_Syntax_Syntax.Tm_match (head1, branches) ->
        let stack1 =
          Match (env, branches, t1.FStar_Syntax_Syntax.pos) :: stack
        in
        norm cfg env stack1 head1
    | FStar_Syntax_Syntax.Tm_let ((b, lbs), lbody)
      when FStar_Syntax_Syntax.is_top_level lbs && cfg.steps.compress_uvars ->
        let lbs1 =
          FStar_All.pipe_right lbs
            (FStar_List.map (fun lb ->
                 ...
                 in
                 match uu____15085 with openings, lbunivs ->
                   let cfg1 =
                     let uu___157_15105 = cfg in
                     let uu____15106 =
                       FStar_TypeChecker_Env.push_univ_vars cfg.tcenv lbunivs
                     in
                     { steps= uu___157_15105.steps
                     ; tcenv= uu____15106
                     ; debug= uu___157_15105.debug
                     ; delta_level= uu___157_15105.delta_level
                     ; primitive_steps= uu___157_15105.primitive_steps
                     ; strong= uu___157_15105.strong
                     ; memoize_lazy= uu___157_15105.memoize_lazy
                     ; normalize_pure_lets= uu___157_15105.normalize_pure_lets
                     }
                   in
                   let norm1 t2 =
                     let uu____15111 =
                       ...
                       in
                       norm cfg1 env [] uu____15112
                     in
                     FStar_Syntax_Subst.close_univ_vars lbunivs uu____15111
                   in
    ...
    | FStar_Syntax_Syntax.Tm_let
        ( ( uu____15127
          , { FStar_Syntax_Syntax.lbname= FStar_Util.Inr uu____15128
            ...
            ; FStar_Syntax_Syntax.lbattrs= uu____15133; _ }
            :: uu____15134 )
        , uu____15135 ) ->
        rebuild cfg env stack t1
    | FStar_Syntax_Syntax.Tm_let ((false, [lb]), body) -> (
        ...
        if uu____15175 then
          let binder =
            let uu____15177 = FStar_Util.left lb.FStar_Syntax_Syntax.lbname in
            FStar_Syntax_Syntax.mk_binder uu____15177
          in
          let env1 =
            let uu____15187 =
              let uu____15194 =
                let uu____15195 =
                  let uu____15226 =
                    FStar_Util.mk_ref FStar_Pervasives_Native.None
                  in
                  (env, lb.FStar_Syntax_Syntax.lbdef, uu____15226, false)
                in
                Clos uu____15195
              in
              (FStar_Pervasives_Native.Some binder, uu____15194)
            in
            uu____15187 :: env
          in
          log cfg (fun uu____15319 ->
              FStar_Util.print_string "+++ Reducing Tm_let\n" ) ;
          norm cfg env1 stack body
        else if cfg.steps.weak then (
          log cfg (fun uu____15323 ->
              ...
              let uu____15332 =
                let uu____15333 =
                  FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname
                    FStar_Util.left
                in
                FStar_All.pipe_right uu____15333 FStar_Syntax_Syntax.mk_binder
              in
              [uu____15332]
            in
            FStar_Syntax_Subst.open_term uu____15331 body
          in
          match uu____15326 with bs, body1 ->
            log cfg (fun uu____15342 ->
                FStar_Util.print_string "+++ Normalizing Tm_let -- type" ) ;
            let ty = norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp in
            let lbname =
              let x =
                let uu____15350 = FStar_List.hd bs in
                FStar_Pervasives_Native.fst uu____15350
              in
              FStar_Util.Inl
                (let uu___159_15360 = x in
                 ...
                 ; FStar_Syntax_Syntax.sort= ty })
            in
            log cfg (fun uu____15363 ->
                FStar_Util.print_string "+++ Normalizing Tm_let -- definiens\n"
            ) ;
            let lb1 =
              let uu___160_15365 = lb in
              let uu____15366 = norm cfg env [] lb.FStar_Syntax_Syntax.lbdef in
              { FStar_Syntax_Syntax.lbname
              ; FStar_Syntax_Syntax.lbunivs=
            ...
            let env' =
              FStar_All.pipe_right bs
                (FStar_List.fold_left
                   (fun env1 uu____15401 -> dummy :: env1)
                   env)
            in
            let stack1 = Cfg cfg :: stack in
            let cfg1 =
              ...
              ; primitive_steps= uu___161_15424.primitive_steps
              ; strong= true
              ; memoize_lazy= uu___161_15424.memoize_lazy
              ; normalize_pure_lets= uu___161_15424.normalize_pure_lets }
            in
            log cfg1 (fun uu____15427 ->
                FStar_Util.print_string "+++ Normalizing Tm_let -- body\n" ) ;
            norm cfg1 env'
              (Let (env, bs, lb1, t1.FStar_Syntax_Syntax.pos) :: stack1) body1
        )
    | FStar_Syntax_Syntax.Tm_let ((true, lbs), body)
      ...
      -> (
        ...
        match uu____15444 with lbs1, body1 ->
          let lbs2 =
            FStar_List.map
              (fun lb ->
                let ty = norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp in
                let lbname =
                  let uu____15480 =
                    ...
                    ; FStar_Syntax_Syntax.sort= ty }
                  in
                  FStar_Util.Inl uu____15480
                in
                let uu____15482 =
                  FStar_Syntax_Util.abs_formals lb.FStar_Syntax_Syntax.lbdef
                in
                match uu____15482 with xs, def_body, lopt ->
                  let xs1 = norm_binders cfg env xs in
                  let env1 =
                    let uu____15508 =
                      FStar_List.map (fun uu____15524 -> dummy) lbs1
                    in
                    let uu____15525 =
                      let uu____15534 =
                        FStar_List.map (fun uu____15554 -> dummy) xs1
                      in
                      FStar_List.append uu____15534 env
                    in
                  ...
                  let lopt1 =
                    ...
                    | FStar_Pervasives_Native.Some rc ->
                        let uu____15578 =
                          ...
                          { FStar_Syntax_Syntax.residual_effect=
                              uu___163_15579
                                .FStar_Syntax_Syntax.residual_effect
                          ; FStar_Syntax_Syntax.residual_typ= uu____15580
                          ; FStar_Syntax_Syntax.residual_flags=
                    ...
                    | uu____15587 -> lopt
                  in
                  let def = FStar_Syntax_Util.abs xs1 def_body1 lopt1 in
          ...
          in
          let env' =
            let uu____15601 = FStar_List.map (fun uu____15617 -> dummy) lbs2 in
            FStar_List.append uu____15601 env
          in
          let body2 = norm cfg env' [] body1 in
          let uu____15625 = FStar_Syntax_Subst.close_let_rec lbs2 body2 in
          match uu____15625 with lbs3, body3 ->
            let t2 =
              let uu___165_15641 = t1 in
              { FStar_Syntax_Syntax.n=
                  FStar_Syntax_Syntax.Tm_let ((true, lbs3), body3)
              ; FStar_Syntax_Syntax.pos= uu___165_15641.FStar_Syntax_Syntax.pos
              ; FStar_Syntax_Syntax.vars=
    ...
    | FStar_Syntax_Syntax.Tm_let (lbs, body) -> (
        let uu____15687 =
          FStar_List.fold_right
            (fun lb uu____15763 ->
              match uu____15763 with rec_env, memos, i ->
                let bv =
                  let uu___166_15884 =
                    FStar_Util.left lb.FStar_Syntax_Syntax.lbname
                  in
                ...
                let fix_f_i =
                  mk (FStar_Syntax_Syntax.Tm_let (lbs, f_i))
                    t1.FStar_Syntax_Syntax.pos
                in
                let memo = FStar_Util.mk_ref FStar_Pervasives_Native.None in
                let rec_env1 =
                  ( FStar_Pervasives_Native.None
                  , Clos (env, fix_f_i, memo, true) )
                  :: rec_env
                in
                (rec_env1, memo :: memos, i + Prims.parse_int "1") )
            (FStar_Pervasives_Native.snd lbs)
            (env, [], Prims.parse_int "0")
        in
        match uu____15687 with rec_env, memos, uu____16097 ->
          let uu____16150 =
            FStar_List.map2
              (fun lb memo ->
    ...
    | FStar_Syntax_Syntax.Tm_meta (head1, m) -> (
        log cfg (fun uu____16610 ->
            let uu____16611 = FStar_Syntax_Print.metadata_to_string m in
        ...
        | uu____16633 ->
            if cfg.steps.unmeta then norm cfg env stack head1
            else
              match stack with
              | uu____16635 :: uu____16636 -> (
                match m with
                | FStar_Syntax_Syntax.Meta_labeled (l, r, uu____16641) ->
              ...
              | [] ->
                  ...
                  let m1 =
                    match m with
                    | FStar_Syntax_Syntax.Meta_pattern args ->
                        let uu____16687 = norm_pattern_args cfg env args in
                        FStar_Syntax_Syntax.Meta_pattern uu____16687
                    | uu____16698 -> m
                  in
                  let t2 =
    ...
    | FStar_Syntax_Syntax.Tm_uvar uu____16728 ->
        ...
        | FStar_Syntax_Syntax.Tm_uvar uu____16746 ->
            if cfg.steps.check_no_uvars then
              let uu____16763 =
                let uu____16764 =
                  FStar_Range.string_of_range t2.FStar_Syntax_Syntax.pos
                in
                let uu____16765 = FStar_Syntax_Print.term_to_string t2 in
                FStar_Util.format2
                  "(%s) CheckNoUvars: Unexpected unification variable remains: %s"
...
and do_unfold_fv
    : cfg -> env -> stack_elt Prims.list -> FStar_Syntax_Syntax.term
      -> FStar_TypeChecker_Env.qninfo -> FStar_Syntax_Syntax.fv
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack t0 qninfo f ->
    let r_env =
      let uu____16777 = FStar_Syntax_Syntax.range_of_fv f in
      FStar_TypeChecker_Env.set_range cfg.tcenv uu____16777
    in
    let uu____16778 =
      FStar_TypeChecker_Env.lookup_definition_qninfo cfg.delta_level
        f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v qninfo
    in
    match uu____16778 with
    | FStar_Pervasives_Native.None ->
        log cfg (fun uu____16791 -> FStar_Util.print "Tm_fvar case 2\n" []) ;
        rebuild cfg env stack t0
    | FStar_Pervasives_Native.Some (us, t) ->
        log cfg (fun uu____16802 ->
            let uu____16803 = FStar_Syntax_Print.term_to_string t0 in
            let uu____16804 = FStar_Syntax_Print.term_to_string t in
            FStar_Util.print2 ">>> Unfolded %s to %s\n" uu____16803 uu____16804
        ) ;
        let t1 =
          if cfg.steps.unfold_until
          ...
          | (UnivArgs (us', uu____16817)) :: stack1 ->
              let env1 =
                FStar_All.pipe_right us'
                  (FStar_List.fold_left
                     (fun env1 u ->
                       (FStar_Pervasives_Native.None, Univ u) :: env1 )
                     env)
              in
              norm cfg env1 stack1 t1
          | uu____16872 when cfg.steps.erase_universes -> norm cfg env stack t1
          | uu____16875 ->
              let uu____16878 =
                let uu____16879 =
    ...
    : cfg -> env -> stack -> FStar_Syntax_Syntax.term
      -> ( FStar_Syntax_Syntax.monad_name
         , ( FStar_Syntax_Syntax.monad_name
           , FStar_Syntax_Syntax.monad_name )
           FStar_Pervasives_Native.tuple2 )
         FStar_Util.either -> FStar_Syntax_Syntax.typ
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack head1 m t ->
    let t1 = norm cfg env [] t in
    let stack1 = Cfg cfg :: stack in
    let cfg1 =
      if cfg.steps.pure_subterms_within_computations then
        ...
        ; normalize_pure_lets= uu___167_16900.normalize_pure_lets }
      else
        ...
        { steps=
            (let uu___169_16906 = cfg.steps in
             ...
             ; allow_unbound_universes= uu___169_16906.allow_unbound_universes
        ...
        ; normalize_pure_lets= uu___168_16903.normalize_pure_lets }
    in
    let metadata =
      match m with
      | FStar_Util.Inl m1 -> FStar_Syntax_Syntax.Meta_monadic (m1, t1)
      | FStar_Util.Inr (m1, m') ->
          FStar_Syntax_Syntax.Meta_monadic_lift (m1, m', t1)
    in
    norm cfg1 env (Meta (metadata, head1.FStar_Syntax_Syntax.pos) :: stack1)
      head1


and do_reify_monadic
    : (Prims.unit -> FStar_Syntax_Syntax.term) -> cfg -> env
      -> stack_elt Prims.list -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.monad_name -> FStar_Syntax_Syntax.typ
      -> FStar_Syntax_Syntax.term =
  fun fallback cfg env stack head1 m t ->
    let head0 = head1 in
    let head2 = FStar_Syntax_Util.unascribe head1 in
    log cfg (fun uu____16936 ->
        let uu____16937 = FStar_Syntax_Print.tag_of_term head2 in
        let uu____16938 = FStar_Syntax_Print.term_to_string head2 in
        FStar_Util.print2 "Reifying: (%s) %s\n" uu____16937 uu____16938 ) ;
    let uu____16939 =
      let uu____16940 = FStar_Syntax_Subst.compress head2 in
      uu____16940.FStar_Syntax_Syntax.n
    in
    match uu____16939 with
    | FStar_Syntax_Syntax.Tm_let ((false, [lb]), body) -> (
        let ed = FStar_TypeChecker_Env.get_effect_decl cfg.tcenv m in
        let uu____16958 = ed.FStar_Syntax_Syntax.bind_repr in
        match uu____16958 with uu____16959, bind_repr ->
          ...
          | FStar_Util.Inl x ->
              let is_return e =
                let uu____16973 =
                  let uu____16974 = FStar_Syntax_Subst.compress e in
                  uu____16974.FStar_Syntax_Syntax.n
                in
                ...
                | FStar_Syntax_Syntax.Tm_meta
                  ...
                  -> (
                    let uu____16990 =
                      let uu____16991 = FStar_Syntax_Subst.compress e1 in
                      uu____16991.FStar_Syntax_Syntax.n
                    in
                    ...
                    | FStar_Syntax_Syntax.Tm_meta
                      ...
                      when FStar_Syntax_Util.is_pure_effect msrc ->
                        let uu____17008 = FStar_Syntax_Subst.compress e2 in
                        FStar_Pervasives_Native.Some uu____17008
                    | uu____17009 -> FStar_Pervasives_Native.None )
                | uu____17010 -> FStar_Pervasives_Native.None
              in
              let uu____17011 = is_return lb.FStar_Syntax_Syntax.lbdef in
              ...
              | FStar_Pervasives_Native.Some e ->
                  ...
                  let uu____17018 =
                    let uu____17019 =
                      let uu____17022 =
                        let uu____17023 =
                          let uu____17036 = FStar_Syntax_Util.mk_reify body in
                          ((false, [lb1]), uu____17036)
                        in
                        FStar_Syntax_Syntax.Tm_let uu____17023
                      in
                      FStar_Syntax_Syntax.mk uu____17022
                    in
                    uu____17019 FStar_Pervasives_Native.None
              ...
              | FStar_Pervasives_Native.None ->
                  let uu____17052 =
                    ...
                    | FStar_Pervasives_Native.Some
                        { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_bvar y
                        ; FStar_Syntax_Syntax.pos= uu____17057
                        ; FStar_Syntax_Syntax.vars= uu____17058; _ } ->
                  ...
                  if uu____17052 then
                    ...
                    let rng = head2.FStar_Syntax_Syntax.pos in
                    let head3 =
                      FStar_All.pipe_left FStar_Syntax_Util.mk_reify
                        lb.FStar_Syntax_Syntax.lbdef
                    in
                    let body1 =
                      FStar_All.pipe_left FStar_Syntax_Util.mk_reify body
                    in
                    let body_rc =
                    ...
                    let body2 =
                      let uu____17086 =
                        let uu____17089 =
                          ...
                          in
                          FStar_Syntax_Syntax.Tm_abs uu____17090
                        in
                        FStar_Syntax_Syntax.mk uu____17089
                      in
                      uu____17086 FStar_Pervasives_Native.None
                    ...
                    let bind_inst =
                      let uu____17126 =
                        let uu____17127 =
                          FStar_Syntax_Subst.compress bind_repr
                        in
                            ...
                            let uu____17144 =
                              let uu____17145 =
                                let uu____17152 =
                                  let uu____17155 =
                                    let uu____17156 =
                                      close1 lb.FStar_Syntax_Syntax.lbtyp
                                    in
                                    cfg.tcenv.FStar_TypeChecker_Env.universe_of
                                      cfg.tcenv uu____17156
                                  in
                                  let uu____17157 =
                                    let uu____17160 =
                                      let uu____17161 = close1 t in
                                      cfg.tcenv
                                        .FStar_TypeChecker_Env.universe_of
                                        cfg.tcenv uu____17161
                                    in
                                    [uu____17160]
                                  in
                                  uu____17155 :: uu____17157
                                in
                                (bind1, uu____17152)
                              in
                              FStar_Syntax_Syntax.Tm_uinst uu____17145
                            in
                            FStar_Syntax_Syntax.mk uu____17144
                          in
                          uu____17141 FStar_Pervasives_Native.None rng
                      | uu____17169 ->
                            ...
                            let uu____17194 =
                              ...
                              let uu____17198 =
                                ...
                                let uu____17202 =
                                  ...
                                  let uu____17206 =
                                    let uu____17209 =
                                      FStar_Syntax_Syntax.as_arg head3
                                    in
                                    let uu____17210 =
                                      let uu____17213 =
                                        FStar_Syntax_Syntax.as_arg
                                      ...
                                      let uu____17214 =
                                        let uu____17217 =
                                          FStar_Syntax_Syntax.as_arg body2
                                        in
                                        [uu____17217]
                                      in
                                      uu____17213 :: uu____17214
                                    in
                                    uu____17209 :: uu____17210
                                  in
                                  uu____17205 :: uu____17206
                                in
                                uu____17201 :: uu____17202
                              in
                              uu____17197 :: uu____17198
                            in
                            (bind_inst, uu____17194)
                          in
                          FStar_Syntax_Syntax.Tm_app uu____17179
                        in
                        FStar_Syntax_Syntax.mk uu____17178
                      in
                      uu____17175 FStar_Pervasives_Native.None rng
                    in
                    log cfg (fun uu____17229 ->
                        let uu____17230 =
                          FStar_Syntax_Print.term_to_string head0
                        in
                        let uu____17231 =
                          FStar_Syntax_Print.term_to_string reified
                        in
                        FStar_Util.print2 "Reified (1) <%s> to %s\n"
    ...
    | FStar_Syntax_Syntax.Tm_app (head_app, args) -> (
        ...
        match uu____17256 with uu____17257, bind_repr ->
          let maybe_unfold_action head3 =
            let maybe_extract_fv t1 =
              let t2 =
                let uu____17292 =
                  let uu____17293 = FStar_Syntax_Subst.compress t1 in
                  uu____17293.FStar_Syntax_Syntax.n
                in
                match uu____17292 with
                | FStar_Syntax_Syntax.Tm_uinst (t2, uu____17299) -> t2
                | uu____17304 -> head3
              in
              let uu____17305 =
                let uu____17306 = FStar_Syntax_Subst.compress t2 in
                uu____17306.FStar_Syntax_Syntax.n
              in
              match uu____17305 with
              | FStar_Syntax_Syntax.Tm_fvar x -> FStar_Pervasives_Native.Some x
              | uu____17312 -> FStar_Pervasives_Native.None
            in
            let uu____17313 = maybe_extract_fv head3 in
            match uu____17313 with
            | FStar_Pervasives_Native.Some x
              when let uu____17323 = FStar_Syntax_Syntax.lid_of_fv x in
                   FStar_TypeChecker_Env.is_action cfg.tcenv uu____17323 ->
                ...
                let action_unfolded =
                  ...
                  | FStar_Pervasives_Native.Some uu____17333 ->
                      FStar_Pervasives_Native.Some true
                  | uu____17334 -> FStar_Pervasives_Native.Some false
                in
                (head4, action_unfolded)
            | uu____17339 -> (head3, FStar_Pervasives_Native.None)
          in
          (let is_arg_impure uu____17354 =
             match uu____17354 with e, q ->
               let uu____17361 =
                 let uu____17362 = FStar_Syntax_Subst.compress e in
                 uu____17362.FStar_Syntax_Syntax.n
               in
               match uu____17361 with
               | FStar_Syntax_Syntax.Tm_meta
                   (e0, FStar_Syntax_Syntax.Meta_monadic_lift (m1, m2, t')) ->
                   Prims.op_Negation (FStar_Syntax_Util.is_pure_effect m1)
               | uu____17377 -> false
           in
           let uu____17378 =
             let uu____17379 =
               let uu____17386 = FStar_Syntax_Syntax.as_arg head_app in
               uu____17386 :: args
             in
           ...
           if uu____17378 then
             let uu____17391 =
               let uu____17392 = FStar_Syntax_Print.term_to_string head2 in
               FStar_Util.format1
          ...
          match uu____17394 with head_app1, found_action ->
            let mk1 tm =
              FStar_Syntax_Syntax.mk tm FStar_Pervasives_Native.None
                head2.FStar_Syntax_Syntax.pos
            in
            let body = mk1 (FStar_Syntax_Syntax.Tm_app (head_app1, args)) in
            let body1 =
              match found_action with
              | FStar_Pervasives_Native.None -> FStar_Syntax_Util.mk_reify body
              | FStar_Pervasives_Native.Some false ->
                  mk1
                    (FStar_Syntax_Syntax.Tm_meta
                       (body, FStar_Syntax_Syntax.Meta_monadic (m, t)))
              | FStar_Pervasives_Native.Some true -> body
            in
            log cfg (fun uu____17435 ->
                let uu____17436 = FStar_Syntax_Print.term_to_string head0 in
                let uu____17437 = FStar_Syntax_Print.term_to_string body1 in
    ...
    | FStar_Syntax_Syntax.Tm_meta
        ...
        let lifted =
          ...
          reify_lift cfg e msrc mtgt uu____17464
        in
        log cfg (fun uu____17468 ->
            let uu____17469 = FStar_Syntax_Print.term_to_string lifted in
    ...
    | FStar_Syntax_Syntax.Tm_match (e, branches) ->
        let branches1 =
          FStar_All.pipe_right branches
            (FStar_List.map (fun uu____17597 ->
                 match uu____17597 with pat, wopt, tm ->
                   let uu____17645 = FStar_Syntax_Util.mk_reify tm in
...
and reify_lift
    : cfg -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
      -> FStar_Syntax_Syntax.monad_name -> FStar_Syntax_Syntax.monad_name
      -> FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun cfg e msrc mtgt t ->
    let env = cfg.tcenv in
    log cfg (fun uu____17692 ->
    ...
    if FStar_Syntax_Util.is_pure_effect msrc then
      let ed = FStar_TypeChecker_Env.get_effect_decl env mtgt in
      let uu____17697 = ed.FStar_Syntax_Syntax.return_repr in
      match uu____17697 with uu____17698, return_repr ->
        let return_inst =
          let uu____17707 =
            let uu____17708 = FStar_Syntax_Subst.compress return_repr in
            uu____17708.FStar_Syntax_Syntax.n
          in
          match uu____17707 with
          | FStar_Syntax_Syntax.Tm_uinst (return_tm, [uu____17714]) ->
              let uu____17721 =
                let uu____17724 =
                  let uu____17725 =
                    let uu____17732 =
                      ...
                      [uu____17735]
                    in
                    (return_tm, uu____17732)
                  in
                  FStar_Syntax_Syntax.Tm_uinst uu____17725
                in
                FStar_Syntax_Syntax.mk uu____17724
              in
              uu____17721 FStar_Pervasives_Native.None
                e.FStar_Syntax_Syntax.pos
          | uu____17743 -> failwith "NIY : Reification of indexed effects"
        in
        let uu____17746 =
          let uu____17749 =
            let uu____17750 =
              let uu____17765 =
                ...
                let uu____17769 =
                  ...
                  [uu____17772]
                in
                uu____17768 :: uu____17769
              in
              (return_inst, uu____17765)
            in
            FStar_Syntax_Syntax.Tm_app uu____17750
          in
          FStar_Syntax_Syntax.mk uu____17749
        in
        uu____17746 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos
    else
      let uu____17781 = FStar_TypeChecker_Env.monad_leq env msrc mtgt in
      ...
      | FStar_Pervasives_Native.Some
          ...
          ; FStar_TypeChecker_Env.mlift=
              ...
              ; FStar_TypeChecker_Env.mlift_term= FStar_Pervasives_Native.None; _
              }; _ } ->
          let uu____17802 =
            FStar_Util.format2
      ...
      | FStar_Pervasives_Native.Some
          ...
          let uu____17829 = env.FStar_TypeChecker_Env.universe_of env t in
...
and norm_pattern_args
  ...
  fun cfg env args ->
    FStar_All.pipe_right args
      (FStar_List.map
         (FStar_List.map (fun uu____17886 ->
              match uu____17886 with a, imp ->
    ...
    | FStar_Syntax_Syntax.Total (t, uopt) ->
        ...
        let uu____17912 =
          let uu____17913 =
            ...
            let uu____17923 = FStar_Option.map (norm_universe cfg env) uopt in
            (uu____17922, uu____17923)
          in
          FStar_Syntax_Syntax.Total uu____17913
        in
        { FStar_Syntax_Syntax.n= uu____17912
        ; FStar_Syntax_Syntax.pos= uu___171_17911.FStar_Syntax_Syntax.pos
        ; FStar_Syntax_Syntax.vars= uu___171_17911.FStar_Syntax_Syntax.vars }
    | FStar_Syntax_Syntax.GTotal (t, uopt) ->
        let uu___172_17938 = comp in
        let uu____17939 =
          let uu____17940 =
            let uu____17949 = norm cfg env [] t in
            let uu____17950 = FStar_Option.map (norm_universe cfg env) uopt in
            (uu____17949, uu____17950)
          in
          FStar_Syntax_Syntax.GTotal uu____17940
        in
        { FStar_Syntax_Syntax.n= uu____17939
        ; FStar_Syntax_Syntax.pos= uu___172_17938.FStar_Syntax_Syntax.pos
        ; FStar_Syntax_Syntax.vars= uu___172_17938.FStar_Syntax_Syntax.vars }
    | FStar_Syntax_Syntax.Comp ct ->
        let norm_args args =
          FStar_All.pipe_right args
            (FStar_List.map (fun uu____18002 ->
                 match uu____18002 with a, i ->
                   let uu____18013 = norm cfg env [] a in
                   (uu____18013, i) ))
        in
        let flags1 =
          FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
            (FStar_List.map (fun uu___88_18024 ->
        ...
        let uu____18033 =
          let uu____18034 =
            ...
            in
            let uu____18037 =
              norm cfg env [] ct.FStar_Syntax_Syntax.result_typ
            in
            let uu____18040 = norm_args ct.FStar_Syntax_Syntax.effect_args in
            ...
            ; FStar_Syntax_Syntax.flags= flags1 }
          in
          FStar_Syntax_Syntax.Comp uu____18034
        in
        { FStar_Syntax_Syntax.n= uu____18033
        ; FStar_Syntax_Syntax.pos= uu___173_18032.FStar_Syntax_Syntax.pos
        ; FStar_Syntax_Syntax.vars= uu___173_18032.FStar_Syntax_Syntax.vars }


and norm_binder
    : cfg -> env -> FStar_Syntax_Syntax.binder -> FStar_Syntax_Syntax.binder =
  fun cfg env uu____18051 ->
    match uu____18051 with x, imp ->
      let uu____18054 =
        let uu___175_18055 = x in
        let uu____18056 = norm cfg env [] x.FStar_Syntax_Syntax.sort in
        { FStar_Syntax_Syntax.ppname= uu___175_18055.FStar_Syntax_Syntax.ppname
        ; FStar_Syntax_Syntax.index= uu___175_18055.FStar_Syntax_Syntax.index
...
and norm_binders
  ...
  fun cfg env bs ->
    let uu____18062 =
      FStar_List.fold_left
        (fun uu____18080 b ->
          match uu____18080 with nbs', env1 ->
...
and rebuild
    : cfg -> env -> stack -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun cfg env stack t ->
    log cfg (fun uu____18158 ->
        let uu____18159 = FStar_Syntax_Print.tag_of_term t in
        let uu____18160 = FStar_Syntax_Print.term_to_string t in
        let uu____18161 = FStar_Util.string_of_int (FStar_List.length env) in
        let uu____18168 =
          let uu____18169 =
            let uu____18172 = firstn (Prims.parse_int "4") stack in
            FStar_All.pipe_left FStar_Pervasives_Native.fst uu____18172
          in
          stack_to_string uu____18169
        in
        FStar_Util.print4
    ...
    | (Debug (tm, time_then)) :: stack1 ->
        if cfg.debug.print_normalized then
          ...
          let uu____18203 =
            let uu____18204 =
              let uu____18205 = FStar_Util.time_diff time_then time_now in
              FStar_Pervasives_Native.snd uu____18205
            in
            FStar_Util.string_of_int uu____18204
          in
          let uu____18210 = FStar_Syntax_Print.term_to_string tm in
          let uu____18211 = FStar_Syntax_Print.term_to_string t1 in
          FStar_Util.print3 "Normalized (%s ms) %s\n\tto %s\n" uu____18203
            uu____18210 uu____18211
        else () ;
    ...
    | (Abs (env', bs, env'', lopt, r)) :: stack1 ->
        ...
        let uu____18302 =
          ...
          { FStar_Syntax_Syntax.n= uu___177_18303.FStar_Syntax_Syntax.n
          ; FStar_Syntax_Syntax.pos= r
          ; FStar_Syntax_Syntax.vars= uu___177_18303.FStar_Syntax_Syntax.vars
          }
        in
    ...
    | (Arg (Clos (env_arg, tm, m, uu____18328), aq, r)) :: stack1 -> (
        log cfg (fun uu____18381 ->
            let uu____18382 = FStar_Syntax_Print.term_to_string tm in
            FStar_Util.print1 "Rebuilding with arg %s\n" uu____18382 ) ;
        if Prims.op_Negation cfg.steps.iota then
          if cfg.steps.hnf then
          ...
          | FStar_Pervasives_Native.None ->
              if cfg.steps.hnf then
                ...
                let stack2 = MemoLazy m :: App (env, t1, aq, r) :: stack1 in
                norm cfg env_arg stack2 tm
    ...
    | (App (env1, head1, aq, r)) :: stack' when should_reify cfg stack -> (
        ...
        let uu____18585 =
          ...
          uu____18586.FStar_Syntax_Syntax.n
        in
        ...
        | FStar_Syntax_Syntax.Tm_meta
            ...
            let lifted =
              ...
              reify_lift cfg t2 msrc mtgt uu____18613
            in
            log cfg (fun uu____18617 ->
                let uu____18618 = FStar_Syntax_Print.term_to_string lifted in
        ...
        | FStar_Syntax_Syntax.Tm_app
            ( { FStar_Syntax_Syntax.n=
              ...
              ; FStar_Syntax_Syntax.vars= uu____18622; _ }
            , [(e, uu____18624)] ) ->
    ...
    | (Match (env1, branches, r)) :: stack1 ->
        log cfg (fun uu____18673 ->
            let uu____18674 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.print1 "Rebuilding with match, scrutinee is %s ...\n"
              uu____18674 ) ;
        let scrutinee = t1 in
        let norm_and_rebuild_match uu____18679 =
          log cfg (fun uu____18684 ->
              let uu____18685 = FStar_Syntax_Print.term_to_string scrutinee in
              let uu____18686 =
                let uu____18687 =
                  FStar_All.pipe_right branches
                    (FStar_List.map (fun uu____18704 ->
                         match uu____18704
                         with p, uu____18714, uu____18715 ->
                           FStar_Syntax_Print.pat_to_string p ))
                in
                FStar_All.pipe_right uu____18687 (FStar_String.concat "\n\t")
              in
              FStar_Util.print2
          ...
          let cfg_exclude_iota_zeta =
            let new_delta =
              FStar_All.pipe_right cfg.delta_level
                (FStar_List.filter (fun uu___89_18732 ->
            ...
            { steps=
                (let uu___179_18737 = cfg.steps in
                 ...
                 ; eager_unfolding= uu___179_18737.eager_unfolding
                 ...
                 ; erase_universes= uu___179_18737.erase_universes
                 ; allow_unbound_universes=
            ...
            ; normalize_pure_lets= uu___178_18734.normalize_pure_lets }
          in
          let norm_or_whnf env2 t2 =
            if whnf then closure_as_term cfg_exclude_iota_zeta env2 t2
            else norm cfg_exclude_iota_zeta env2 [] t2
          in
          let rec norm_pat env2 p =
            match p.FStar_Syntax_Syntax.v with
            | FStar_Syntax_Syntax.Pat_constant uu____18769 -> (p, env2)
            | FStar_Syntax_Syntax.Pat_cons (fv, pats) -> (
                let uu____18790 =
                  FStar_All.pipe_right pats
                    (FStar_List.fold_left
                       (fun uu____18850 uu____18851 ->
                         match (uu____18850, uu____18851)
                         with (pats1, env3), (p1, b) ->
                           let uu____18942 = norm_pat env3 p1 in
                           match uu____18942 with p2, env4 ->
                             ((p2, b) :: pats1, env4) )
                       ([], env2))
                in
                match uu____18790 with pats1, env3 ->
            ...
            | uu____19118 ->
                FStar_All.pipe_right branches
                  (FStar_List.map (fun branch1 ->
                       ...
                       in
                       match uu____19132 with p, wopt, e ->
                         let uu____19152 = norm_pat env1 p in
                         match uu____19152 with p1, env2 ->
                           let wopt1 =
                             match wopt with
                             | FStar_Pervasives_Native.None ->
                                 FStar_Pervasives_Native.None
                             | FStar_Pervasives_Native.Some w ->
                                 let uu____19177 = norm_or_whnf env2 w in
          ...
          in
          let uu____19183 =
            mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1)) r
          in
          rebuild cfg env1 stack1 uu____19183
        in
        let rec is_cons head1 =
          match head1.FStar_Syntax_Syntax.n with
          | FStar_Syntax_Syntax.Tm_uinst (h, uu____19193) -> is_cons h
        ...
        let rec matches_pat scrutinee_orig p =
          ...
          let uu____19355 = FStar_Syntax_Util.head_and_args scrutinee1 in
          match uu____19355 with head1, args ->
            match p.FStar_Syntax_Syntax.v with
            | FStar_Syntax_Syntax.Pat_var bv ->
                FStar_Util.Inl [(bv, scrutinee_orig)]
            | FStar_Syntax_Syntax.Pat_wild bv ->
                FStar_Util.Inl [(bv, scrutinee_orig)]
            | FStar_Syntax_Syntax.Pat_dot_term uu____19442 -> FStar_Util.Inl []
            | FStar_Syntax_Syntax.Pat_constant s -> (
              match scrutinee1.FStar_Syntax_Syntax.n with
              | FStar_Syntax_Syntax.Tm_constant s'
                when FStar_Const.eq_const s s' ->
                  FStar_Util.Inl []
              | uu____19481 ->
                  let uu____19482 =
                    let uu____19483 = is_cons head1 in
                    Prims.op_Negation uu____19483
                  in
                  FStar_Util.Inr uu____19482 )
            | FStar_Syntax_Syntax.Pat_cons (fv, arg_pats) ->
                let uu____19508 =
                  let uu____19509 = FStar_Syntax_Util.un_uinst head1 in
                  uu____19509.FStar_Syntax_Syntax.n
                in
                match uu____19508 with
                | FStar_Syntax_Syntax.Tm_fvar fv'
                  when FStar_Syntax_Syntax.fv_eq fv fv' ->
        ...
        let rec matches scrutinee1 p =
          ...
          | (p1, wopt, b) :: rest ->
              ...
              | FStar_Util.Inl s ->
                  log cfg (fun uu____19840 ->
                      let uu____19841 = FStar_Syntax_Print.pat_to_string p1 in
                      let uu____19842 =
                        let uu____19843 =
                          FStar_List.map
                            (fun uu____19853 ->
                              match uu____19853 with uu____19858, t2 ->
                        ...
                        FStar_All.pipe_right uu____19843
                          (FStar_String.concat "; ")
                      in
                      FStar_Util.print2 "Matches pattern %s with subst = %s\n"
                        uu____19841 uu____19842 ) ;
                  let env2 =
                    FStar_List.fold_left
                      (fun env2 uu____19889 ->
                        match uu____19889 with bv, t2 ->
                          let uu____19912 =
                            let uu____19919 =
                              let uu____19922 =
                                FStar_Syntax_Syntax.mk_binder bv
                              in
                              FStar_Pervasives_Native.Some uu____19922
                            in
                            let uu____19923 =
                              let uu____19924 =
                                let uu____19955 =
        ...
        in
        if Prims.op_Negation cfg.steps.iota then norm_and_rebuild_match ()
        else matches scrutinee branches


let config'
    : primitive_step Prims.list -> step Prims.list -> FStar_TypeChecker_Env.env
      -> cfg =
  fun psteps s e ->
    let d =
      FStar_All.pipe_right s
        (FStar_List.collect (fun uu___90_20100 ->
             match uu___90_20100 with
             | UnfoldUntil k -> [FStar_TypeChecker_Env.Unfold k]
             | Eager_unfolding -> [FStar_TypeChecker_Env.Eager_unfolding_only]
             | Inlining -> [FStar_TypeChecker_Env.Inlining]
             | UnfoldTac -> [FStar_TypeChecker_Env.UnfoldTac]
             | uu____20104 -> [] ))
    in
    let d1 =
      match d with [] -> [FStar_TypeChecker_Env.NoDelta] | uu____20110 -> d
    in
    ...
    let uu____20114 =
      ...
      in
      let uu____20117 =
        FStar_TypeChecker_Env.debug e (FStar_Options.Other "380")
      in
      let uu____20118 =
...
let normalize
    : steps -> FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun s e t -> normalize_with_primitive_steps [] s e t


let normalize_comp
    : steps -> FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.comp
      -> FStar_Syntax_Syntax.comp =
  fun s e t ->
    let uu____20183 = config s e in
    norm_comp uu____20183 [] t
...
let normalize_universe
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.universe
      -> FStar_Syntax_Syntax.universe =
  fun env u ->
    let uu____20196 = config [] env in
    norm_universe uu____20196 [] u
...
let ghost_to_pure
  ...
  fun env c ->
    ...
    let non_info t =
      ...
      FStar_Syntax_Util.non_informative uu____20214
    in
    match c.FStar_Syntax_Syntax.n with
    ...
    | FStar_Syntax_Syntax.GTotal (t, uopt) when non_info t ->
        ...
        ; FStar_Syntax_Syntax.pos= uu___187_20240.FStar_Syntax_Syntax.pos
        ; FStar_Syntax_Syntax.vars= uu___187_20240.FStar_Syntax_Syntax.vars }
    | FStar_Syntax_Syntax.Comp ct ->
        let l =
          FStar_TypeChecker_Env.norm_eff_name cfg.tcenv
        ...
        if uu____20247 then
          let ct1 =
            match
              downgrade_ghost_effect_name ct.FStar_Syntax_Syntax.effect_name
            with
            | FStar_Pervasives_Native.Some pure_eff ->
                let flags1 =
                  if FStar_Ident.lid_equals pure_eff
                       FStar_Parser_Const.effect_Tot_lid
                  then
                    FStar_Syntax_Syntax.TOTAL :: ct.FStar_Syntax_Syntax.flags
                  else ct.FStar_Syntax_Syntax.flags
                in
          ...
          ; FStar_Syntax_Syntax.pos= uu___190_20259.FStar_Syntax_Syntax.pos
          ; FStar_Syntax_Syntax.vars= uu___190_20259.FStar_Syntax_Syntax.vars
          }
        else c
    | uu____20261 -> c
...
let ghost_to_pure_lcomp
  ...
  fun env lc ->
    ...
    let non_info t =
      ...
      FStar_Syntax_Util.non_informative uu____20273
    in
    let uu____20280 =
    ...
    if uu____20280 then
      ...
      | FStar_Pervasives_Native.Some pure_eff ->
          FStar_Syntax_Syntax.mk_lcomp pure_eff lc.FStar_Syntax_Syntax.res_typ
            lc.FStar_Syntax_Syntax.cflags (fun uu____20284 ->
...
let term_to_string
  ...
  fun env t ->
    let t1 =
      try normalize [AllowUnboundUniverses] env t with e ->
        (let uu____20302 =
           let uu____20307 =
             ...
             FStar_Util.format1 "Normalization failed with error %s\n"
               uu____20308
           in
           (FStar_Errors.Warning_NormalizationFailure, uu____20307)
         in
        ...
        (let uu____20332 =
           let uu____20337 =
             ...
             FStar_Util.format1 "Normalization failed with error %s\n"
               uu____20338
           in
           (FStar_Errors.Warning_NormalizationFailure, uu____20337)
         in
...
let normalize_refinement
    : steps -> FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.typ
          ...
          | FStar_Syntax_Syntax.Tm_refine (y, phi1) ->
              let uu____20375 =
                let uu____20376 =
                  ...
                  (y, uu____20383)
                in
                FStar_Syntax_Syntax.Tm_refine uu____20376
              in
...
let unfold_whnf
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun env t ->
    normalize [Weak; HNF; UnfoldUntil FStar_Syntax_Syntax.Delta_constant; Beta]
      env t
...
let reduce_or_remove_uvar_solutions
  ...
  fun remove env t ->
    normalize
      (FStar_List.append
         (if remove then [CheckNoUvars] else [])
         [ Beta
         ; NoDeltaSteps
         ; CompressUvars
         ; Exclude Zeta
...
let reduce_uvar_solutions
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun env t -> reduce_or_remove_uvar_solutions false env t


let remove_uvar_solutions
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun env t -> reduce_or_remove_uvar_solutions true env t
...
let eta_expand_with_type
  ...
  fun env e t_e ->
    ...
    match uu____20429 with formals, c ->
      match formals with
      | [] -> e
      | uu____20458 ->
          let uu____20465 = FStar_Syntax_Util.abs_formals e in
          match uu____20465 with actuals, uu____20475, uu____20476 ->
            if FStar_List.length actuals = FStar_List.length formals then e
            else
              let uu____20490 =
                FStar_All.pipe_right formals FStar_Syntax_Util.args_of_binders
              in
              match uu____20490 with binders, args ->
                let uu____20507 =
...
let eta_expand
  ...
  fun env t ->
    ...
    | uu____20515 ->
        ...
        match uu____20516 with head1, args ->
          let uu____20553 =
          ...
          | FStar_Syntax_Syntax.Tm_uvar (uu____20557, thead) -> (
              ...
              match uu____20583 with formals, tres ->
                if FStar_List.length formals = FStar_List.length args then t
                else
                  let uu____20625 =
                    env.FStar_TypeChecker_Env.type_of
                      ...
                      t
                  in
                  match uu____20625 with uu____20634, ty, uu____20636 ->
          ...
          | uu____20637 ->
              let uu____20638 =
                env.FStar_TypeChecker_Env.type_of
                  ...
                  t
              in
              match uu____20638 with uu____20647, ty, uu____20649 ->
                eta_expand_with_type env t ty
...
let rec elim_delayed_subst_term
  ...
  fun t ->
    ...
    let elim_bv x =
      ...
      { FStar_Syntax_Syntax.ppname= uu___197_20706.FStar_Syntax_Syntax.ppname
      ; FStar_Syntax_Syntax.index= uu___197_20706.FStar_Syntax_Syntax.index
    ...
    | FStar_Syntax_Syntax.Tm_abs (bs, t2, rc_opt) ->
        ...
        let uu____20785 =
          let uu____20786 =
            ...
            (uu____20803, uu____20810, uu____20811)
          in
          FStar_Syntax_Syntax.Tm_abs uu____20786
        in
        mk1 uu____20785
    | FStar_Syntax_Syntax.Tm_arrow (bs, c) ->
        let uu____20840 =
          let uu____20841 =
            ...
            (uu____20854, uu____20861)
          in
          FStar_Syntax_Syntax.Tm_arrow uu____20841
        in
        mk1 uu____20840
    | FStar_Syntax_Syntax.Tm_refine (bv, phi) ->
        let uu____20874 =
          ...
          in
          FStar_Syntax_Syntax.Tm_refine uu____20875
        in
        mk1 uu____20874
    | FStar_Syntax_Syntax.Tm_app (t2, args) ->
        let uu____20906 =
          let uu____20907 =
            ...
            (uu____20922, uu____20923)
          in
          FStar_Syntax_Syntax.Tm_app uu____20907
        in
        mk1 uu____20906
    | FStar_Syntax_Syntax.Tm_match (t2, branches) ->
        let rec elim_pat p =
          ...
          | FStar_Syntax_Syntax.Pat_var x ->
              ...
              let uu____20988 =
                ...
                FStar_Syntax_Syntax.Pat_var uu____20989
              in
              { FStar_Syntax_Syntax.v= uu____20988
              ; FStar_Syntax_Syntax.p= uu___199_20987.FStar_Syntax_Syntax.p }
          | FStar_Syntax_Syntax.Pat_wild x ->
              let uu___200_20991 = p in
              let uu____20992 =
                let uu____20993 = elim_bv x in
                FStar_Syntax_Syntax.Pat_wild uu____20993
              in
              { FStar_Syntax_Syntax.v= uu____20992
              ; FStar_Syntax_Syntax.p= uu___200_20991.FStar_Syntax_Syntax.p }
          | FStar_Syntax_Syntax.Pat_dot_term (x, t0) ->
              ...
              let uu____21001 =
                ...
                in
                FStar_Syntax_Syntax.Pat_dot_term uu____21002
              in
              { FStar_Syntax_Syntax.v= uu____21001
              ; FStar_Syntax_Syntax.p= uu___201_21000.FStar_Syntax_Syntax.p }
          | FStar_Syntax_Syntax.Pat_cons (fv, pats) ->
              ...
              let uu____21030 =
                let uu____21031 =
                  ...
                  (fv, uu____21044)
                in
                FStar_Syntax_Syntax.Pat_cons uu____21031
              in
              { FStar_Syntax_Syntax.v= uu____21030
              ; FStar_Syntax_Syntax.p= uu___202_21029.FStar_Syntax_Syntax.p }
          | uu____21093 -> p
        in
        let elim_branch uu____21115 =
          match uu____21115 with pat, wopt, t3 ->
            let uu____21141 = elim_pat pat in
            let uu____21144 =
              FStar_Util.map_opt wopt elim_delayed_subst_term
            in
        ...
        let uu____21152 =
          ...
          in
          FStar_Syntax_Syntax.Tm_match uu____21153
        in
        mk1 uu____21152
    | FStar_Syntax_Syntax.Tm_ascribed (t2, a, lopt) ->
        let elim_ascription uu____21286 =
          match uu____21286 with tc, topt ->
            let uu____21321 =
              match tc with
              | FStar_Util.Inl t3 ->
            ...
            in
            let uu____21334 =
              FStar_Util.map_opt topt elim_delayed_subst_term
            in
        ...
        let uu____21343 =
          let uu____21344 =
            ...
            (uu____21371, uu____21372, lopt)
          in
          FStar_Syntax_Syntax.Tm_ascribed uu____21344
        in
        mk1 uu____21343
    | FStar_Syntax_Syntax.Tm_let (lbs, t2) ->
        let elim_lb lb =
          ...
          let uu____21418 =
            elim_delayed_subst_term lb.FStar_Syntax_Syntax.lbtyp
          in
          let uu____21421 =
            elim_delayed_subst_term lb.FStar_Syntax_Syntax.lbdef
          in
          { FStar_Syntax_Syntax.lbname=
          ...
          ; FStar_Syntax_Syntax.lbeff= uu___203_21417.FStar_Syntax_Syntax.lbeff
        ...
        let uu____21424 =
          let uu____21425 =
            let uu____21438 =
              let uu____21445 =
                FStar_List.map elim_lb (FStar_Pervasives_Native.snd lbs)
              in
              (FStar_Pervasives_Native.fst lbs, uu____21445)
            in
            let uu____21454 = elim_delayed_subst_term t2 in
            (uu____21438, uu____21454)
          in
          FStar_Syntax_Syntax.Tm_let uu____21425
        in
        mk1 uu____21424
    | FStar_Syntax_Syntax.Tm_uvar (uv, t2) ->
        let uu____21487 =
          let uu____21488 =
            ...
            (uv, uu____21505)
          in
          FStar_Syntax_Syntax.Tm_uvar uu____21488
        in
        mk1 uu____21487
    | FStar_Syntax_Syntax.Tm_meta (t2, md) ->
        let uu____21522 =
          ...
          in
          FStar_Syntax_Syntax.Tm_meta uu____21523
        in
        mk1 uu____21522
    ...
    | FStar_Syntax_Syntax.Total (t, uopt) ->
        let uu____21563 =
          let uu____21564 =
            ...
            (uu____21573, uopt)
          in
          FStar_Syntax_Syntax.Total uu____21564
        in
        mk1 uu____21563
    | FStar_Syntax_Syntax.GTotal (t, uopt) ->
        let uu____21586 =
          let uu____21587 =
            ...
            (uu____21596, uopt)
          in
          FStar_Syntax_Syntax.GTotal uu____21587
        in
        mk1 uu____21586
    | FStar_Syntax_Syntax.Comp ct ->
        let ct1 =
          ...
          let uu____21602 =
            elim_delayed_subst_term ct.FStar_Syntax_Syntax.result_typ
          in
          let uu____21605 =
            elim_delayed_subst_args ct.FStar_Syntax_Syntax.effect_args
          in
          let uu____21614 =
            elim_delayed_subst_cflags ct.FStar_Syntax_Syntax.flags
          in
          { FStar_Syntax_Syntax.comp_univs=
...
and elim_delayed_subst_meta
  ...
  fun uu___92_21617 ->
    ...
    | FStar_Syntax_Syntax.Meta_monadic (m, t) ->
        let uu____21662 =
          let uu____21669 = elim_delayed_subst_term t in
          (m, uu____21669)
        in
    ...
    | FStar_Syntax_Syntax.Meta_alien (d, s, t) ->
        let uu____21694 =
          let uu____21703 = elim_delayed_subst_term t in
          (d, s, uu____21703)
        in
...
and elim_delayed_subst_args
  ...
  fun args ->
    FStar_List.map
      (fun uu____21726 ->
        match uu____21726 with t, q ->
          let uu____21737 = elim_delayed_subst_term t in
          (uu____21737, q) )
      args
...
and elim_delayed_subst_binders
  ...
  fun bs ->
    FStar_List.map
      (fun uu____21757 ->
        match uu____21757 with x, q ->
          let uu____21768 =
            let uu___205_21769 = x in
            let uu____21770 =
              elim_delayed_subst_term x.FStar_Syntax_Syntax.sort
            in
            { FStar_Syntax_Syntax.ppname=
...
let elim_uvars_aux_tc
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.univ_names
      -> FStar_Syntax_Syntax.binders
      ...
      -> ( FStar_Syntax_Syntax.univ_names
         ...
         , ( FStar_Syntax_Syntax.term
           ...
           FStar_Util.either )
         FStar_Pervasives_Native.tuple3 =
  fun env univ_names binders tc ->
    let t =
      match (binders, tc) with
      | [], FStar_Util.Inl t -> t
      | [], FStar_Util.Inr c -> failwith "Impossible: empty bindes with a comp"
      | uu____21846, FStar_Util.Inr c ->
          FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (binders, c))
          ...
          let uu____21858 =
            let uu____21861 =
              let uu____21862 =
                ...
                (binders, uu____21875)
              in
              FStar_Syntax_Syntax.Tm_arrow uu____21862
            in
            FStar_Syntax_Syntax.mk uu____21861
          in
          uu____21858 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
    in
    let uu____21879 = FStar_Syntax_Subst.open_univ_vars univ_names t in
    match uu____21879 with univ_names1, t1 ->
      ...
      let uu____21907 =
        ...
        | uu____21962 ->
            ...
            | ( FStar_Syntax_Syntax.Tm_arrow (binders1, c)
              , FStar_Util.Inr uu____21998 ) ->
                (binders1, FStar_Util.Inr c)
            | ( FStar_Syntax_Syntax.Tm_arrow (binders1, c)
              , FStar_Util.Inl uu____22035 ) ->
                (binders1, FStar_Util.Inl (FStar_Syntax_Util.comp_result c))
            | uu____22074, FStar_Util.Inl uu____22075 -> ([], FStar_Util.Inl t4)
            | uu____22098 -> failwith "Impossible"
      in
      match uu____21907 with binders1, tc1 -> (univ_names1, binders1, tc1)
...
let elim_uvars_aux_t
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.univ_names
      ...
      -> ( FStar_Syntax_Syntax.univ_names
         ...
         , FStar_Syntax_Syntax.term )
         FStar_Pervasives_Native.tuple3 =
  fun env univ_names binders t ->
    let uu____22203 =
      elim_uvars_aux_tc env univ_names binders (FStar_Util.Inl t)
    in
    match uu____22203 with univ_names1, binders1, tc ->
...
let elim_uvars_aux_c
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.univ_names
      ...
      -> ( FStar_Syntax_Syntax.univ_names
         ...
         , FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax )
         FStar_Pervasives_Native.tuple3 =
  fun env univ_names binders c ->
    let uu____22296 =
      elim_uvars_aux_tc env univ_names binders (FStar_Util.Inr c)
    in
    match uu____22296 with univ_names1, binders1, tc ->
  ...
  fun env s ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ
      ...
      -> (
        ...
        match uu____22389 with univ_names1, binders1, typ1 ->
    ...
    | FStar_Syntax_Syntax.Sig_bundle (sigs, lids) ->
        ...
        let uu____22439 =
          let uu____22440 =
            ...
            (uu____22449, lids)
          in
          FStar_Syntax_Syntax.Sig_bundle uu____22440
        in
        { FStar_Syntax_Syntax.sigel= uu____22439
        ; FStar_Syntax_Syntax.sigrng= uu___207_22438.FStar_Syntax_Syntax.sigrng
        ; FStar_Syntax_Syntax.sigquals=
    ...
    | FStar_Syntax_Syntax.Sig_datacon (lid, univ_names, typ, lident, i, lids)
      -> (
        ...
        match uu____22466 with univ_names1, uu____22484, typ1 ->
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (lid, univ_names, typ) -> (
        ...
        match uu____22504 with univ_names1, uu____22522, typ1 ->
          let uu___209_22536 = s in
          { FStar_Syntax_Syntax.sigel=
              FStar_Syntax_Syntax.Sig_declare_typ (lid, univ_names1, typ1)
          ; FStar_Syntax_Syntax.sigrng=
    ...
    | FStar_Syntax_Syntax.Sig_let ((b, lbs), lids) ->
            ...
            (FStar_List.map (fun lb ->
                 let uu____22570 =
                   FStar_Syntax_Subst.univ_var_opening
                     lb.FStar_Syntax_Syntax.lbunivs
                 in
                 match uu____22570 with opening, lbunivs ->
                   let elim t =
                     let uu____22593 =
                       let uu____22594 =
                         let uu____22595 =
                           FStar_Syntax_Subst.subst opening t
                         in
                         remove_uvar_solutions env uu____22595
                       in
                       FStar_Syntax_Subst.close_univ_vars lbunivs uu____22594
                     in
                     elim_delayed_subst_term uu____22593
                   in
        ...
        ; FStar_Syntax_Syntax.sigrng= uu___211_22599.FStar_Syntax_Syntax.sigrng
        ; FStar_Syntax_Syntax.sigquals=
    ...
    | FStar_Syntax_Syntax.Sig_main t ->
        ...
        let uu____22612 =
          ...
          FStar_Syntax_Syntax.Sig_main uu____22613
        in
        { FStar_Syntax_Syntax.sigel= uu____22612
        ; FStar_Syntax_Syntax.sigrng= uu___212_22611.FStar_Syntax_Syntax.sigrng
        ; FStar_Syntax_Syntax.sigquals=
    ...
    | FStar_Syntax_Syntax.Sig_assume (l, us, t) -> (
        ...
        match uu____22617 with us1, uu____22635, t1 ->
    ...
    | FStar_Syntax_Syntax.Sig_new_effect ed -> (
        ...
        in
        match uu____22652 with univs1, binders, signature ->
          let uu____22680 =
            let uu____22689 = FStar_Syntax_Subst.univ_var_opening univs1 in
            match uu____22689 with univs_opening, univs2 ->
              let uu____22716 = FStar_Syntax_Subst.univ_var_closing univs2 in
              (univs_opening, uu____22716)
          in
          match uu____22680 with univs_opening, univs_closing ->
            let uu____22733 =
              let binders1 = FStar_Syntax_Subst.open_binders binders in
              let uu____22739 =
                FStar_Syntax_Subst.opening_of_binders binders1
              in
              let uu____22740 =
                FStar_Syntax_Subst.closing_of_binders binders1
              in
              (uu____22739, uu____22740)
            in
            match uu____22733 with b_opening, b_closing ->
              let n1 = FStar_List.length univs1 in
              let n_binders = FStar_List.length binders in
              let elim_tscheme uu____22762 =
                match uu____22762 with us, t ->
                  let n_us = FStar_List.length us in
                  let uu____22780 = FStar_Syntax_Subst.open_univ_vars us t in
                  match uu____22780 with us1, t1 ->
                    let uu____22791 =
                      let uu____22796 =
                      ...
                      let uu____22803 =
                        FStar_All.pipe_right b_closing
                          (FStar_Syntax_Subst.shift_subst n_us)
                      in
                      (uu____22796, uu____22803)
                    in
                    match uu____22791 with b_opening1, b_closing1 ->
                      let uu____22816 =
                        let uu____22821 =
                          FStar_All.pipe_right univs_opening
                            (FStar_Syntax_Subst.shift_subst n_us)
                        in
                        let uu____22830 =
                          FStar_All.pipe_right univs_closing
                            (FStar_Syntax_Subst.shift_subst n_us)
                        in
                        (uu____22821, uu____22830)
                      in
                      match uu____22816
                      with univs_opening1, univs_closing1 ->
                        let t2 =
                          let uu____22846 =
                            FStar_Syntax_Subst.subst b_opening1 t1
                          in
                          FStar_Syntax_Subst.subst univs_opening1 uu____22846
                        in
                        let uu____22847 = elim_uvars_aux_t env [] [] t2 in
                        match uu____22847
                        with uu____22868, uu____22869, t3 ->
                          let t4 =
                            let uu____22884 =
                              let uu____22885 =
                                FStar_Syntax_Subst.close_univ_vars us1 t3
                              in
                              FStar_Syntax_Subst.subst b_closing1 uu____22885
                            in
                            FStar_Syntax_Subst.subst univs_closing1 uu____22884
                          in
                          (us1, t4)
              in
              let elim_term t =
                let uu____22890 = elim_uvars_aux_t env univs1 binders t in
                match uu____22890 with uu____22903, uu____22904, t1 -> t1
              in
              let elim_action a =
                  ...
                  let body =
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_ascribed
                         ...
                         , ( FStar_Util.Inl a.FStar_Syntax_Syntax.action_typ
                           , FStar_Pervasives_Native.None )
                         , FStar_Pervasives_Native.None ))
                      FStar_Pervasives_Native.None
                ...
                let destruct_action_body body =
                  let uu____22981 =
                    let uu____22982 = FStar_Syntax_Subst.compress body in
                    uu____22982.FStar_Syntax_Syntax.n
                  in
                  match uu____22981 with
                  | FStar_Syntax_Syntax.Tm_ascribed
                      ( defn
                      , (FStar_Util.Inl typ, FStar_Pervasives_Native.None)
                      , FStar_Pervasives_Native.None ) ->
                      (defn, typ)
                  | uu____23041 -> failwith "Impossible"
                in
                let destruct_action_typ_templ t =
                  let uu____23070 =
                    let uu____23071 = FStar_Syntax_Subst.compress t in
                    uu____23071.FStar_Syntax_Syntax.n
                  in
                  match uu____23070 with
                  | FStar_Syntax_Syntax.Tm_abs (pars, body, uu____23092) -> (
                      let uu____23113 = destruct_action_body body in
                      match uu____23113 with defn, typ -> (pars, defn, typ) )
                  | uu____23158 ->
                      let uu____23159 = destruct_action_body t in
                      match uu____23159 with defn, typ -> ([], defn, typ)
                in
                let uu____23208 =
                  elim_tscheme
                    (a.FStar_Syntax_Syntax.action_univs, action_typ_templ)
                in
                match uu____23208 with action_univs, t ->
                  let uu____23217 = destruct_action_typ_templ t in
                  match uu____23217
                  with action_params, action_defn, action_typ ->
                    let a' =
              ...
              let ed1 =
                ...
                let uu____23261 = elim_tscheme ed.FStar_Syntax_Syntax.ret_wp in
                let uu____23262 =
                  elim_tscheme ed.FStar_Syntax_Syntax.bind_wp
                in
                let uu____23263 =
                  elim_tscheme ed.FStar_Syntax_Syntax.if_then_else
                in
                let uu____23264 = elim_tscheme ed.FStar_Syntax_Syntax.ite_wp in
                let uu____23265 =
                  elim_tscheme ed.FStar_Syntax_Syntax.stronger
                in
                let uu____23266 =
                  elim_tscheme ed.FStar_Syntax_Syntax.close_wp
                in
                let uu____23267 =
                  elim_tscheme ed.FStar_Syntax_Syntax.assert_p
                in
                let uu____23268 =
                  elim_tscheme ed.FStar_Syntax_Syntax.assume_p
                in
                let uu____23269 =
                  elim_tscheme ed.FStar_Syntax_Syntax.null_wp
                in
                let uu____23270 =
                  elim_tscheme ed.FStar_Syntax_Syntax.trivial
                in
                let uu____23271 = elim_term ed.FStar_Syntax_Syntax.repr in
                let uu____23272 =
                ...
                in
                let uu____23274 =
                  FStar_List.map elim_action ed.FStar_Syntax_Syntax.actions
                in
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
        let elim_tscheme_opt uu___93_23294 =
          ...
          | FStar_Pervasives_Native.Some (us, t) ->
              ...
              match uu____23321 with us1, uu____23345, t1 ->
                FStar_Pervasives_Native.Some (us1, t1)
        in
        let sub_eff1 =
          let uu___217_23364 = sub_eff in
          let uu____23365 =
            elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift_wp
          in
          let uu____23368 =
            elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift
          in
        ...
        { FStar_Syntax_Syntax.sigel= FStar_Syntax_Syntax.Sig_sub_effect sub_eff1
        ; FStar_Syntax_Syntax.sigrng= uu___218_23371.FStar_Syntax_Syntax.sigrng
        ; FStar_Syntax_Syntax.sigquals=
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev
      ...
      -> (
        ...
        match uu____23381 with univ_names1, binders1, comp1 ->
...
let erase_universes
    : FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun env t -> normalize [EraseUniverses; AllowUnboundUniverses] env t
