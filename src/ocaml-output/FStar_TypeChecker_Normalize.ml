...
(FStar_List.tryFind (fun _53_563 -> (match (_53_563) with
| (l, _53_562) -> begin
...
| FStar_Syntax_Syntax.Tm_app (fv, ((a1, _53_573))::((a2, _53_569))::[]) -> begin
(match ((arith_op fv)) with
| None -> begin
tm
end
| Some (_53_580, op) -> begin
...
let _53_604 = t
in {FStar_Syntax_Syntax.n = _53_604.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _53_604.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = tm.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_604.FStar_Syntax_Syntax.vars}))
in (
...
| ((Some (true), _53_761))::((_53_752, (arg, _53_755)))::[] -> begin
arg
end
| _53_765 -> begin
tm
...
(match ((FStar_All.pipe_right args (FStar_List.map simplify))) with
| ((Some (true), _53_769))::[] -> begin
(w FStar_Syntax_Util.t_false)
end
| ((Some (false), _53_775))::[] -> begin
(w FStar_Syntax_Util.t_true)
end
| _53_779 -> begin
tm
...
| FStar_Syntax_Syntax.Tm_abs ((_53_797)::[], body, _53_801) -> begin
...
let _53_822 = (log cfg (fun _53_821 -> (match (()) with
| () -> begin
...
let _53_879 = cfg
in {steps = s; tcenv = _53_879.tcenv; delta_level = FStar_TypeChecker_Env.Unfold (FStar_Syntax_Syntax.Delta_constant)})
in (

let stack' = (Steps (((cfg.steps), (cfg.delta_level))))::stack
in (norm cfg' env stack' tm))))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _53_888; FStar_Syntax_Syntax.pos = _53_886; FStar_Syntax_Syntax.vars = _53_884}, (a1)::(a2)::rest) -> begin
(

let _53_902 = (FStar_Syntax_Util.head_and_args t)
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _53_910; FStar_Syntax_Syntax.pos = _53_908; FStar_Syntax_Syntax.vars = _53_906}, (a)::[]) when (FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) -> begin
(

let _53_921 = (FStar_Syntax_Util.head_and_args t)
in (match (_53_921) with
| (reify_head, _53_920) -> begin
(
...
let _53_941 = ed.FStar_Syntax_Syntax.bind_repr
in (match (_53_941) with
| (_53_939, bind_repr) -> begin
...
| FStar_Util.Inr (_53_948) -> begin
(FStar_All.failwith "Cannot reify a top-level let binding")
end)
end)))
end
| FStar_Syntax_Syntax.Tm_app (_53_951) -> begin
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect (_53_963)); FStar_Syntax_Syntax.tk = _53_961; FStar_Syntax_Syntax.pos = _53_959; FStar_Syntax_Syntax.vars = _53_957}, (a)::[]) -> begin
...
let branches = (FStar_All.pipe_right branches (FStar_List.map (fun _53_979 -> (match (_53_979) with
| (pat, wopt, tm) -> begin
...
let _53_1008 = (log cfg (fun _53_1007 -> (match (()) with
| () -> begin
...
(match (stack) with
| (UnivArgs (us', _53_1014))::stack -> begin
(

let env = (FStar_All.pipe_right us' (FStar_List.fold_left (fun env u -> (Univ (u))::env) env))
in (norm cfg env stack t))
end
| _53_1022 when (FStar_All.pipe_right cfg.steps (FStar_List.contains EraseUniverses)) -> begin
(norm cfg env stack t)
end
| _53_1024 -> begin
...
let _53_1042 = (log cfg (fun _53_1041 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_abs (_53_1045) -> begin
(norm cfg env stack t')
end
| _53_1048 -> begin
(rebuild cfg env stack t')
...
let _53_1161 = (FStar_Syntax_Subst.open_term' bs body)
in (match (_53_1161) with
...
let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _53_1169 -> (Dummy)::env) env))
in (

let _53_1173 = (log cfg (fun _53_1172 -> (match (()) with
| () -> begin
...
let stack = (FStar_All.pipe_right stack (FStar_List.fold_right (fun _53_1181 stack -> (match (_53_1181) with
| (a, aq) -> begin
...
let _53_1185 = (log cfg (fun _53_1184 -> (match (()) with
| () -> begin
...
let _53_1195 = x
in {FStar_Syntax_Syntax.ppname = _53_1195.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1195.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t.FStar_Syntax_Syntax.pos)
...
let _53_1203 = (FStar_Syntax_Subst.open_term ((((x), (None)))::[]) f)
...
let _53_1205 = x
in {FStar_Syntax_Syntax.ppname = _53_1205.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1205.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_147_706)))
...
let _53_1214 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_53_1214) with
| (bs, c) -> begin
(

let c = (let _147_712 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _53_1216 -> (Dummy)::env) env))
...
| FStar_Syntax_Syntax.Tm_let ((_53_1260, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (_53_1272); FStar_Syntax_Syntax.lbunivs = _53_1270; FStar_Syntax_Syntax.lbtyp = _53_1268; FStar_Syntax_Syntax.lbeff = _53_1266; FStar_Syntax_Syntax.lbdef = _53_1264})::_53_1262), _53_1278) -> begin
(rebuild cfg env stack t)
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), body) -> begin
(
...
let _53_1292 = (let _147_723 = (let _147_722 = (let _147_721 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
...
in {FStar_Syntax_Syntax.lbname = _147_729; FStar_Syntax_Syntax.lbunivs = _53_1293.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _147_728; FStar_Syntax_Syntax.lbeff = _53_1293.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _147_727}))))
in (
...
let _53_1323 = (FStar_List.fold_right (fun lb _53_1312 -> (match (_53_1312) with
| (rec_env, memos, i) -> begin
(

let f_i = (let _147_735 = (

let _53_1313 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = _53_1313.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = _53_1313.FStar_Syntax_Syntax.sort})
...
| (rec_env, memos, _53_1322) -> begin
(

let _53_1326 = (FStar_List.map2 (fun lb memo -> (FStar_ST.op_Colon_Equals memo (Some (((rec_env), (lb.FStar_Syntax_Syntax.lbdef)))))) (Prims.snd lbs) memos)
in (
...
let _53_1341 = cfg
in {steps = (FStar_List.append ((NoInline)::(Exclude (Zeta))::[]) cfg.steps); tcenv = _53_1341.tcenv; delta_level = FStar_TypeChecker_Env.NoDelta})
...
let _53_1349 = cfg
in {steps = (PureSubtermsWithinComputations)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = _53_1349.tcenv; delta_level = FStar_TypeChecker_Env.OnlyInline})
...
| _53_1353 -> begin
(match (stack) with
| (_53_1357)::_53_1355 -> begin
(match (m) with
| FStar_Syntax_Syntax.Meta_labeled (l, r, _53_1362) -> begin
...
and norm_pattern_args : cfg  ->  env  ->  FStar_Syntax_Syntax.args Prims.list  ->  FStar_Syntax_Syntax.args Prims.list = (fun cfg env args -> (FStar_All.pipe_right args (FStar_List.map (FStar_List.map (fun _53_1384 -> (match (_53_1384) with
| (a, imp) -> begin
...
in {FStar_Syntax_Syntax.n = _147_755; FStar_Syntax_Syntax.tk = _53_1393.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1393.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1393.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(
...
in {FStar_Syntax_Syntax.n = _147_759; FStar_Syntax_Syntax.tk = _53_1399.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1399.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1399.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let norm_args = (fun args -> (FStar_All.pipe_right args (FStar_List.map (fun _53_1407 -> (match (_53_1407) with
| (a, i) -> begin
...
| FStar_Syntax_Syntax.DECREASES (t) -> begin
(let _147_765 = (norm cfg env [] t)
in FStar_Syntax_Syntax.DECREASES (_147_765))
end
| f -> begin
f
end))))
...
let _53_1413 = comp
in (let _147_770 = (let _147_769 = (

let _53_1415 = ct
in (let _147_768 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _147_767 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _147_766 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _147_768; FStar_Syntax_Syntax.effect_name = _53_1415.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _147_767; FStar_Syntax_Syntax.effect_args = _147_766; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (_147_769))
in {FStar_Syntax_Syntax.n = _147_770; FStar_Syntax_Syntax.tk = _53_1413.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1413.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1413.FStar_Syntax_Syntax.vars}))))
end)))
...
let _53_1422 = cfg
in {steps = (Inline)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = _53_1422.tcenv; delta_level = _53_1422.delta_level}) env [] t))
in (

let non_info = (fun t -> (let _147_778 = (norm t)
in (FStar_Syntax_Util.non_informative _147_778)))
in (match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (_53_1427) -> begin
c
end
...
let _53_1433 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = _53_1433.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1433.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1433.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let _53_1440 = ct
in {FStar_Syntax_Syntax.comp_univs = _53_1440.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = _53_1440.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _53_1440.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = _53_1440.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let _53_1444 = ct
in {FStar_Syntax_Syntax.comp_univs = _53_1444.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = _53_1444.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _53_1444.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = _53_1444.FStar_Syntax_Syntax.flags}))
end)
in (

let _53_1447 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct); FStar_Syntax_Syntax.tk = _53_1447.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1447.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1447.FStar_Syntax_Syntax.vars}))
end else begin
c
end)
end
...
and norm_binder : cfg  ->  env  ->  FStar_Syntax_Syntax.binder  ->  FStar_Syntax_Syntax.binder = (fun cfg env _53_1455 -> (match (_53_1455) with
| (x, imp) -> begin
(let _147_783 = (

let _53_1456 = x
in (let _147_782 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _53_1456.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1456.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_782}))
in ((_147_783), (imp)))
end))
and norm_binders : cfg  ->  env  ->  FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun cfg env bs -> (

let _53_1469 = (FStar_List.fold_left (fun _53_1463 b -> (match (_53_1463) with
| (nbs', env) -> begin
(
...
(let _147_794 = (let _147_793 = (let _147_792 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.lcomp_of_comp _147_792))
in FStar_Util.Inl (_147_793))
in Some (_147_794))
end else begin
(let _147_797 = (let _147_796 = (let _147_795 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.lcomp_of_comp _147_795))
in FStar_Util.Inl (_147_796))
in Some (_147_797))
end)
end else begin
Some (FStar_Util.Inr (lc.FStar_Syntax_Syntax.eff_name))
...
let _53_1490 = cfg
in {steps = s; tcenv = _53_1490.tcenv; delta_level = dl}) env stack t)
end
...
let _53_1503 = (set_memo r ((env), (t)))
in (

let _53_1506 = (log cfg (fun _53_1505 -> (match (()) with
| () -> begin
(let _147_803 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _147_803))
end)))
in (rebuild cfg env stack t)))
end
...
let _53_1529 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = _53_1529.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _53_1529.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = _53_1529.FStar_Syntax_Syntax.vars})
...
| (Arg (Clos (env, tm, m, _53_1565), aq, r))::stack -> begin
(

let _53_1574 = (log cfg (fun _53_1573 -> (match (()) with
| () -> begin
(let _147_806 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _147_807 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _147_807)))
end
| (Match (env, branches, r))::stack -> begin
(

let _53_1605 = (log cfg (fun _53_1604 -> (match (()) with
| () -> begin
(let _147_809 = (FStar_Syntax_Print.term_to_string t)
...
let _53_1611 = cfg
in (let _147_812 = (FStar_TypeChecker_Env.glb_delta cfg.delta_level FStar_TypeChecker_Env.OnlyInline)
in {steps = (Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = _53_1611.tcenv; delta_level = _147_812}))
in (
...
let tl = (FStar_All.pipe_right tl (FStar_List.map (fun p -> (let _147_822 = (norm_pat env p)
in (Prims.fst _147_822)))))
in (((
...
in {FStar_Syntax_Syntax.ppname = _53_1656.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1656.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_825}))
in (((
...
let _53_1663 = x
in (let _147_826 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _53_1663.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1663.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_826}))
in (((
...
let _53_1672 = x
in (let _147_827 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _53_1672.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1672.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_827}))
in (
...
| Some (w) -> begin
(let _147_829 = (norm_or_whnf env w)
in Some (_147_829))
end)
in (
...
in (let _147_830 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
in (rebuild cfg env stack _147_830)))))))
end))
in (
...
let _53_1741 = (FStar_Syntax_Util.head_and_args scrutinee)
...
(match ((let _147_848 = (FStar_Syntax_Util.un_uinst head)
in _147_848.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv') when (FStar_Syntax_Syntax.fv_eq fv fv') -> begin
(matches_args [] args arg_pats)
end
| _53_1779 -> begin
(let _147_849 = (not ((is_cons head)))
in FStar_Util.Inr (_147_849))
end)
end)
end))))
...
| () -> begin
(let _147_860 = (FStar_Syntax_Print.pat_to_string p)
in (let _147_859 = (let _147_858 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _147_858 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _147_860 _147_859)))
end)))
in (

let env = (FStar_List.fold_left (fun env t -> (let _147_865 = (let _147_864 = (let _147_863 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_147_863), (false)))
in Clos (_147_864))
in (_147_865)::env)) env s)
in (let _147_866 = (guard_when_clause wopt b rest)
in (norm cfg env stack _147_866))))
end)
end))
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _147_878 = (config s e)
in (norm _147_878 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _147_885 = (config s e)
in (norm_comp _147_885 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _147_890 = (config [] env)
in (norm_universe _147_890 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _147_895 = (config [] env)
in (ghost_to_pure_aux _147_895 [] c)))
...
let non_info = (fun t -> (let _147_902 = (norm cfg [] [] t)
in (FStar_Syntax_Util.non_informative _147_902)))
...
| () -> begin
(let _147_904 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _147_904))
end))})
end
| None -> begin
lc
...
let term_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string = (fun env t -> (let _147_909 = (normalize ((AllowUnboundUniverses)::[]) env t)
in (FStar_Syntax_Print.term_to_string _147_909)))


let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (let _147_915 = (let _147_914 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _147_914 [] c))
in (FStar_Syntax_Print.comp_to_string _147_915)))
...
(let _147_926 = (let _147_925 = (let _147_924 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_147_924)))
in FStar_Syntax_Syntax.Tm_refine (_147_925))
in (mk _147_926 t0.FStar_Syntax_Syntax.pos))
end
| _53_1879 -> begin
t
end))
...
| (binders, args) -> begin
(let _147_937 = (FStar_Syntax_Syntax.mk_Tm_app t args None t.FStar_Syntax_Syntax.pos)
in (let _147_936 = (let _147_935 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _147_933 -> FStar_Util.Inl (_147_933)))
in (FStar_All.pipe_right _147_935 (fun _147_934 -> Some (_147_934))))
in (FStar_Syntax_Util.abs binders _147_937 _147_936)))
end))
end)
end)))
in (match ((let _147_938 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_147_938), (t.FStar_Syntax_Syntax.n)))) with
| (Some (sort), _53_1898) -> begin
(let _147_939 = (mk sort t.FStar_Syntax_Syntax.pos)
in (expand _147_939))
end
...
| (head, args) -> begin
(match ((let _147_940 = (FStar_Syntax_Subst.compress head)
in _147_940.FStar_Syntax_Syntax.n)) with
