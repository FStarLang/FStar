                                               ...
                                               let uu____5966 =
                                                 let uu____5967 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____5967.FStar_Syntax_Syntax.n
                                                  in
                                ...
                                ((let is_arg_impure uu____6147 =
                                    ...
                                    | (e,q) ->
                                        let uu____6152 =
                                          let uu____6153 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____6153.FStar_Syntax_Syntax.n
                                           in
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              (let uu____6544 = FStar_TypeChecker_Env.monad_leq env msrc mtgt
                  in
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            ...
            let uu____6723 =
              let uu____6724 =
                ...
                let uu____6730 = norm_args ct.FStar_Syntax_Syntax.effect_args
                   in
                {
              ...
              (log cfg
               ...
               (let scrutinee = t  in
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps  in
                             ...
                             (FStar_List.fold_left
                                (fun uu____7272  ->
                                   fun uu____7273  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____7338 = norm_pat env3 p1
                                            in
                   ...
                   let uu____7509 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____7509)
                   in
                ...
                let rec matches_pat scrutinee1 p =
                  ...
                  let uu____7629 = FStar_Syntax_Util.head_and_args scrutinee2
                     in
                      ...
                      (match uu____7820 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____7834 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____7927 =
                                        ...
                                        Clos uu____7928  in
                                      uu____7927 :: env2) env1 s
                                in
                             let uu____7961 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____7961)))
                   in
                let uu____7962 =
                  FStar_All.pipe_right cfg.steps
...
let normalize_universe :
  ...
  fun env  ->
    fun u  ->
      let uu____8029 = config [] env  in norm_universe uu____8029 [] u
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____8106 =
                     let uu____8107 =
                       let uu____8112 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____8112)  in
           ...
           | (head1,args) ->
               ...
               (match uu____8294 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____8298,thead) ->
                    let uu____8312 = FStar_Syntax_Util.arrow_formals thead
                       in
