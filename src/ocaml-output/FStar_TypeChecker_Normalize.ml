  ...
  fun env1  ->
    fun s  ->
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_subcomp (m,n,(us_t,t),(us_ty,ty))
          ->
          let uu____31657 = elim_uvars_aux_t env1 us_t [] t  in
          (match uu____31657 with
           | (us_t1,uu____31681,t1) ->
               let uu____31703 = elim_uvars_aux_t env1 us_ty [] ty  in
               (match uu____31703 with
                | (us_ty1,uu____31727,ty1) ->
                    let uu___3858_31749 = s  in
                    {
                      FStar_Syntax_Syntax.sigel =
                        (FStar_Syntax_Syntax.Sig_polymonadic_subcomp
                           (m, n, (us_t1, t1), (us_ty1, ty1)));
                      FStar_Syntax_Syntax.sigrng =
                        (uu___3858_31749.FStar_Syntax_Syntax.sigrng);
                      FStar_Syntax_Syntax.sigquals =
                        (uu___3858_31749.FStar_Syntax_Syntax.sigquals);
                      FStar_Syntax_Syntax.sigmeta =
                        (uu___3858_31749.FStar_Syntax_Syntax.sigmeta);
                      FStar_Syntax_Syntax.sigattrs =
                        (uu___3858_31749.FStar_Syntax_Syntax.sigattrs);
                      FStar_Syntax_Syntax.sigopts =
                        (uu___3858_31749.FStar_Syntax_Syntax.sigopts)
                    }))
    ...
    fun t  ->
      let aux f us args =
        ...
        | FStar_Pervasives_Native.Some head_def_ts ->
         ...
         in
      let uu____31833 = FStar_Syntax_Util.head_and_args t  in
      match uu____31833 with
      | (head,args) ->
          let uu____31878 =
            let uu____31879 = FStar_Syntax_Subst.compress head  in
            uu____31879.FStar_Syntax_Syntax.n  in
          (match uu____31878 with
           | FStar_Syntax_Syntax.Tm_fvar fv -> aux fv [] args
           | FStar_Syntax_Syntax.Tm_uinst
               ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                  FStar_Syntax_Syntax.pos = uu____31886;
                  FStar_Syntax_Syntax.vars = uu____31887;_},us)
               -> aux fv us args
           | uu____31893 -> FStar_Pervasives_Native.None)
