                                                    ...
                                                    let uu____5493 =
                                                      let uu____5510 =
                                                        ...
                                                        (uu____5529,
                                                         ...
                                                         in
                                                      [uu____5510]  in
                                                    uu____5469 :: uu____5493
                                                     in
                                                  uu____5428 :: uu____5452
                                                   in
                    ...
                    (FStar_Parser_Const.op_GTE, (Prims.parse_int "2"),
                      (binary_op arg_as_int
                         (fun r  ->
                            fun x  ->
                              fun y  ->
                                let uu____5914 = FStar_BigInt.ge_big_int x y
                                   in
                  ...
                  (FStar_Parser_Const.op_GT, (Prims.parse_int "2"),
                    (binary_op arg_as_int
                       (fun r  ->
                          fun x  ->
                            fun y  ->
                              let uu____5940 = FStar_BigInt.gt_big_int x y
                                 in
                      ...
                      fun uu____6212  ->
                        fun uu____6213  ->
                          ...
                          | ((int_to_t1,x),(uu____6232,y)) ->
                              let uu____6242 = FStar_BigInt.add_big_int x y
                                 in
                              int_as_bounded r int_to_t1 uu____6242)))
               in
            let uu____6243 =
              let uu____6258 =
                let uu____6271 = FStar_Parser_Const.p2l ["FStar"; m; "sub"]
                   in
                        ...
                        fun uu____6291  ->
                          fun uu____6292  ->
                            ...
                            | ((int_to_t1,x),(uu____6311,y)) ->
                                let uu____6321 = FStar_BigInt.sub_big_int x y
                                   in
                                int_as_bounded r int_to_t1 uu____6321)))
                 in
              let uu____6322 =
                let uu____6337 =
                  let uu____6350 = FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                     in
                          ...
                          fun uu____6370  ->
                            fun uu____6371  ->
                              ...
                              | ((int_to_t1,x),(uu____6390,y)) ->
                                  ...
                                  int_as_bounded r int_to_t1 uu____6400)))
                   in
                [uu____6337]  in
              uu____6258 :: uu____6322  in
            uu____6179 :: uu____6243))
     in
                             ...
                             (let term1 = closure_as_term cfg env1 term  in
                              ...
                              | FStar_Pervasives_Native.Some x ->
                                  let b1 =
                                    ...
                                    FStar_Syntax_Syntax.freshen_bv uu____6823
                                     in
                                  let b_for_x =
                                    let uu____6829 =
                                      let uu____6836 =
                      ...
                      (let uu____9652 =
                       ...
                       then
                         ...
                         | (uu____9904,(p,uu____9906))::(uu____9907,(q,uu____9909))::[]
                             ->
                             let uu____9974 = FStar_Syntax_Util.term_eq p q
                                in
                             (if uu____9974
                              then w FStar_Syntax_Util.t_true
                              else squashed_head_un_auto_squash_args tm1)
...
let (tr_norm_step : FStar_Syntax_Embeddings.norm_step -> step Prims.list) =
  fun uu___79_10621  ->
    ...
    | FStar_Syntax_Embeddings.UnfoldOnly names1 ->
        let uu____10627 =
          let uu____10630 =
            let uu____10631 = FStar_List.map FStar_Ident.lid_of_str names1
               in
  ...
  fun full_norm  ->
    fun args  ->
      ...
      | (steps,uu____10757)::uu____10758::(tm,uu____10760)::[] ->
          ...
          let s =
            let uu____10800 =
              let uu____10803 = full_norm steps  in parse_steps uu____10803
               in
            Beta :: uu____10800  in
        ...
        fun t  ->
          ...
          (match t1.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_fvar fv when
               ...
               (log cfg
                  (fun uu____11168  ->
                     let uu____11169 = FStar_Syntax_Print.term_to_string t1
                        in
               ...
               let should_delta1 =
                 ...
                 then false
                   ...
                   (let uu____11346 =
                    ...
                    | uu____11361 -> should_delta)
                  in
               (log cfg
                  (fun uu____11369  ->
                     let uu____11370 = FStar_Syntax_Print.term_to_string t1
                        in
                     let uu____11371 =
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11869  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11992  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12246  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12377  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12492  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                      ...
                      let c2 =
                        let uu____12853 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env1  ->
                                  fun uu____12877  -> dummy :: env1) env)
                           in
                       ...
                       | (Cfg cfg1)::stack1 ->
                           let t2 =
                             let uu____13057 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____13058
                                in
                       ...
                       | uu____13104 ->
                           let uu____13105 =
                             let uu____13106 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____13107
                                in
                        ...
                        (let lb1 =
                         ...
                         let env' =
                           FStar_All.pipe_right bs
                             (FStar_List.fold_left
                                (fun env1  ->
                                   fun uu____13555  -> dummy :: env1) env)
                            in
                         let stack1 = (Cfg cfg) :: stack  in
                         let cfg1 =
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____13679 =
                                   let uu____13688 =
                                     FStar_List.map
                                       (fun uu____13708  -> dummy) xs1
                                      in
                                   FStar_List.append uu____13688 env  in
                                 FStar_List.append uu____13662 uu____13679
                                  in
                               ...
                               let uu____14622 =
                                 let uu____14623 =
                                   ...
                                   (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                    ...
                                    in
                                 Clos uu____14623  in
                               (FStar_Pervasives_Native.None, uu____14622)
                                in
                             uu____14615 :: env1)
        ...
        fun t0  ->
          fun f  ->
            ...
            | FStar_Pervasives_Native.Some (us,t) ->
                (log cfg
                   (fun uu____14889  ->
                      let uu____14890 = FStar_Syntax_Print.term_to_string t0
                         in
                      let uu____14891 = FStar_Syntax_Print.term_to_string t
                         in
          ...
          fun head1  ->
            fun m  ->
              fun t  ->
                ...
                log cfg
                  (fun uu____15020  ->
                     let uu____15021 = FStar_Syntax_Print.tag_of_term head2
                        in
                     let uu____15022 =
                                      ...
                                      let uu____15103 =
                                        let uu____15106 =
                                          ...
                                          FStar_Syntax_Syntax.Tm_let
                                            uu____15107
                                           in
                                        FStar_Syntax_Syntax.mk uu____15106
                                         in
                                      uu____15103
                                        FStar_Pervasives_Native.None
                                      ...
                                      (let rng =
                                         ...
                                         let uu____15170 =
                                           let uu____15173 =
                                             ...
                                             FStar_Syntax_Syntax.Tm_abs
                                               uu____15174
                                              in
                                           FStar_Syntax_Syntax.mk uu____15173
                                            in
                                         uu____15170
                                           FStar_Pervasives_Native.None
                                         ...
                                         let uu____15210 =
                                           let uu____15211 =
                                             FStar_Syntax_Subst.compress
                                               bind_repr
                                              in
                                           uu____15211.FStar_Syntax_Syntax.n
                                            in
                                                 ...
                                                 let uu____15282 =
                                                   ...
                                                   let uu____15286 =
                                                     ...
                                                     uu____15289 ::
                                                       uu____15290
                                                      in
                                                   uu____15285 :: uu____15286
                                                    in
                                                 uu____15281 :: uu____15282
                                                  in
                                               (bind_inst, uu____15278)  in
                                             FStar_Syntax_Syntax.Tm_app
                                               uu____15263
                                              in
                                           FStar_Syntax_Syntax.mk uu____15262
                                            in
                                         uu____15259
                                       ...
                                       log cfg
                                         (fun uu____15312  ->
                                            ...
                                            FStar_Util.print1
                                              "Reified to %s\n" uu____15313);
                                       (let uu____15314 = FStar_List.tl stack
                                           in
                          ...
                          let maybe_unfold_action head3 =
                            let maybe_extract_fv t1 =
                              ...
                              | FStar_Syntax_Syntax.Tm_fvar x ->
                                  FStar_Pervasives_Native.Some x
                              | uu____15394 -> FStar_Pervasives_Native.None
                               in
                            ...
                            | FStar_Pervasives_Native.Some x when
                                ...
                                let action_unfolded =
                                  let uu____15410 = maybe_extract_fv head4
                                     in
                          ...
                          ((let is_arg_impure uu____15436 =
                            ...
                            let uu____15460 =
                              let uu____15461 =
                                ...
                                uu____15468 :: args  in
                              FStar_Util.for_some is_arg_impure uu____15461
                               in
                            if uu____15460
                            then
                              let uu____15473 =
                           ...
                           (let uu____15476 = maybe_unfold_action head_app
                               in
                     ...
                     let uu____15824 =
                       let uu____15825 =
                         let uu____15840 =
                           ...
                           let uu____15844 =
                             let uu____15847 = FStar_Syntax_Syntax.as_arg e
                                in
                             [uu____15847]  in
      ...
      fun uu____16125  ->
        ...
        | (x,imp) ->
            let uu____16128 =
              ...
              let uu____16130 = norm cfg env [] x.FStar_Syntax_Syntax.sort
                 in
              {
                FStar_Syntax_Syntax.ppname =
          ...
          (match stack with
           ...
           | (MemoLazy r)::stack1 ->
               (set_memo cfg r (env, t);
                log cfg
                  (fun uu____16339  ->
                     let uu____16340 = FStar_Syntax_Print.term_to_string t
                        in
                     FStar_Util.print1 "\tSet memo %s\n" uu____16340);
                rebuild cfg env stack1 t)
           ...
           | (Arg (Clos (env_arg,tm,m,uu____16402),aq,r))::stack1 ->
               (log cfg
                  (fun uu____16455  ->
                     let uu____16456 = FStar_Syntax_Print.term_to_string tm
                        in
           ...
           | (App (env1,head1,aq,r))::stack' when should_reify cfg stack ->
               ...
               let fallback msg uu____16650 =
                 log cfg
                   (fun uu____16654  ->
                      let uu____16655 = FStar_Syntax_Print.term_to_string t
                         in
           ...
           | (Match (env1,branches,r))::stack1 ->
               (log cfg
                  (fun uu____16750  ->
                     let uu____16751 = FStar_Syntax_Print.term_to_string t
                        in
                     FStar_Util.print1
                   ...
                   (let whnf =
                              ...
                              (FStar_List.fold_left
                                 (fun uu____16927  ->
                                    fun uu____16928  ->
                                      ...
                                      | ((pats1,env3),(p1,b)) ->
                                          let uu____17019 = norm_pat env3 p1
                                             in
                    ...
                    let uu____17260 =
                      mk
                        ...
                        r
                       in
                    rebuild cfg env1 stack1 uu____17260)
                    in
                       ...
                       (match uu____17722 with
                        | FStar_Util.Inl s ->
                            matches_args (FStar_List.append out s) rest_a
                              rest_p
                        | m -> m)
                   | uu____17771 -> FStar_Util.Inr false
                  in
                                                 ...
                                                 let uu____18032 =
                                                   FStar_Util.mk_ref
                                                     (FStar_Pervasives_Native.Some
                                                        ([], t1))
                                                    in
                                                 ([], t1, uu____18032, false)
                                                  in
                                               Clos uu____18001  in
                                             (uu____17996, uu____18000)  in
                                           uu____17989 :: env2) env1 s
                                 in
                              let uu____18149 = guard_when_clause wopt b rest
                                 in
                              norm cfg env2 stack1 uu____18149)))
                    in
                 let uu____18150 =
                   FStar_All.pipe_right cfg.steps
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____18423 =
                     let uu____18424 =
                       let uu____18431 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____18431)  in
           ...
           | (head1,args) ->
               ...
               (match uu____18601 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____18605,thead) ->
                    let uu____18631 = FStar_Syntax_Util.arrow_formals thead
                       in
        ...
        fun tc  ->
          let t =
            ...
            | (uu____18777,FStar_Util.Inl t) ->
             ...
             in
          let uu____18804 = FStar_Syntax_Subst.open_univ_vars univ_names t
             in
                ...
                | uu____18886 ->
                    ...
                    (match uu____18887 with
                     ...
                     | (uu____18998,FStar_Util.Inl uu____18999) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____19022 -> failwith "Impossible")
                 in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____19575 with
           | (univs1,binders,signature) ->
               let uu____19603 =
                 let uu____19612 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____19612 with
                 | (univs_opening,univs2) ->
                     let uu____19639 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____19639)
                  in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____20036 = destruct_action_body body
                                    in
                           ...
                           | (action_univs,t) ->
                               let uu____20140 = destruct_action_typ_templ t
                                  in
