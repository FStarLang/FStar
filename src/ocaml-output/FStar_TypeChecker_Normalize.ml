...
let _53_1397 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = _53_1397.tcenv; delta_level = (FStar_TypeChecker_Env.Eager_unfolding_only)::[]})
