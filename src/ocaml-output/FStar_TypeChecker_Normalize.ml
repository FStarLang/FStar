...
let uu___170_6402 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = uu___170_6402.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]; primitive_steps = uu___170_6402.primitive_steps})
...
in {FStar_Syntax_Syntax.n = uu____6630; FStar_Syntax_Syntax.tk = uu___171_6627.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___171_6627.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___171_6627.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___172_6653 = comp1
in (
...
in {FStar_Syntax_Syntax.n = uu____6656; FStar_Syntax_Syntax.tk = uu___172_6653.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___172_6653.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___172_6653.FStar_Syntax_Syntax.vars}))
end
...
let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___137_6707 -> (match (uu___137_6707) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
(
...
in {FStar_Syntax_Syntax.comp_univs = uu____6721; FStar_Syntax_Syntax.effect_name = uu___174_6720.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu____6722; FStar_Syntax_Syntax.effect_args = uu____6725; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (uu____6719))
in {FStar_Syntax_Syntax.n = uu____6718; FStar_Syntax_Syntax.tk = uu___173_6715.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___173_6715.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___173_6715.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___175_6742 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = uu___175_6742.tcenv; delta_level = uu___175_6742.delta_level; primitive_steps = uu___175_6742.primitive_steps}) env [] t))
in (
...
let uu___176_6764 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = uu___176_6764.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___176_6764.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___176_6764.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let uu___177_6779 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___177_6779.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = uu___177_6779.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___177_6779.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___177_6779.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let uu___178_6781 = ct1
in {FStar_Syntax_Syntax.comp_univs = uu___178_6781.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = uu___178_6781.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___178_6781.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___178_6781.FStar_Syntax_Syntax.flags}))
end)
in (

let uu___179_6782 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct1); FStar_Syntax_Syntax.tk = uu___179_6782.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___179_6782.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___179_6782.FStar_Syntax_Syntax.vars}))
end
| uu____6787 -> begin
c
end)))
...
in {FStar_Syntax_Syntax.ppname = uu___180_6795.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___180_6795.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____6796}))
in ((uu____6794), (imp)))
end))
...
let uu___181_6908 = cfg
in {steps = s; tcenv = uu___181_6908.tcenv; delta_level = dl; primitive_steps = ps}) env stack2 t)
end
...
let uu___182_6967 = (FStar_Syntax_Util.abs bs1 t lopt1)
in {FStar_Syntax_Syntax.n = uu___182_6967.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___182_6967.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___182_6967.FStar_Syntax_Syntax.vars})
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun uu___138_7107 -> (match (uu___138_7107) with
| (FStar_TypeChecker_Env.Inlining) | (FStar_TypeChecker_Env.Eager_unfolding_only) -> begin
true
end
| uu____7108 -> begin
...
let uu___183_7114 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = uu___183_7114.tcenv; delta_level = new_delta; primitive_steps = uu___183_7114.primitive_steps})))
in (
...
let uu___184_7216 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd2)::tl2); FStar_Syntax_Syntax.ty = uu___184_7216.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___184_7216.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___185_7399 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___185_7399.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___185_7399.FStar_Syntax_Syntax.p})), (env3))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___186_7413.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___186_7413.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____7414}))
in (((

let uu___187_7420 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___187_7420.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___187_7420.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___188_7425.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___188_7425.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____7426}))
in (((

let uu___189_7432 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___189_7432.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___189_7432.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
in {FStar_Syntax_Syntax.ppname = uu___190_7442.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___190_7442.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____7443}))
in (
...
let uu___191_7450 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t2))); FStar_Syntax_Syntax.ty = uu___191_7450.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___191_7450.FStar_Syntax_Syntax.p})), (env2))))
end))
in (
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun uu___139_7971 -> (match (uu___139_7971) with
| UnfoldUntil (k) -> begin
...
let uu___192_7998 = (config s e)
in {steps = uu___192_7998.steps; tcenv = uu___192_7998.tcenv; delta_level = uu___192_7998.delta_level; primitive_steps = (FStar_List.append c.primitive_steps ps)})
in (norm c1 [] [] t))))
...
let uu___193_8046 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___193_8046.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___193_8046.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____8047 -> (
...
let uu___194_8299 = env
in {FStar_TypeChecker_Env.solver = uu___194_8299.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___194_8299.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___194_8299.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___194_8299.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___194_8299.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___194_8299.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___194_8299.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___194_8299.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___194_8299.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___194_8299.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___194_8299.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___194_8299.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___194_8299.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___194_8299.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___194_8299.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___194_8299.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___194_8299.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___194_8299.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___194_8299.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___194_8299.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___194_8299.FStar_TypeChecker_Env.qname_and_index}) t)
...
let uu___195_8308 = env
in {FStar_TypeChecker_Env.solver = uu___195_8308.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___195_8308.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___195_8308.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___195_8308.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___195_8308.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___195_8308.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___195_8308.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___195_8308.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___195_8308.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___195_8308.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___195_8308.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___195_8308.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___195_8308.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___195_8308.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___195_8308.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___195_8308.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___195_8308.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___195_8308.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___195_8308.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___195_8308.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___195_8308.FStar_TypeChecker_Env.qname_and_index}) t)
