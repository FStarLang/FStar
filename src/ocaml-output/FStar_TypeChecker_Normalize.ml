         ...
         | uu____1990 ->
             ...
             (match t1.FStar_Syntax_Syntax.n with
              ...
              | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
                  let uu____2051 = FStar_List.map (norm_universe cfg env) us
                     in
              ...
              | FStar_Syntax_Syntax.Tm_ascribed (t11,(annot,tacopt),lopt) ->
                  let annot1 =
                    match annot with
                    | FStar_Util.Inl t2 ->
                        let uu____2427 = closure_as_term_delayed cfg env t2
                           in
                        FStar_Util.Inl uu____2427
                    | FStar_Util.Inr c ->
                        let uu____2441 = close_comp cfg env c  in
                        FStar_Util.Inr uu____2441
                     in
                  let tacopt1 =
                  ...
                  let uu____2457 =
                    let uu____2458 =
                      let uu____2485 = closure_as_term_delayed cfg env t11
                         in
                  ...
                  let norm_one_lb env1 lb =
                    let env_univs =
                      FStar_List.fold_right
                       ...
                       in
                    let env2 =
                      let uu____2900 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____2900
                      then env_univs
                      else
                    ...
                    let ty =
                      closure_as_term cfg env_univs
                       ...
                       in
                    let nm =
                      let uu____2942 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____2942
...
let built_in_primitive_steps : primitive_step Prims.list =
    ...
    unary_op arg_as_int
      (fun r  ->
         fun x  ->
           ...
           FStar_Syntax_Embeddings.embed_int r uu____4490)
     in
  let binary_int_op f =
      ...
      (fun r  ->
         fun x  ->
           fun y  ->
             ...
             FStar_Syntax_Embeddings.embed_int r uu____4518)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  ->
           ...
           FStar_Syntax_Embeddings.embed_bool r uu____4539)
     in
      ...
      (fun r  ->
         fun x  ->
           fun y  ->
             ...
             FStar_Syntax_Embeddings.embed_bool r uu____4567)
     in
      ...
      (fun r  ->
         fun x  ->
           fun y  ->
             ...
             FStar_Syntax_Embeddings.embed_string r uu____4595)
     in
  ...
  let basic_ops =
                    ...
                    (FStar_Parser_Const.op_GTE, (Prims.parse_int "2"),
                      (binary_op arg_as_int
                         (fun r  ->
                            fun x  ->
                              fun y  ->
                                let uu____5979 = FStar_BigInt.ge_big_int x y
                                   in
                  ...
                  (FStar_Parser_Const.op_GT, (Prims.parse_int "2"),
                    (binary_op arg_as_int
                       (fun r  ->
                          fun x  ->
                            fun y  ->
                              let uu____6005 = FStar_BigInt.gt_big_int x y
                                 in
    ...
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> FStar_BigInt.minus_big_int x))) :: uu____5140
     in
                      ...
                      fun uu____6277  ->
                        fun uu____6278  ->
                          ...
                          | ((int_to_t1,x),(uu____6297,y)) ->
                              let uu____6307 = FStar_BigInt.add_big_int x y
                                 in
                              int_as_bounded r int_to_t1 uu____6307)))
               in
            let uu____6308 =
              let uu____6323 =
                let uu____6336 = FStar_Parser_Const.p2l ["FStar"; m; "sub"]
                   in
                        ...
                        fun uu____6356  ->
                          fun uu____6357  ->
                            ...
                            | ((int_to_t1,x),(uu____6376,y)) ->
                                let uu____6386 = FStar_BigInt.sub_big_int x y
                                   in
                                int_as_bounded r int_to_t1 uu____6386)))
                 in
              let uu____6387 =
                let uu____6402 =
                  let uu____6415 = FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                     in
                          ...
                          fun uu____6435  ->
                            fun uu____6436  ->
                              ...
                              | ((int_to_t1,x),(uu____6455,y)) ->
                                  ...
                                  int_as_bounded r int_to_t1 uu____6465)))
                   in
                [uu____6402]  in
              uu____6323 :: uu____6387  in
            uu____6244 :: uu____6308))
     in
                             ...
                             (let term1 = closure_as_term cfg env1 term  in
                              ...
                              | FStar_Pervasives_Native.Some x ->
                                  let b1 =
                                    ...
                                    FStar_Syntax_Syntax.freshen_bv uu____6888
                                     in
                                  let b_for_x =
                                    let uu____6894 =
                                      let uu____6901 =
                      ...
                      (let uu____8163 =
                       ...
                       then
                         ...
                         | (uu____8415,(p,uu____8417))::(uu____8418,(q,uu____8420))::[]
                             ->
                             let uu____8485 = FStar_Syntax_Util.term_eq p q
                                in
                             (if uu____8485
                      ...
                      (let uu____9717 =
                       ...
                       then
                         ...
                         | (uu____9969,(p,uu____9971))::(uu____9972,(q,uu____9974))::[]
                             ->
                             let uu____10039 = FStar_Syntax_Util.term_eq p q
                                in
                             (if uu____10039
                              then w FStar_Syntax_Util.t_true
                              else squashed_head_un_auto_squash_args tm1)
...
let tr_norm_step : FStar_Syntax_Embeddings.norm_step -> step Prims.list =
  fun uu___78_10686  ->
    ...
    | FStar_Syntax_Embeddings.UnfoldOnly names1 ->
        let uu____10692 =
          let uu____10695 =
            let uu____10696 = FStar_List.map FStar_Ident.lid_of_str names1
               in
  ...
  fun full_norm  ->
    fun args  ->
      ...
      | (steps,uu____10822)::uu____10823::(tm,uu____10825)::[] ->
          ...
          let s =
            let uu____10865 =
              let uu____10868 = full_norm steps  in parse_steps uu____10868
               in
            Beta :: uu____10865  in
        ...
        fun t  ->
          ...
          (match t1.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_fvar fv when
               ...
               (log cfg
                  (fun uu____11202  ->
                     let uu____11203 = FStar_Syntax_Print.term_to_string t1
                        in
               ...
               let should_delta1 =
                 ...
                 then false
                   ...
                   (let uu____11948 =
                    ...
                    | uu____11963 -> should_delta)
                  in
               (log cfg
                  (fun uu____11971  ->
                     let uu____11972 = FStar_Syntax_Print.term_to_string t1
                        in
                     let uu____11973 =
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12513  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12771  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12902  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____13037  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____13156  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (Steps (s,ps,dl))::stack1 ->
                           let t2 =
                             let uu____13735 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____13736
                                in
                       ...
                       | uu____13785 ->
                           let uu____13786 =
                             let uu____13787 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____13788
                                in
                        ...
                        (let lb1 =
                         ...
                         let env' =
                           FStar_All.pipe_right bs
                             (FStar_List.fold_left
                                (fun env1  ->
                                   fun uu____14236  -> dummy :: env1) env)
                            in
                         let cfg1 =
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____14357 =
                                   let uu____14366 =
                                     FStar_List.map
                                       (fun uu____14386  -> dummy) xs1
                                      in
                                   FStar_List.append uu____14366 env  in
                                 FStar_List.append uu____14340 uu____14357
                                  in
                               ...
                               let uu____15532 =
                                 let uu____15533 =
                                   ...
                                   (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                    ...
                                    in
                                 Clos uu____15533  in
                               (FStar_Pervasives_Native.None, uu____15532)
                                in
                             uu____15525 :: env1)
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____15693 =
                         let uu____15694 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____15712 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       let uu____15727 =
                                         ...
                                         uu____15728.FStar_Syntax_Syntax.n
                                          in
                                     ...
                                     (match uu____15765 with
                                      ...
                                      | FStar_Pervasives_Native.None  ->
                                          let uu____15806 =
                                            let uu____15807 = is_return body
                                               in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____16004 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                let maybe_unfold_action head2 =
                                  let maybe_extract_fv t3 =
                                    ...
                                    | uu____16060 ->
                                        FStar_Pervasives_Native.None
                                     in
                                  let uu____16061 = maybe_extract_fv head2
                                     in
                                ...
                                ((let is_arg_impure uu____16102 =
                                    ...
                                    | (e,q) ->
                                        let uu____16109 =
                                          let uu____16110 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____16110.FStar_Syntax_Syntax.n
                                           in
                                  ...
                                  | (head_app1,found_action) ->
                                      ...
                                      let body1 =
                                        ...
                                        | FStar_Pervasives_Native.Some (true
                                         ...
                                         in
                                      let uu____16181 = FStar_List.tl stack
                                         in
        ...
        fun t0  ->
          fun f  ->
            ...
            | FStar_Pervasives_Native.Some (us,t) ->
                (log cfg
                   (fun uu____16525  ->
                      let uu____16526 = FStar_Syntax_Print.term_to_string t0
                         in
                    ...
                    let uu____16663 =
                      let uu____16664 =
                        let uu____16679 =
                          ...
                          let uu____16683 =
                            let uu____16686 = FStar_Syntax_Syntax.as_arg e
                               in
                            [uu____16686]  in
      ...
      fun uu____17033  ->
        ...
        | (x,imp) ->
            let uu____17036 =
              ...
              let uu____17038 = norm cfg env [] x.FStar_Syntax_Syntax.sort
                 in
              {
                FStar_Syntax_Syntax.ppname =
          ...
          (match stack with
           ...
           | (MemoLazy r)::stack1 ->
               (set_memo r (env, t);
                log cfg
                  (fun uu____17260  ->
                     let uu____17261 = FStar_Syntax_Print.term_to_string t
                        in
                     FStar_Util.print1 "\tSet memo %s\n" uu____17261);
                rebuild cfg env stack1 t)
           ...
           | (Arg (Clos (env_arg,tm,m,uu____17323),aq,r))::stack1 ->
               (log cfg
                  (fun uu____17376  ->
                     let uu____17377 = FStar_Syntax_Print.term_to_string tm
                        in
           ...
           | (Match (env1,branches,r))::stack1 ->
               (log cfg
                  (fun uu____17608  ->
                     let uu____17609 = FStar_Syntax_Print.term_to_string t
                        in
                     FStar_Util.print1
                   ...
                   (let whnf =
                              ...
                              (FStar_List.fold_left
                                 (fun uu____17785  ->
                                    fun uu____17786  ->
                                      ...
                                      | ((pats1,env3),(p1,b)) ->
                                          let uu____17877 = norm_pat env3 p1
                                             in
                    ...
                    let uu____18118 =
                      mk
                        ...
                        r
                       in
                    rebuild cfg env1 stack1 uu____18118)
                    in
                       ...
                       (match uu____18580 with
                        | FStar_Util.Inl s ->
                            matches_args (FStar_List.append out s) rest_a
                              rest_p
                        | m -> m)
                   | uu____18629 -> FStar_Util.Inr false
                  in
                                                 ...
                                                 let uu____18890 =
                                                   FStar_Util.mk_ref
                                                     (FStar_Pervasives_Native.Some
                                                        ([], t1))
                                                    in
                                                 ([], t1, uu____18890, false)
                                                  in
                                               Clos uu____18859  in
                                             (uu____18854, uu____18858)  in
                                           uu____18847 :: env2) env1 s
                                 in
                              let uu____19007 = guard_when_clause wopt b rest
                                 in
                              norm cfg env2 stack1 uu____19007)))
                    in
                 let uu____19008 =
                   FStar_All.pipe_right cfg.steps
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____19236 =
                     let uu____19237 =
                       let uu____19244 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____19244)  in
           ...
           | (head1,args) ->
               ...
               (match uu____19414 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____19418,thead) ->
                    let uu____19444 = FStar_Syntax_Util.arrow_formals thead
                       in
        ...
        fun tc  ->
          let t =
            ...
            | (uu____19590,FStar_Util.Inl t) ->
             ...
             in
          let uu____19617 = FStar_Syntax_Subst.open_univ_vars univ_names t
             in
                ...
                | uu____19699 ->
                    ...
                    (match uu____19700 with
                     ...
                     | (uu____19811,FStar_Util.Inl uu____19812) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____19835 -> failwith "Impossible")
                 in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____20388 with
           | (univs1,binders,signature) ->
               let uu____20416 =
                 let uu____20425 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____20425 with
                 | (univs_opening,univs2) ->
                     let uu____20452 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____20452)
                  in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____20849 = destruct_action_body body
                                    in
                           ...
                           | (action_univs,t) ->
                               let uu____20953 = destruct_action_typ_templ t
                                  in
