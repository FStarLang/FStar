         ...
         | uu____1934 ->
             ...
             (match t1.FStar_Syntax_Syntax.n with
                    ...
                    let uu____1982 =
                      let uu____1983 =
                        FStar_Range.string_of_range
                         ...
                         in
                      let uu____1984 = FStar_Syntax_Print.term_to_string t1
                         in
                      FStar_Util.format2
              ...
              | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
                  let uu____1995 = FStar_List.map (norm_universe cfg env) us
                     in
              ...
              | FStar_Syntax_Syntax.Tm_ascribed (t11,(annot,tacopt),lopt) ->
                  let annot1 =
                    match annot with
                    | FStar_Util.Inl t2 ->
                        let uu____2371 = closure_as_term_delayed cfg env t2
                           in
                        FStar_Util.Inl uu____2371
                    | FStar_Util.Inr c ->
                        let uu____2385 = close_comp cfg env c  in
                        FStar_Util.Inr uu____2385
                     in
                  let tacopt1 =
                  ...
                  let uu____2401 =
                    let uu____2402 =
                      let uu____2429 = closure_as_term_delayed cfg env t11
                         in
              ...
              | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                  ...
                  let uu____2691 =
                    let uu____2702 = FStar_Syntax_Syntax.is_top_level [lb]
                       in
                    if uu____2702
                  ...
                  let norm_one_lb env1 lb =
                    let env_univs =
                      FStar_List.fold_right
                       ...
                       in
                    let env2 =
                      let uu____2844 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____2844
                      then env_univs
                      else
                    ...
                    let ty =
                      closure_as_term cfg env_univs
                       ...
                       in
                    let nm =
                      let uu____2886 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____2886
                        ...
                        (let x =
                         ...
                         FStar_All.pipe_right
                           (let uu___311_2898 = x  in
                            ...
                            }) (fun _0_42  -> FStar_Util.Inl _0_42))
                       in
...
let built_in_primitive_steps : primitive_step Prims.list =
    ...
    unary_op arg_as_int
      (fun r  ->
         fun x  ->
           ...
           FStar_Syntax_Embeddings.embed_int r uu____4432)
     in
  let binary_int_op f =
      ...
      (fun r  ->
         fun x  ->
           fun y  ->
             ...
             FStar_Syntax_Embeddings.embed_int r uu____4460)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  ->
           ...
           FStar_Syntax_Embeddings.embed_bool r uu____4481)
     in
      ...
      (fun r  ->
         fun x  ->
           fun y  ->
             ...
             FStar_Syntax_Embeddings.embed_bool r uu____4509)
     in
      ...
      (fun r  ->
         fun x  ->
           fun y  ->
             ...
             FStar_Syntax_Embeddings.embed_string r uu____4537)
     in
  ...
  let basic_ops =
                                    ...
                                    let uu____5165 =
                                      let uu____5180 =
                                        ...
                                        (FStar_Parser_Const.op_notEq,
                                          (Prims.parse_int "3"),
                                          (decidable_eq true)) :: uu____5195
                                         in
                                      (FStar_Parser_Const.op_Eq,
                                        (Prims.parse_int "3"),
                                        (decidable_eq false)) :: uu____5180
                                       in
                    ...
                    (FStar_Parser_Const.op_GTE, (Prims.parse_int "2"),
                      (binary_op arg_as_int
                         (fun r  ->
                            fun x  ->
                              fun y  ->
                                let uu____5719 = FStar_BigInt.ge_big_int x y
                                   in
                  ...
                  (FStar_Parser_Const.op_GT, (Prims.parse_int "2"),
                    (binary_op arg_as_int
                       (fun r  ->
                          fun x  ->
                            fun y  ->
                              let uu____5745 = FStar_BigInt.gt_big_int x y
                                 in
    ...
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> FStar_BigInt.minus_big_int x))) :: uu____4925
     in
                      ...
                      fun uu____6017  ->
                        fun uu____6018  ->
                          ...
                          | ((int_to_t1,x),(uu____6037,y)) ->
                              let uu____6047 = FStar_BigInt.add_big_int x y
                                 in
                              int_as_bounded r int_to_t1 uu____6047)))
               in
            let uu____6048 =
              let uu____6063 =
                let uu____6076 = FStar_Parser_Const.p2l ["FStar"; m; "sub"]
                   in
                        ...
                        fun uu____6096  ->
                          fun uu____6097  ->
                            ...
                            | ((int_to_t1,x),(uu____6116,y)) ->
                                let uu____6126 = FStar_BigInt.sub_big_int x y
                                   in
                                int_as_bounded r int_to_t1 uu____6126)))
                 in
              let uu____6127 =
                let uu____6142 =
                  let uu____6155 = FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                     in
                          ...
                          fun uu____6175  ->
                            fun uu____6176  ->
                              ...
                              | ((int_to_t1,x),(uu____6195,y)) ->
                                  ...
                                  int_as_bounded r int_to_t1 uu____6205)))
                   in
                [uu____6142]  in
              uu____6063 :: uu____6127  in
            uu____5984 :: uu____6048))
     in
                             ...
                             (let term1 = closure_as_term cfg env1 term  in
                              ...
                              | FStar_Pervasives_Native.Some x ->
                                  let b1 =
                                    ...
                                    FStar_Syntax_Syntax.freshen_bv uu____6628
                                     in
                                  let b_for_x =
                                    let uu____6634 =
                                      let uu____6641 =
                      ...
                      (let uu____7770 =
                       ...
                       then
                         ...
                         | (uu____8022,(p,uu____8024))::(uu____8025,(q,uu____8027))::[]
                             ->
                             let uu____8092 = FStar_Syntax_Util.term_eq p q
                                in
                             (if uu____8092
                      ...
                      (let uu____9295 =
                       ...
                       then
                         ...
                         | (uu____9547,(p,uu____9549))::(uu____9550,(q,uu____9552))::[]
                             ->
                             let uu____9617 = FStar_Syntax_Util.term_eq p q
                                in
                             (if uu____9617
                              then w FStar_Syntax_Util.t_true
                              else tm1)
...
let tr_norm_step : FStar_Syntax_Embeddings.norm_step -> step Prims.list =
  fun uu___295_10180  ->
    ...
    | FStar_Syntax_Embeddings.UnfoldOnly names1 ->
        let uu____10186 =
          let uu____10189 =
            let uu____10190 = FStar_List.map FStar_Ident.lid_of_str names1
               in
  ...
  fun full_norm  ->
    fun args  ->
      ...
      | (steps,uu____10316)::uu____10317::(tm,uu____10319)::[] ->
          ...
          let s =
            let uu____10359 =
              let uu____10362 = full_norm steps  in parse_steps uu____10362
               in
            Beta :: uu____10359  in
        ...
        fun t  ->
          ...
          (match t1.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_fvar fv when
               ...
               (log cfg
                  (fun uu____10696  ->
                     let uu____10697 = FStar_Syntax_Print.term_to_string t1
                        in
               ...
               let should_delta1 =
                 ...
                 then false
                   ...
                   (let uu____11442 =
                    ...
                    | uu____11457 -> should_delta)
                  in
               (log cfg
                  (fun uu____11465  ->
                     let uu____11466 = FStar_Syntax_Print.term_to_string t1
                        in
                     let uu____11467 =
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11977  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12104  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12366  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12501  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12620  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                      ...
                      let c2 =
                        let uu____12977 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env1  ->
                                  fun uu____13001  -> dummy :: env1) env)
                           in
                        ...
                        (let lb1 =
                         ...
                         let env' =
                           FStar_All.pipe_right bs
                             (FStar_List.fold_left
                                (fun env1  ->
                                   fun uu____13540  -> dummy :: env1) env)
                            in
                         let cfg1 =
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____13661 =
                                   let uu____13670 =
                                     FStar_List.map
                                       (fun uu____13690  -> dummy) xs1
                                      in
                                   FStar_List.append uu____13670 env  in
                                 FStar_List.append uu____13644 uu____13661
                                  in
                               ...
                               let uu____14808 =
                                 let uu____14809 =
                                   ...
                                   (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                    ...
                                    in
                                 Clos uu____14809  in
                               (FStar_Pervasives_Native.None, uu____14808)
                                in
                             uu____14801 :: env1)
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____14961 =
                         let uu____14962 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____14980 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       let uu____14995 =
                                         ...
                                         uu____14996.FStar_Syntax_Syntax.n
                                          in
                                           ...
                                           let uu____15012 =
                                             let uu____15013 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____15013.FStar_Syntax_Syntax.n
                                              in
                                     ...
                                     (match uu____15033 with
                                      ...
                                      | FStar_Pervasives_Native.None  ->
                                          let uu____15074 =
                                            let uu____15075 = is_return body
                                               in
                                               ...
                                               let uu____15149 =
                                                 let uu____15150 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____15150.FStar_Syntax_Syntax.n
                                                  in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____15272 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                let maybe_unfold_action head2 =
                                  let maybe_extract_fv t3 =
                                    ...
                                    | uu____15328 ->
                                        FStar_Pervasives_Native.None
                                     in
                                  let uu____15329 = maybe_extract_fv head2
                                     in
                                ...
                                ((let is_arg_impure uu____15370 =
                                    ...
                                    | (e,q) ->
                                        let uu____15377 =
                                          let uu____15378 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____15378.FStar_Syntax_Syntax.n
                                           in
                                  ...
                                  | (head_app1,found_action) ->
                                      ...
                                      let body1 =
                                        ...
                                        | FStar_Pervasives_Native.Some (true
                                         ...
                                         in
                                      let uu____15449 = FStar_List.tl stack1
                                         in
        ...
        fun t0  ->
          fun f  ->
            ...
            | FStar_Pervasives_Native.Some (us,t) ->
                (log cfg
                   (fun uu____15793  ->
                      let uu____15794 = FStar_Syntax_Print.term_to_string t0
                         in
                      let uu____15795 = FStar_Syntax_Print.term_to_string t
                         in
      ...
      fun uu____16290  ->
        ...
        | (x,imp) ->
            let uu____16293 =
              ...
              let uu____16295 = norm cfg env [] x.FStar_Syntax_Syntax.sort
                 in
              {
                FStar_Syntax_Syntax.ppname =
          ...
          (match stack1 with
           ...
           | (MemoLazy r)::stack2 ->
               (set_memo r (env, t);
                log cfg
                  (fun uu____16509  ->
                     let uu____16510 = FStar_Syntax_Print.term_to_string t
                        in
                     FStar_Util.print1 "\tSet memo %s\n" uu____16510);
                rebuild cfg env stack2 t)
           ...
           | (Arg (Clos (env_arg,tm,m,uu____16572),aq,r))::stack2 ->
               (log cfg
                  (fun uu____16625  ->
                     let uu____16626 = FStar_Syntax_Print.term_to_string tm
                        in
           ...
           | (Match (env1,branches,r))::stack2 ->
               (log cfg
                  (fun uu____16835  ->
                     let uu____16836 = FStar_Syntax_Print.term_to_string t
                        in
                     FStar_Util.print1
                   ...
                   (let whnf =
                              ...
                              (FStar_List.fold_left
                                 (fun uu____17012  ->
                                    fun uu____17013  ->
                                      ...
                                      | ((pats1,env3),(p1,b)) ->
                                          let uu____17104 = norm_pat env3 p1
                                             in
                    ...
                    let uu____17345 =
                      mk
                        ...
                        r
                       in
                    rebuild cfg env1 stack2 uu____17345)
                    in
                       ...
                       (match uu____17807 with
                        | FStar_Util.Inl s ->
                            matches_args (FStar_List.append out s) rest_a
                              rest_p
                        | m -> m)
                   | uu____17856 -> FStar_Util.Inr false
                  in
                                                 ...
                                                 let uu____18117 =
                                                   FStar_Util.mk_ref
                                                     (FStar_Pervasives_Native.Some
                                                        ([], t1))
                                                    in
                                                 ([], t1, uu____18117, false)
                                                  in
                                               Clos uu____18086  in
                                             (uu____18081, uu____18085)  in
                                           uu____18074 :: env2) env1 s
                                 in
                              let uu____18226 = guard_when_clause wopt b rest
                                 in
                              norm cfg env2 stack2 uu____18226)))
                    in
                 let uu____18227 =
                   FStar_All.pipe_right cfg.steps
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____18443 =
                     let uu____18444 =
                       let uu____18451 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____18451)  in
           ...
           | (head1,args) ->
               ...
               (match uu____18621 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____18625,thead) ->
                    let uu____18651 = FStar_Syntax_Util.arrow_formals thead
                       in
        ...
        fun tc  ->
          let t =
            ...
            | (uu____18797,FStar_Util.Inl t) ->
             ...
             in
          let uu____18824 = FStar_Syntax_Subst.open_univ_vars univ_names t
             in
                ...
                | uu____18906 ->
                    ...
                    (match uu____18907 with
                     ...
                     | (uu____19018,FStar_Util.Inl uu____19019) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____19042 -> failwith "Impossible")
                 in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____19595 with
           | (univs1,binders,signature) ->
               let uu____19623 =
                 let uu____19632 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____19632 with
                 | (univs_opening,univs2) ->
                     let uu____19659 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____19659)
                  in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____20056 = destruct_action_body body
                                    in
                           ...
                           | (action_univs,t) ->
                               let uu____20160 = destruct_action_typ_templ t
                                  in
