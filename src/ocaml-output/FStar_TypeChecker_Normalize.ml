...
let env_to_string : closure Prims.list  ->  Prims.string = (fun env -> (let _0_270 = (FStar_List.map closure_to_string env)
...
(let _0_271 = (closure_to_string c)
in (FStar_Util.format1 "Closure %s" _0_271))
end
| MemoLazy (uu____595) -> begin
"MemoLazy"
end
| Abs (uu____599, bs, uu____601, uu____602, uu____603) -> begin
(let _0_272 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
in (FStar_Util.format1 "Abs %s" _0_272))
end
...
(let _0_273 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "App %s" _0_273))
end
...
| Debug (t) -> begin
(let _0_274 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "Debug %s" _0_274))
end))


let stack_to_string : stack_elt Prims.list  ->  Prims.string = (fun s -> (let _0_275 = (FStar_List.map stack_elt_to_string s)
...
with
| uu____683 -> begin
(failwith (let _0_276 = (FStar_Syntax_Print.db_to_string x)
...
| true -> begin
(Prims.raise (FStar_Errors.Error ((let _0_280 = (let _0_279 = (FStar_Util.string_of_int (FStar_List.length binders))
in (let _0_278 = (FStar_Util.string_of_int ((FStar_List.length c.FStar_Syntax_Syntax.effect_args) + (Prims.parse_int "1")))
in (let _0_277 = (FStar_Syntax_Print.comp_to_string (FStar_Syntax_Syntax.mk_Comp c))
in (FStar_Util.format3 "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s" _0_279 _0_278 _0_277))))
in ((_0_280), (comp.FStar_Syntax_Syntax.pos))))))
end
| uu____752 -> begin
()
end);
...
let inst = (let _0_282 = (let _0_281 = (FStar_Syntax_Syntax.as_arg c.FStar_Syntax_Syntax.result_typ)
in (_0_281)::c.FStar_Syntax_Syntax.effect_args)
...
in (FStar_All.pipe_right _0_283 FStar_Syntax_Syntax.mk_Comp))
...
let us = (let _0_284 = (FStar_List.collect aux us)
in (FStar_All.pipe_right _0_284 norm_univs))
in (match (us) with
| (u_k)::(hd)::rest -> begin
(
...
(let _0_286 = (aux u)
in (FStar_List.map (fun _0_285 -> FStar_Syntax_Syntax.U_succ (_0_285)) _0_286))
end)))
in (
...
let rec closure_as_term : cfg  ->  closure Prims.list  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun cfg env t -> ((log cfg (fun uu____1030 -> (let _0_288 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_287 = (FStar_Syntax_Print.term_to_string t)
...
(let _0_289 = FStar_Syntax_Syntax.Tm_type ((norm_universe cfg env u))
in (mk _0_289 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_uinst (t, us) -> begin
(let _0_290 = (FStar_List.map (norm_universe cfg env) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst t _0_290))
end
...
in (let _0_292 = FStar_Syntax_Syntax.Tm_abs ((let _0_291 = (close_lcomp_opt cfg env lopt)
in ((bs), (body), (_0_291))))
...
let uu____1222 = (let _0_294 = (let _0_293 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_293)::[])
in (closures_as_binders_delayed cfg env _0_294))
in (match (uu____1222) with
| (x, env) -> begin
(

let phi = (closure_as_term_delayed cfg env phi)
in (let _0_297 = FStar_Syntax_Syntax.Tm_refine ((let _0_296 = (let _0_295 = (FStar_List.hd x)
in (FStar_All.pipe_right _0_295 Prims.fst))
in ((_0_296), (phi))))
in (mk _0_297 t.FStar_Syntax_Syntax.pos)))
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inl (t2), lopt) -> begin
(let _0_302 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_301 = (closure_as_term_delayed cfg env t1)
in (let _0_300 = (let _0_299 = (closure_as_term_delayed cfg env t2)
in (FStar_All.pipe_left (fun _0_298 -> FStar_Util.Inl (_0_298)) _0_299))
in ((_0_301), (_0_300), (lopt)))))
in (mk _0_302 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inr (c), lopt) -> begin
(let _0_307 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_306 = (closure_as_term_delayed cfg env t1)
in (let _0_305 = (let _0_304 = (close_comp cfg env c)
in (FStar_All.pipe_left (fun _0_303 -> FStar_Util.Inr (_0_303)) _0_304))
in ((_0_306), (_0_305), (lopt)))))
in (mk _0_307 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_pattern (args)) -> begin
(let _0_310 = FStar_Syntax_Syntax.Tm_meta ((let _0_309 = (closure_as_term_delayed cfg env t')
in (let _0_308 = FStar_Syntax_Syntax.Meta_pattern ((FStar_All.pipe_right args (FStar_List.map (closures_as_args_delayed cfg env))))
in ((_0_309), (_0_308)))))
in (mk _0_310 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_monadic (m, tbody)) -> begin
(let _0_314 = FStar_Syntax_Syntax.Tm_meta ((let _0_313 = (closure_as_term_delayed cfg env t')
in (let _0_312 = FStar_Syntax_Syntax.Meta_monadic ((let _0_311 = (closure_as_term_delayed cfg env tbody)
in ((m), (_0_311))))
in ((_0_313), (_0_312)))))
in (mk _0_314 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_monadic_lift (m1, m2, tbody)) -> begin
(let _0_318 = FStar_Syntax_Syntax.Tm_meta ((let _0_317 = (closure_as_term_delayed cfg env t')
in (let _0_316 = FStar_Syntax_Syntax.Meta_monadic_lift ((let _0_315 = (closure_as_term_delayed cfg env tbody)
in ((m1), (m2), (_0_315))))
in ((_0_317), (_0_316)))))
...
in (let _0_322 = (closure_as_term cfg env_univs lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_321 = (closure_as_term cfg env lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___139_1480.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___139_1480.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_322; FStar_Syntax_Syntax.lbeff = uu___139_1480.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_321}))))))
in (
...
let uu___142_1849 = x
in (let _0_323 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___142_1849.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___142_1849.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_323}))
in (((
...
let uu___144_1858 = x
in (let _0_324 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___144_1858.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___144_1858.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_324}))
in (((
...
in {FStar_Syntax_Syntax.ppname = uu___146_1872.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___146_1872.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_325}))
in (
...
in (let _0_327 = FStar_Syntax_Syntax.Tm_match ((let _0_326 = (FStar_All.pipe_right branches (FStar_List.map (norm_one_branch env)))
in ((head), (_0_326))))
in (mk _0_327 t.FStar_Syntax_Syntax.pos))))
end))
end);
))
...
| (x, imp) -> begin
(let _0_328 = (closure_as_term_delayed cfg env x)
in ((_0_328), (imp)))
end)) args)
end))
...
let uu___148_2072 = b
in (let _0_329 = (closure_as_term_delayed cfg env b.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___148_2072.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___148_2072.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_329}))
in (
...
(let _0_331 = (closure_as_term_delayed cfg env t)
in (let _0_330 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_Total' _0_331 _0_330)))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(let _0_333 = (closure_as_term_delayed cfg env t)
in (let _0_332 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_GTotal' _0_333 _0_332)))
end
...
let uu___149_2156 = c
in (let _0_334 = (FStar_List.map (norm_universe cfg env) c.FStar_Syntax_Syntax.comp_univs)
in {FStar_Syntax_Syntax.comp_univs = _0_334; FStar_Syntax_Syntax.effect_name = uu___149_2156.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))))))
end)
end))
...
let int_as_const = (fun i -> FStar_Const.Const_int ((let _0_335 = (FStar_Util.string_of_int i)
in ((_0_335), (None)))))
in (

let bool_as_const = (fun b -> FStar_Const.Const_bool (b))
in (let _0_344 = (FStar_List.flatten (FStar_List.map (fun m -> (let _0_343 = (let _0_336 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("add")::[]))
in ((_0_336), ((fun x y -> (int_as_const (x + y))))))
in (let _0_342 = (let _0_341 = (let _0_337 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("sub")::[]))
in ((_0_337), ((fun x y -> (int_as_const (x - y))))))
in (let _0_340 = (let _0_339 = (let _0_338 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("mul")::[]))
in ((_0_338), ((fun x y -> (int_as_const (x * y))))))
in (_0_339)::[])
in (_0_341)::_0_340))
in (_0_343)::_0_342))) (("Int8")::("UInt8")::("Int16")::("UInt16")::("Int32")::("UInt32")::("Int64")::("UInt64")::("UInt128")::[])))
...
let name = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_345 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_345 FStar_Syntax_Syntax.Delta_constant None))))))
in (

let ctor = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_346 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_346 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))))))
in (let _0_363 = (let _0_362 = (FStar_Syntax_Const.p2l (("FStar")::("String")::("list_of_string")::[]))
in ((_0_362), ((fun s -> (let _0_361 = (FStar_String.list_of_string s)
in (let _0_360 = (mk (FStar_Syntax_Syntax.Tm_app ((let _0_359 = (let _0_355 = (ctor (("Prims")::("Nil")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_355 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_358 = (let _0_357 = (let _0_356 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_356), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (_0_357)::[])
in ((_0_359), (_0_358)))))))
in (FStar_List.fold_right (fun c a -> (mk (FStar_Syntax_Syntax.Tm_app ((let _0_354 = (let _0_347 = (ctor (("Prims")::("Cons")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_347 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_353 = (let _0_352 = (let _0_348 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_348), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (let _0_351 = (let _0_350 = (let _0_349 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_char (c))))
in ((_0_349), (None)))
in (_0_350)::(((a), (None)))::[])
in (_0_352)::_0_351))
in ((_0_354), (_0_353)))))))) _0_361 _0_360)))))))
in (_0_363)::[]))))
...
let c = (let _0_365 = (FStar_Util.int_of_string i)
in (let _0_364 = (FStar_Util.int_of_string j)
in (op _0_365 _0_364)))
in (mk (FStar_Syntax_Syntax.Tm_constant (c)) tm.FStar_Syntax_Syntax.pos)))
in (

let uu____2843 = (let _0_367 = (FStar_Syntax_Subst.compress a1).FStar_Syntax_Syntax.n
in (let _0_366 = (FStar_Syntax_Subst.compress a2).FStar_Syntax_Syntax.n
in ((_0_367), (_0_366))))
...
let uu____2896 = (let _0_371 = (FStar_Syntax_Subst.compress head1).FStar_Syntax_Syntax.n
in (let _0_370 = (FStar_Syntax_Subst.compress head2).FStar_Syntax_Syntax.n
in (let _0_369 = (FStar_Syntax_Subst.compress arg1).FStar_Syntax_Syntax.n
in (let _0_368 = (FStar_Syntax_Subst.compress arg2).FStar_Syntax_Syntax.n
in ((_0_371), (_0_370), (_0_369), (_0_368))))))
...
(let _0_375 = (mk (FStar_Syntax_Syntax.Tm_fvar (fv1)) tm.FStar_Syntax_Syntax.pos)
in (let _0_374 = (let _0_373 = (let _0_372 = (norm i j)
in ((_0_372), (None)))
in (_0_373)::[])
in (FStar_Syntax_Util.mk_app _0_375 _0_374)))
end
| uu____2938 -> begin
tm
end))
...
let uu____3850 = (let _0_376 = (FStar_Syntax_Util.un_uinst hd).FStar_Syntax_Syntax.n
in ((_0_376), (args)))
...
in ((log cfg (fun uu____4014 -> (let _0_380 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_379 = (FStar_Syntax_Print.term_to_string t)
in (let _0_378 = (stack_to_string (let _0_377 = (firstn (Prims.parse_int "4") stack)
in (FStar_All.pipe_left Prims.fst _0_377)))
...
let uu___151_4081 = cfg
in {steps = s; tcenv = uu___151_4081.tcenv; delta_level = (FStar_TypeChecker_Env.Unfold (FStar_Syntax_Syntax.Delta_constant))::[]})
in (
...
in (let _0_381 = (mk (FStar_Syntax_Syntax.Tm_type (u)) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _0_381)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
(
...
let us = UnivArgs ((let _0_382 = (FStar_List.map (norm_universe cfg env) us)
in ((_0_382), (t.FStar_Syntax_Syntax.pos))))
in (
...
let should_delta = (FStar_All.pipe_right cfg.delta_level (FStar_Util.for_some (fun uu___128_4293 -> (match (uu___128_4293) with
...
let r_env = (let _0_383 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv _0_383))
in (
...
| Some (us, t) -> begin
((log cfg (fun uu____4314 -> (let _0_385 = (FStar_Syntax_Print.term_to_string t0)
in (let _0_384 = (FStar_Syntax_Print.term_to_string t)
...
| uu____4335 -> begin
(failwith (let _0_386 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _0_386)))
end)
end
| uu____4340 -> begin
(norm cfg env stack t)
...
| Some (env, t') -> begin
((log cfg (fun uu____4377 -> (let _0_388 = (FStar_Syntax_Print.term_to_string t)
in (let _0_387 = (FStar_Syntax_Print.term_to_string t')
...
((log cfg (fun uu____4461 -> (let _0_389 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_389))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inr (l, cflags)) when (((FStar_Ident.lid_equals l FStar_Syntax_Const.effect_Tot_lid) || (FStar_Ident.lid_equals l FStar_Syntax_Const.effect_GTot_lid)) || (FStar_All.pipe_right cflags (FStar_Util.for_some (fun uu___129_4475 -> (match (uu___129_4475) with
...
((log cfg (fun uu____4478 -> (let _0_390 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_390))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inl (lc)) when (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc) -> begin
((log cfg (fun uu____4489 -> (let _0_391 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_391))));
(norm cfg ((c)::env) stack_rest body);
)
end
...
let uu___152_4505 = cfg
in {steps = (WHNF)::(Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = uu___152_4505.tcenv; delta_level = uu___152_4505.delta_level})
in (let _0_392 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_392)))
end)
end
| (uu____4506)::tl -> begin
((log cfg (fun uu____4516 -> (let _0_393 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_393))));
(
...
let uu___153_4537 = cfg
in {steps = s; tcenv = uu___153_4537.tcenv; delta_level = dl}) env stack t)
end
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____4550 -> (let _0_394 = (FStar_Syntax_Print.term_to_string t)
...
| true -> begin
(let _0_395 = (closure_as_term cfg env t)
...
(let _0_401 = (let _0_399 = (let _0_397 = (let _0_396 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _0_396))
in (FStar_All.pipe_right _0_397 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _0_399 (fun _0_398 -> FStar_Util.Inl (_0_398))))
...
in ((log cfg (fun uu____4634 -> (let _0_402 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
| (a, aq) -> begin
(let _0_405 = Arg ((let _0_404 = Clos ((let _0_403 = (FStar_Util.mk_ref None)
in ((env), (a), (_0_403), (false))))
in ((_0_404), (aq), (t.FStar_Syntax_Syntax.pos))))
in (_0_405)::stack)
end)) args))
in ((log cfg (fun uu____4691 -> (let _0_406 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
let uu___154_4712 = x
in {FStar_Syntax_Syntax.ppname = uu___154_4712.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___154_4712.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t.FStar_Syntax_Syntax.pos)
...
let t = (let _0_409 = FStar_Syntax_Syntax.Tm_refine ((let _0_408 = (FStar_Syntax_Subst.close closing f)
in (((

let uu___155_4734 = x
in {FStar_Syntax_Syntax.ppname = uu___155_4734.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___155_4734.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_0_408))))
in (mk _0_409 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end)
end
...
(match ((FStar_List.contains WHNF cfg.steps)) with
| true -> begin
(let _0_410 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_410))
end
| uu____4747 -> begin
(
...
let c = (let _0_411 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env uu____4759 -> (Dummy)::env) env))
in (norm_comp cfg _0_411 c))
in (

let t = (let _0_412 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _0_412 c))
in (rebuild cfg env stack t)))
end))
end)
end
...
in (let _0_413 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t1), (tc), (l)))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _0_413)));
))
end)
end
| FStar_Syntax_Syntax.Tm_match (head, branches) -> begin
...
let env = (let _0_415 = Clos ((let _0_414 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (_0_414), (false))))
in (_0_415)::env)
...
let uu____4921 = (let _0_418 = (let _0_417 = (let _0_416 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _0_416 FStar_Syntax_Syntax.mk_binder))
in (_0_417)::[])
in (FStar_Syntax_Subst.open_term _0_418 body))
...
let uu___156_4929 = lb
in (let _0_424 = (let _0_421 = (let _0_419 = (FStar_List.hd bs)
in (FStar_All.pipe_right _0_419 Prims.fst))
in (FStar_All.pipe_right _0_421 (fun _0_420 -> FStar_Util.Inl (_0_420))))
in (let _0_423 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_422 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _0_424; FStar_Syntax_Syntax.lbunivs = uu___156_4929.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_423; FStar_Syntax_Syntax.lbeff = uu___156_4929.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_422}))))
in (
...
(let _0_425 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_425))
end
...
let uu___157_5032 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___157_5032.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___157_5032.FStar_Syntax_Syntax.sort}))
in (
...
let body_env = (FStar_List.fold_right (fun lb env -> (let _0_427 = Clos ((let _0_426 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (_0_426), (false))))
in (_0_427)::env)) (Prims.snd lbs) env)
...
let uu___158_5197 = cfg
in {steps = (FStar_List.append ((NoDeltaSteps)::(Exclude (Zeta))::[]) cfg.steps); tcenv = uu___158_5197.tcenv; delta_level = (FStar_TypeChecker_Env.NoDelta)::[]})
...
let body = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_abs ((let _0_429 = (let _0_428 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_428)::[])
in ((_0_429), (body), (Some (FStar_Util.Inr (((m), ([])))))))))) None body.FStar_Syntax_Syntax.pos)
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_433 = (let _0_432 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_431 = (let _0_430 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_430)::[])
in (_0_432)::_0_431))
in ((bind), (_0_433)))))) None t.FStar_Syntax_Syntax.pos)
end
| uu____5285 -> begin
...
let reified = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_445 = (let _0_444 = (FStar_Syntax_Syntax.as_arg lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_443 = (let _0_442 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_441 = (let _0_440 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_439 = (let _0_438 = (FStar_Syntax_Syntax.as_arg head)
in (let _0_437 = (let _0_436 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_435 = (let _0_434 = (FStar_Syntax_Syntax.as_arg body)
in (_0_434)::[])
in (_0_436)::_0_435))
in (_0_438)::_0_437))
in (_0_440)::_0_439))
in (_0_442)::_0_441))
in (_0_444)::_0_443))
in ((bind_inst), (_0_445)))))) None t.FStar_Syntax_Syntax.pos)
in (let _0_446 = (FStar_List.tl stack)
in (norm cfg env _0_446 reified)))))))
end
...
| Some (x) when (let _0_447 = (FStar_Syntax_Syntax.lid_of_fv x)
in (FStar_TypeChecker_Env.is_action cfg.tcenv _0_447)) -> begin
(
...
let body = (let _0_450 = (let _0_449 = (let _0_448 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_0_448), (q)))
in (_0_449)::acc)
in (bind_on_lift es _0_450))
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_454 = (let _0_453 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t')
in (let _0_452 = (let _0_451 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_451)::[])
in (_0_453)::_0_452))
in ((bind), (_0_454)))))) None e0.FStar_Syntax_Syntax.pos)
end
| uu____5546 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_466 = (let _0_465 = (FStar_Syntax_Syntax.as_arg t')
in (let _0_464 = (let _0_463 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_462 = (let _0_461 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_460 = (let _0_459 = (FStar_Syntax_Syntax.as_arg lifted_e0)
in (let _0_458 = (let _0_457 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_456 = (let _0_455 = (FStar_Syntax_Syntax.as_arg continuation)
in (_0_455)::[])
in (_0_457)::_0_456))
in (_0_459)::_0_458))
in (_0_461)::_0_460))
in (_0_463)::_0_462))
in (_0_465)::_0_464))
in ((bind_inst), (_0_466)))))) None e0.FStar_Syntax_Syntax.pos))))))
end
...
let binded_head = (let _0_468 = (let _0_467 = (FStar_Syntax_Syntax.as_arg head)
in (_0_467)::args)
in (bind_on_lift _0_468 []))
in (let _0_469 = (FStar_List.tl stack)
in (norm cfg env _0_469 binded_head)))))
end)))
end
...
| (pat, wopt, tm) -> begin
(let _0_471 = (FStar_Syntax_Util.mk_reify tm)
in ((pat), (wopt), (_0_471)))
end))))
in (

let tm = (mk (FStar_Syntax_Syntax.Tm_match (((e), (branches)))) t.FStar_Syntax_Syntax.pos)
in (let _0_472 = (FStar_List.tl stack)
in (norm cfg env _0_472 tm))))
end
| uu____5743 -> begin
(norm cfg env stack head)
end))
...
| true -> begin
(let _0_474 = (FStar_List.tl stack)
in (let _0_473 = (reify_lift cfg.tcenv head m m' t)
in (norm cfg env _0_474 _0_473)))
end
| uu____5764 -> begin
(
...
let uu___159_5770 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = uu___159_5770.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]})
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_476 = (let _0_475 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_0_475)::[])
in ((return_tm), (_0_476)))))) None e.FStar_Syntax_Syntax.pos)
end
| uu____5851 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_480 = (let _0_479 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_478 = (let _0_477 = (FStar_Syntax_Syntax.as_arg e)
in (_0_477)::[])
in (_0_479)::_0_478))
in ((return_inst), (_0_480)))))) None e.FStar_Syntax_Syntax.pos))
end)))
end
| uu____5865 -> begin
...
let uu___160_5916 = comp
in (let _0_484 = FStar_Syntax_Syntax.Total ((let _0_483 = (norm cfg env [] t)
in (let _0_482 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_483), (_0_482)))))
in {FStar_Syntax_Syntax.n = _0_484; FStar_Syntax_Syntax.tk = uu___160_5916.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___160_5916.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___160_5916.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___161_5932 = comp
in (let _0_487 = FStar_Syntax_Syntax.GTotal ((let _0_486 = (norm cfg env [] t)
in (let _0_485 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_486), (_0_485)))))
in {FStar_Syntax_Syntax.n = _0_487; FStar_Syntax_Syntax.tk = uu___161_5932.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___161_5932.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___161_5932.FStar_Syntax_Syntax.vars}))
end
...
| (a, i) -> begin
(let _0_488 = (norm cfg env [] a)
in ((_0_488), (i)))
end)))))
in (

let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___130_5975 -> (match (uu___130_5975) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
...
let uu___162_5980 = comp
in (let _0_492 = FStar_Syntax_Syntax.Comp ((

let uu___163_5983 = ct
in (let _0_491 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _0_490 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _0_489 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _0_491; FStar_Syntax_Syntax.effect_name = uu___163_5983.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _0_490; FStar_Syntax_Syntax.effect_args = _0_489; FStar_Syntax_Syntax.flags = flags})))))
in {FStar_Syntax_Syntax.n = _0_492; FStar_Syntax_Syntax.tk = uu___162_5980.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___162_5980.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___162_5980.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___164_5995 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = uu___164_5995.tcenv; delta_level = uu___164_5995.delta_level}) env [] t))
in (
...
let uu___165_6016 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = uu___165_6016.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___165_6016.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___165_6016.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let uu___166_6031 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___166_6031.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = uu___166_6031.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___166_6031.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___166_6031.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let uu___167_6033 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___167_6033.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = uu___167_6033.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___167_6033.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___167_6033.FStar_Syntax_Syntax.flags}))
end)
in (

let uu___168_6034 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct); FStar_Syntax_Syntax.tk = uu___168_6034.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___168_6034.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___168_6034.FStar_Syntax_Syntax.vars}))
end
| uu____6039 -> begin
c
end)))
...
let uu___169_6046 = x
in (let _0_493 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___169_6046.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___169_6046.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_493}))
in ((_0_494), (imp)))
end))
...
| true -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_495 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags _0_495 flags)))))
end
| uu____6102 -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_496 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.comp_set_flags _0_496 flags)))))
end)))
end
| uu____6105 -> begin
Some (FStar_Util.Inr (((lc.FStar_Syntax_Syntax.eff_name), (flags))))
...
| true -> begin
(let _0_498 = (FStar_Syntax_Print.term_to_string tm)
in (let _0_497 = (FStar_Syntax_Print.term_to_string t)
...
let uu___170_6135 = cfg
in {steps = s; tcenv = uu___170_6135.tcenv; delta_level = dl}) env stack t)
end
...
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____6155 -> (let _0_499 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _0_499))));
(rebuild cfg env stack t);
)
end
...
let uu___171_6192 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = uu___171_6192.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___171_6192.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___171_6192.FStar_Syntax_Syntax.vars})
...
((log cfg (fun uu____6230 -> (let _0_501 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _0_502 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _0_502)))
end
| (Match (env, branches, r))::stack -> begin
((log cfg (fun uu____6295 -> (let _0_503 = (FStar_Syntax_Print.term_to_string t)
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun uu___131_6307 -> (match (uu___131_6307) with
| (FStar_TypeChecker_Env.Inlining) | (FStar_TypeChecker_Env.Eager_unfolding_only) -> begin
true
end
| uu____6308 -> begin
...
let uu___172_6314 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = uu___172_6314.tcenv; delta_level = new_delta})))
in (
...
let uu___173_6410 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = uu___173_6410.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___173_6410.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___174_6593 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___174_6593.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___174_6593.FStar_Syntax_Syntax.p})), (env))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___175_6607.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___175_6607.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_504}))
in (((

let uu___176_6611 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = uu___176_6611.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___176_6611.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___177_6616 = x
in (let _0_505 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___177_6616.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___177_6616.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_505}))
in (((

let uu___178_6620 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = uu___178_6620.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___178_6620.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t) -> begin
(
...
let uu___179_6630 = x
in (let _0_506 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___179_6630.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___179_6630.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_506}))
in (
...
let uu___180_6635 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = uu___180_6635.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___180_6635.FStar_Syntax_Syntax.p})), (env))))
end))
in (
...
in (let _0_507 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
in (rebuild cfg env stack _0_507))))))))
in (
...
| FStar_Util.Inl (s) -> begin
((log cfg (fun uu____7086 -> (let _0_510 = (FStar_Syntax_Print.pat_to_string p)
in (let _0_509 = (let _0_508 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _0_508 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _0_510 _0_509)))));
(

let env = (FStar_List.fold_left (fun env t -> (let _0_512 = Clos ((let _0_511 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_0_511), (false))))
in (_0_512)::env)) env s)
in (let _0_513 = (guard_when_clause wopt b rest)
in (norm cfg env stack _0_513)));
)
end))
end))
in (
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun uu___132_7124 -> (match (uu___132_7124) with
| UnfoldUntil (k) -> begin
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _0_514 = (config s e)
in (norm _0_514 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _0_515 = (config s e)
in (norm_comp _0_515 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _0_516 = (config [] env)
in (norm_universe _0_516 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _0_517 = (config [] env)
in (ghost_to_pure_aux _0_517 [] c)))
...
let uu___181_7176 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___181_7176.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___181_7176.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____7177 -> (let _0_518 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _0_518)))})
end
| None -> begin
lc
end)
...
let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (FStar_Syntax_Print.comp_to_string (let _0_519 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _0_519 [] c))))
...
(let _0_521 = FStar_Syntax_Syntax.Tm_refine ((let _0_520 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_0_520))))
in (mk _0_521 t0.FStar_Syntax_Syntax.pos))
end
| uu____7229 -> begin
t
end))
...
| (binders, args) -> begin
(let _0_526 = ((FStar_Syntax_Syntax.mk_Tm_app t args) None t.FStar_Syntax_Syntax.pos)
in (let _0_525 = (let _0_524 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _0_522 -> FStar_Util.Inl (_0_522)))
in (FStar_All.pipe_right _0_524 (fun _0_523 -> Some (_0_523))))
in (FStar_Syntax_Util.abs binders _0_526 _0_525)))
end))
end)
end)))
...
let uu____7303 = (let _0_527 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_0_527), (t.FStar_Syntax_Syntax.n)))
in (match (uu____7303) with
| (Some (sort), uu____7312) -> begin
(let _0_528 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _0_528))
end
| (uu____7314, FStar_Syntax_Syntax.Tm_name (x)) -> begin
(eta_expand_with_type t x.FStar_Syntax_Syntax.sort)
end
| uu____7318 -> begin
(

let uu____7322 = (FStar_Syntax_Util.head_and_args t)
in (match (uu____7322) with
| (head, args) -> begin
(

let uu____7348 = (FStar_Syntax_Subst.compress head).FStar_Syntax_Syntax.n
in (match (uu____7348) with
| FStar_Syntax_Syntax.Tm_uvar (uu____7349, thead) -> begin
(
...
let uu____7394 = (env.FStar_TypeChecker_Env.type_of (

let uu___182_7398 = env
in {FStar_TypeChecker_Env.solver = uu___182_7398.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___182_7398.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___182_7398.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___182_7398.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___182_7398.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___182_7398.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___182_7398.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___182_7398.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___182_7398.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___182_7398.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___182_7398.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___182_7398.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___182_7398.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___182_7398.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___182_7398.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___182_7398.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___182_7398.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___182_7398.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___182_7398.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___182_7398.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___182_7398.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (uu____7394) with
| (uu____7399, ty, uu____7401) -> begin
...
let uu____7403 = (env.FStar_TypeChecker_Env.type_of (

let uu___183_7407 = env
in {FStar_TypeChecker_Env.solver = uu___183_7407.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___183_7407.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___183_7407.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___183_7407.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___183_7407.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___183_7407.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___183_7407.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___183_7407.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___183_7407.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___183_7407.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___183_7407.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___183_7407.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___183_7407.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___183_7407.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___183_7407.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___183_7407.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___183_7407.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___183_7407.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___183_7407.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___183_7407.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___183_7407.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (uu____7403) with
| (uu____7408, ty, uu____7410) -> begin
(eta_expand_with_type t ty)
end))
end))
end))
