               ...
               (if
                ...
                (let inst =
                     ...
                     (fun uu____761  ->
                        fun uu____762  ->
                          ...
                          | ((x,uu____776),(t,uu____778)) ->
                              FStar_Syntax_Syntax.NT (x, t)) binders _0_303 in
                 ...
                 let c =
                   ...
                   FStar_All.pipe_right _0_304 FStar_Syntax_Syntax.mk_Comp in
      ...
      fun u  ->
        ...
        let rec aux u =
          ...
          | FStar_Syntax_Syntax.U_succ u ->
              let _0_307 = aux u in
              FStar_List.map
                (fun _0_306  -> FStar_Syntax_Syntax.U_succ _0_306) _0_307 in
        let uu____931 =
                    ...
                    FStar_Syntax_Syntax.Tm_ascribed
                      (let _0_322 = closure_as_term_delayed cfg env t1 in
                       let _0_321 =
                         ...
                         FStar_All.pipe_left
                           (fun _0_319  -> FStar_Util.Inl _0_319) _0_320 in
                       (_0_322, _0_321, lopt)) in
                    ...
                    FStar_Syntax_Syntax.Tm_ascribed
                      (let _0_327 = closure_as_term_delayed cfg env t1 in
                       let _0_326 =
                         ...
                         FStar_All.pipe_left
                           (fun _0_324  -> FStar_Util.Inr _0_324) _0_325 in
                       (_0_327, _0_326, lopt)) in
        ...
        | uu____2117 ->
            (match c.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Total (t,uopt) ->
                 ...
                 let _0_351 = FStar_Option.map (norm_universe cfg env) uopt in
                 FStar_Syntax_Syntax.mk_Total' _0_352 _0_351
             | FStar_Syntax_Syntax.GTotal (t,uopt) ->
                 let _0_354 = closure_as_term_delayed cfg env t in
                 let _0_353 = FStar_Option.map (norm_universe cfg env) uopt in
...
let arith_ops:
  ...
  let int_as_const i =
    FStar_Const.Const_int
      (let _0_356 = FStar_Util.string_of_int i in (_0_356, None)) in
...
let un_ops:
  ...
  let _0_384 =
    let _0_383 = FStar_Syntax_Const.p2l ["FStar"; "String"; "list_of_string"] in
    (_0_383,
      (fun s  ->
                     ...
                     (let _0_375 =
                      ...
                      let _0_374 =
                        ...
                        let _0_372 =
                          ...
                          [_0_371; (a, None)] in
                        _0_373 :: _0_372 in
                      (_0_375, _0_374)))) _0_382 _0_381)) in
  [_0_384]
let reduce_equality:
  (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
    FStar_Syntax_Syntax.syntax ->
          ...
          (match t.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
               ...
               then norm cfg env stack t'
                 ...
                 (let us =
                    UnivArgs
                      (let _0_402 = FStar_List.map (norm_universe cfg env) us in
                       (_0_402, (t.FStar_Syntax_Syntax.pos))) in
                  ...
                  | Some (us,t) ->
                      (log cfg
                         (fun uu____4284  ->
                            ...
                            let _0_404 = FStar_Syntax_Print.term_to_string t in
               ...
               (match stack with
                ...
                | (MemoLazy r)::stack ->
                    (set_memo r (env, t);
                     log cfg
                       (fun uu____4520  ->
                          let _0_414 = FStar_Syntax_Print.term_to_string t in
                             ...
                             | Some (FStar_Util.Inl l) ->
                                 let _0_421 =
                                   ...
                                   FStar_All.pipe_right _0_419
                                     (fun _0_418  -> FStar_Util.Inl _0_418) in
                           ...
                           | (a,aq) ->
                               let _0_425 =
                                 Arg
                                   (let _0_424 =
                                      Clos
                                        (let _0_423 = FStar_Util.mk_ref None in
                                         (env, a, _0_423, false)) in
                                    (_0_424, aq, (t.FStar_Syntax_Syntax.pos))) in
                               _0_425 :: stack) args) in
               (log cfg
                  (fun uu____4661  ->
                     let _0_426 =
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort in
                  ...
                  | (closing,f) ->
                      ...
                      let t =
                        let _0_429 =
                          FStar_Syntax_Syntax.Tm_refine
                            (let _0_428 = FStar_Syntax_Subst.close closing f in
                   ...
                   let _0_435 =
                     Clos
                       (let _0_434 = FStar_Util.mk_ref None in
                        (env, (lb.FStar_Syntax_Syntax.lbdef), _0_434, false)) in
                   _0_435 :: env in
                      ...
                      let lb =
                        ...
                        let _0_444 =
                          ...
                          FStar_All.pipe_right _0_441
                            (fun _0_440  -> FStar_Util.Inl _0_440) in
                        let _0_443 =
                             ...
                             let _0_447 =
                               Clos
                                 (let _0_446 = FStar_Util.mk_ref None in
                                  (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                    _0_446, false)) in
                             _0_447 :: env) (Prims.snd lbs) env in
            ...
            let _0_501 =
              FStar_Syntax_Syntax.Total
                (let _0_500 = norm cfg env [] t in
                 let _0_499 = FStar_Option.map (norm_universe cfg env) uopt in
                 (_0_500, _0_499)) in
            {
            ...
            let _0_504 =
              FStar_Syntax_Syntax.GTotal
                (let _0_503 = norm cfg env [] t in
                 let _0_502 = FStar_Option.map (norm_universe cfg env) uopt in
                 (_0_503, _0_502)) in
            {
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____5787  ->
                      ...
                      | (a,i) ->
                          let _0_505 = norm cfg env [] a in (_0_505, i))) in
            let flags =
            ...
            let _0_509 =
              FStar_Syntax_Syntax.Comp
                (let uu___165_5806 = ct in
                 ...
                 let _0_506 = norm_args ct.FStar_Syntax_Syntax.effect_args in
                 {
                    ...
                    let _0_542 =
                      let _0_541 =
                        FStar_All.pipe_right
                          ...
                          (fun _0_539  -> FStar_Util.Inl _0_539) in
                      FStar_All.pipe_right _0_541
                        (fun _0_540  -> Some _0_540) in
