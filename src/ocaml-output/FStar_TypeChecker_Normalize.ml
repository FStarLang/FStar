...
let (built_in_primitive_steps : primitive_step FStar_Util.psmap) =
  ...
  let weak_ops =
    let uu____8827 =
      ...
      (uu____8848, (Prims.parse_int "1"), prims_to_fstar_range_step)  in
    [uu____8827]  in
        ...
        fun t  ->
          ...
          log cfg
            (fun uu____11741  ->
               ...
               let uu____11751 =
                 let uu____11752 =
                   let uu____11755 = firstn (Prims.parse_int "4") stack  in
          ...
          log cfg
            (fun uu____22145  ->
               (let uu____22147 = FStar_Syntax_Print.tag_of_term t  in
                ...
                let uu____22156 =
                  let uu____22157 =
                    let uu____22160 = firstn (Prims.parse_int "4") stack  in
                    FStar_All.pipe_left FStar_Pervasives_Native.fst
                      uu____22160
                     in
