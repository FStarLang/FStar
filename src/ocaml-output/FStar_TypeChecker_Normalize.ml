         ...
         | uu____1565 ->
             ...
             (match t1.FStar_Syntax_Syntax.n with
                    ...
                    let uu____1615 =
                      let uu____1616 =
                        FStar_Range.string_of_range
                         ...
                         in
                      let uu____1617 = FStar_Syntax_Print.term_to_string t1
                         in
                      FStar_Util.format2
                        "(%s): CheckNoUvars: Unexpected unification variable remains: %s"
                        uu____1616 uu____1617
                       in
                    failwith uu____1615
                  else t1
              ...
              | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
                  let uu____1628 = FStar_List.map (norm_universe cfg env) us
                     in
              ...
              | FStar_Syntax_Syntax.Tm_ascribed (t11,(annot,tacopt),lopt) ->
                  let annot1 =
                    match annot with
                    | FStar_Util.Inl t2 ->
                        let uu____1996 = closure_as_term_delayed cfg env t2
                           in
                        FStar_Util.Inl uu____1996
                    | FStar_Util.Inr c ->
                        let uu____2010 = close_comp cfg env c  in
                        FStar_Util.Inr uu____2010
                     in
                  let tacopt1 =
                  ...
                  let uu____2026 =
                    let uu____2027 =
                      let uu____2054 = closure_as_term_delayed cfg env t11
                         in
              ...
              | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                  ...
                  let uu____2294 =
                    let uu____2305 = FStar_Syntax_Syntax.is_top_level [lb]
                       in
                    if uu____2305
                  ...
                  let norm_one_lb env1 lb =
                    let env_univs =
                      FStar_List.fold_right
                       ...
                       in
                    let env2 =
                      let uu____2399 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____2399
                      then env_univs
                      else
                    ...
                    let ty =
                      closure_as_term cfg env_univs
                       ...
                       in
                    let nm =
                      let uu____2417 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____2417
...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let unary_op as_a f r args =
    let uu____4074 = FStar_List.map as_a args  in lift_unary (f r) uu____4074
     in
  let binary_op as_a f r args =
    let uu____4130 = FStar_List.map as_a args  in
    lift_binary (f r) uu____4130  in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____4202 = f x  in int_as_const r uu____4202)
     in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4230 = f x y  in int_as_const r uu____4230)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  -> let uu____4251 = f x  in bool_as_const r uu____4251)
     in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4279 = f x y  in bool_as_const r uu____4279)
     in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4307 = f x y  in string_as_const r uu____4307)
     in
        ...
        let uu____4941 =
          let uu____4956 =
                                                    ...
                                                    let uu____5431 =
                                                      let uu____5454 =
                                                        ...
                                                        (uu____5473,
                                                         ...
                                                         in
                                                      [uu____5454]  in
                                                    uu____5395 :: uu____5431
                                                     in
                                                  uu____5336 :: uu____5372
                                                   in
            ...
            (FStar_Parser_Const.op_Division, (Prims.parse_int "2"),
              (binary_int_op (fun x  -> fun y  -> x / y))) :: uu____4971
             in
          (FStar_Parser_Const.op_Multiply, (Prims.parse_int "2"),
            (binary_int_op (fun x  -> fun y  -> x * y))) :: uu____4956
           in
        (FStar_Parser_Const.op_Subtraction, (Prims.parse_int "2"),
          (binary_int_op (fun x  -> fun y  -> x - y))) :: uu____4941
         in
      (FStar_Parser_Const.op_Addition, (Prims.parse_int "2"),
        (binary_int_op (fun x  -> fun y  -> x + y))) :: uu____4926
       in
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> - x))) :: uu____4911
     in
    ...
    FStar_All.pipe_right bounded_int_types
      (FStar_List.collect
         (fun m  ->
            ...
            let uu____6179 =
              let uu____6194 =
                let uu____6207 = FStar_Parser_Const.p2l ["FStar"; m; "sub"]
                   in
              ...
              let uu____6256 =
                let uu____6271 =
                  let uu____6284 = FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                     in
            ...
            (fun uu____9929  ->
               ...
               let uu____9932 =
                 let uu____9933 =
                   ...
                   FStar_All.pipe_left FStar_Pervasives_Native.fst uu____9936
                    in
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11011  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11109  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11213  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11301  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                      ...
                      let c2 =
                        let uu____11579 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env1  ->
                                  fun uu____11591  -> Dummy :: env1) env)
                           in
                    ...
                    (log cfg
                     ...
                     (let tc1 =
                      ...
                      let uu____11736 =
                        let uu____11737 =
                          let uu____11738 =
                            let uu____11765 = FStar_Syntax_Util.unascribe t12
                               in
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____12090 =
                                   let uu____12093 =
                                     FStar_List.map
                                       (fun uu____12101  -> Dummy) xs1
                                      in
                                   FStar_List.append uu____12093 env  in
                                 FStar_List.append uu____12085 uu____12090
                                  in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____12628 =
                         let uu____12629 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____12647 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                (match lb.FStar_Syntax_Syntax.lbname with
                                 ...
                                 | FStar_Util.Inl x ->
                                           ...
                                           let uu____12679 =
                                             let uu____12680 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____12680.FStar_Syntax_Syntax.n
                                              in
                                     ...
                                     (match uu____12700 with
                                      ...
                                      | FStar_Pervasives_Native.None  ->
                                          let uu____12741 =
                                            let uu____12742 = is_return body
                                               in
                                               ...
                                               let uu____12816 =
                                                 let uu____12817 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____12817.FStar_Syntax_Syntax.n
                                                  in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____12939 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                let maybe_unfold_action head2 =
                                  let maybe_extract_fv t3 =
                                    ...
                                    | uu____12989 ->
                                        FStar_Pervasives_Native.None
                                     in
                                  let uu____12990 = maybe_extract_fv head2
                                     in
                                ...
                                ((let is_arg_impure uu____13031 =
                                    ...
                                    | (e,q) ->
                                        let uu____13038 =
                                          let uu____13039 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____13039.FStar_Syntax_Syntax.n
                                           in
                                  ...
                                  | (head_app1,found_action) ->
                                      ...
                                      let body1 =
                                        ...
                                        | FStar_Pervasives_Native.Some (true
                                         ...
                                         in
                                      let uu____13110 = FStar_List.tl stack1
                                         in
                    ...
                    let uu____13485 =
                      let uu____13486 =
                        let uu____13501 =
                          ...
                          let uu____13505 =
                            let uu____13508 = FStar_Syntax_Syntax.as_arg e
                               in
                            [uu____13508]  in
      ...
      fun uu____13844  ->
        ...
        | (x,imp) ->
            let uu____13847 =
              ...
              let uu____13849 = norm cfg env [] x.FStar_Syntax_Syntax.sort
                 in
              {
                FStar_Syntax_Syntax.ppname =
      ...
      fun stack1  ->
        fun t  ->
          ...
          | (Arg (Clos (env1,tm,m,uu____14050),aq,r))::stack2 ->
              (log cfg
                 (fun uu____14079  ->
                    let uu____14080 = FStar_Syntax_Print.term_to_string tm
                       in
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps  in
                             ...
                             (FStar_List.fold_left
                                (fun uu____14361  ->
                                   fun uu____14362  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____14465 = norm_pat env3 p1
                                            in
                   ...
                   let uu____14704 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____14704)
                   in
                      ...
                      (match uu____15070 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____15095 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____15237 =
                                        ...
                                        Clos uu____15238  in
                                      uu____15237 :: env2) env1 s
                                in
                             let uu____15298 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____15298)))
                   in
                let uu____15299 =
                  FStar_All.pipe_right cfg.steps
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____15504 =
                     let uu____15505 =
                       let uu____15512 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____15512)  in
           ...
           | (head1,args) ->
               ...
               (match uu____15696 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____15700,thead) ->
                    let uu____15726 = FStar_Syntax_Util.arrow_formals thead
                       in
        ...
        fun tc  ->
          let t =
            ...
            | (uu____15876,FStar_Util.Inl t) ->
             ...
             in
          let uu____15903 = FStar_Syntax_Subst.open_univ_vars univ_names t
             in
                ...
                | uu____15985 ->
                    ...
                    (match uu____15986 with
                     ...
                     | (uu____16097,FStar_Util.Inl uu____16098) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____16121 -> failwith "Impossible")
                 in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____16684 with
           | (univs1,binders,signature) ->
               let uu____16712 =
                 let uu____16721 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____16721 with
                 | (univs_opening,univs2) ->
                     let uu____16748 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____16748)
                  in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____17145 = destruct_action_body body
                                    in
                           ...
                           | (action_univs,t) ->
                               let uu____17249 = destruct_action_typ_templ t
                                  in
