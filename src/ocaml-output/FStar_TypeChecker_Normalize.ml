...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let arg_as_bool uu____4409 =
    ...
    | (a,uu____4417) ->
        ...
        (match uu____4420 with
         ...
         | uu____4427 -> FStar_Pervasives_Native.None)
     in
  ...
  let unary_op as_a f r args =
    let uu____4757 = FStar_List.map as_a args  in lift_unary (f r) uu____4757
     in
  let binary_op as_a f r args =
    let uu____4813 = FStar_List.map as_a args  in
    lift_binary (f r) uu____4813  in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____4885 = f x  in int_as_const r uu____4885)
     in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4913 = f x y  in int_as_const r uu____4913)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  -> let uu____4934 = f x  in bool_as_const r uu____4934)
     in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4962 = f x y  in bool_as_const r uu____4962)
     in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4990 = f x y  in string_as_const r uu____4990)
     in
  ...
  let basic_ops =
        ...
        let uu____5624 =
          let uu____5639 =
                                                    ...
                                                    let uu____6114 =
                                                      let uu____6137 =
                                                        ...
                                                        (uu____6156,
                                                         ...
                                                         in
                                                      [uu____6137]  in
                                                    uu____6078 :: uu____6114
                                                     in
                                                  uu____6019 :: uu____6055
                                                   in
            ...
            (FStar_Parser_Const.op_Division, (Prims.parse_int "2"),
              (binary_int_op (fun x  -> fun y  -> x / y))) :: uu____5654
             in
    ...
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> - x))) :: uu____5594
     in
  ...
  fun full_norm  ->
    fun args  ->
      ...
      | (steps,uu____10529)::uu____10530::(tm,uu____10532)::[] ->
          ...
          let s =
            let uu____10572 =
              let uu____10575 = full_norm steps  in parse_steps uu____10575
               in
            Beta :: uu____10572  in
               ...
               (log cfg
                ...
                then rebuild cfg env stack1 t1
                  ...
                  (let r_env =
                     ...
                     FStar_TypeChecker_Env.set_range cfg.tcenv uu____11350
                      in
                   let uu____11351 =
                  ...
                  (let whnf1 = FStar_List.contains WHNF cfg.steps  in
                   ...
                   let uu____16195 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____16195)
                   in
                      ...
                      (match uu____16561 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____16586 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____16728 =
                                        ...
                                        Clos uu____16729  in
                                      uu____16728 :: env2) env1 s
                                in
                             let uu____16801 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____16801)))
                   in
                let uu____16802 =
                  FStar_All.pipe_right cfg.steps
