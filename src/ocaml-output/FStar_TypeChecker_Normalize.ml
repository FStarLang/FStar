...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let unary_op as_a f r args =
    let uu____4762 = FStar_List.map as_a args  in lift_unary (f r) uu____4762
     in
  let binary_op as_a f r args =
    let uu____4818 = FStar_List.map as_a args  in
    lift_binary (f r) uu____4818  in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____4890 = f x  in int_as_const r uu____4890)
     in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4918 = f x y  in int_as_const r uu____4918)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  -> let uu____4939 = f x  in bool_as_const r uu____4939)
     in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4967 = f x y  in bool_as_const r uu____4967)
     in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4995 = f x y  in string_as_const r uu____4995)
     in
        ...
        let uu____5629 =
          let uu____5644 =
                                                    ...
                                                    let uu____6119 =
                                                      let uu____6142 =
                                                        ...
                                                        (uu____6161,
                                                         ...
                                                         in
                                                      [uu____6142]  in
                                                    uu____6083 :: uu____6119
                                                     in
                                                  uu____6024 :: uu____6060
                                                   in
            ...
            (FStar_Parser_Const.op_Division, (Prims.parse_int "2"),
              (binary_int_op (fun x  -> fun y  -> x / y))) :: uu____5659
             in
          (FStar_Parser_Const.op_Multiply, (Prims.parse_int "2"),
            (binary_int_op (fun x  -> fun y  -> x * y))) :: uu____5644
           in
        (FStar_Parser_Const.op_Subtraction, (Prims.parse_int "2"),
          (binary_int_op (fun x  -> fun y  -> x - y))) :: uu____5629
         in
      (FStar_Parser_Const.op_Addition, (Prims.parse_int "2"),
        (binary_int_op (fun x  -> fun y  -> x + y))) :: uu____5614
       in
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> - x))) :: uu____5599
     in
  ...
  fun full_norm  ->
    fun args  ->
      ...
      | (steps,uu____10534)::uu____10535::(tm,uu____10537)::[] ->
          ...
          let s =
            let uu____10577 =
              let uu____10580 = full_norm steps  in parse_steps uu____10580
               in
            Beta :: uu____10577  in
               ...
               (log cfg
                ...
                then rebuild cfg env stack1 t1
                  ...
                  (let r_env =
                     ...
                     FStar_TypeChecker_Env.set_range cfg.tcenv uu____11355
                      in
                   let uu____11356 =
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11999  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12097  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12201  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12289  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____13102 =
                                   let uu____13105 =
                                     FStar_List.map
                                       (fun uu____13113  -> Dummy) xs1
                                      in
                                   FStar_List.append uu____13105 env  in
                                 FStar_List.append uu____13097 uu____13102
                                  in
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       let uu____14045 =
                                         ...
                                         uu____14046.FStar_Syntax_Syntax.n
                                          in
                                           ...
                                           let uu____14062 =
                                             let uu____14063 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____14063.FStar_Syntax_Syntax.n
                                              in
                                               ...
                                               let uu____14199 =
                                                 let uu____14200 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____14200.FStar_Syntax_Syntax.n
                                                  in
                  ...
                  (let whnf1 = FStar_List.contains WHNF cfg.steps  in
                   ...
                   let uu____16201 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____16201)
                   in
                      ...
                      (match uu____16567 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____16592 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____16734 =
                                        ...
                                        Clos uu____16735  in
                                      uu____16734 :: env2) env1 s
                                in
                             let uu____16807 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____16807)))
                   in
                let uu____16808 =
                  FStar_All.pipe_right cfg.steps
                ...
                | uu____17494 ->
                    ...
                    (match uu____17495 with
                     ...
                     | (uu____17606,FStar_Util.Inl uu____17607) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____17630 -> failwith "Impossible")
                 in
