...
let built_in_primitive_steps: primitive_step Prims.list =
  ...
  let lift_binary f aopts =
    match aopts with
    | (Some a0)::(Some a1)::[] -> let uu____2690 = f a0 a1 in Some uu____2690
    | uu____2691 -> None in
  let unary_op as_a f r args =
    let uu____2735 = FStar_List.map as_a args in lift_unary (f r) uu____2735 in
  let binary_op as_a f r args =
    let uu____2785 = FStar_List.map as_a args in lift_binary (f r) uu____2785 in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____2840 = f x in int_as_const r uu____2840) in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____2863 = f x y in int_as_const r uu____2863) in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  -> fun x  -> let uu____2880 = f x in bool_as_const r uu____2880) in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____2903 = f x y in bool_as_const r uu____2903) in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____2926 = f x y in string_as_const r uu____2926) in
  let list_of_string1 rng s =
    ...
    let nil_char =
      let uu____2962 =
        ...
        let uu____2965 =
          let uu____2966 = FStar_Syntax_Syntax.iarg char_t in [uu____2966] in
    ...
    FStar_List.fold_right
      (fun c  ->
         fun a  ->
           ...
           uu____2977 None rng) uu____2971 nil_char in
        ...
        let uu____3039 =
          let uu____3049 =
            ...
            (FStar_Syntax_Const.op_Division, (Prims.parse_int "2"),
              (binary_int_op (fun x  -> fun y  -> x / y))) :: uu____3059 in
          (FStar_Syntax_Const.op_Multiply, (Prims.parse_int "2"),
            (binary_int_op (fun x  -> fun y  -> x * y))) :: uu____3049 in
        (FStar_Syntax_Const.op_Subtraction, (Prims.parse_int "2"),
          (binary_int_op (fun x  -> fun y  -> x - y))) :: uu____3039 in
      (FStar_Syntax_Const.op_Addition, (Prims.parse_int "2"),
        (binary_int_op (fun x  -> fun y  -> x + y))) :: uu____3029 in
    (FStar_Syntax_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> - x))) :: uu____3019 in
    ...
    FStar_All.pipe_right bounded_int_types
      (FStar_List.collect
         (fun m  ->
            ...
            let uu____3536 =
              let uu____3546 =
                let uu____3555 = FStar_Syntax_Const.p2l ["FStar"; m; "sub"] in
              ...
              let uu____3582 =
                let uu____3592 =
                  let uu____3601 = FStar_Syntax_Const.p2l ["FStar"; m; "mul"] in
          ...
          (match t1.FStar_Syntax_Syntax.n with
                          ...
                          | uu____5440::[] ->
                              (match lopt with
                               | None  when FStar_Options.__unit_tests () ->
                                   (log cfg
                                      (fun uu____5453  ->
                                         let uu____5454 = closure_to_string c in
                               ...
                               | Some (FStar_Util.Inr (l,cflags)) when
                                   ...
                                   (log cfg
                                      (fun uu____5471  ->
                                         let uu____5472 = closure_to_string c in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____5472);
                                    norm cfg (c :: env) stack_rest body)
                               | Some (FStar_Util.Inl lc) when
                                   ...
                                   (log cfg
                                      (fun uu____5483  ->
                                         let uu____5484 = closure_to_string c in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____5484);
                                    norm cfg (c :: env) stack_rest body)
                               | uu____5485 when
                ...
                | (Debug _)::_
                  |(Meta _)::_|(Let _)::_|(App _)::_|(Abs _)::_|[] ->
                    ...
                    then
                      ...
                      (let uu____5564 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1,body1,opening) ->
                           ...
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____5640  -> Dummy :: env1) env) in
                           (log cfg
                              (fun uu____5645  ->
                                 let uu____5646 =
                                   FStar_All.pipe_left
           ...
           | FStar_Syntax_Syntax.Tm_refine (x,f) ->
               ...
               then
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort in
                  let uu____5764 = FStar_Syntax_Subst.open_term [(x, None)] f in
                             ...
                             let uu____6277 =
                               let uu____6278 =
                                 ...
                                 (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                   uu____6288, false) in
                               Clos uu____6278 in
                             uu____6277 :: env1) (Prims.snd lbs) env in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____6349 =
                         let uu____6350 = FStar_Syntax_Subst.compress head1 in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1 in
                           let uu____6364 = ed.FStar_Syntax_Syntax.bind_repr in
                                ...
                                (match lb.FStar_Syntax_Syntax.lbname with
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       ...
                                       | FStar_Syntax_Syntax.Tm_meta
                                           ...
                                           let uu____6392 =
                                             ...
                                             uu____6393.FStar_Syntax_Syntax.n in
                                     ...
                                     (match uu____6412 with
                                      ...
                                      | None  ->
                                          let uu____6448 =
                                            let uu____6449 = is_return body in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1 in
                           let uu____6642 = ed.FStar_Syntax_Syntax.bind_repr in
                                              ...
                                              (FStar_Syntax_Syntax.Tm_meta
                                                 (body,
                                                   (FStar_Syntax_Syntax.Meta_monadic
                                                      (m1, t2))))
                                        | Some (true ) -> body in
                                      let uu____6782 = FStar_List.tl stack1 in
                ...
                | FStar_Syntax_Syntax.Meta_monadic_lift (m1,m',t2) ->
                    ...
                    then
                      ...
                      let uu____6966 = reify_lift cfg.tcenv head1 m1 m' t2 in
                         ...
                         let cfg1 =
                           let uu___175_6974 = cfg in
                           {
                             steps =
                               ...
                               EraseUniverses;
                               Exclude Zeta];
                             tcenv = (uu___175_6974.tcenv);
                             delta_level =
                               [FStar_TypeChecker_Env.Inlining;
                               FStar_TypeChecker_Env.Eager_unfolding_only];
                             primitive_steps =
                               (uu___175_6974.primitive_steps)
                           } in
                         norm cfg1 env
                           ((Meta
                ...
                | uu____6980 ->
                    (match stack1 with
                     | uu____6981::uu____6982 ->
                         (match m with
                          | FStar_Syntax_Syntax.Meta_labeled (l,r,uu____6986)
                              ...
                              norm cfg env
                                ((Meta
                                    ((FStar_Syntax_Syntax.Meta_pattern args1),
                                      (t1.FStar_Syntax_Syntax.pos))) ::
                                stack1) head1
                          | uu____7001 -> norm cfg env stack1 head1)
                     | [] ->
                         ...
                         let m1 =
                           ...
                           | FStar_Syntax_Syntax.Meta_pattern args ->
                               ...
                               FStar_Syntax_Syntax.Meta_pattern uu____7011
                           | uu____7018 -> m in
                         let t2 =
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              let uu____7032 = ed.FStar_Syntax_Syntax.return_repr in
              match uu____7032 with
              | (uu____7033,return_repr) ->
                  let return_inst =
                    let uu____7040 =
                      let uu____7041 =
                    ...
                    | FStar_Syntax_Syntax.Tm_uinst (return_tm,uu____7047::[])
                        ->
                        let uu____7053 =
                          let uu____7056 =
                            let uu____7057 =
                              let uu____7062 =
                                ...
                                [uu____7064] in
                              (return_tm, uu____7062) in
                            FStar_Syntax_Syntax.Tm_uinst uu____7057 in
                          FStar_Syntax_Syntax.mk uu____7056 in
                        uu____7053 None e.FStar_Syntax_Syntax.pos
                    | uu____7076 ->
                  ...
                  let uu____7079 =
                    let uu____7082 =
                      let uu____7083 =
                        let uu____7093 =
                          let uu____7095 = FStar_Syntax_Syntax.as_arg t in
                          let uu____7096 =
                            let uu____7098 = FStar_Syntax_Syntax.as_arg e in
                            [uu____7098] in
                          uu____7095 :: uu____7096 in
                        (return_inst, uu____7093) in
                      FStar_Syntax_Syntax.Tm_app uu____7083 in
                    FStar_Syntax_Syntax.mk uu____7082 in
                  uu____7079 None e.FStar_Syntax_Syntax.pos
            else
              (let uu____7111 = FStar_TypeChecker_Env.monad_leq env msrc mtgt in
               ...
               | None  ->
                   ...
                   failwith uu____7113
               | Some
                   { FStar_TypeChecker_Env.msource = uu____7114;
                     FStar_TypeChecker_Env.mtarget = uu____7115;
                     FStar_TypeChecker_Env.mlift =
                       { FStar_TypeChecker_Env.mlift_wp = uu____7116;
                         FStar_TypeChecker_Env.mlift_term = None ;_};_}
                   ->
                   failwith
                     "Impossible : trying to reify a non-reifiable lift (from %s to %s)"
               | Some
                   { FStar_TypeChecker_Env.msource = uu____7127;
                     FStar_TypeChecker_Env.mtarget = uu____7128;
                     FStar_TypeChecker_Env.mlift =
                       { FStar_TypeChecker_Env.mlift_wp = uu____7129;
                         FStar_TypeChecker_Env.mlift_term = Some lift;_};_}
                   ->
                   let uu____7147 = FStar_Syntax_Util.mk_reify e in
                   lift t FStar_Syntax_Syntax.tun uu____7147)
  ...
  fun cfg  ->
    fun env  ->
      fun comp  ->
        ...
        | FStar_Syntax_Syntax.Total (t,uopt) ->
            let uu___176_7199 = comp1 in
            let uu____7202 =
              let uu____7203 =
                let uu____7209 = norm cfg env [] t in
                let uu____7210 =
                  FStar_Option.map (norm_universe cfg env) uopt in
                (uu____7209, uu____7210) in
              FStar_Syntax_Syntax.Total uu____7203 in
            {
              FStar_Syntax_Syntax.n = uu____7202;
              FStar_Syntax_Syntax.tk = (uu___176_7199.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___176_7199.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___176_7199.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.GTotal (t,uopt) ->
            let uu___177_7225 = comp1 in
            let uu____7228 =
              let uu____7229 =
                let uu____7235 = norm cfg env [] t in
                let uu____7236 =
                  FStar_Option.map (norm_universe cfg env) uopt in
                (uu____7235, uu____7236) in
              FStar_Syntax_Syntax.GTotal uu____7229 in
            {
              FStar_Syntax_Syntax.n = uu____7228;
              FStar_Syntax_Syntax.tk = (uu___177_7225.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___177_7225.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___177_7225.FStar_Syntax_Syntax.vars)
            }
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____7267  ->
                      ...
                      | (a,i) ->
                          let uu____7274 = norm cfg env [] a in
                          (uu____7274, i))) in
            let flags =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___140_7279  ->
                      match uu___140_7279 with
                      | FStar_Syntax_Syntax.DECREASES t ->
                          let uu____7283 = norm cfg env [] t in
                          FStar_Syntax_Syntax.DECREASES uu____7283
                      | f -> f)) in
            let uu___178_7287 = comp1 in
            let uu____7290 =
              let uu____7291 =
                let uu___179_7292 = ct in
                let uu____7293 =
                  FStar_List.map (norm_universe cfg env)
                    ct.FStar_Syntax_Syntax.comp_univs in
                let uu____7294 =
                  norm cfg env [] ct.FStar_Syntax_Syntax.result_typ in
                let uu____7297 = norm_args ct.FStar_Syntax_Syntax.effect_args in
                {
                  FStar_Syntax_Syntax.comp_univs = uu____7293;
                  FStar_Syntax_Syntax.effect_name =
                    (uu___179_7292.FStar_Syntax_Syntax.effect_name);
                  FStar_Syntax_Syntax.result_typ = uu____7294;
                  FStar_Syntax_Syntax.effect_args = uu____7297;
                  FStar_Syntax_Syntax.flags = flags
                } in
              FStar_Syntax_Syntax.Comp uu____7291 in
            {
              FStar_Syntax_Syntax.n = uu____7290;
              FStar_Syntax_Syntax.tk = (uu___178_7287.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___178_7287.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___178_7287.FStar_Syntax_Syntax.vars)
            }
  ...
  fun cfg  ->
    fun env  ->
      fun c  ->
        let norm1 t =
          norm
            (let uu___180_7314 = cfg in
             {
               steps =
                 [Eager_unfolding;
                 UnfoldUntil FStar_Syntax_Syntax.Delta_constant;
                 AllowUnboundUniverses];
               tcenv = (uu___180_7314.tcenv);
               delta_level = (uu___180_7314.delta_level);
               primitive_steps = (uu___180_7314.primitive_steps)
             }) env [] t in
        let non_info t =
          let uu____7319 = norm1 t in
          FStar_Syntax_Util.non_informative uu____7319 in
        match c.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Total uu____7322 -> c
        | FStar_Syntax_Syntax.GTotal (t,uopt) when non_info t ->
            let uu___181_7336 = c in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Total (t, uopt));
              FStar_Syntax_Syntax.tk = (uu___181_7336.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___181_7336.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___181_7336.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.Comp ct ->
            let l =
              FStar_TypeChecker_Env.norm_eff_name cfg.tcenv
            ...
            then
              let ct1 =
                ...
                with
                | Some pure_eff ->
                    let uu___182_7351 = ct in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___182_7351.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name = pure_eff;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___182_7351.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___182_7351.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags =
                        (uu___182_7351.FStar_Syntax_Syntax.flags)
                    }
                | None  ->
                    let ct1 =
                      FStar_TypeChecker_Env.unfold_effect_abbrev cfg.tcenv c in
                    let uu___183_7353 = ct1 in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___183_7353.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name =
                        FStar_Syntax_Const.effect_PURE_lid;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___183_7353.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___183_7353.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags =
                        (uu___183_7353.FStar_Syntax_Syntax.flags)
                    } in
              let uu___184_7354 = c in
              {
                FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
                FStar_Syntax_Syntax.tk =
                  (uu___184_7354.FStar_Syntax_Syntax.tk);
                FStar_Syntax_Syntax.pos =
                  (uu___184_7354.FStar_Syntax_Syntax.pos);
                FStar_Syntax_Syntax.vars =
                  (uu___184_7354.FStar_Syntax_Syntax.vars)
              }
            else c
        | uu____7360 -> c
and norm_binder:
  ...
  fun cfg  ->
    fun env  ->
      fun uu____7363  ->
        ...
        | (x,imp) ->
            let uu____7366 =
              let uu___185_7367 = x in
              let uu____7368 = norm cfg env [] x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___185_7367.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___185_7367.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____7368
              } in
            (uu____7366, imp)
and norm_binders:
  ...
  fun cfg  ->
    fun env  ->
      fun bs  ->
        ...
        match uu____7374 with | (nbs,uu____7398) -> FStar_List.rev nbs
and norm_lcomp_opt:
  cfg ->
    env ->
      (FStar_Syntax_Syntax.lcomp,FStar_Syntax_Syntax.residual_comp)
  ...
  fun cfg  ->
    fun env  ->
      fun lopt  ->
        ...
        | Some (FStar_Util.Inl lc) ->
            let flags = filter_out_lcomp_cflags lc in
            let uu____7415 = FStar_Syntax_Util.is_tot_or_gtot_lcomp lc in
            if uu____7415
            then
              let t = norm cfg env [] lc.FStar_Syntax_Syntax.res_typ in
              let uu____7420 = FStar_Syntax_Util.is_total_lcomp lc in
              (if uu____7420
               then
                 let uu____7424 =
                   let uu____7427 =
                     let uu____7428 =
                       let uu____7431 = FStar_Syntax_Syntax.mk_Total t in
                       FStar_Syntax_Util.comp_set_flags uu____7431 flags in
                     FStar_Syntax_Util.lcomp_of_comp uu____7428 in
                   FStar_Util.Inl uu____7427 in
                 Some uu____7424
               else
                 (let uu____7435 =
                    let uu____7438 =
                      let uu____7439 =
                        let uu____7442 = FStar_Syntax_Syntax.mk_GTotal t in
                        FStar_Syntax_Util.comp_set_flags uu____7442 flags in
                      FStar_Syntax_Util.lcomp_of_comp uu____7439 in
                    FStar_Util.Inl uu____7438 in
                  Some uu____7435))
            else
              Some
                (FStar_Util.Inr ((lc.FStar_Syntax_Syntax.eff_name), flags))
    ...
    fun env  ->
      fun stack1  ->
        fun t  ->
          ...
          | (Debug tm)::stack2 ->
              ((let uu____7467 =
                ...
                then
                  ...
                  let uu____7469 = FStar_Syntax_Print.term_to_string t in
          ...
          | (Steps (s,ps,dl))::stack2 ->
              rebuild
                (let uu___186_7480 = cfg in
                 {
                   steps = s;
                   tcenv = (uu___186_7480.tcenv);
                   delta_level = dl;
                   primitive_steps = ps
                 }) env stack2 t
          | (Meta (m,r))::stack2 ->
          ...
          | (MemoLazy r)::stack2 ->
              (set_memo r (env, t);
               log cfg
                 (fun uu____7500  ->
                    let uu____7501 = FStar_Syntax_Print.term_to_string t in
                    FStar_Util.print1 "\tSet memo %s\n" uu____7501);
               rebuild cfg env stack2 t)
          ...
          | (Abs (env',bs,env'',lopt,r))::stack2 ->
              ...
              let uu____7538 =
                let uu___187_7539 = FStar_Syntax_Util.abs bs1 t lopt1 in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___187_7539.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.tk =
                    (uu___187_7539.FStar_Syntax_Syntax.tk);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___187_7539.FStar_Syntax_Syntax.vars)
                } in
              rebuild cfg env stack2 uu____7538
          | (Arg (Univ _,_,_))::_|(Arg (Dummy ,_,_))::_ ->
              failwith "Impossible"
          | (UnivArgs (us,r))::stack2 ->
              let t1 = FStar_Syntax_Syntax.mk_Tm_uinst t us in
              rebuild cfg env stack2 t1
          | (Arg (Clos (env1,tm,m,uu____7561),aq,r))::stack2 ->
              (log cfg
                 (fun uu____7577  ->
                    let uu____7578 = FStar_Syntax_Print.term_to_string tm in
               ...
               then
                 ...
                 (let uu____7589 = FStar_ST.read m in
          ...
          | (App (head1,aq,r))::stack2 ->
              ...
              let uu____7637 = maybe_simplify cfg t1 in
              rebuild cfg env stack2 uu____7637
          | (Match (env1,branches,r))::stack2 ->
              (log cfg
                 (fun uu____7644  ->
                    let uu____7645 = FStar_Syntax_Print.term_to_string t in
                    FStar_Util.print1
                      "Rebuilding with match, scrutinee is %s ...\n"
                      uu____7645);
               (let scrutinee = t in
                let norm_and_rebuild_match uu____7650 =
                  log cfg
                    (fun uu____7652  ->
                       let uu____7653 =
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps in
                   let cfg_exclude_iota_zeta =
                     ...
                     let uu___188_7686 = cfg in
                     {
                       steps = (FStar_List.append steps' cfg.steps);
                       tcenv = (uu___188_7686.tcenv);
                       delta_level = new_delta;
                       primitive_steps = (uu___188_7686.primitive_steps)
                     } in
                   ...
                   let rec norm_pat env2 p =
                     match p.FStar_Syntax_Syntax.v with
                     | FStar_Syntax_Syntax.Pat_constant uu____7720 ->
                         (p, env2)
                     | FStar_Syntax_Syntax.Pat_disj [] ->
                         failwith "Impossible"
                     | FStar_Syntax_Syntax.Pat_disj (hd1::tl1) ->
                         let uu____7740 = norm_pat env2 hd1 in
                          ...
                          | (hd2,env') ->
                              let tl2 =
                                FStar_All.pipe_right tl1
                                  (FStar_List.map
                                     (fun p1  ->
                                        let uu____7776 = norm_pat env2 p1 in
                                        Prims.fst uu____7776)) in
                              ((let uu___189_7788 = p in
                                {
                                  FStar_Syntax_Syntax.v =
                                    (FStar_Syntax_Syntax.Pat_disj (hd2 ::
                                       tl2));
                                  FStar_Syntax_Syntax.ty =
                                    (uu___189_7788.FStar_Syntax_Syntax.ty);
                                  FStar_Syntax_Syntax.p =
                                    (uu___189_7788.FStar_Syntax_Syntax.p)
                                }), env'))
                     | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
                         let uu____7805 =
                           FStar_All.pipe_right pats
                             (FStar_List.fold_left
                                (fun uu____7839  ->
                                   fun uu____7840  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____7905 = norm_pat env3 p1 in
                         ...
                         (match uu____7805 with
                          | (pats1,env3) ->
                              ((let uu___190_7971 = p in
                                {
                                  FStar_Syntax_Syntax.v =
                                    (FStar_Syntax_Syntax.Pat_cons
                                       (fv, (FStar_List.rev pats1)));
                                  FStar_Syntax_Syntax.ty =
                                    (uu___190_7971.FStar_Syntax_Syntax.ty);
                                  FStar_Syntax_Syntax.p =
                                    (uu___190_7971.FStar_Syntax_Syntax.p)
                                }), env3))
                     | FStar_Syntax_Syntax.Pat_var x ->
                         let x1 =
                           let uu___191_7985 = x in
                           let uu____7986 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___191_7985.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___191_7985.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7986
                           } in
                         ((let uu___192_7992 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_var x1);
                             FStar_Syntax_Syntax.ty =
                               (uu___192_7992.FStar_Syntax_Syntax.ty);
                             FStar_Syntax_Syntax.p =
                               (uu___192_7992.FStar_Syntax_Syntax.p)
                           }), (Dummy :: env2))
                     | FStar_Syntax_Syntax.Pat_wild x ->
                         let x1 =
                           let uu___193_7997 = x in
                           let uu____7998 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___193_7997.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___193_7997.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7998
                           } in
                         ((let uu___194_8004 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_wild x1);
                             FStar_Syntax_Syntax.ty =
                               (uu___194_8004.FStar_Syntax_Syntax.ty);
                             FStar_Syntax_Syntax.p =
                               (uu___194_8004.FStar_Syntax_Syntax.p)
                           }), (Dummy :: env2))
                     | FStar_Syntax_Syntax.Pat_dot_term (x,t1) ->
                         let x1 =
                           let uu___195_8014 = x in
                           let uu____8015 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___195_8014.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___195_8014.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____8015
                           } in
                         let t2 = norm_or_whnf env2 t1 in
                         ((let uu___196_8022 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_dot_term (x1, t2));
                             FStar_Syntax_Syntax.ty =
                               (uu___196_8022.FStar_Syntax_Syntax.ty);
                             FStar_Syntax_Syntax.p =
                               (uu___196_8022.FStar_Syntax_Syntax.p)
                           }), env2) in
                   let branches1 =
                     match env1 with
                     | [] when whnf -> branches
                         ...
                         FStar_All.pipe_right branches
                           (FStar_List.map
                              (fun branch1  ->
                                 ...
                                 | (p,wopt,e) ->
                                     let uu____8047 = norm_pat env1 p in
                   ...
                   let uu____8076 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r in
                   rebuild cfg env1 stack2 uu____8076) in
                let rec is_cons head1 =
                  match head1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_uinst (h,uu____8086) -> is_cons h
                  | FStar_Syntax_Syntax.Tm_constant _
                    |FStar_Syntax_Syntax.Tm_fvar
                     { FStar_Syntax_Syntax.fv_name = _;
                       FStar_Syntax_Syntax.fv_delta = _;
                ...
                let rec matches_pat scrutinee1 p =
                  ...
                  let uu____8196 = FStar_Syntax_Util.head_and_args scrutinee2 in
                  ...
                  | (head1,args) ->
                      (match p.FStar_Syntax_Syntax.v with
                           ...
                           let mopt =
                             FStar_Util.find_map ps
                               (fun p1  ->
                                  ...
                                  match m with
                                  | FStar_Util.Inl uu____8253 -> Some m
                       ...
                       | FStar_Syntax_Syntax.Pat_dot_term uu____8284 ->
                           FStar_Util.Inl []
                       | FStar_Syntax_Syntax.Pat_constant s ->
                           (match scrutinee2.FStar_Syntax_Syntax.n with
                            ...
                            | uu____8296 ->
                                let uu____8297 =
                                  let uu____8298 = is_cons head1 in
                                  Prims.op_Negation uu____8298 in
                                FStar_Util.Inr uu____8297)
                       | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                           ...
                           (match uu____8312 with
                            ...
                            | uu____8320 ->
                                let uu____8321 =
                                  let uu____8322 = is_cons head1 in
                                  Prims.op_Negation uu____8322 in
                                FStar_Util.Inr uu____8321))
                and matches_args out a p =
                  match (a, p) with
                  | ([],[]) -> FStar_Util.Inl out
                  | ((t1,uu____8356)::rest_a,(p1,uu____8359)::rest_p) ->
                      let uu____8387 = matches_pat t1 p1 in
                      (match uu____8387 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____8401 -> FStar_Util.Inr false in
                let rec matches scrutinee1 p =
                  match p with
                  | [] -> norm_and_rebuild_match ()
                  | (p1,wopt,b)::rest ->
                      let uu____8472 = matches_pat scrutinee1 p1 in
                                    ...
                                    fun t1  ->
                                      let uu____8494 =
                                        let uu____8495 =
                                          ...
                                          ([], t1, uu____8505, false) in
                                        Clos uu____8495 in
                                      uu____8494 :: env2) env1 s in
                             let uu____8528 = guard_when_clause wopt b rest in
                             norm cfg env2 stack2 uu____8528))) in
                let uu____8529 =
                  FStar_All.pipe_right cfg.steps
    ...
    fun s  ->
      fun e  ->
        fun t  ->
          let c = config s e in
          let c1 =
            let uu___197_8570 = config s e in
            {
              steps = (uu___197_8570.steps);
              tcenv = (uu___197_8570.tcenv);
              delta_level = (uu___197_8570.delta_level);
...
let normalize_comp:
  ...
  fun s  ->
    fun e  ->
      fun t  -> let uu____8589 = config s e in norm_comp uu____8589 [] t
let normalize_universe:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.universe -> FStar_Syntax_Syntax.universe
  =
  fun env  ->
    fun u  -> let uu____8596 = config [] env in norm_universe uu____8596 [] u
let ghost_to_pure:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
      (FStar_Syntax_Syntax.comp',Prims.unit) FStar_Syntax_Syntax.syntax
  ...
  fun env  ->
    fun c  ->
      let uu____8603 = config [] env in ghost_to_pure_aux uu____8603 [] c
let ghost_to_pure_lcomp:
  ...
  fun env  ->
    fun lc  ->
      ...
      let non_info t =
        let uu____8615 = norm cfg [] [] t in
        FStar_Syntax_Util.non_informative uu____8615 in
      let uu____8616 =
      ...
      then
        ...
        with
        | Some pure_eff ->
            let uu___198_8618 = lc in
            {
              FStar_Syntax_Syntax.eff_name = pure_eff;
              FStar_Syntax_Syntax.res_typ =
                (uu___198_8618.FStar_Syntax_Syntax.res_typ);
              FStar_Syntax_Syntax.cflags =
                (uu___198_8618.FStar_Syntax_Syntax.cflags);
              FStar_Syntax_Syntax.comp =
                ((fun uu____8619  ->
                    let uu____8620 = lc.FStar_Syntax_Syntax.comp () in
                    ghost_to_pure env uu____8620))
            }
        | None  -> lc
      else lc
let term_to_string:
  ...
  fun env  ->
    fun t  ->
      let uu____8628 = normalize [AllowUnboundUniverses] env t in
      FStar_Syntax_Print.term_to_string uu____8628
let comp_to_string:
  FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.comp -> Prims.string =
  fun env  ->
    fun c  ->
      let uu____8635 =
        let uu____8636 = config [AllowUnboundUniverses] env in
        norm_comp uu____8636 [] c in
      FStar_Syntax_Print.comp_to_string uu____8635
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____8673 =
                     let uu____8674 =
                       let uu____8679 = FStar_Syntax_Util.mk_conj phi1 phi in
                       (y, uu____8679) in
                     FStar_Syntax_Syntax.Tm_refine uu____8674 in
                   mk uu____8673 t01.FStar_Syntax_Syntax.pos
               | uu____8684 -> t2)
          | uu____8685 -> t2 in
        aux t
let unfold_whnf:
...
let eta_expand_with_type:
  ...
  fun env  ->
    fun e  ->
      fun t_e  ->
        let uu____8701 = FStar_Syntax_Util.arrow_formals_comp t_e in
        match uu____8701 with
        | (formals,c) ->
            (match formals with
             | [] -> e
             | uu____8717 ->
                 let uu____8721 = FStar_Syntax_Util.abs_formals e in
                 (match uu____8721 with
                  | (actuals,uu____8732,uu____8733) ->
                      if
                      ...
                      then e
                        ...
                        (let uu____8755 =
                         ...
                         | (binders,args) ->
                             ...
                             FStar_Syntax_Util.abs binders uu____8765
                               uu____8770)))
let eta_expand:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  ...
  fun env  ->
    fun t  ->
      let uu____8813 =
        let uu____8817 = FStar_ST.read t.FStar_Syntax_Syntax.tk in
        (uu____8817, (t.FStar_Syntax_Syntax.n)) in
      match uu____8813 with
      | (Some sort,uu____8824) ->
          let uu____8826 = mk sort t.FStar_Syntax_Syntax.pos in
          eta_expand_with_type env t uu____8826
      | (uu____8827,FStar_Syntax_Syntax.Tm_name x) ->
      ...
      | uu____8831 ->
          ...
          (match uu____8835 with
           | (head1,args) ->
               let uu____8861 =
                 let uu____8862 = FStar_Syntax_Subst.compress head1 in
                 uu____8862.FStar_Syntax_Syntax.n in
               (match uu____8861 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____8865,thead) ->
                    let uu____8879 = FStar_Syntax_Util.arrow_formals thead in
                         ...
                         then t
                           ...
                           (let uu____8910 =
                              env.FStar_TypeChecker_Env.type_of
                                (let uu___199_8914 = env in
                                 {
                                   FStar_TypeChecker_Env.solver =
                                     (uu___199_8914.FStar_TypeChecker_Env.solver);
                                   FStar_TypeChecker_Env.range =
                                     (uu___199_8914.FStar_TypeChecker_Env.range);
                                   FStar_TypeChecker_Env.curmodule =
                                     (uu___199_8914.FStar_TypeChecker_Env.curmodule);
                                   FStar_TypeChecker_Env.gamma =
                                     (uu___199_8914.FStar_TypeChecker_Env.gamma);
                                   FStar_TypeChecker_Env.gamma_cache =
                                     (uu___199_8914.FStar_TypeChecker_Env.gamma_cache);
                                   FStar_TypeChecker_Env.modules =
                                     (uu___199_8914.FStar_TypeChecker_Env.modules);
                                   FStar_TypeChecker_Env.expected_typ = None;
                                   FStar_TypeChecker_Env.sigtab =
                                     (uu___199_8914.FStar_TypeChecker_Env.sigtab);
                                   FStar_TypeChecker_Env.is_pattern =
                                     (uu___199_8914.FStar_TypeChecker_Env.is_pattern);
                                   FStar_TypeChecker_Env.instantiate_imp =
                                     (uu___199_8914.FStar_TypeChecker_Env.instantiate_imp);
                                   FStar_TypeChecker_Env.effects =
                                     (uu___199_8914.FStar_TypeChecker_Env.effects);
                                   FStar_TypeChecker_Env.generalize =
                                     (uu___199_8914.FStar_TypeChecker_Env.generalize);
                                   FStar_TypeChecker_Env.letrecs =
                                     (uu___199_8914.FStar_TypeChecker_Env.letrecs);
                                   FStar_TypeChecker_Env.top_level =
                                     (uu___199_8914.FStar_TypeChecker_Env.top_level);
                                   FStar_TypeChecker_Env.check_uvars =
                                     (uu___199_8914.FStar_TypeChecker_Env.check_uvars);
                                   FStar_TypeChecker_Env.use_eq =
                                     (uu___199_8914.FStar_TypeChecker_Env.use_eq);
                                   FStar_TypeChecker_Env.is_iface =
                                     (uu___199_8914.FStar_TypeChecker_Env.is_iface);
                                   FStar_TypeChecker_Env.admit =
                                     (uu___199_8914.FStar_TypeChecker_Env.admit);
                                   FStar_TypeChecker_Env.lax = true;
                                   FStar_TypeChecker_Env.lax_universes =
                                     (uu___199_8914.FStar_TypeChecker_Env.lax_universes);
                                   FStar_TypeChecker_Env.type_of =
                                     (uu___199_8914.FStar_TypeChecker_Env.type_of);
                                   FStar_TypeChecker_Env.universe_of =
                                     (uu___199_8914.FStar_TypeChecker_Env.universe_of);
                                   FStar_TypeChecker_Env.use_bv_sorts = true;
                                   FStar_TypeChecker_Env.qname_and_index =
                                     (uu___199_8914.FStar_TypeChecker_Env.qname_and_index)
                                 }) t in
                            match uu____8910 with
                            | (uu____8915,ty,uu____8917) ->
                                eta_expand_with_type env t ty))
                | uu____8918 ->
                    let uu____8919 =
                      env.FStar_TypeChecker_Env.type_of
                        (let uu___200_8923 = env in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___200_8923.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___200_8923.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___200_8923.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___200_8923.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___200_8923.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___200_8923.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ = None;
                           FStar_TypeChecker_Env.sigtab =
                             (uu___200_8923.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___200_8923.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___200_8923.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___200_8923.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___200_8923.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___200_8923.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level =
                             (uu___200_8923.FStar_TypeChecker_Env.top_level);
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___200_8923.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq =
                             (uu___200_8923.FStar_TypeChecker_Env.use_eq);
                           FStar_TypeChecker_Env.is_iface =
                             (uu___200_8923.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___200_8923.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax = true;
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___200_8923.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.type_of =
                             (uu___200_8923.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___200_8923.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts = true;
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___200_8923.FStar_TypeChecker_Env.qname_and_index)
                         }) t in
                    (match uu____8919 with
                     | (uu____8924,ty,uu____8926) ->
                         eta_expand_with_type env t ty)))