...
let stack_elt_to_string : stack_elt  ->  Prims.string = (fun uu___168_1740 -> (match (uu___168_1740) with
...
let is_empty : 'Auu____1841 . 'Auu____1841 Prims.list  ->  Prims.bool = (fun uu___169_1847 -> (match (uu___169_1847) with
| [] -> begin
true
end
| uu____1850 -> begin
...
let lookup_bvar : 'Auu____1859 . 'Auu____1859 Prims.list  ->  FStar_Syntax_Syntax.bv  ->  'Auu____1859 = (fun env x -> (FStar_All.try_with (fun uu___184_1873 -> (match (()) with
| () -> begin
(FStar_List.nth env x.FStar_Syntax_Syntax.index)
end)) (fun uu___183_1877 -> (match (uu___183_1877) with
| uu____1878 -> begin
(
...
(FStar_All.try_with (fun uu___186_2031 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___185_2044 -> (match (uu___185_2044) with
| uu____2047 -> begin
(
...
let uu___187_3024 = x
in {FStar_Syntax_Syntax.ppname = uu___187_3024.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___187_3024.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = typ}))), (uu____3018))))
end))
...
let uu___188_3040 = lb
in {FStar_Syntax_Syntax.lbname = nm; FStar_Syntax_Syntax.lbunivs = uu___188_3040.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = typ; FStar_Syntax_Syntax.lbeff = uu___188_3040.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = def})
...
let uu___189_3123 = x
in {FStar_Syntax_Syntax.ppname = uu___189_3123.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___189_3123.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = ty}) (fun _0_43 -> FStar_Util.Inl (_0_43))))
end))
in (

let uu___190_3124 = lb
in (

let uu____3125 = (closure_as_term cfg env2 lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = nm; FStar_Syntax_Syntax.lbunivs = uu___190_3124.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty; FStar_Syntax_Syntax.lbeff = uu___190_3124.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____3125})))))))
in (
...
let uu___191_3582 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___191_3582.FStar_Syntax_Syntax.p})), (env3))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___192_3601.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___192_3601.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3602}))
in (((

let uu___193_3610 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.p = uu___193_3610.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
in {FStar_Syntax_Syntax.ppname = uu___194_3615.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___194_3615.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3616}))
in (((

let uu___195_3624 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.p = uu___195_3624.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
in {FStar_Syntax_Syntax.ppname = uu___196_3634.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___196_3634.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3635}))
in (
...
let uu___197_3644 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t3))); FStar_Syntax_Syntax.p = uu___197_3644.FStar_Syntax_Syntax.p})), (env2))))
end))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___198_4010.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___198_4010.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4011}))
in (
...
let flags = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___170_4148 -> (match (uu___170_4148) with
...
let uu___199_4157 = c1
in (

let uu____4158 = (FStar_List.map (norm_universe cfg env) c1.FStar_Syntax_Syntax.comp_univs)
in {FStar_Syntax_Syntax.comp_univs = uu____4158; FStar_Syntax_Syntax.effect_name = uu___199_4157.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))
in (FStar_Syntax_Syntax.mk_Comp uu____4156)))))
end)
end))
and filter_out_lcomp_cflags : FStar_Syntax_Syntax.cflags Prims.list  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun flags -> (FStar_All.pipe_right flags (FStar_List.filter (fun uu___171_4168 -> (match (uu___171_4168) with
...
let flags = (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_List.filter (fun uu___172_4192 -> (match (uu___172_4192) with
...
let uu___200_4198 = rc
in (

let uu____4199 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (closure_as_term cfg env))
in {FStar_Syntax_Syntax.residual_effect = uu___200_4198.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____4199; FStar_Syntax_Syntax.residual_flags = flags}))
...
let uu___201_5320 = t
in {FStar_Syntax_Syntax.n = uu___201_5320.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = r1; FStar_Syntax_Syntax.vars = uu___201_5320.FStar_Syntax_Syntax.vars}))
end
| uu____5323 -> begin
FStar_Pervasives_Native.None
end))
...
let uu___202_7154 = FStar_Syntax_Util.t_true
in {FStar_Syntax_Syntax.n = uu___202_7154.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___202_7154.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Util.NotEqual -> begin
FStar_Pervasives_Native.Some ((

let uu___203_7158 = FStar_Syntax_Util.t_false
in {FStar_Syntax_Syntax.n = uu___203_7158.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___203_7158.FStar_Syntax_Syntax.vars}))
end
| uu____7159 -> begin
FStar_Pervasives_Native.None
end))
...
let uu___202_7221 = FStar_Syntax_Util.t_true
in {FStar_Syntax_Syntax.n = uu___202_7221.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___202_7221.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Util.NotEqual -> begin
FStar_Pervasives_Native.Some ((

let uu___203_7225 = FStar_Syntax_Util.t_false
in {FStar_Syntax_Syntax.n = uu___203_7225.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___203_7225.FStar_Syntax_Syntax.vars}))
end
| uu____7226 -> begin
FStar_Pervasives_Native.None
end))
...
let uu___204_7312 = cfg
in {steps = (Primops)::[]; tcenv = uu___204_7312.tcenv; delta_level = uu___204_7312.delta_level; primitive_steps = equality_ops}) tm))
...
let uu___205_7336 = t
in {FStar_Syntax_Syntax.n = uu___205_7336.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = tm.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___205_7336.FStar_Syntax_Syntax.vars}))
in (
...
let tr_norm_step : FStar_Syntax_Embeddings.norm_step  ->  step Prims.list = (fun uu___173_10414 -> (match (uu___173_10414) with
...
let is_reify_head : stack_elt Prims.list  ->  Prims.bool = (fun uu___174_10607 -> (match (uu___174_10607) with
...
let uu___206_10900 = t1
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app (((hd2), (args1))); FStar_Syntax_Syntax.pos = uu___206_10900.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___206_10900.FStar_Syntax_Syntax.vars})
...
let uu___207_10941 = cfg
in (

let uu____10942 = (FStar_List.filter (fun uu___175_10945 -> (match (uu___175_10945) with
...
in {steps = uu____10942; tcenv = uu___207_10941.tcenv; delta_level = (FStar_TypeChecker_Env.Unfold (FStar_Syntax_Syntax.Delta_constant))::[]; primitive_steps = uu___207_10941.primitive_steps}))
in (
...
let uu____10966 = (FStar_All.pipe_right s (FStar_Util.for_some (fun uu___176_10971 -> (match (uu___176_10971) with
...
let uu___208_10981 = cfg
in {steps = s; tcenv = uu___208_10981.tcenv; delta_level = delta_level; primitive_steps = uu___208_10981.primitive_steps})
in (
...
let should_delta = (FStar_All.pipe_right cfg.delta_level (FStar_Util.for_some (fun uu___177_11321 -> (match (uu___177_11321) with
...
let uu____11326 = (FStar_All.pipe_right cfg.steps (FStar_List.tryFind (fun uu___178_11333 -> (match (uu___178_11333) with
...
let uu___209_11706 = cfg
in {steps = s; tcenv = uu___209_11706.tcenv; delta_level = dl; primitive_steps = ps}) env stack2 t1)
end
...
let uu___210_11834 = rc
in {FStar_Syntax_Syntax.residual_effect = uu___210_11834.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = rct; FStar_Syntax_Syntax.residual_flags = uu___210_11834.FStar_Syntax_Syntax.residual_flags})))
end
| uu____11835 -> begin
lopt
end)
...
let uu___211_11855 = cfg
in (

let uu____11856 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___211_11855.steps; tcenv = uu___211_11855.tcenv; delta_level = uu___211_11855.delta_level; primitive_steps = uu____11856}))
...
let uu___210_11930 = rc
in {FStar_Syntax_Syntax.residual_effect = uu___210_11930.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = rct; FStar_Syntax_Syntax.residual_flags = uu___210_11930.FStar_Syntax_Syntax.residual_flags})))
end
| uu____11931 -> begin
lopt
end)
...
let uu___211_11951 = cfg
in (

let uu____11952 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___211_11951.steps; tcenv = uu___211_11951.tcenv; delta_level = uu___211_11951.delta_level; primitive_steps = uu____11952}))
in (norm cfg1 env' ((Abs (((env), (bs1), (env'), (lopt1), (t1.FStar_Syntax_Syntax.pos))))::stack2) body1)));
)))
end))
end)
...
let uu___210_12030 = rc
in {FStar_Syntax_Syntax.residual_effect = uu___210_12030.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = rct; FStar_Syntax_Syntax.residual_flags = uu___210_12030.FStar_Syntax_Syntax.residual_flags})))
end
| uu____12031 -> begin
lopt
end)
...
let uu___211_12051 = cfg
in (

let uu____12052 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___211_12051.steps; tcenv = uu___211_12051.tcenv; delta_level = uu___211_12051.delta_level; primitive_steps = uu____12052}))
in (norm cfg1 env' ((Abs (((env), (bs1), (env'), (lopt1), (t1.FStar_Syntax_Syntax.pos))))::stack2) body1)));
)))
end))
end)
...
let uu___210_12128 = rc
in {FStar_Syntax_Syntax.residual_effect = uu___210_12128.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = rct; FStar_Syntax_Syntax.residual_flags = uu___210_12128.FStar_Syntax_Syntax.residual_flags})))
end
| uu____12129 -> begin
lopt
end)
...
let uu___211_12149 = cfg
in (

let uu____12150 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___211_12149.steps; tcenv = uu___211_12149.tcenv; delta_level = uu___211_12149.delta_level; primitive_steps = uu____12150}))
in (norm cfg1 env' ((Abs (((env), (bs1), (env'), (lopt1), (t1.FStar_Syntax_Syntax.pos))))::stack2) body1)));
)))
end))
end)
...
let uu___210_12232 = rc
in {FStar_Syntax_Syntax.residual_effect = uu___210_12232.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = rct; FStar_Syntax_Syntax.residual_flags = uu___210_12232.FStar_Syntax_Syntax.residual_flags})))
end
| uu____12233 -> begin
lopt
end)
...
let uu___211_12253 = cfg
in (

let uu____12254 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___211_12253.steps; tcenv = uu___211_12253.tcenv; delta_level = uu___211_12253.delta_level; primitive_steps = uu____12254}))
in (norm cfg1 env' ((Abs (((env), (bs1), (env'), (lopt1), (t1.FStar_Syntax_Syntax.pos))))::stack2) body1)));
)))
end))
end)
...
let uu___210_12320 = rc
in {FStar_Syntax_Syntax.residual_effect = uu___210_12320.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = rct; FStar_Syntax_Syntax.residual_flags = uu___210_12320.FStar_Syntax_Syntax.residual_flags})))
end
| uu____12321 -> begin
lopt
end)
...
let uu___211_12341 = cfg
in (

let uu____12342 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___211_12341.steps; tcenv = uu___211_12341.tcenv; delta_level = uu___211_12341.delta_level; primitive_steps = uu____12342}))
in (norm cfg1 env' ((Abs (((env), (bs1), (env'), (lopt1), (t1.FStar_Syntax_Syntax.pos))))::stack2) body1)));
)))
end))
end)
...
let uu___212_12506 = x
in {FStar_Syntax_Syntax.ppname = uu___212_12506.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___212_12506.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t1.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack1 t2)))
end
| uu____12507 -> begin
(
...
let uu___213_12550 = x
in {FStar_Syntax_Syntax.ppname = uu___213_12550.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___213_12550.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (uu____12548)))
...
let uu___214_12996 = x
in {FStar_Syntax_Syntax.ppname = uu___214_12996.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___214_12996.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = ty})))
in (

let lb1 = (

let uu___215_12998 = lb
in (

let uu____12999 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___215_12998.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty; FStar_Syntax_Syntax.lbeff = uu___215_12998.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____12999}))
in (
...
let uu___216_13076 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___216_13076.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___216_13076.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = ty})
...
let uu___217_13126 = rc
in (

let uu____13127 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (norm cfg env1 []))
in {FStar_Syntax_Syntax.residual_effect = uu___217_13126.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____13127; FStar_Syntax_Syntax.residual_flags = uu___217_13126.FStar_Syntax_Syntax.residual_flags}))
...
let uu___218_13138 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___218_13138.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty; FStar_Syntax_Syntax.lbeff = uu___218_13138.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = def}))))))
end))))) lbs1)
in (
...
let uu___219_13164 = t1
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (((((true), (lbs3))), (body3))); FStar_Syntax_Syntax.pos = uu___219_13164.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___219_13164.FStar_Syntax_Syntax.vars})
in (rebuild cfg env stack1 t2))
end)))))
end))
end
...
let uu___220_13335 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___220_13335.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___220_13335.FStar_Syntax_Syntax.sort})
...
let uu___221_14007 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::(NoDeltaSteps)::[]; tcenv = uu___221_14007.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]; primitive_steps = uu___221_14007.primitive_steps})
end
| uu____14008 -> begin
(

let uu___222_14009 = cfg
in {steps = (FStar_List.append ((Exclude (Zeta))::[]) cfg.steps); tcenv = uu___222_14009.tcenv; delta_level = uu___222_14009.delta_level; primitive_steps = uu___222_14009.primitive_steps})
end))
...
let uu___223_14088 = lb
in {FStar_Syntax_Syntax.lbname = uu___223_14088.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___223_14088.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___223_14088.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_PURE_lid; FStar_Syntax_Syntax.lbdef = e})
in (
...
let uu___224_14745 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = uu___224_14745.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]; primitive_steps = uu___224_14745.primitive_steps})
...
in {FStar_Syntax_Syntax.n = uu____15025; FStar_Syntax_Syntax.pos = uu___225_15022.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___225_15022.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___226_15051 = comp1
in (
...
in {FStar_Syntax_Syntax.n = uu____15054; FStar_Syntax_Syntax.pos = uu___226_15051.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___226_15051.FStar_Syntax_Syntax.vars}))
end
...
let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___179_15139 -> (match (uu___179_15139) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
(
...
in {FStar_Syntax_Syntax.comp_univs = uu____15153; FStar_Syntax_Syntax.effect_name = uu___228_15152.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu____15154; FStar_Syntax_Syntax.effect_args = uu____15157; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (uu____15151))
in {FStar_Syntax_Syntax.n = uu____15150; FStar_Syntax_Syntax.pos = uu___227_15147.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___227_15147.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___229_15175 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = uu___229_15175.tcenv; delta_level = uu___229_15175.delta_level; primitive_steps = uu___229_15175.primitive_steps}) env [] t))
in (
...
let uu___230_15202 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.pos = uu___230_15202.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___230_15202.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let uu___231_15220 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___231_15220.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = uu___231_15220.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___231_15220.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = flags}))
end
| FStar_Pervasives_Native.None -> begin
(
...
let uu___232_15222 = ct1
in {FStar_Syntax_Syntax.comp_univs = uu___232_15222.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Parser_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = uu___232_15222.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___232_15222.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___232_15222.FStar_Syntax_Syntax.flags}))
end)
in (

let uu___233_15223 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct1); FStar_Syntax_Syntax.pos = uu___233_15223.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___233_15223.FStar_Syntax_Syntax.vars}))
end
| uu____15224 -> begin
c
end)))
...
let uu___234_15232 = x
in (

let uu____15233 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___234_15232.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___234_15232.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____15233}))
in ((uu____15231), (imp)))
end))
...
let uu___235_15302 = rc
in (

let uu____15303 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (norm cfg env []))
in {FStar_Syntax_Syntax.residual_effect = uu___235_15302.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____15303; FStar_Syntax_Syntax.residual_flags = uu___235_15302.FStar_Syntax_Syntax.residual_flags}))
...
let uu___236_15351 = cfg
in {steps = s; tcenv = uu___236_15351.tcenv; delta_level = dl; primitive_steps = ps}) env stack2 t)
end
...
let uu___237_15458 = (FStar_Syntax_Util.abs bs1 t lopt1)
in {FStar_Syntax_Syntax.n = uu___237_15458.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___237_15458.FStar_Syntax_Syntax.vars})
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun uu___180_15716 -> (match (uu___180_15716) with
| FStar_TypeChecker_Env.Inlining -> begin
true
end
| FStar_TypeChecker_Env.Eager_unfolding_only -> begin
...
let uu___238_15725 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = uu___238_15725.tcenv; delta_level = new_delta; primitive_steps = uu___238_15725.primitive_steps})))
in (
...
let uu___239_16064 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___239_16064.FStar_Syntax_Syntax.p})), (env3))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___240_16083 = x
in (

let uu____16084 = (norm_or_whnf env2 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___240_16083.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___240_16083.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____16084}))
in (((

let uu___241_16092 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.p = uu___241_16092.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___242_16097 = x
in (

let uu____16098 = (norm_or_whnf env2 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___242_16097.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___242_16097.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____16098}))
in (((

let uu___243_16106 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.p = uu___243_16106.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
let uu___244_16116 = x
in (

let uu____16117 = (norm_or_whnf env2 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___244_16116.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___244_16116.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____16117}))
in (

let t2 = (norm_or_whnf env2 t1)
in (((

let uu___245_16126 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t2))); FStar_Syntax_Syntax.p = uu___245_16126.FStar_Syntax_Syntax.p})), (env2))))
end))
in (
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun uu___181_16831 -> (match (uu___181_16831) with
| UnfoldUntil (k) -> begin
...
let uu___246_16870 = (config s e)
in {steps = uu___246_16870.steps; tcenv = uu___246_16870.tcenv; delta_level = uu___246_16870.delta_level; primitive_steps = (FStar_List.append c.primitive_steps ps)})
in (norm c1 [] [] t))))
...
let uu___247_16930 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___247_16930.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___247_16930.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____16933 -> (
...
let t1 = (FStar_All.try_with (fun uu___249_16946 -> (match (()) with
| () -> begin
(normalize ((AllowUnboundUniverses)::[]) env t)
end)) (fun uu___248_16950 -> (match (uu___248_16950) with
| e -> begin
((
...
let c1 = (FStar_All.try_with (fun uu___251_16965 -> (match (()) with
| () -> begin
(

let uu____16966 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp uu____16966 [] c))
end)) (fun uu___250_16970 -> (match (uu___250_16970) with
| e -> begin
((
...
let uu___252_17285 = env
in {FStar_TypeChecker_Env.solver = uu___252_17285.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___252_17285.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___252_17285.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___252_17285.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___252_17285.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___252_17285.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = FStar_Pervasives_Native.None; FStar_TypeChecker_Env.sigtab = uu___252_17285.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___252_17285.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___252_17285.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___252_17285.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___252_17285.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___252_17285.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___252_17285.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___252_17285.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___252_17285.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___252_17285.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___252_17285.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___252_17285.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___252_17285.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___252_17285.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.type_of = uu___252_17285.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___252_17285.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___252_17285.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___252_17285.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___252_17285.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___252_17285.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___252_17285.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.dsenv = uu___252_17285.FStar_TypeChecker_Env.dsenv}) t)
...
let uu___253_17298 = env
in {FStar_TypeChecker_Env.solver = uu___253_17298.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___253_17298.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___253_17298.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___253_17298.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___253_17298.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___253_17298.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = FStar_Pervasives_Native.None; FStar_TypeChecker_Env.sigtab = uu___253_17298.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___253_17298.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___253_17298.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___253_17298.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___253_17298.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___253_17298.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___253_17298.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___253_17298.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___253_17298.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___253_17298.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___253_17298.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___253_17298.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___253_17298.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___253_17298.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.type_of = uu___253_17298.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___253_17298.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___253_17298.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___253_17298.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___253_17298.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___253_17298.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___253_17298.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.dsenv = uu___253_17298.FStar_TypeChecker_Env.dsenv}) t)
...
let uu___254_17959 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((lid), (univ_names1), (binders1), (typ1), (lids), (lids'))); FStar_Syntax_Syntax.sigrng = uu___254_17959.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___254_17959.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___254_17959.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___254_17959.FStar_Syntax_Syntax.sigattrs})
end))
end
| FStar_Syntax_Syntax.Sig_bundle (sigs, lids) -> begin
(

let uu___255_17980 = s
in (
...
in {FStar_Syntax_Syntax.sigel = uu____17981; FStar_Syntax_Syntax.sigrng = uu___255_17980.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___255_17980.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___255_17980.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___255_17980.FStar_Syntax_Syntax.sigattrs}))
end
...
let uu___256_18040 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((lid), (univ_names1), (typ1), (lident), (i), (lids))); FStar_Syntax_Syntax.sigrng = uu___256_18040.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___256_18040.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___256_18040.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___256_18040.FStar_Syntax_Syntax.sigattrs})
end))
end
...
let uu___257_18078 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (univ_names1), (typ1))); FStar_Syntax_Syntax.sigrng = uu___257_18078.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___257_18078.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___257_18078.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___257_18078.FStar_Syntax_Syntax.sigattrs})
end))
end
...
let uu___258_18139 = lb
in {FStar_Syntax_Syntax.lbname = uu___258_18139.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = lbunivs; FStar_Syntax_Syntax.lbtyp = lbtyp; FStar_Syntax_Syntax.lbeff = uu___258_18139.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}))))
end)))))
in (

let uu___259_18140 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let (((((b), (lbs1))), (lids))); FStar_Syntax_Syntax.sigrng = uu___259_18140.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___259_18140.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___259_18140.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___259_18140.FStar_Syntax_Syntax.sigattrs}))
end
| FStar_Syntax_Syntax.Sig_main (t) -> begin
(

let uu___260_18152 = s
in (
...
in {FStar_Syntax_Syntax.sigel = uu____18153; FStar_Syntax_Syntax.sigrng = uu___260_18152.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___260_18152.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___260_18152.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___260_18152.FStar_Syntax_Syntax.sigattrs}))
end
...
let uu___261_18190 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_assume (((l), (us1), (t1))); FStar_Syntax_Syntax.sigrng = uu___261_18190.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___261_18190.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___261_18190.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___261_18190.FStar_Syntax_Syntax.sigattrs})
end))
end
...
let uu___262_18799 = a
in {FStar_Syntax_Syntax.action_name = uu___262_18799.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___262_18799.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = action_univs; FStar_Syntax_Syntax.action_params = action_params; FStar_Syntax_Syntax.action_defn = action_defn; FStar_Syntax_Syntax.action_typ = action_typ})
in a')
end))
end))))))
in (
...
in {FStar_Syntax_Syntax.cattributes = uu___263_18801.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___263_18801.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs1; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret_wp = uu____18802; FStar_Syntax_Syntax.bind_wp = uu____18803; FStar_Syntax_Syntax.if_then_else = uu____18804; FStar_Syntax_Syntax.ite_wp = uu____18805; FStar_Syntax_Syntax.stronger = uu____18806; FStar_Syntax_Syntax.close_wp = uu____18807; FStar_Syntax_Syntax.assert_p = uu____18808; FStar_Syntax_Syntax.assume_p = uu____18809; FStar_Syntax_Syntax.null_wp = uu____18810; FStar_Syntax_Syntax.trivial = uu____18811; FStar_Syntax_Syntax.repr = uu____18812; FStar_Syntax_Syntax.return_repr = uu____18813; FStar_Syntax_Syntax.bind_repr = uu____18814; FStar_Syntax_Syntax.actions = uu____18815})))))))))))))))
in (

let uu___264_18818 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ed1); FStar_Syntax_Syntax.sigrng = uu___264_18818.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___264_18818.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___264_18818.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___264_18818.FStar_Syntax_Syntax.sigattrs})))))))
end))
end))
end))
end
...
let elim_tscheme_opt = (fun uu___182_18835 -> (match (uu___182_18835) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
...
in {FStar_Syntax_Syntax.source = uu___265_18905.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = uu___265_18905.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = uu____18906; FStar_Syntax_Syntax.lift = uu____18909})))
in (

let uu___266_18912 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_sub_effect (sub_eff1); FStar_Syntax_Syntax.sigrng = uu___266_18912.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___266_18912.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___266_18912.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___266_18912.FStar_Syntax_Syntax.sigattrs})))
end
...
let uu___267_18956 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_effect_abbrev (((lid), (univ_names1), (binders1), (comp1), (flags))); FStar_Syntax_Syntax.sigrng = uu___267_18956.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___267_18956.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___267_18956.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___267_18956.FStar_Syntax_Syntax.sigattrs})
end))
end
