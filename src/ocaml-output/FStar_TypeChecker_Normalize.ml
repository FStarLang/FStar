                 ...
                 FStar_All.pipe_right lbs
                   (FStar_List.map
                      (fun lb  ->
                         ...
                         | (openings,lbunivs) ->
                             let cfg1 =
                               let uu___196_12895 = cfg in
                               let uu____12896 =
                                 FStar_TypeChecker_Env.push_univ_vars
                                   cfg.tcenv lbunivs in
                               {
                                 steps = (uu___196_12895.steps);
                                 tcenv = uu____12896;
                                 delta_level = (uu___196_12895.delta_level);
                                 primitive_steps =
                                   (uu___196_12895.primitive_steps)
                               } in
                             let norm1 t2 =
                               let uu____12901 =
                                 let uu____12902 =
                                   FStar_Syntax_Subst.subst openings t2 in
                                 norm cfg1 env [] uu____12902 in
                               FStar_Syntax_Subst.close_univ_vars lbunivs
                                 uu____12901 in
                             let lbtyp = norm1 lb.FStar_Syntax_Syntax.lbtyp in
                             let lbdef = norm1 lb.FStar_Syntax_Syntax.lbdef in
                             let uu___197_12905 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___197_12905.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs = lbunivs;
                               FStar_Syntax_Syntax.lbtyp = lbtyp;
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___197_12905.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = lbdef
                             })) in
               let uu____12906 =
                 mk (FStar_Syntax_Syntax.Tm_let ((b, lbs1), lbody))
                   t1.FStar_Syntax_Syntax.pos in
               rebuild cfg env stack1 uu____12906
           | FStar_Syntax_Syntax.Tm_let
               ((uu____12917,{
                               FStar_Syntax_Syntax.lbname = FStar_Util.Inr
                                 uu____12918;
                               FStar_Syntax_Syntax.lbunivs = uu____12919;
                               FStar_Syntax_Syntax.lbtyp = uu____12920;
                               FStar_Syntax_Syntax.lbeff = uu____12921;
                               FStar_Syntax_Syntax.lbdef = uu____12922;_}::uu____12923),uu____12924)
               -> rebuild cfg env stack1 t1
           | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
               let n1 =
               ...
               then
                 let env1 =
                   let uu____12969 =
                     let uu____12970 =
                       ...
                       (env, (lb.FStar_Syntax_Syntax.lbdef), uu____12989,
                         false) in
                     Clos uu____12970 in
                   uu____12969 :: env in
                 ...
                 (let uu____13041 =
                    let uu____13046 =
                      ...
                      [uu____13047] in
                    FStar_Syntax_Subst.open_term uu____13046 body in
                  match uu____13041 with
                  | (bs,body1) ->
                      let ty = norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp in
                      let lbname =
                        let x =
                          let uu____13062 = FStar_List.hd bs in
                          FStar_Pervasives_Native.fst uu____13062 in
                        FStar_Util.Inl
                          (let uu___198_13072 = x in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___198_13072.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___198_13072.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = ty
                           }) in
                      let lb1 =
                        let uu___199_13074 = lb in
                        let uu____13075 =
                          norm cfg env [] lb.FStar_Syntax_Syntax.lbdef in
                        {
                          FStar_Syntax_Syntax.lbname = lbname;
                          FStar_Syntax_Syntax.lbunivs =
                            (uu___199_13074.FStar_Syntax_Syntax.lbunivs);
                          FStar_Syntax_Syntax.lbtyp = ty;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___199_13074.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = uu____13075
                        } in
                      let env' =
                        FStar_All.pipe_right bs
                          (FStar_List.fold_left
                             (fun env1  -> fun uu____13092  -> Dummy :: env1)
                             env) in
                      norm cfg env'
               ...
               (FStar_List.contains CompressUvars cfg.steps) ||
                 ((FStar_List.contains (Exclude Zeta) cfg.steps) &&
                    (FStar_List.contains PureSubtermsWithinComputations
                       cfg.steps))
               ->
               let uu____13115 = FStar_Syntax_Subst.open_let_rec lbs body in
               (match uu____13115 with
                | (lbs1,body1) ->
                        ...
                        (fun lb  ->
                           ...
                           let lbname =
                             let uu____13151 =
                               ...
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___200_13152.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___200_13152.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = ty
                               } in
                             FStar_Util.Inl uu____13151 in
                           let uu____13153 =
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 let uu____13173 =
                                   FStar_List.map (fun uu____13177  -> Dummy)
                                     lbs1 in
                                 let uu____13178 =
                                   let uu____13181 =
                                     FStar_List.map
                                       (fun uu____13189  -> Dummy) xs1 in
                                   FStar_List.append uu____13181 env in
                                 FStar_List.append uu____13173 uu____13178 in
                               let def_body1 = norm cfg env1 [] def_body in
                               let lopt1 =
                                 match lopt with
                                 | FStar_Pervasives_Native.Some rc ->
                                     let uu____13201 =
                                       let uu___201_13202 = rc in
                                       let uu____13203 =
                                         FStar_Util.map_opt
                                           rc.FStar_Syntax_Syntax.residual_typ
                                           (norm cfg env1 []) in
                                       {
                                         FStar_Syntax_Syntax.residual_effect
                                           =
                                           (uu___201_13202.FStar_Syntax_Syntax.residual_effect);
                                         FStar_Syntax_Syntax.residual_typ =
                                           uu____13203;
                                         FStar_Syntax_Syntax.residual_flags =
                                           (uu___201_13202.FStar_Syntax_Syntax.residual_flags)
                                       } in
                                     FStar_Pervasives_Native.Some uu____13201
                                 | uu____13210 -> lopt in
                               let def =
                                 FStar_Syntax_Util.abs xs1 def_body1 lopt1 in
                               let uu___202_13214 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname = lbname;
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___202_13214.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp = ty;
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___202_13214.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef = def
                               }) lbs1 in
                    let env' =
                      let uu____13218 =
                        FStar_List.map (fun uu____13222  -> Dummy) lbs2 in
                      FStar_List.append uu____13218 env in
                    ...
                    (match uu____13224 with
                     | (lbs3,body3) ->
                         let t2 =
                           let uu___203_13240 = t1 in
                           {
                             FStar_Syntax_Syntax.n =
                               (FStar_Syntax_Syntax.Tm_let
                                  ((true, lbs3), body3));
                             FStar_Syntax_Syntax.pos =
                               (uu___203_13240.FStar_Syntax_Syntax.pos);
                             FStar_Syntax_Syntax.vars =
                               (uu___203_13240.FStar_Syntax_Syntax.vars)
                           } in
                         rebuild cfg env stack1 t2))
           | FStar_Syntax_Syntax.Tm_let (lbs,body) when
               FStar_List.contains (Exclude Zeta) cfg.steps ->
               let uu____13267 = closure_as_term cfg env t1 in
               rebuild cfg env stack1 uu____13267
                        ...
                        | (rec_env,memos,i) ->
                            let f_i =
                              let uu____13410 =
                                ...
                                {
                                  FStar_Syntax_Syntax.ppname =
                                    (uu___204_13411.FStar_Syntax_Syntax.ppname);
                                  FStar_Syntax_Syntax.index = i;
                                  FStar_Syntax_Syntax.sort =
                                    (uu___204_13411.FStar_Syntax_Syntax.sort)
                                } in
                              FStar_Syntax_Syntax.bv_to_tm uu____13410 in
                            let fix_f_i =
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                      ...
                      | (App
                          ({
                             FStar_Syntax_Syntax.n =
                               FStar_Syntax_Syntax.Tm_constant
                               (FStar_Const.Const_reify );
                             FStar_Syntax_Syntax.pos = uu____14061;
                             FStar_Syntax_Syntax.vars = uu____14062;_},uu____14063,uu____14064))::uu____14065
                          ->
                          FStar_All.pipe_right cfg.steps
                    ...
                    then
                        ...
                        then
                          let uu___205_14083 = cfg in
                          {
                            steps =
                              ...
                              Exclude Zeta;
                              NoDeltaSteps];
                            tcenv = (uu___205_14083.tcenv);
                            delta_level =
                              [FStar_TypeChecker_Env.Inlining;
                              FStar_TypeChecker_Env.Eager_unfolding_only];
                            primitive_steps =
                              (uu___205_14083.primitive_steps)
                          }
                        else
                          (let uu___206_14085 = cfg in
                           {
                             steps =
                               (FStar_List.append [Exclude Zeta] cfg.steps);
                             tcenv = (uu___206_14085.tcenv);
                             delta_level = (uu___206_14085.delta_level);
                             primitive_steps =
                               (uu___206_14085.primitive_steps)
                           }) in
                      norm cfg1 env
                        ((Meta
                      ...
                      (let uu____14087 =
                         let uu____14088 = FStar_Syntax_Subst.compress head1 in
                         uu____14088.FStar_Syntax_Syntax.n in
                       match uu____14087 with
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1 in
                           let uu____14106 = ed.FStar_Syntax_Syntax.bind_repr in
                           (match uu____14106 with
                            | (uu____14107,bind_repr) ->
                                (match lb.FStar_Syntax_Syntax.lbname with
                                 | FStar_Util.Inr uu____14113 ->
                                     failwith
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       ...
                                       | FStar_Syntax_Syntax.Tm_meta
                                           (e1,FStar_Syntax_Syntax.Meta_monadic
                                            (uu____14128,uu____14129))
                                           ->
                                           let uu____14138 =
                                             let uu____14139 =
                                               FStar_Syntax_Subst.compress e1 in
                                             uu____14139.FStar_Syntax_Syntax.n in
                                           (match uu____14138 with
                                            | FStar_Syntax_Syntax.Tm_meta
                                                (e2,FStar_Syntax_Syntax.Meta_monadic_lift
                                                 (uu____14145,msrc,uu____14147))
                                                when
                                     ...
                                     (match uu____14159 with
                                      | FStar_Pervasives_Native.Some e ->
                                          let lb1 =
                                            let uu___207_14164 = lb in
                                            {
                                              FStar_Syntax_Syntax.lbname =
                                                (uu___207_14164.FStar_Syntax_Syntax.lbname);
                                              FStar_Syntax_Syntax.lbunivs =
                                                (uu___207_14164.FStar_Syntax_Syntax.lbunivs);
                                              FStar_Syntax_Syntax.lbtyp =
                                                (uu___207_14164.FStar_Syntax_Syntax.lbtyp);
                                              FStar_Syntax_Syntax.lbeff =
                                          ...
                                          norm cfg env uu____14165
                                            uu____14166
                                      | FStar_Pervasives_Native.None  ->
                                          let uu____14200 =
                                            let uu____14201 = is_return body in
                                          ...
                                          then
                                            ...
                                            (let head2 =
                                             ...
                                             let bind_inst =
                                               let uu____14275 =
                                                 let uu____14276 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr in
                                                 uu____14276.FStar_Syntax_Syntax.n in
                                               match uu____14275 with
                                               | FStar_Syntax_Syntax.Tm_uinst
                                                   (bind1,uu____14282::uu____14283::[])
                                                   ->
                                                   let uu____14290 =
                                                     let uu____14293 =
                                                       let uu____14294 =
                                             ...
                                             let uu____14374 =
                                               FStar_List.tl stack1 in
                                             norm cfg env uu____14374 reified))))
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1 in
                           let uu____14398 = ed.FStar_Syntax_Syntax.bind_repr in
                           (match uu____14398 with
                            | (uu____14399,bind_repr) ->
                      ...
                      | (App
                          ({
                             FStar_Syntax_Syntax.n =
                               FStar_Syntax_Syntax.Tm_constant
                               (FStar_Const.Const_reify );
                             FStar_Syntax_Syntax.pos = uu____14795;
                             FStar_Syntax_Syntax.vars = uu____14796;_},uu____14797,uu____14798))::uu____14799
                          ->
                          FStar_All.pipe_right cfg.steps
                            (FStar_List.contains Reify)
                      | uu____14806 -> false in
                    if should_reify
                    then
                      let uu____14807 = FStar_List.tl stack1 in
                      let uu____14808 =
                        let uu____14809 = closure_as_term cfg env t2 in
                        reify_lift cfg.tcenv head1 m1 m' uu____14809 in
                      norm cfg env uu____14807 uu____14808
                    else
                      (let t3 = norm cfg env [] t2 in
                       let uu____14812 =
                         ...
                         let cfg1 =
                           let uu___208_14821 = cfg in
                           {
                             steps =
                               ...
                               EraseUniverses;
                               Exclude Zeta];
                             tcenv = (uu___208_14821.tcenv);
                             delta_level =
                               [FStar_TypeChecker_Env.Inlining;
                               FStar_TypeChecker_Env.Eager_unfolding_only];
                             primitive_steps =
                               (uu___208_14821.primitive_steps)
                           } in
                         norm cfg1 env
                           ((Meta
                                ...
                                norm cfg env
                                  ((Meta
                                      ((FStar_Syntax_Syntax.Meta_pattern
                                        ...
                                        (t1.FStar_Syntax_Syntax.pos))) ::
                                  stack1) head1
                            | uu____14856 -> norm cfg env stack1 head1)
                       | [] ->
                           ...
                           let m1 =
                             ...
                             | FStar_Syntax_Syntax.Meta_pattern args ->
                                 ...
                                 FStar_Syntax_Syntax.Meta_pattern uu____14870
                             | uu____14881 -> m in
                           let t2 =
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              let uu____14893 = ed.FStar_Syntax_Syntax.return_repr in
              match uu____14893 with
              | (uu____14894,return_repr) ->
                  let return_inst =
                    let uu____14903 =
                      let uu____14904 =
                          ...
                          let uu____14920 =
                            let uu____14921 =
                              let uu____14928 =
                                ...
                                [uu____14931] in
                              (return_tm, uu____14928) in
                            FStar_Syntax_Syntax.Tm_uinst uu____14921 in
                          FStar_Syntax_Syntax.mk uu____14920 in
                        uu____14917 FStar_Pervasives_Native.None
                  ...
                  let uu____14942 =
                    let uu____14945 =
                      let uu____14946 =
                        let uu____14961 =
                          let uu____14964 = FStar_Syntax_Syntax.as_arg t in
                          let uu____14965 =
                            let uu____14968 = FStar_Syntax_Syntax.as_arg e in
                            [uu____14968] in
                          uu____14964 :: uu____14965 in
                        (return_inst, uu____14961) in
                      FStar_Syntax_Syntax.Tm_app uu____14946 in
                    FStar_Syntax_Syntax.mk uu____14945 in
                  uu____14942 FStar_Pervasives_Native.None
                    e.FStar_Syntax_Syntax.pos
            else
              (let uu____14977 =
               ...
               | FStar_Pervasives_Native.None  ->
                   ...
                   failwith uu____14980
               | FStar_Pervasives_Native.Some
                   { FStar_TypeChecker_Env.msource = uu____14981;
                     FStar_TypeChecker_Env.mtarget = uu____14982;
                     FStar_TypeChecker_Env.mlift =
                       { FStar_TypeChecker_Env.mlift_wp = uu____14983;
               ...
               | FStar_Pervasives_Native.Some
                   { FStar_TypeChecker_Env.msource = uu____14994;
                     FStar_TypeChecker_Env.mtarget = uu____14995;
                     FStar_TypeChecker_Env.mlift =
                       { FStar_TypeChecker_Env.mlift_wp = uu____14996;
                         FStar_TypeChecker_Env.mlift_term =
                           FStar_Pervasives_Native.Some lift;_};_}
                   ->
                   let uu____15014 = FStar_Syntax_Util.mk_reify e in
                   lift t FStar_Syntax_Syntax.tun uu____15014)
  ...
  fun cfg  ->
    fun env  ->
      fun comp  ->
        ...
        | FStar_Syntax_Syntax.Total (t,uopt) ->
            let uu___209_15098 = comp1 in
            let uu____15101 =
              let uu____15102 =
                let uu____15111 = norm cfg env [] t in
                let uu____15112 =
                  FStar_Option.map (norm_universe cfg env) uopt in
                (uu____15111, uu____15112) in
              FStar_Syntax_Syntax.Total uu____15102 in
            {
              FStar_Syntax_Syntax.n = uu____15101;
              FStar_Syntax_Syntax.pos =
                (uu___209_15098.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___209_15098.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.GTotal (t,uopt) ->
            let uu___210_15127 = comp1 in
            let uu____15130 =
              let uu____15131 =
                let uu____15140 = norm cfg env [] t in
                let uu____15141 =
                  FStar_Option.map (norm_universe cfg env) uopt in
                (uu____15140, uu____15141) in
              FStar_Syntax_Syntax.GTotal uu____15131 in
            {
              FStar_Syntax_Syntax.n = uu____15130;
              FStar_Syntax_Syntax.pos =
                (uu___210_15127.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___210_15127.FStar_Syntax_Syntax.vars)
            }
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____15193  ->
                      ...
                      | (a,i) ->
                          let uu____15204 = norm cfg env [] a in
                          (uu____15204, i))) in
            let flags =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___161_15215  ->
                      match uu___161_15215 with
                      | FStar_Syntax_Syntax.DECREASES t ->
                          let uu____15219 = norm cfg env [] t in
                          FStar_Syntax_Syntax.DECREASES uu____15219
                      | f -> f)) in
            let uu___211_15223 = comp1 in
            let uu____15226 =
              let uu____15227 =
                let uu___212_15228 = ct in
                let uu____15229 =
                  FStar_List.map (norm_universe cfg env)
                ...
                {
                  FStar_Syntax_Syntax.comp_univs = uu____15229;
                  FStar_Syntax_Syntax.effect_name =
                    (uu___212_15228.FStar_Syntax_Syntax.effect_name);
                  FStar_Syntax_Syntax.result_typ = uu____15230;
                  FStar_Syntax_Syntax.effect_args = uu____15233;
                  FStar_Syntax_Syntax.flags = flags
                } in
              FStar_Syntax_Syntax.Comp uu____15227 in
            {
              FStar_Syntax_Syntax.n = uu____15226;
              FStar_Syntax_Syntax.pos =
                (uu___211_15223.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___211_15223.FStar_Syntax_Syntax.vars)
            }
  ...
  fun cfg  ->
    fun env  ->
      fun c  ->
        let norm1 t =
          norm
            (let uu___213_15251 = cfg in
             {
               steps =
                 [Eager_unfolding;
                 UnfoldUntil FStar_Syntax_Syntax.Delta_constant;
                 AllowUnboundUniverses];
               tcenv = (uu___213_15251.tcenv);
               delta_level = (uu___213_15251.delta_level);
               primitive_steps = (uu___213_15251.primitive_steps)
             }) env [] t in
        let non_info t =
          let uu____15256 = norm1 t in
          FStar_Syntax_Util.non_informative uu____15256 in
        match c.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Total uu____15259 -> c
        | FStar_Syntax_Syntax.GTotal (t,uopt) when non_info t ->
            let uu___214_15278 = c in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Total (t, uopt));
              FStar_Syntax_Syntax.pos =
                (uu___214_15278.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___214_15278.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.Comp ct ->
            let l =
              FStar_TypeChecker_Env.norm_eff_name cfg.tcenv
            ...
            then
              let ct1 =
                ...
                | FStar_Pervasives_Native.Some pure_eff ->
                    ...
                    let uu___215_15296 = ct in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___215_15296.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name = pure_eff;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___215_15296.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___215_15296.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags = flags
                    }
                | FStar_Pervasives_Native.None  ->
                    let ct1 =
                      FStar_TypeChecker_Env.unfold_effect_abbrev cfg.tcenv c in
                    let uu___216_15298 = ct1 in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___216_15298.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name =
                        FStar_Parser_Const.effect_PURE_lid;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___216_15298.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___216_15298.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags =
                        (uu___216_15298.FStar_Syntax_Syntax.flags)
                    } in
              let uu___217_15299 = c in
              {
                FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
                FStar_Syntax_Syntax.pos =
                  (uu___217_15299.FStar_Syntax_Syntax.pos);
                FStar_Syntax_Syntax.vars =
                  (uu___217_15299.FStar_Syntax_Syntax.vars)
              }
            else c
        | uu____15301 -> c
and norm_binder:
  ...
  fun cfg  ->
    fun env  ->
      fun uu____15304  ->
        ...
        | (x,imp) ->
            let uu____15307 =
              let uu___218_15308 = x in
              let uu____15309 = norm cfg env [] x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___218_15308.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___218_15308.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____15309
              } in
            (uu____15307, imp)
and norm_binders:
  ...
  fun cfg  ->
    fun env  ->
      fun bs  ->
        ...
        match uu____15315 with | (nbs,uu____15361) -> FStar_List.rev nbs
and norm_lcomp_opt:
  cfg ->
    env ->
      FStar_Syntax_Syntax.residual_comp FStar_Pervasives_Native.option ->
    ...
    fun env  ->
      fun lopt  ->
        ...
        | FStar_Pervasives_Native.Some rc ->
            ...
            let uu____15377 =
              let uu___219_15378 = rc in
              let uu____15379 =
                FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                  (norm cfg env []) in
              {
                FStar_Syntax_Syntax.residual_effect =
                  (uu___219_15378.FStar_Syntax_Syntax.residual_effect);
                FStar_Syntax_Syntax.residual_typ = uu____15379;
                FStar_Syntax_Syntax.residual_flags =
                  (uu___219_15378.FStar_Syntax_Syntax.residual_flags)
              } in
        ...
        fun t  ->
                ...
                then
                  ...
                  let uu____15401 =
                    let uu____15402 =
                      ...
                      FStar_Pervasives_Native.snd uu____15403 in
                    FStar_Util.string_of_int uu____15402 in
                  let uu____15408 = FStar_Syntax_Print.term_to_string tm in
                  let uu____15409 = FStar_Syntax_Print.term_to_string t in
                  FStar_Util.print3 "Normalized (%s ms) %s\n\tto %s\n"
                    uu____15401 uu____15408 uu____15409
                else ());
               rebuild cfg env stack2 t)
          | (Steps (s,ps,dl))::stack2 ->
              rebuild
                (let uu___220_15427 = cfg in
                 {
                   steps = s;
                   tcenv = (uu___220_15427.tcenv);
                   delta_level = dl;
                   primitive_steps = ps
                 }) env stack2 t
          | (Meta (m,r))::stack2 ->
          ...
          | (MemoLazy r)::stack2 ->
              (set_memo r (env, t);
               log cfg
                 (fun uu____15496  ->
                    let uu____15497 = FStar_Syntax_Print.term_to_string t in
                    FStar_Util.print1 "\tSet memo %s\n" uu____15497);
               rebuild cfg env stack2 t)
          ...
          | (Abs (env',bs,env'',lopt,r))::stack2 ->
              ...
              let uu____15533 =
                let uu___221_15534 = FStar_Syntax_Util.abs bs1 t lopt1 in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___221_15534.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___221_15534.FStar_Syntax_Syntax.vars)
                } in
              rebuild cfg env stack2 uu____15533
          | (Arg (Univ uu____15535,uu____15536,uu____15537))::uu____15538 ->
              failwith "Impossible"
          | (Arg (Dummy ,uu____15541,uu____15542))::uu____15543 ->
              failwith "Impossible"
          | (UnivArgs (us,r))::stack2 ->
              let t1 = FStar_Syntax_Syntax.mk_Tm_uinst t us in
              rebuild cfg env stack2 t1
          | (Arg (Clos (env1,tm,m,uu____15559),aq,r))::stack2 ->
              (log cfg
                 (fun uu____15588  ->
                    let uu____15589 = FStar_Syntax_Print.term_to_string tm in
               ...
               then
                 ...
                 (let uu____15599 = FStar_ST.op_Bang m in
                  ...
                  | FStar_Pervasives_Native.None  ->
                      ...
                      then
                        ...
                        (let stack3 = (MemoLazy m) :: (App (t, aq, r)) ::
                           stack2 in
                         norm cfg env1 stack3 tm)
                  | FStar_Pervasives_Native.Some (uu____15699,a) ->
                      let t1 =
          ...
          | (App (head1,aq,r))::stack2 ->
              let t1 =
                FStar_Syntax_Syntax.extend_app head1 (t, aq)
                  FStar_Pervasives_Native.None r in
              let uu____15723 = maybe_simplify cfg t1 in
              rebuild cfg env stack2 uu____15723
          | (Match (env1,branches,r))::stack2 ->
              (log cfg
                 (fun uu____15733  ->
                    let uu____15734 = FStar_Syntax_Print.term_to_string t in
                    FStar_Util.print1
                      "Rebuilding with match, scrutinee is %s ...\n"
                      uu____15734);
               (let scrutinee = t in
                let norm_and_rebuild_match uu____15739 =
                  log cfg
                    (fun uu____15744  ->
                       let uu____15745 =
                           ...
                           FStar_All.pipe_right branches
                             (FStar_List.map
                                (fun uu____15764  ->
                                   ...
                                   | (p,uu____15774,uu____15775) ->
                                       FStar_Syntax_Print.pat_to_string p)) in
                         FStar_All.pipe_right uu____15747
                           (FStar_String.concat "\n\t") in
                       FStar_Util.print2
                  ...
                  (let whnf1 = FStar_List.contains WHNF cfg.steps in
                   let cfg_exclude_iota_zeta =
                     let new_delta =
                       FStar_All.pipe_right cfg.delta_level
                         (FStar_List.filter
                            (fun uu___162_15792  ->
                               match uu___162_15792 with
                               | FStar_TypeChecker_Env.Inlining  -> true
                               | FStar_TypeChecker_Env.Eager_unfolding_only 
                                   -> true
                               | uu____15793 -> false)) in
                     let steps' =
                       let uu____15797 =
                         FStar_All.pipe_right cfg.steps
                           (FStar_List.contains
                     ...
                     let uu___222_15801 = cfg in
                     {
                       steps = (FStar_List.append steps' cfg.steps);
                       tcenv = (uu___222_15801.tcenv);
                       delta_level = new_delta;
                       primitive_steps = (uu___222_15801.primitive_steps)
                     } in
                   ...
                   let rec norm_pat env2 p =
                     match p.FStar_Syntax_Syntax.v with
                     | FStar_Syntax_Syntax.Pat_constant uu____15845 ->
                         (p, env2)
                     | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
                         let uu____15868 =
                           FStar_All.pipe_right pats
                             (FStar_List.fold_left
                                (fun uu____15934  ->
                                   fun uu____15935  ->
                                     match (uu____15934, uu____15935) with
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____16038 = norm_pat env3 p1 in
                         ...
                         (match uu____15868 with
                          | (pats1,env3) ->
                              ((let uu___223_16140 = p in
                                {
                                  FStar_Syntax_Syntax.v =
                                    (FStar_Syntax_Syntax.Pat_cons
                                       (fv, (FStar_List.rev pats1)));
                                  FStar_Syntax_Syntax.p =
                                    (uu___223_16140.FStar_Syntax_Syntax.p)
                                }), env3))
                     | FStar_Syntax_Syntax.Pat_var x ->
                         let x1 =
                           let uu___224_16159 = x in
                           let uu____16160 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___224_16159.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___224_16159.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____16160
                           } in
                         ((let uu___225_16168 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_var x1);
                             FStar_Syntax_Syntax.p =
                               (uu___225_16168.FStar_Syntax_Syntax.p)
                           }), (Dummy :: env2))
                     | FStar_Syntax_Syntax.Pat_wild x ->
                         let x1 =
                           let uu___226_16173 = x in
                           let uu____16174 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___226_16173.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___226_16173.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____16174
                           } in
                         ((let uu___227_16182 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_wild x1);
                             FStar_Syntax_Syntax.p =
                               (uu___227_16182.FStar_Syntax_Syntax.p)
                           }), (Dummy :: env2))
                     | FStar_Syntax_Syntax.Pat_dot_term (x,t1) ->
                         let x1 =
                           let uu___228_16192 = x in
                           let uu____16193 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___228_16192.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___228_16192.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____16193
                           } in
                         let t2 = norm_or_whnf env2 t1 in
                         ((let uu___229_16202 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_dot_term (x1, t2));
                             FStar_Syntax_Syntax.p =
                               (uu___229_16202.FStar_Syntax_Syntax.p)
                           }), env2) in
                   let branches1 =
                     match env1 with
                     | [] when whnf1 -> branches
                         ...
                         FStar_All.pipe_right branches
                           (FStar_List.map
                              (fun branch1  ->
                                 ...
                                 | (p,wopt,e) ->
                                     let uu____16240 = norm_pat env1 p in
                   ...
                   let uu____16277 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r in
                   rebuild cfg env1 stack2 uu____16277) in
                let rec is_cons head1 =
                  match head1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_uinst (h,uu____16287) -> is_cons h
                  | FStar_Syntax_Syntax.Tm_constant uu____16292 -> true
                  | FStar_Syntax_Syntax.Tm_fvar
                      { FStar_Syntax_Syntax.fv_name = uu____16293;
                        FStar_Syntax_Syntax.fv_delta = uu____16294;
                        FStar_Syntax_Syntax.fv_qual =
                          FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Data_ctor );_}
                      -> true
                  | FStar_Syntax_Syntax.Tm_fvar
                      { FStar_Syntax_Syntax.fv_name = uu____16295;
                        FStar_Syntax_Syntax.fv_delta = uu____16296;
                        FStar_Syntax_Syntax.fv_qual =
                          FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Record_ctor uu____16297);_}
                      -> true
                  | uu____16304 -> false in
                ...
                let rec matches_pat scrutinee_orig p =
                  ...
                  | (head1,args) ->
                      (match p.FStar_Syntax_Syntax.v with
                       | FStar_Syntax_Syntax.Pat_var uu____16482 ->
                           FStar_Util.Inl [scrutinee_orig]
                       | FStar_Syntax_Syntax.Pat_wild uu____16485 ->
                           FStar_Util.Inl [scrutinee_orig]
                       | FStar_Syntax_Syntax.Pat_dot_term uu____16488 ->
                           FStar_Util.Inl []
                       ...
                       | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                           let uu____16530 =
                             ...
                             uu____16531.FStar_Syntax_Syntax.n in
                           (match uu____16530 with
                            ...
                            | uu____16541 ->
                                let uu____16542 =
                                  let uu____16543 = is_cons head1 in
                                  Prims.op_Negation uu____16543 in
                                FStar_Util.Inr uu____16542))
                and matches_args out a p =
                  match (a, p) with
                  | ([],[]) -> FStar_Util.Inl out
                  | ((t1,uu____16596)::rest_a,(p1,uu____16599)::rest_p) ->
                      let uu____16643 = matches_pat t1 p1 in
                      (match uu____16643 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____16668 -> FStar_Util.Inr false in
                let rec matches scrutinee1 p =
                  match p with
                  | [] -> norm_and_rebuild_match ()
                  | (p1,wopt,b)::rest ->
                      let uu____16770 = matches_pat scrutinee1 p1 in
                           ...
                           (log cfg
                              (fun uu____16790  ->
                                 ...
                                 let uu____16792 =
                                   ...
                                   FStar_All.pipe_right uu____16793
                                        ...
                                        let uu____16811 =
                                          let uu____16830 =
                                            FStar_Util.mk_ref
                                              (FStar_Pervasives_Native.Some
                                                 ([], t1)) in
                                          ([], t1, uu____16830, false) in
                                        Clos uu____16811 in
                                      uu____16810 :: env2) env1 s in
                             let uu____16883 = guard_when_clause wopt b rest in
                             norm cfg env2 stack2 uu____16883))) in
                let uu____16884 =
                  FStar_All.pipe_right cfg.steps
    ...
    fun s  ->
      fun e  ->
        fun t  ->
          let c = config s e in
          let c1 =
            let uu___230_16946 = config s e in
            {
              steps = (uu___230_16946.steps);
              tcenv = (uu___230_16946.tcenv);
              delta_level = (uu___230_16946.delta_level);
...
let normalize_comp:
  ...
  fun s  ->
    fun e  ->
      fun t  -> let uu____16971 = config s e in norm_comp uu____16971 [] t
let normalize_universe:
  ...
  fun env  ->
    fun u  ->
      let uu____16980 = config [] env in norm_universe uu____16980 [] u
let ghost_to_pure:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp
  =
  fun env  ->
    fun c  ->
      let uu____16989 = config [] env in ghost_to_pure_aux uu____16989 [] c
let ghost_to_pure_lcomp:
  ...
  fun env  ->
    fun lc  ->
      ...
      let non_info t =
        let uu____17003 = norm cfg [] [] t in
        FStar_Syntax_Util.non_informative uu____17003 in
      let uu____17004 =
      ...
      then
        ...
        with
        | FStar_Pervasives_Native.Some pure_eff ->
            let uu___231_17006 = lc in
            {
              FStar_Syntax_Syntax.eff_name = pure_eff;
              FStar_Syntax_Syntax.res_typ =
                (uu___231_17006.FStar_Syntax_Syntax.res_typ);
              FStar_Syntax_Syntax.cflags =
                (uu___231_17006.FStar_Syntax_Syntax.cflags);
              FStar_Syntax_Syntax.comp =
                ((fun uu____17009  ->
                    let uu____17010 = lc.FStar_Syntax_Syntax.comp () in
                    ghost_to_pure env uu____17010))
            }
  ...
  fun env  ->
    fun t  ->
      let t1 =
        ...
        with
        | e ->
            ((let uu____17029 = FStar_Util.message_of_exn e in
...
let comp_to_string:
  ...
  fun env  ->
    fun c  ->
      let c1 =
        try
          let uu____17042 = config [AllowUnboundUniverses] env in
          norm_comp uu____17042 [] c
        with
        | e ->
            ((let uu____17049 = FStar_Util.message_of_exn e in
              FStar_Util.print1_warning "Normalization failed with error %s"
                uu____17049);
             c) in
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____17089 =
                     let uu____17090 =
                       let uu____17097 = FStar_Syntax_Util.mk_conj phi1 phi in
                       (y, uu____17097) in
                     FStar_Syntax_Syntax.Tm_refine uu____17090 in
                   mk uu____17089 t01.FStar_Syntax_Syntax.pos
               | uu____17102 -> t2)
          | uu____17103 -> t2 in
        aux t
let unfold_whnf:
...
let eta_expand_with_type:
  ...
  fun env  ->
    fun e  ->
      fun t_e  ->
        let uu____17155 = FStar_Syntax_Util.arrow_formals_comp t_e in
        match uu____17155 with
        | (formals,c) ->
            (match formals with
             | [] -> e
             | uu____17184 ->
                 let uu____17191 = FStar_Syntax_Util.abs_formals e in
                 (match uu____17191 with
                  | (actuals,uu____17201,uu____17202) ->
                      if
                      ...
                      then e
                        ...
                        (let uu____17216 =
                         ...
                         | (binders,args) ->
                             ...
                             FStar_Syntax_Util.abs binders uu____17233
                               (FStar_Pervasives_Native.Some
...
let eta_expand:
  ...
  fun env  ->
    fun t  ->
      ...
      | uu____17243 ->
          let uu____17244 = FStar_Syntax_Util.head_and_args t in
          (match uu____17244 with
           | (head1,args) ->
               let uu____17281 =
                 let uu____17282 = FStar_Syntax_Subst.compress head1 in
                 uu____17282.FStar_Syntax_Syntax.n in
               (match uu____17281 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____17285,thead) ->
                    let uu____17311 = FStar_Syntax_Util.arrow_formals thead in
                         ...
                         then t
                           ...
                           (let uu____17353 =
                              env.FStar_TypeChecker_Env.type_of
                                (let uu___236_17361 = env in
                                 {
                                   FStar_TypeChecker_Env.solver =
                                     (uu___236_17361.FStar_TypeChecker_Env.solver);
                                   FStar_TypeChecker_Env.range =
                                     (uu___236_17361.FStar_TypeChecker_Env.range);
                                   FStar_TypeChecker_Env.curmodule =
                                     (uu___236_17361.FStar_TypeChecker_Env.curmodule);
                                   FStar_TypeChecker_Env.gamma =
                                     (uu___236_17361.FStar_TypeChecker_Env.gamma);
                                   FStar_TypeChecker_Env.gamma_cache =
                                     (uu___236_17361.FStar_TypeChecker_Env.gamma_cache);
                                   FStar_TypeChecker_Env.modules =
                                     (uu___236_17361.FStar_TypeChecker_Env.modules);
                                   FStar_TypeChecker_Env.expected_typ =
                                     FStar_Pervasives_Native.None;
                                   FStar_TypeChecker_Env.sigtab =
                                     (uu___236_17361.FStar_TypeChecker_Env.sigtab);
                                   FStar_TypeChecker_Env.is_pattern =
                                     (uu___236_17361.FStar_TypeChecker_Env.is_pattern);
                                   FStar_TypeChecker_Env.instantiate_imp =
                                     (uu___236_17361.FStar_TypeChecker_Env.instantiate_imp);
                                   FStar_TypeChecker_Env.effects =
                                     (uu___236_17361.FStar_TypeChecker_Env.effects);
                                   FStar_TypeChecker_Env.generalize =
                                     (uu___236_17361.FStar_TypeChecker_Env.generalize);
                                   FStar_TypeChecker_Env.letrecs =
                                     (uu___236_17361.FStar_TypeChecker_Env.letrecs);
                                   FStar_TypeChecker_Env.top_level =
                                     (uu___236_17361.FStar_TypeChecker_Env.top_level);
                                   FStar_TypeChecker_Env.check_uvars =
                                     (uu___236_17361.FStar_TypeChecker_Env.check_uvars);
                                   FStar_TypeChecker_Env.use_eq =
                                     (uu___236_17361.FStar_TypeChecker_Env.use_eq);
                                   FStar_TypeChecker_Env.is_iface =
                                     (uu___236_17361.FStar_TypeChecker_Env.is_iface);
                                   FStar_TypeChecker_Env.admit =
                                     (uu___236_17361.FStar_TypeChecker_Env.admit);
                                   FStar_TypeChecker_Env.lax = true;
                                   FStar_TypeChecker_Env.lax_universes =
                                     (uu___236_17361.FStar_TypeChecker_Env.lax_universes);
                                   FStar_TypeChecker_Env.failhard =
                                     (uu___236_17361.FStar_TypeChecker_Env.failhard);
                                   FStar_TypeChecker_Env.nosynth =
                                     (uu___236_17361.FStar_TypeChecker_Env.nosynth);
                                   FStar_TypeChecker_Env.type_of =
                                     (uu___236_17361.FStar_TypeChecker_Env.type_of);
                                   FStar_TypeChecker_Env.universe_of =
                                     (uu___236_17361.FStar_TypeChecker_Env.universe_of);
                                   FStar_TypeChecker_Env.use_bv_sorts = true;
                                   FStar_TypeChecker_Env.qname_and_index =
                                     (uu___236_17361.FStar_TypeChecker_Env.qname_and_index);
                                   FStar_TypeChecker_Env.proof_ns =
                                     (uu___236_17361.FStar_TypeChecker_Env.proof_ns);
                                   FStar_TypeChecker_Env.synth =
                                     (uu___236_17361.FStar_TypeChecker_Env.synth);
                                   FStar_TypeChecker_Env.is_native_tactic =
                                     (uu___236_17361.FStar_TypeChecker_Env.is_native_tactic);
                                   FStar_TypeChecker_Env.identifier_info =
                                     (uu___236_17361.FStar_TypeChecker_Env.identifier_info)
                                 }) t in
                            match uu____17353 with
                            | (uu____17362,ty,uu____17364) ->
                                eta_expand_with_type env t ty))
                | uu____17365 ->
                    let uu____17366 =
                      env.FStar_TypeChecker_Env.type_of
                        (let uu___237_17374 = env in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___237_17374.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___237_17374.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___237_17374.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___237_17374.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___237_17374.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___237_17374.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ =
                             FStar_Pervasives_Native.None;
                           FStar_TypeChecker_Env.sigtab =
                             (uu___237_17374.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___237_17374.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___237_17374.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___237_17374.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___237_17374.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___237_17374.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level =
                             (uu___237_17374.FStar_TypeChecker_Env.top_level);
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___237_17374.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq =
                             (uu___237_17374.FStar_TypeChecker_Env.use_eq);
                           FStar_TypeChecker_Env.is_iface =
                             (uu___237_17374.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___237_17374.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax = true;
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___237_17374.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.failhard =
                             (uu___237_17374.FStar_TypeChecker_Env.failhard);
                           FStar_TypeChecker_Env.nosynth =
                             (uu___237_17374.FStar_TypeChecker_Env.nosynth);
                           FStar_TypeChecker_Env.type_of =
                             (uu___237_17374.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___237_17374.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts = true;
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___237_17374.FStar_TypeChecker_Env.qname_and_index);
                           FStar_TypeChecker_Env.proof_ns =
                             (uu___237_17374.FStar_TypeChecker_Env.proof_ns);
                           FStar_TypeChecker_Env.synth =
                             (uu___237_17374.FStar_TypeChecker_Env.synth);
                           FStar_TypeChecker_Env.is_native_tactic =
                             (uu___237_17374.FStar_TypeChecker_Env.is_native_tactic);
                           FStar_TypeChecker_Env.identifier_info =
                             (uu___237_17374.FStar_TypeChecker_Env.identifier_info)
                         }) t in
                    (match uu____17366 with
                     | (uu____17375,ty,uu____17377) ->
                         eta_expand_with_type env t ty)))
      ...
      fun binders  ->
        fun tc  ->
          let t =
            ...
            | (uu____17455,FStar_Util.Inr c) ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_arrow (binders, c))
                  FStar_Pervasives_Native.None c.FStar_Syntax_Syntax.pos
            | (uu____17461,FStar_Util.Inl t) ->
                let uu____17467 =
                  let uu____17470 =
                    let uu____17471 =
                      let uu____17484 = FStar_Syntax_Syntax.mk_Total t in
                      (binders, uu____17484) in
                    FStar_Syntax_Syntax.Tm_arrow uu____17471 in
                  FStar_Syntax_Syntax.mk uu____17470 in
                uu____17467 FStar_Pervasives_Native.None
                  t.FStar_Syntax_Syntax.pos in
          let uu____17488 = FStar_Syntax_Subst.open_univ_vars univ_names t in
          ...
          | (univ_names1,t1) ->
              ...
              let uu____17515 =
                ...
                | uu____17570 ->
                    let uu____17571 =
                      let uu____17580 =
                        let uu____17581 = FStar_Syntax_Subst.compress t3 in
                        uu____17581.FStar_Syntax_Syntax.n in
                      (uu____17580, tc) in
                    (match uu____17571 with
                     | (FStar_Syntax_Syntax.Tm_arrow
                        (binders1,c),FStar_Util.Inr uu____17606) ->
                         (binders1, (FStar_Util.Inr c))
                     | (FStar_Syntax_Syntax.Tm_arrow
                        (binders1,c),FStar_Util.Inl uu____17643) ->
                         (binders1,
                           (FStar_Util.Inl (FStar_Syntax_Util.comp_result c)))
                     | (uu____17682,FStar_Util.Inl uu____17683) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____17706 -> failwith "Impossible") in
      ...
      fun binders  ->
        fun t  ->
          ...
          | (univ_names1,binders1,tc) ->
              let uu____17873 = FStar_Util.left tc in
              (univ_names1, binders1, uu____17873)
    ...
    fun univ_names  ->
      fun binders  ->
        fun c  ->
          ...
          | (univ_names1,binders1,tc) ->
              let uu____17972 = FStar_Util.right tc in
              (univ_names1, binders1, uu____17972)
let rec elim_uvars:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun s  ->
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          let uu____18007 = elim_uvars_aux_t env univ_names binders typ in
          (match uu____18007 with
           | (univ_names1,binders1,typ1) ->
               let uu___238_18035 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_inductive_typ
                      (lid, univ_names1, binders1, typ1, lids, lids'));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___238_18035.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___238_18035.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___238_18035.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___238_18035.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_bundle (sigs,lids) ->
          let uu___239_18056 = s in
          let uu____18057 =
            let uu____18058 =
              let uu____18067 = FStar_List.map (elim_uvars env) sigs in
              (uu____18067, lids) in
            FStar_Syntax_Syntax.Sig_bundle uu____18058 in
          {
            FStar_Syntax_Syntax.sigel = uu____18057;
            FStar_Syntax_Syntax.sigrng =
              (uu___239_18056.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___239_18056.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___239_18056.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___239_18056.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_datacon (lid,univ_names,typ,lident,i,lids) ->
          let uu____18084 = elim_uvars_aux_t env univ_names [] typ in
          (match uu____18084 with
           | (univ_names1,uu____18102,typ1) ->
               let uu___240_18116 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_datacon
                      (lid, univ_names1, typ1, lident, i, lids));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___240_18116.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___240_18116.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___240_18116.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___240_18116.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,univ_names,typ) ->
          let uu____18122 = elim_uvars_aux_t env univ_names [] typ in
          (match uu____18122 with
           | (univ_names1,uu____18140,typ1) ->
               let uu___241_18154 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_declare_typ
                      (lid, univ_names1, typ1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___241_18154.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___241_18154.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___241_18154.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___241_18154.FStar_Syntax_Syntax.sigattrs)
               })
                    ...
                    | (opening,lbunivs) ->
                        let elim t =
                          let uu____18211 =
                            ...
                            remove_uvar_solutions env uu____18212 in
                          FStar_Syntax_Subst.close_univ_vars lbunivs
                            uu____18211 in
                        let lbtyp = elim lb.FStar_Syntax_Syntax.lbtyp in
                        let lbdef = elim lb.FStar_Syntax_Syntax.lbdef in
                        let uu___242_18215 = lb in
                        {
                          FStar_Syntax_Syntax.lbname =
                            (uu___242_18215.FStar_Syntax_Syntax.lbname);
                          FStar_Syntax_Syntax.lbunivs = lbunivs;
                          FStar_Syntax_Syntax.lbtyp = lbtyp;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___242_18215.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = lbdef
                        })) in
          let uu___243_18216 = s in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_let ((b, lbs1), lids));
            FStar_Syntax_Syntax.sigrng =
              (uu___243_18216.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___243_18216.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___243_18216.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___243_18216.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_main t ->
          let uu___244_18228 = s in
          let uu____18229 =
            let uu____18230 = remove_uvar_solutions env t in
            FStar_Syntax_Syntax.Sig_main uu____18230 in
          {
            FStar_Syntax_Syntax.sigel = uu____18229;
            FStar_Syntax_Syntax.sigrng =
              (uu___244_18228.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___244_18228.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___244_18228.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___244_18228.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_assume (l,us,t) ->
          let uu____18234 = elim_uvars_aux_t env us [] t in
          (match uu____18234 with
           | (us1,uu____18252,t1) ->
               let uu___245_18266 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_assume (l, us1, t1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___245_18266.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___245_18266.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___245_18266.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___245_18266.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____18267 ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____18269 with
           | (univs1,binders,signature) ->
               let uu____18297 =
                 let uu____18306 = FStar_Syntax_Subst.univ_var_opening univs1 in
                 match uu____18306 with
                 | (univs_opening,univs2) ->
                     let uu____18333 =
                       FStar_Syntax_Subst.univ_var_closing univs2 in
                     (univs_opening, uu____18333) in
               (match uu____18297 with
                | (univs_opening,univs_closing) ->
                    let uu____18350 =
                      ...
                      (uu____18356, uu____18357) in
                    (match uu____18350 with
                     | (b_opening,b_closing) ->
                         let n1 = FStar_List.length univs1 in
                         let n_binders = FStar_List.length binders in
                         let elim_tscheme uu____18379 =
                                              ...
                                              let t2 =
                                                let uu____18463 =
                                                  FStar_Syntax_Subst.subst
                                                    b_opening1 t1 in
                                                FStar_Syntax_Subst.subst
                                                  univs_opening1 uu____18463 in
                                              let uu____18464 =
                                                elim_uvars_aux_t env [] [] t2 in
                                              (match uu____18464 with
                                               | (uu____18485,uu____18486,t3)
                                                   ->
                                                   let t4 =
                                                     let uu____18501 =
                                                       let uu____18502 =
                         ...
                         let elim_term t =
                           ...
                           | (uu____18520,uu____18521,t1) -> t1 in
                         let elim_action a =
                           ...
                           let destruct_action_body body =
                             ...
                             | FStar_Syntax_Syntax.Tm_ascribed
                                 ...
                                 -> (defn, typ)
                             | uu____18658 -> failwith "Impossible" in
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 (pars,body,uu____18709) ->
                                 let uu____18730 = destruct_action_body body in
                                 (match uu____18730 with
                                  | (defn,typ) -> (pars, defn, typ))
                             | uu____18775 ->
                                 let uu____18776 = destruct_action_body t in
                           ...
                           | (action_univs,t) ->
                               let uu____18834 = destruct_action_typ_templ t in
                               (match uu____18834 with
                                | (action_params,action_defn,action_typ) ->
                                    let a' =
                                      let uu___246_18875 = a in
                                      {
                                        FStar_Syntax_Syntax.action_name =
                                          (uu___246_18875.FStar_Syntax_Syntax.action_name);
                                        FStar_Syntax_Syntax.action_unqualified_name
                                          =
                                          (uu___246_18875.FStar_Syntax_Syntax.action_unqualified_name);
                         ...
                         let ed1 =
                               ...
                               ed.FStar_Syntax_Syntax.actions in
                           {
                             FStar_Syntax_Syntax.cattributes =
                               (uu___247_18877.FStar_Syntax_Syntax.cattributes);
                             FStar_Syntax_Syntax.mname =
                               (uu___247_18877.FStar_Syntax_Syntax.mname);
                             FStar_Syntax_Syntax.univs = univs1;
                             FStar_Syntax_Syntax.binders = binders;
                             FStar_Syntax_Syntax.signature = signature;
                             FStar_Syntax_Syntax.ret_wp = uu____18878;
                             FStar_Syntax_Syntax.bind_wp = uu____18879;
                             FStar_Syntax_Syntax.if_then_else = uu____18880;
                             FStar_Syntax_Syntax.ite_wp = uu____18881;
                             FStar_Syntax_Syntax.stronger = uu____18882;
                             FStar_Syntax_Syntax.close_wp = uu____18883;
                             FStar_Syntax_Syntax.assert_p = uu____18884;
                             FStar_Syntax_Syntax.assume_p = uu____18885;
                             FStar_Syntax_Syntax.null_wp = uu____18886;
                             FStar_Syntax_Syntax.trivial = uu____18887;
                             FStar_Syntax_Syntax.repr = uu____18888;
                             FStar_Syntax_Syntax.return_repr = uu____18889;
                             FStar_Syntax_Syntax.bind_repr = uu____18890;
                             FStar_Syntax_Syntax.actions = uu____18891
                           } in
                         let uu___248_18894 = s in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_new_effect ed1);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___248_18894.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___248_18894.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___248_18894.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___248_18894.FStar_Syntax_Syntax.sigattrs)
                         })))
      | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
          let elim_tscheme_opt uu___164_18911 =
            match uu___164_18911 with
            | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
            | FStar_Pervasives_Native.Some (us,t) ->
                let uu____18938 = elim_uvars_aux_t env us [] t in
                (match uu____18938 with
                 | (us1,uu____18962,t1) ->
                     FStar_Pervasives_Native.Some (us1, t1)) in
          let sub_eff1 =
            let uu___249_18981 = sub_eff in
            let uu____18982 =
              ...
              elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift in
            {
              FStar_Syntax_Syntax.source =
                (uu___249_18981.FStar_Syntax_Syntax.source);
              FStar_Syntax_Syntax.target =
                (uu___249_18981.FStar_Syntax_Syntax.target);
              FStar_Syntax_Syntax.lift_wp = uu____18982;
              FStar_Syntax_Syntax.lift = uu____18985
            } in
          let uu___250_18988 = s in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_sub_effect sub_eff1);
            FStar_Syntax_Syntax.sigrng =
              (uu___250_18988.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___250_18988.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___250_18988.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___250_18988.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_effect_abbrev
          (lid,univ_names,binders,comp,flags) ->
          let uu____18998 = elim_uvars_aux_c env univ_names binders comp in
          (match uu____18998 with
           | (univ_names1,binders1,comp1) ->
               let uu___251_19032 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_effect_abbrev
                      (lid, univ_names1, binders1, comp1, flags));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___251_19032.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___251_19032.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___251_19032.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___251_19032.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_pragma uu____19043 -> s