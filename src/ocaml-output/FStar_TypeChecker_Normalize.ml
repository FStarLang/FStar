           ...
           | FStar_Syntax_Syntax.Tm_app (hd1, args) when
               ...
               (if
                ...
                (let cfg' =
                   ...
                   {
                     FStar_TypeChecker_Cfg.steps =
                       (let uu___1271_9979 = cfg.FStar_TypeChecker_Cfg.steps in
                        {
                          FStar_TypeChecker_Cfg.beta =
           ...
           | FStar_Syntax_Syntax.Tm_match (head1, branches) ->
               ...
               then
                 let cfg' =
                   ...
                   {
                     FStar_TypeChecker_Cfg.steps =
                       (let uu___1556_12337 = cfg.FStar_TypeChecker_Cfg.steps in
                        {
                          FStar_TypeChecker_Cfg.beta =
           ...
           then
             ...
             (let t1 = maybe_simplify cfg env stack t in
              ...
              | (Abs (env', bs, env'', lopt, r))::stack1 ->
                  ...
                  let uu____23185 =
                    let uu___2744_23186 = FStar_Syntax_Util.abs bs1 t1 lopt1 in
                    {
                      FStar_Syntax_Syntax.n =
    ...
    fun t ->
      let t1 =
        ...
        | uu___3176_25956 ->
            ((let uu____25958 =
                let uu____25964 =
                  let uu____25966 = FStar_Util.message_of_exn uu___3176_25956 in
    ...
    fun c ->
      let c1 =
        ...
        | uu___3186_25995 ->
            ((let uu____25997 =
                let uu____26003 =
                  let uu____26005 = FStar_Util.message_of_exn uu___3186_25995 in
                  FStar_Util.format1 "Normalization failed with error %s\n"
                    uu____26005 in
