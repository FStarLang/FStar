...
let r_env = (let _147_748 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv _147_748))
...
let _53_1053 = (log cfg (fun _53_1052 -> (match (()) with
| () -> begin
(let _147_751 = (FStar_Syntax_Print.term_to_string t0)
...
(match (stack) with
| (UnivArgs (us', _53_1059))::stack -> begin
(

let env = (FStar_All.pipe_right us' (FStar_List.fold_left (fun env u -> (Univ (u))::env) env))
in (norm cfg env stack t))
end
| _53_1067 when (FStar_All.pipe_right cfg.steps (FStar_List.contains EraseUniverses)) -> begin
(norm cfg env stack t)
end
| _53_1069 -> begin
(let _147_755 = (let _147_754 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _147_754))
in (FStar_All.failwith _147_755))
end)
end else begin
(norm cfg env stack t)
end))
...
| () -> begin
(let _147_758 = (FStar_Syntax_Print.term_to_string t)
in (let _147_757 = (FStar_Syntax_Print.term_to_string t')
in (FStar_Util.print2 "Lazy hit: %s cached to %s\n" _147_758 _147_757)))
end)))
in (match ((let _147_759 = (FStar_Syntax_Subst.compress t')
in _147_759.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_abs (_53_1090) -> begin
(norm cfg env stack t')
end
| _53_1093 -> begin
(rebuild cfg env stack t')
...
| () -> begin
(let _147_763 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _147_763))
end)))
in (norm cfg ((c)::env) stack_rest body))
end
...
| () -> begin
(let _147_765 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _147_765))
end)))
in (norm cfg ((c)::env) stack_rest body))
end
| _53_1147 when (FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) -> begin
...
let _53_1150 = cfg
in {steps = (WHNF)::(Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = _53_1150.tcenv; delta_level = _53_1150.delta_level})
in (let _147_766 = (closure_as_term cfg env t)
in (rebuild cfg env stack _147_766)))
end)
end
| (_53_1155)::tl -> begin
(
...
| () -> begin
(let _147_768 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _147_768))
end)))
in (
...
let _53_1167 = cfg
in {steps = s; tcenv = _53_1167.tcenv; delta_level = dl}) env stack t)
end
| (MemoLazy (r))::stack -> begin
(

let _53_1173 = (set_memo r ((env), (t)))
in (

let _53_1176 = (log cfg (fun _53_1175 -> (match (()) with
| () -> begin
(let _147_770 = (FStar_Syntax_Print.term_to_string t)
...
(let _147_771 = (closure_as_term cfg env t)
in (rebuild cfg env stack _147_771))
end else begin
(

let _53_1206 = (FStar_Syntax_Subst.open_term' bs body)
in (match (_53_1206) with
| (bs, body, opening) -> begin
(

let lopt = (match (lopt) with
| Some (FStar_Util.Inl (l)) -> begin
(let _147_777 = (let _147_775 = (let _147_773 = (let _147_772 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _147_772))
in (FStar_All.pipe_right _147_773 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _147_775 (fun _147_774 -> FStar_Util.Inl (_147_774))))
in (FStar_All.pipe_right _147_777 (fun _147_776 -> Some (_147_776))))
end
| _53_1211 -> begin
lopt
end)
...
let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _53_1214 -> (Dummy)::env) env))
in (

let _53_1218 = (log cfg (fun _53_1217 -> (match (()) with
| () -> begin
(let _147_781 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
let stack = (FStar_All.pipe_right stack (FStar_List.fold_right (fun _53_1226 stack -> (match (_53_1226) with
| (a, aq) -> begin
(let _147_788 = (let _147_787 = (let _147_786 = (let _147_785 = (let _147_784 = (FStar_Util.mk_ref None)
in ((env), (a), (_147_784), (false)))
in Clos (_147_785))
in ((_147_786), (aq), (t.FStar_Syntax_Syntax.pos)))
in Arg (_147_787))
in (_147_788)::stack)
end)) args))
in (
...
| () -> begin
(let _147_790 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
let _53_1240 = x
in {FStar_Syntax_Syntax.ppname = _53_1240.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1240.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t.FStar_Syntax_Syntax.pos)
...
let _53_1248 = (FStar_Syntax_Subst.open_term ((((x), (None)))::[]) f)
in (match (_53_1248) with
| (closing, f) -> begin
(
...
let t = (let _147_794 = (let _147_793 = (let _147_792 = (FStar_Syntax_Subst.close closing f)
in (((

let _53_1250 = x
in {FStar_Syntax_Syntax.ppname = _53_1250.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1250.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_147_792)))
in FStar_Syntax_Syntax.Tm_refine (_147_793))
in (mk _147_794 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if (FStar_List.contains WHNF cfg.steps) then begin
(let _147_795 = (closure_as_term cfg env t)
in (rebuild cfg env stack _147_795))
end else begin
(

let _53_1259 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_53_1259) with
| (bs, c) -> begin
(

let c = (let _147_798 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _53_1261 -> (Dummy)::env) env))
in (norm_comp cfg _147_798 c))
in (

let t = (let _147_799 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _147_799 c))
in (rebuild cfg env stack t)))
end))
end
end
...
let _53_1292 = (log cfg (fun _53_1291 -> (match (()) with
| () -> begin
...
(let _147_801 = (norm cfg env [] t)
in FStar_Util.Inl (_147_801))
end
| FStar_Util.Inr (c) -> begin
(let _147_802 = (norm_comp cfg env c)
in FStar_Util.Inr (_147_802))
end)
in (let _147_803 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t1), (tc), (l)))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _147_803)))))
end)
end
| FStar_Syntax_Syntax.Tm_match (head, branches) -> begin
(
...
| FStar_Syntax_Syntax.Tm_let ((_53_1305, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (_53_1317); FStar_Syntax_Syntax.lbunivs = _53_1315; FStar_Syntax_Syntax.lbtyp = _53_1313; FStar_Syntax_Syntax.lbeff = _53_1311; FStar_Syntax_Syntax.lbdef = _53_1309})::_53_1307), _53_1323) -> begin
(rebuild cfg env stack t)
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), body) -> begin
(
...
let env = (let _147_806 = (let _147_805 = (let _147_804 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (_147_804), (false)))
in Clos (_147_805))
in (_147_806)::env)
...
let _53_1337 = (let _147_809 = (let _147_808 = (let _147_807 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _147_807 FStar_Syntax_Syntax.mk_binder))
in (_147_808)::[])
in (FStar_Syntax_Subst.open_term _147_809 body))
...
let _53_1338 = lb
in (let _147_815 = (let _147_812 = (let _147_810 = (FStar_List.hd bs)
in (FStar_All.pipe_right _147_810 Prims.fst))
in (FStar_All.pipe_right _147_812 (fun _147_811 -> FStar_Util.Inl (_147_811))))
in (let _147_814 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (let _147_813 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _147_815; FStar_Syntax_Syntax.lbunivs = _53_1338.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _147_814; FStar_Syntax_Syntax.lbeff = _53_1338.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _147_813}))))
in (

let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _53_1342 -> (Dummy)::env) env))
...
(let _147_818 = (closure_as_term cfg env t)
in (rebuild cfg env stack _147_818))
end
| FStar_Syntax_Syntax.Tm_let (lbs, body) -> begin
(

let _53_1368 = (FStar_List.fold_right (fun lb _53_1357 -> (match (_53_1357) with
| (rec_env, memos, i) -> begin
(

let f_i = (let _147_821 = (

let _53_1358 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = _53_1358.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = _53_1358.FStar_Syntax_Syntax.sort})
in (FStar_Syntax_Syntax.bv_to_tm _147_821))
in (
...
| (rec_env, memos, _53_1367) -> begin
(

let _53_1371 = (FStar_List.map2 (fun lb memo -> (FStar_ST.op_Colon_Equals memo (Some (((rec_env), (lb.FStar_Syntax_Syntax.lbdef)))))) (Prims.snd lbs) memos)
in (

let body_env = (FStar_List.fold_right (fun lb env -> (let _147_828 = (let _147_827 = (let _147_826 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (_147_826), (false)))
in Clos (_147_827))
in (_147_828)::env)) (Prims.snd lbs) env)
...
let _53_1386 = cfg
in {steps = (FStar_List.append ((NoInline)::(Exclude (Zeta))::[]) cfg.steps); tcenv = _53_1386.tcenv; delta_level = FStar_TypeChecker_Env.NoDelta})
...
let _53_1394 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = _53_1394.tcenv; delta_level = FStar_TypeChecker_Env.OnlyInline})
...
| _53_1398 -> begin
(match (stack) with
| (_53_1402)::_53_1400 -> begin
(match (m) with
| FStar_Syntax_Syntax.Meta_labeled (l, r, _53_1407) -> begin
...
let m = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (args) -> begin
(let _147_829 = (norm_pattern_args cfg env args)
in FStar_Syntax_Syntax.Meta_pattern (_147_829))
end
| _53_1421 -> begin
m
end)
...
and norm_pattern_args : cfg  ->  env  ->  FStar_Syntax_Syntax.args Prims.list  ->  FStar_Syntax_Syntax.args Prims.list = (fun cfg env args -> (FStar_All.pipe_right args (FStar_List.map (FStar_List.map (fun _53_1429 -> (match (_53_1429) with
| (a, imp) -> begin
(let _147_834 = (norm cfg env [] a)
in ((_147_834), (imp)))
end))))))
...
in FStar_Syntax_Syntax.Total (_147_840))
in {FStar_Syntax_Syntax.n = _147_841; FStar_Syntax_Syntax.tk = _53_1438.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1438.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1438.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let _53_1444 = comp
in (let _147_845 = (let _147_844 = (let _147_843 = (norm cfg env [] t)
in (let _147_842 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_147_843), (_147_842))))
in FStar_Syntax_Syntax.GTotal (_147_844))
in {FStar_Syntax_Syntax.n = _147_845; FStar_Syntax_Syntax.tk = _53_1444.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1444.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1444.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let norm_args = (fun args -> (FStar_All.pipe_right args (FStar_List.map (fun _53_1452 -> (match (_53_1452) with
| (a, i) -> begin
...
| FStar_Syntax_Syntax.DECREASES (t) -> begin
(let _147_851 = (norm cfg env [] t)
in FStar_Syntax_Syntax.DECREASES (_147_851))
end
| f -> begin
f
end))))
...
let _53_1458 = comp
in (let _147_856 = (let _147_855 = (

let _53_1460 = ct
in (let _147_854 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _147_853 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _147_852 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _147_854; FStar_Syntax_Syntax.effect_name = _53_1460.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _147_853; FStar_Syntax_Syntax.effect_args = _147_852; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (_147_855))
in {FStar_Syntax_Syntax.n = _147_856; FStar_Syntax_Syntax.tk = _53_1458.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1458.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1458.FStar_Syntax_Syntax.vars}))))
end)))
...
let _53_1467 = cfg
in {steps = (Inline)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = _53_1467.tcenv; delta_level = _53_1467.delta_level}) env [] t))
in (

let non_info = (fun t -> (let _147_864 = (norm t)
in (FStar_Syntax_Util.non_informative _147_864)))
in (match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (_53_1472) -> begin
c
end
...
let _53_1478 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = _53_1478.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1478.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1478.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let _53_1485 = ct
in {FStar_Syntax_Syntax.comp_univs = _53_1485.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = _53_1485.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _53_1485.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = _53_1485.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let _53_1489 = ct
in {FStar_Syntax_Syntax.comp_univs = _53_1489.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = _53_1489.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _53_1489.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = _53_1489.FStar_Syntax_Syntax.flags}))
end)
in (

let _53_1492 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct); FStar_Syntax_Syntax.tk = _53_1492.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _53_1492.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _53_1492.FStar_Syntax_Syntax.vars}))
end else begin
c
end)
end
...
and norm_binder : cfg  ->  env  ->  FStar_Syntax_Syntax.binder  ->  FStar_Syntax_Syntax.binder = (fun cfg env _53_1500 -> (match (_53_1500) with
| (x, imp) -> begin
(let _147_869 = (

let _53_1501 = x
in (let _147_868 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _53_1501.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1501.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_868}))
in ((_147_869), (imp)))
end))
and norm_binders : cfg  ->  env  ->  FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun cfg env bs -> (

let _53_1514 = (FStar_List.fold_left (fun _53_1508 b -> (match (_53_1508) with
| (nbs', env) -> begin
(
...
(let _147_880 = (let _147_879 = (let _147_878 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.lcomp_of_comp _147_878))
in FStar_Util.Inl (_147_879))
in Some (_147_880))
end else begin
(let _147_883 = (let _147_882 = (let _147_881 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.lcomp_of_comp _147_881))
in FStar_Util.Inl (_147_882))
in Some (_147_883))
end)
end else begin
Some (FStar_Util.Inr (lc.FStar_Syntax_Syntax.eff_name))
...
let _53_1535 = cfg
in {steps = s; tcenv = _53_1535.tcenv; delta_level = dl}) env stack t)
end
...
let _53_1548 = (set_memo r ((env), (t)))
in (

let _53_1551 = (log cfg (fun _53_1550 -> (match (()) with
| () -> begin
...
let _53_1574 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = _53_1574.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _53_1574.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = _53_1574.FStar_Syntax_Syntax.vars})
...
| (Arg (Clos (env, tm, m, _53_1610), aq, r))::stack -> begin
(

let _53_1619 = (log cfg (fun _53_1618 -> (match (()) with
| () -> begin
(let _147_892 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _147_893 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _147_893)))
end
| (Match (env, branches, r))::stack -> begin
(

let _53_1650 = (log cfg (fun _53_1649 -> (match (()) with
| () -> begin
(let _147_895 = (FStar_Syntax_Print.term_to_string t)
...
let norm_and_rebuild_match = (fun _53_1654 -> (match (()) with
| () -> begin
(
...
let _53_1656 = cfg
in (let _147_898 = (FStar_TypeChecker_Env.glb_delta cfg.delta_level FStar_TypeChecker_Env.OnlyInline)
in {steps = (Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = _53_1656.tcenv; delta_level = _147_898}))
in (
...
let rec norm_pat = (fun env p -> (match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_constant (_53_1666) -> begin
((p), (env))
end
| FStar_Syntax_Syntax.Pat_disj ([]) -> begin
(FStar_All.failwith "Impossible")
...
let _53_1676 = (norm_pat env hd)
in (match (_53_1676) with
| (hd, env') -> begin
(

let tl = (FStar_All.pipe_right tl (FStar_List.map (fun p -> (let _147_908 = (norm_pat env p)
in (Prims.fst _147_908)))))
in (((

let _53_1679 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = _53_1679.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _53_1679.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(

let _53_1696 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _53_1687 _53_1690 -> (match (((_53_1687), (_53_1690))) with
| ((pats, env), (p, b)) -> begin
(

let _53_1693 = (norm_pat env p)
...
let _53_1697 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = _53_1697.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _53_1697.FStar_Syntax_Syntax.p})), (env))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _53_1701.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1701.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_911}))
in (((

let _53_1704 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = _53_1704.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _53_1704.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _53_1708.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _53_1708.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_912}))
in (((

let _53_1711 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = _53_1711.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _53_1711.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t) -> begin
(
...
let _53_1721 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = _53_1721.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _53_1721.FStar_Syntax_Syntax.p})), (env))))
end))
in (
...
let _53_1730 = (FStar_Syntax_Subst.open_branch branch)
in (match (_53_1730) with
| (p, wopt, e) -> begin
(

let _53_1733 = (norm_pat env p)
in (match (_53_1733) with
| (p, env) -> begin
(
...
| Some (w) -> begin
(let _147_915 = (norm_or_whnf env w)
in Some (_147_915))
end)
in (
...
in (let _147_916 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
in (rebuild cfg env stack _147_916)))))))
end))
in (

let rec is_cons = (fun head -> (match (head.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uinst (h, _53_1744) -> begin
(is_cons h)
end
...
let _53_1786 = (FStar_Syntax_Util.head_and_args scrutinee)
...
| FStar_Syntax_Syntax.Pat_dot_term (_53_1809) -> begin
FStar_Util.Inl ([])
end
...
| _53_1816 -> begin
(let _147_933 = (not ((is_cons head)))
in FStar_Util.Inr (_147_933))
end)
end
| FStar_Syntax_Syntax.Pat_cons (fv, arg_pats) -> begin
(match ((let _147_934 = (FStar_Syntax_Util.un_uinst head)
in _147_934.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv') when (FStar_Syntax_Syntax.fv_eq fv fv') -> begin
(matches_args [] args arg_pats)
end
| _53_1824 -> begin
(let _147_935 = (not ((is_cons head)))
in FStar_Util.Inr (_147_935))
end)
end)
end))))
...
| (((t, _53_1834))::rest_a, ((p, _53_1840))::rest_p) -> begin
...
let _53_1866 = (log cfg (fun _53_1865 -> (match (()) with
| () -> begin
(let _147_946 = (FStar_Syntax_Print.pat_to_string p)
in (let _147_945 = (let _147_944 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _147_944 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _147_946 _147_945)))
end)))
in (

let env = (FStar_List.fold_left (fun env t -> (let _147_951 = (let _147_950 = (let _147_949 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_147_949), (false)))
in Clos (_147_950))
in (_147_951)::env)) env s)
in (let _147_952 = (guard_when_clause wopt b rest)
in (norm cfg env stack _147_952))))
end)
end))
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _147_964 = (config s e)
in (norm _147_964 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _147_971 = (config s e)
in (norm_comp _147_971 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _147_976 = (config [] env)
in (norm_universe _147_976 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _147_981 = (config [] env)
in (ghost_to_pure_aux _147_981 [] c)))
...
let non_info = (fun t -> (let _147_988 = (norm cfg [] [] t)
in (FStar_Syntax_Util.non_informative _147_988)))
...
let _53_1899 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = _53_1899.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _53_1899.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _53_1901 -> (match (()) with
| () -> begin
(let _147_990 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _147_990))
end))})
end
| None -> begin
lc
...
let term_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string = (fun env t -> (let _147_995 = (normalize ((AllowUnboundUniverses)::[]) env t)
in (FStar_Syntax_Print.term_to_string _147_995)))


let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (let _147_1001 = (let _147_1000 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _147_1000 [] c))
in (FStar_Syntax_Print.comp_to_string _147_1001)))
...
(let _147_1012 = (let _147_1011 = (let _147_1010 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_147_1010)))
in FStar_Syntax_Syntax.Tm_refine (_147_1011))
in (mk _147_1012 t0.FStar_Syntax_Syntax.pos))
end
| _53_1924 -> begin
t
end))
...
let _53_1933 = (FStar_Syntax_Util.arrow_formals_comp sort)
...
let _53_1939 = (FStar_All.pipe_right binders FStar_Syntax_Util.args_of_binders)
in (match (_53_1939) with
| (binders, args) -> begin
(let _147_1023 = (FStar_Syntax_Syntax.mk_Tm_app t args None t.FStar_Syntax_Syntax.pos)
...
in (FStar_Syntax_Util.abs binders _147_1023 _147_1022)))
end))
end)
end)))
in (match ((let _147_1024 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_147_1024), (t.FStar_Syntax_Syntax.n)))) with
| (Some (sort), _53_1943) -> begin
(let _147_1025 = (mk sort t.FStar_Syntax_Syntax.pos)
in (expand _147_1025))
end
| (_53_1946, FStar_Syntax_Syntax.Tm_name (x)) -> begin
(expand x.FStar_Syntax_Syntax.sort)
end
| _53_1951 -> begin
(

let _53_1954 = (FStar_Syntax_Util.head_and_args t)
in (match (_53_1954) with
| (head, args) -> begin
(match ((let _147_1026 = (FStar_Syntax_Subst.compress head)
in _147_1026.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (_53_1956, thead) -> begin
(

let _53_1962 = (FStar_Syntax_Util.arrow_formals thead)
...
let _53_1970 = (env.FStar_TypeChecker_Env.type_of (

let _53_1963 = env
in {FStar_TypeChecker_Env.solver = _53_1963.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _53_1963.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _53_1963.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _53_1963.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _53_1963.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _53_1963.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = _53_1963.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _53_1963.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _53_1963.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _53_1963.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _53_1963.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _53_1963.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _53_1963.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _53_1963.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _53_1963.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _53_1963.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _53_1963.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _53_1963.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _53_1963.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _53_1963.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = _53_1963.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (_53_1970) with
| (_53_1966, ty, _53_1969) -> begin
(expand ty)
end))
end
end))
...
let _53_1980 = (env.FStar_TypeChecker_Env.type_of (

let _53_1973 = env
in {FStar_TypeChecker_Env.solver = _53_1973.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _53_1973.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _53_1973.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _53_1973.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _53_1973.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _53_1973.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = _53_1973.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _53_1973.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _53_1973.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _53_1973.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _53_1973.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _53_1973.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _53_1973.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _53_1973.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _53_1973.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _53_1973.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _53_1973.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _53_1973.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _53_1973.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _53_1973.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = _53_1973.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (_53_1980) with
| (_53_1976, ty, _53_1979) -> begin
(expand ty)
end))
end)
end))
