...
let mk:
  'Auu____628 'Auu____629 .
    'Auu____629 ->
      FStar_Range.range ->
        ('Auu____629,'Auu____628) FStar_Syntax_Syntax.syntax
  =
  fun t  -> fun r  -> FStar_Syntax_Syntax.mk t FStar_Pervasives_Native.None r
let set_memo:
  'Auu____648 .
    'Auu____648 FStar_Pervasives_Native.option FStar_ST.ref ->
      'Auu____648 -> Prims.unit
  =
  fun r  ->
    fun t  ->
...
let is_empty: 'Auu____758 . 'Auu____758 Prims.list -> Prims.bool =
  fun uu___132_763  ->
    match uu___132_763 with | [] -> true | uu____765 -> false
let lookup_bvar:
  'Auu____770 .
    'Auu____770 Prims.list -> FStar_Syntax_Syntax.bv -> 'Auu____770
  =
  fun env  ->
    fun x  ->
  ...
  let arg_as_int uu____2441 =
    ...
    | (a,uu____2446) ->
        ...
        (match uu____2448 with
         ...
         | uu____2460 -> FStar_Pervasives_Native.None) in
  let arg_as_bounded_int uu____2469 =
    ...
    | (a,uu____2476) ->
        ...
        (match uu____2480 with
         ...
         | uu____2532 -> FStar_Pervasives_Native.None) in
  let arg_as_bool uu____2541 =
    ...
    | (a,uu____2546) ->
        ...
        (match uu____2548 with
         ...
         | uu____2554 -> FStar_Pervasives_Native.None) in
  let arg_as_char uu____2561 =
    ...
    | (a,uu____2566) ->
        ...
        (match uu____2568 with
         ...
         | uu____2574 -> FStar_Pervasives_Native.None) in
    ...
    FStar_All.pipe_right bounded_int_types
      (FStar_List.collect
         (fun m  ->
            ...
            let uu____3623 =
              let uu____3633 =
                let uu____3642 = FStar_Parser_Const.p2l ["FStar"; m; "sub"] in
              ...
              let uu____3669 =
                let uu____3679 =
                  let uu____3688 = FStar_Parser_Const.p2l ["FStar"; m; "mul"] in
...
let is_norm_request:
  'Auu____5974 .
    FStar_Syntax_Syntax.term -> 'Auu____5974 Prims.list -> Prims.bool
  =
  fun hd1  ->
    fun args  ->
      let uu____5985 =
...
let get_norm_request:
  'Auu____6008 'Auu____6009 .
    ('Auu____6009,'Auu____6008) FStar_Pervasives_Native.tuple2 Prims.list ->
      'Auu____6009
  =
  fun args  ->
    match args with
            ...
            (fun uu____6181  ->
               ...
               let uu____6184 =
                 let uu____6185 =
                   ...
                   FStar_All.pipe_left FStar_Pervasives_Native.fst uu____6187 in
