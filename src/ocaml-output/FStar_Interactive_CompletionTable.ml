    ...
    fun id1  ->
      fun v1  ->
        ...
        | (bt,name_collections1) ->
            let uu____2518 =
              let uu____2521 = btree_insert_replace bt id1 v1 in
              Names uu____2521 in
        ...
        (fun tr1  ->
           fun uu____2801  ->
             fun uu____2802  ->
               fun uu____2803  ->
                 fun namespaces  ->
                   let uu___170_2812 = tr1 in
                   { bindings = (uu___170_2812.bindings); namespaces })
      ...
      fun id1  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2855  ->
                 let uu___171_2858 = tr1 in
                 let uu____2861 = names_insert tr1.bindings id1 v1 in
                 {
                   bindings = uu____2861;
                   namespaces = (uu___171_2858.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___172_2981 = tr1 in
                 {
                   bindings = ((ImportedNames (label, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___172_2981.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___173_3026 = tr1 in
                 {
                   bindings = (uu___173_3026.bindings);
      ...
      let matching_values_per_collection_with_imports =
        ...
        | NSTPrefix "" ->
            names_revmap (btree_find_all (FStar_Pervasives_Native.Some ""))
              names1
        | NSTPrefix id2 ->
            names_revmap (fun bt  -> btree_find_prefix bt id2) names1 in
...
let insert: table -> query -> Prims.string -> lid_symbol -> table =
  fun tbl  ->
    fun host_query  ->
      fun id1  ->
        fun c  ->
          let uu___174_3947 = tbl in
          let uu____3948 = trie_insert tbl.tbl_lids host_query id1 c in
          { tbl_lids = uu____3948; tbl_mods = (uu___174_3947.tbl_mods) }
let register_alias: table -> Prims.string -> query -> query -> table =
  fun tbl  ->
    fun key  ->
      fun host_query  ->
        fun included_query  ->
          let uu___175_3967 = tbl in
          let uu____3968 =
            trie_add_alias tbl.tbl_lids key host_query included_query in
          { tbl_lids = uu____3968; tbl_mods = (uu___175_3967.tbl_mods) }
let register_include: table -> query -> query -> table =
  fun tbl  ->
    fun host_query  ->
      fun included_query  ->
        let uu___176_3983 = tbl in
        let uu____3984 = trie_include tbl.tbl_lids host_query included_query in
        { tbl_lids = uu____3984; tbl_mods = (uu___176_3983.tbl_mods) }
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___177_4004 = tbl in
             let uu____4005 =
               trie_open_namespace tbl.tbl_lids host_query included_query in
             { tbl_lids = uu____4005; tbl_mods = (uu___177_4004.tbl_mods) })
      ...
      fun path  ->
        fun mod_query  ->
          let ins_ns id1 bindings full_name loaded1 =
            let uu____4045 =
              let uu____4052 = names_find_exact bindings id1 in
          ...
          let ins id1 q revq bindings loaded1 =
            ...
            | uu____4145 -> ins_ns id1 bindings name loaded1 in
          let uu___178_4151 = tbl in
          let uu____4152 =
              ...
              (fun tr  ->
                 fun id1  ->
                   fun q  ->
                     fun revq  ->
                       fun namespaces  ->
                         let uu___179_4174 = tr in
                         let uu____4177 = ins id1 q revq tr.bindings loaded in
                         { bindings = uu____4177; namespaces })
              (fun tr  -> fun uu____4188  -> tr) in
          { tbl_lids = (uu___178_4151.tbl_lids); tbl_mods = uu____4152 }
