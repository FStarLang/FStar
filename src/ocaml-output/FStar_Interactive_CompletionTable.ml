        ...
        (fun tr1  ->
           fun uu____2709  ->
             fun uu____2710  ->
               fun uu____2711  ->
                 fun namespaces  ->
                   let uu___533_2720 = tr1 in
                   { bindings = (uu___533_2720.bindings); namespaces })
      ...
      fun id  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2758  ->
                 let uu___534_2761 = tr1 in
                 let uu____2764 = names_insert tr1.bindings id v1 in
                 {
                   bindings = uu____2764;
                   namespaces = (uu___534_2761.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___535_2875 = tr1 in
                 {
                   bindings = ((ImportedNames (label1, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___535_2875.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___536_2916 = tr1 in
                 {
                   bindings = (uu___536_2916.bindings);
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___540_3837 = tbl in
             let uu____3838 =
               trie_open_namespace tbl.tbl_lids host_query included_query in
             { tbl_lids = uu____3838; tbl_mods = (uu___540_3837.tbl_mods) })
