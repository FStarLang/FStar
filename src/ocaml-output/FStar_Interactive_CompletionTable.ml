        ...
        (fun tr1  ->
           fun uu____2709  ->
             fun uu____2710  ->
               fun uu____2711  ->
                 fun namespaces  ->
                   let uu___40_2720 = tr1  in
                   { bindings = (uu___40_2720.bindings); namespaces })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___42_2875 = tr1  in
                 {
                   bindings = ((ImportedNames (label, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___42_2875.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___43_2916 = tr1  in
                 {
                   bindings = (uu___43_2916.bindings);
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___47_3837 = tbl  in
             let uu____3838 =
               trie_open_namespace tbl.tbl_lids host_query included_query  in
             { tbl_lids = uu____3838; tbl_mods = (uu___47_3837.tbl_mods) })
