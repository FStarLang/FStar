        ...
        (fun tr1  ->
           fun uu____2693  ->
             fun uu____2694  ->
               fun uu____2695  ->
                 fun namespaces  ->
                   let uu___536_2704 = tr1 in
                   { bindings = (uu___536_2704.bindings); namespaces })
      ...
      fun id  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2742  ->
                 let uu___537_2745 = tr1 in
                 let uu____2748 = names_insert tr1.bindings id v1 in
                 {
                   bindings = uu____2748;
                   namespaces = (uu___537_2745.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___538_2859 = tr1 in
                 {
                   bindings = ((ImportedNames (label1, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___538_2859.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___539_2900 = tr1 in
                 {
                   bindings = (uu___539_2900.bindings);
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___543_3820 = tbl in
             let uu____3821 =
               trie_open_namespace tbl.tbl_lids host_query included_query in
             { tbl_lids = uu____3821; tbl_mods = (uu___543_3820.tbl_mods) })
