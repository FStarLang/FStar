    ...
    fun ns  ->
      let uu____2100 =
        ...
        | (Names bt)::names2 ->
            ...
            (uu____2150, (FStar_Pervasives_Native.Some names2))
        | (ImportedNames (uu____2165,names2))::more_names ->
            let uu____2182 = names_find_exact names2 ns in
        ...
        (fun tr1  ->
           fun uu____2709  ->
             fun uu____2710  ->
               fun uu____2711  ->
                 fun namespaces  ->
                   let uu___534_2720 = tr1 in
                   { bindings = (uu___534_2720.bindings); namespaces })
      ...
      fun id  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2758  ->
                 let uu___535_2761 = tr1 in
                 let uu____2764 = names_insert tr1.bindings id v1 in
                 {
                   bindings = uu____2764;
                   namespaces = (uu___535_2761.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        fun mutator  ->
          ...
          trie_mutate_leaf tr host_query
            (fun tr1  -> fun uu____2838  -> mutator tr1 included_trie label1)
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___536_2875 = tr1 in
                 {
                   bindings = ((ImportedNames (label1, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___536_2875.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___537_2916 = tr1 in
                 {
                   bindings = (uu___537_2916.bindings);
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___541_3837 = tbl in
             let uu____3838 =
               trie_open_namespace tbl.tbl_lids host_query included_query in
             { tbl_lids = uu____3838; tbl_mods = (uu___541_3837.tbl_mods) })
