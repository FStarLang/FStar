        ...
        (fun tr1  ->
           fun uu____2801  ->
             fun uu____2802  ->
               fun uu____2803  ->
                 fun namespaces  ->
                   let uu___181_2812 = tr1 in
                   { bindings = (uu___181_2812.bindings); namespaces })
      ...
      fun id  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2855  ->
                 let uu___182_2858 = tr1 in
                 let uu____2861 = names_insert tr1.bindings id v1 in
                 {
                   bindings = uu____2861;
                   namespaces = (uu___182_2858.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___183_2981 = tr1 in
                 {
                   bindings = ((ImportedNames (label, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___183_2981.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___184_3026 = tr1 in
                 {
                   bindings = (uu___184_3026.bindings);
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___188_4004 = tbl in
             let uu____4005 =
               trie_open_namespace tbl.tbl_lids host_query included_query in
             { tbl_lids = uu____4005; tbl_mods = (uu___188_4004.tbl_mods) })
