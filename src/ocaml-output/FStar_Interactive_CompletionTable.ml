        ...
        (fun tr1  ->
           fun uu____2693  ->
             fun uu____2694  ->
               fun uu____2695  ->
                 fun namespaces  ->
                   let uu___532_2704 = tr1 in
                   { bindings = (uu___532_2704.bindings); namespaces })
      ...
      fun id  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2742  ->
                 let uu___533_2745 = tr1 in
                 let uu____2748 = names_insert tr1.bindings id v1 in
                 {
                   bindings = uu____2748;
                   namespaces = (uu___533_2745.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___534_2859 = tr1 in
                 {
                   bindings = ((ImportedNames (label1, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___534_2859.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___535_2900 = tr1 in
                 {
                   bindings = (uu___535_2900.bindings);
