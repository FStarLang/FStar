    ...
    fun id1  ->
      fun v1  ->
        ...
        | (bt,name_collections1) ->
            let uu____2414 =
              let uu____2417 = btree_insert_replace bt id1 v1 in
              Names uu____2417 in
        ...
        (fun tr1  ->
           fun uu____2693  ->
             fun uu____2694  ->
               fun uu____2695  ->
                 fun namespaces  ->
                   let uu___535_2704 = tr1 in
                   { bindings = (uu___535_2704.bindings); namespaces })
      ...
      fun id1  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2742  ->
                 let uu___536_2745 = tr1 in
                 let uu____2748 = names_insert tr1.bindings id1 v1 in
                 {
                   bindings = uu____2748;
                   namespaces = (uu___536_2745.namespaces)
                 })
let trie_import:
  'a .
    'a trie ->
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___537_2859 = tr1 in
                 {
                   bindings = ((ImportedNames (label1, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___537_2859.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label1  ->
                 let uu___538_2900 = tr1 in
                 {
                   bindings = (uu___538_2900.bindings);
...
let insert: table -> query -> Prims.string -> lid_symbol -> table =
  fun tbl  ->
    fun host_query  ->
      fun id1  ->
        fun c  ->
          let uu___539_3774 = tbl in
          let uu____3775 = trie_insert tbl.tbl_lids host_query id1 c in
          { tbl_lids = uu____3775; tbl_mods = (uu___539_3774.tbl_mods) }
let register_alias: table -> Prims.string -> query -> query -> table =
  fun tbl  ->
    fun key  ->
      fun host_query  ->
        fun included_query  ->
          let uu___540_3790 = tbl in
          let uu____3791 =
            trie_add_alias tbl.tbl_lids key host_query included_query in
          { tbl_lids = uu____3791; tbl_mods = (uu___540_3790.tbl_mods) }
let register_include: table -> query -> query -> table =
  fun tbl  ->
    fun host_query  ->
      fun included_query  ->
        let uu___541_3803 = tbl in
        let uu____3804 = trie_include tbl.tbl_lids host_query included_query in
        { tbl_lids = uu____3804; tbl_mods = (uu___541_3803.tbl_mods) }
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___542_3820 = tbl in
             let uu____3821 =
               trie_open_namespace tbl.tbl_lids host_query included_query in
             { tbl_lids = uu____3821; tbl_mods = (uu___542_3820.tbl_mods) })
      ...
      fun path  ->
        fun mod_query  ->
          let ins_ns id1 bindings full_name loaded1 =
            let uu____3857 =
              let uu____3864 = names_find_exact bindings id1 in
          ...
          let ins id1 q revq bindings loaded1 =
            ...
            | uu____3957 -> ins_ns id1 bindings name loaded1 in
          let uu___543_3963 = tbl in
          let uu____3964 =
              ...
              (fun tr  ->
                 fun id1  ->
                   fun q  ->
                     fun revq  ->
                       fun namespaces  ->
                         let uu___544_3986 = tr in
                         let uu____3989 = ins id1 q revq tr.bindings loaded in
                         { bindings = uu____3989; namespaces })
              (fun tr  -> fun uu____4000  -> tr) in
          { tbl_lids = (uu___543_3963.tbl_lids); tbl_mods = uu____3964 }
