...
let rec heap_merge_pairs : 'Auu____251 . ('Auu____251  ->  'Auu____251  ->  Prims.int)  ->  'Auu____251 heap Prims.list  ->  'Auu____251 heap = (fun cmp uu___171_271 -> (match (uu___171_271) with
| [] -> begin
EmptyHeap
end
| (h)::[] -> begin
...
let heap_peek : 'Auu____314 . 'Auu____314 heap  ->  'Auu____314 FStar_Pervasives_Native.option = (fun uu___172_322 -> (match (uu___172_322) with
| EmptyHeap -> begin
...
let heap_pop : 'Auu____341 . ('Auu____341  ->  'Auu____341  ->  Prims.int)  ->  'Auu____341 heap  ->  ('Auu____341 * 'Auu____341 heap) FStar_Pervasives_Native.option = (fun cmp uu___173_365 -> (match (uu___173_365) with
| EmptyHeap -> begin
FStar_Pervasives_Native.None
end
| Heap (v1, hh) -> begin
...
let push_nodup : 'Auu____447 . ('Auu____447  ->  Prims.string)  ->  'Auu____447  ->  'Auu____447 Prims.list  ->  'Auu____447 Prims.list = (fun key_fn x uu___174_466 -> (match (uu___174_466) with
| [] -> begin
(x)::[]
end
| (h)::t -> begin
...
let rec add_priorities : 'Auu____490 . Prims.int  ->  (Prims.int * 'Auu____490) Prims.list  ->  'Auu____490 Prims.list  ->  (Prims.int * 'Auu____490) Prims.list = (fun n1 acc uu___175_516 -> (match (uu___175_516) with
| [] -> begin
acc
end
| (h)::t -> begin
...
let uu___177_2812 = tr1
in {bindings = uu___177_2812.bindings; namespaces = namespaces}))))
...
let uu___178_2858 = tr1
in (

let uu____2861 = (names_insert tr1.bindings id v1)
in {bindings = uu____2861; namespaces = uu___178_2858.namespaces})))))
...
let uu___179_2981 = tr1
in {bindings = (ImportedNames (((label), (inc.bindings))))::tr1.bindings; namespaces = uu___179_2981.namespaces}))))
...
let uu___180_3026 = tr1
in {bindings = uu___180_3026.bindings; namespaces = (ImportedNames (((label), (inc.namespaces))))::tr1.namespaces}))))
...
let rec aux = (fun acc imports name_collections1 -> (FStar_List.fold_left (fun acc1 uu___176_3206 -> (match (uu___176_3206) with
| Names (bt) -> begin
(
...
let uu___184_4004 = tbl
in (

let uu____4005 = (trie_open_namespace tbl.tbl_lids host_query included_query)
in {tbl_lids = uu____4005; tbl_mods = uu___184_4004.tbl_mods}))
end))
