...
let to_string_l = (fun ( sep ) ( f ) ( l ) -> (let _105_953 = (Support.List.map f l)
in (Support.String.concat sep _105_953)))
...
in (Support.Microsoft.FStar.Util.format1 "(requires %s)" _105_960))
end
| Ensures ((t, _39_254)) -> begin
(let _105_961 = (term_to_string t)
in (Support.Microsoft.FStar.Util.format1 "(ensures %s)" _105_961))
end
| Labeled ((t, l, _39_260)) -> begin
(let _105_962 = (term_to_string t)
in (Support.Microsoft.FStar.Util.format2 "(labeled %s %s)" l _105_962))
end
| Const (c) -> begin
(Microsoft_FStar_Absyn_Print.const_to_string c)
end
| Op ((s, xs)) -> begin
(let _105_965 = (let _105_964 = (Support.List.map (fun ( x ) -> (Support.All.pipe_right x term_to_string)) xs)
in (Support.String.concat ", " _105_964))
in (Support.Microsoft.FStar.Util.format2 "%s(%s)" s _105_965))
end
| Tvar (id) -> begin
...
in (Support.Microsoft.FStar.Util.format2 "%s%s" (imp_to_string imp) _105_967))
end)) args)
in (Support.Microsoft.FStar.Util.format2 "(%s %s)" _105_969 _105_968)))
end
| Abs ((pats, t)) when (x.level = Expr) -> begin
(let _105_971 = (to_string_l " " pat_to_string pats)
in (let _105_970 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "(fun %s -> %s)" _105_971 _105_970)))
end
| Abs ((pats, t)) when (x.level = Type) -> begin
(let _105_973 = (to_string_l " " pat_to_string pats)
in (let _105_972 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "(fun %s => %s)" _105_973 _105_972)))
end
| App ((t1, t2, imp)) -> begin
(let _105_975 = (Support.All.pipe_right t1 term_to_string)
in (let _105_974 = (Support.All.pipe_right t2 term_to_string)
in (Support.Microsoft.FStar.Util.format3 "%s %s%s" _105_975 (imp_to_string imp) _105_974)))
end
| Let ((false, (pat, tm)::[], body)) -> begin
(let _105_978 = (Support.All.pipe_right pat pat_to_string)
in (let _105_977 = (Support.All.pipe_right tm term_to_string)
in (let _105_976 = (Support.All.pipe_right body term_to_string)
in (Support.Microsoft.FStar.Util.format3 "let %s = %s in %s" _105_978 _105_977 _105_976))))
end
| Let ((_39_304, lbs, body)) -> begin
(let _105_983 = (to_string_l " and " (fun ( _39_311 ) -> (match (_39_311) with
| (p, b) -> begin
(let _105_981 = (Support.All.pipe_right p pat_to_string)
in (let _105_980 = (Support.All.pipe_right b term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s=%s" _105_981 _105_980)))
end)) lbs)
in (let _105_982 = (Support.All.pipe_right body term_to_string)
in (Support.Microsoft.FStar.Util.format2 "let rec %s in %s" _105_983 _105_982)))
end
| Seq ((t1, t2)) -> begin
(let _105_985 = (Support.All.pipe_right t1 term_to_string)
in (let _105_984 = (Support.All.pipe_right t2 term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s; %s" _105_985 _105_984)))
end
| If ((t1, t2, t3)) -> begin
(let _105_988 = (Support.All.pipe_right t1 term_to_string)
in (let _105_987 = (Support.All.pipe_right t2 term_to_string)
in (let _105_986 = (Support.All.pipe_right t3 term_to_string)
in (Support.Microsoft.FStar.Util.format3 "if %s then %s else %s" _105_988 _105_987 _105_986))))
end
| Match ((t, branches)) -> begin
(let _105_995 = (Support.All.pipe_right t term_to_string)
in (let _105_994 = (to_string_l " | " (fun ( _39_328 ) -> (match (_39_328) with
| (p, w, e) -> begin
(let _105_993 = (Support.All.pipe_right p pat_to_string)
...
in (Support.Microsoft.FStar.Util.format1 "when %s" _105_990))
end)
in (let _105_991 = (Support.All.pipe_right e term_to_string)
in (Support.Microsoft.FStar.Util.format3 "%s %s -> %s" _105_993 _105_992 _105_991))))
end)) branches)
in (Support.Microsoft.FStar.Util.format2 "match %s with %s" _105_995 _105_994)))
end
| Ascribed ((t1, t2)) -> begin
(let _105_997 = (Support.All.pipe_right t1 term_to_string)
in (let _105_996 = (Support.All.pipe_right t2 term_to_string)
in (Support.Microsoft.FStar.Util.format2 "(%s : %s)" _105_997 _105_996)))
end
| Record ((Some (e), fields)) -> begin
(let _105_1002 = (Support.All.pipe_right e term_to_string)
in (let _105_1001 = (to_string_l " " (fun ( _39_343 ) -> (match (_39_343) with
| (l, e) -> begin
(let _105_1000 = (Microsoft_FStar_Absyn_Print.sli l)
in (let _105_999 = (Support.All.pipe_right e term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s=%s" _105_1000 _105_999)))
end)) fields)
in (Support.Microsoft.FStar.Util.format2 "{%s with %s}" _105_1002 _105_1001)))
end
...
in (let _105_1004 = (Support.All.pipe_right e term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s=%s" _105_1005 _105_1004)))
end)) fields)
in (Support.Microsoft.FStar.Util.format1 "{%s}" _105_1006))
end
| Project ((e, l)) -> begin
(let _105_1008 = (Support.All.pipe_right e term_to_string)
in (let _105_1007 = (Microsoft_FStar_Absyn_Print.sli l)
in (Support.Microsoft.FStar.Util.format2 "%s.%s" _105_1008 _105_1007)))
end
| Product (([], t)) -> begin
(term_to_string t)
end
...
(let _105_1010 = (Support.All.pipe_right b binder_to_string)
in (let _105_1009 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s -> %s" _105_1010 _105_1009)))
end
| Product ((b::[], t)) when (x.level = Kind) -> begin
(let _105_1012 = (Support.All.pipe_right b binder_to_string)
in (let _105_1011 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s => %s" _105_1012 _105_1011)))
end
| Sum ((binders, t)) -> begin
(let _105_1015 = (let _105_1013 = (Support.All.pipe_right binders (Support.List.map binder_to_string))
in (Support.All.pipe_right _105_1013 (Support.String.concat " * ")))
in (let _105_1014 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s * %s" _105_1015 _105_1014)))
end
| QForall ((bs, pats, t)) -> begin
(let _105_1018 = (to_string_l " " binder_to_string bs)
in (let _105_1017 = (to_string_l "; " term_to_string pats)
in (let _105_1016 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format3 "forall %s.{:pattern %s} %s" _105_1018 _105_1017 _105_1016))))
end
| QExists ((bs, pats, t)) -> begin
(let _105_1021 = (to_string_l " " binder_to_string bs)
in (let _105_1020 = (to_string_l "; " term_to_string pats)
in (let _105_1019 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format3 "exists %s.{:pattern %s} %s" _105_1021 _105_1020 _105_1019))))
end
| Refine ((b, t)) -> begin
(let _105_1023 = (Support.All.pipe_right b binder_to_string)
in (let _105_1022 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s:{%s}" _105_1023 _105_1022)))
end
| NamedTyp ((x, t)) -> begin
(let _105_1024 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s:%s" x.Microsoft_FStar_Absyn_Syntax.idText _105_1024))
end
| Paren (t) -> begin
(let _105_1025 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format1 "(%s)" _105_1025))
end
| Product ((bs, t)) -> begin
(let _105_1028 = (let _105_1026 = (Support.All.pipe_right bs (Support.List.map binder_to_string))
in (Support.All.pipe_right _105_1026 (Support.String.concat ",")))
in (let _105_1027 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "Unidentified product: [%s] %s" _105_1028 _105_1027)))
end
| t -> begin
...
(let _105_1030 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s:%s" i.Microsoft_FStar_Absyn_Syntax.idText _105_1030))
end
| NoName (t) -> begin
...
| PatApp ((p, ps)) -> begin
(let _105_1033 = (Support.All.pipe_right p pat_to_string)
in (let _105_1032 = (to_string_l " " pat_to_string ps)
in (Support.Microsoft.FStar.Util.format2 "(%s %s)" _105_1033 _105_1032)))
end
...
in (Support.Microsoft.FStar.Util.format1 "[%s]" _105_1034))
end
| PatTuple ((l, false)) -> begin
(let _105_1035 = (to_string_l ", " pat_to_string l)
in (Support.Microsoft.FStar.Util.format1 "(%s)" _105_1035))
end
| PatTuple ((l, true)) -> begin
(let _105_1036 = (to_string_l ", " pat_to_string l)
in (Support.Microsoft.FStar.Util.format1 "(|%s|)" _105_1036))
end
| PatRecord (l) -> begin
(let _105_1040 = (to_string_l "; " (fun ( _39_464 ) -> (match (_39_464) with
| (f, e) -> begin
(let _105_1039 = (Microsoft_FStar_Absyn_Print.sli f)
in (let _105_1038 = (Support.All.pipe_right e pat_to_string)
in (Support.Microsoft.FStar.Util.format2 "%s=%s" _105_1039 _105_1038)))
end)) l)
in (Support.Microsoft.FStar.Util.format1 "{%s}" _105_1040))
end
| PatOr (l) -> begin
(to_string_l "|\n " pat_to_string l)
end
| PatAscribed ((p, t)) -> begin
(let _105_1042 = (Support.All.pipe_right p pat_to_string)
in (let _105_1041 = (Support.All.pipe_right t term_to_string)
in (Support.Microsoft.FStar.Util.format2 "(%s:%s)" _105_1042 _105_1041)))
end))

let error = (fun ( msg ) ( tm ) ( r ) -> (let tm = (Support.All.pipe_right tm term_to_string)
in (let tm = (match (((Support.String.length tm) >= 80)) with
| true -> begin
(let _105_1046 = (Support.Microsoft.FStar.Util.substring tm 0 77)
in (Support.Prims.strcat _105_1046 "..."))
end
| false -> begin
tm
end)
in (raise (Microsoft_FStar_Absyn_Syntax.Error (((Support.Prims.strcat (Support.Prims.strcat msg "\n") tm), r)))))))
...
(match (t.tm) with
| Name (s) -> begin
(let _105_1108 = (let _105_1107 = (let _105_1106 = (Support.List.map (fun ( a ) -> (a, Nothing)) args)
in (s, _105_1106))
...
in (let focussed = (let _105_1121 = (Support.List.filter Support.Prims.fst branches)
in (Support.All.pipe_right _105_1121 (Support.List.map Support.Prims.snd)))
in (let _105_1123 = (let _105_1122 = (mkWildAdmitMagic r)
in (_105_1122)::[])
in (Support.List.append focussed _105_1123))))
end
| false -> begin
...
in ((Support.Prims.fst lb), _105_1127))
end)
end)) lbs))
end
| false -> begin
...
let mkFsTypApp = (fun ( t ) ( args ) ( r ) -> (let _105_1135 = (Support.List.map (fun ( a ) -> (a, FsTypApp)) args)
...
in (let _105_1141 = (Support.List.map (fun ( x ) -> (x, Nothing)) args)
...
in (let _105_1147 = (Support.List.map (fun ( x ) -> (x, Nothing)) args)
