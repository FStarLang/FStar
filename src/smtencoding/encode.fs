...
let escape_null_name a = a.ppname.idText ^ (a.index |> string_of_int)
...
let whnf env t = 
    ...
    else N.normalize [N.Beta; N.WHNF; N.Inline] env.tcenv t
let norm env t = N.normalize [N.Beta; N.Inline] env.tcenv t
