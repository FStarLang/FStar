...
and encode_binders_aux (fuel_opt:option term) (bs:Syntax.binders) (env:env_t) : ML
...
and encode_term_pred_aux (fuel_opt:option term) (t:typ) (env:env_t) (e:term) : ML (term & term & decls_t) =
