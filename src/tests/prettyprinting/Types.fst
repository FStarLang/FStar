...
type cm
  ...
  | CM :
    ...
    commutativity: (x: a -> y: a -> Lemma (mult x y == mult y x)) -> cm a
...
and cm2 (a: Type) (b: Type) (c: Type) (d: Type) (e: Type) (f: Type) =
  | CM2 :
    ...
    identity: (x: a -> Lemma (mult unit x == x)) ->
    associativity: (x: a -> y: a -> z: a -> Lemma (mult (mult x y) z == mult x (mult y z))) ->
    commutativity: (x: a -> y: a -> Lemma (mult x y == mult y x)) -> cm2 a
...
and cm3 (a: Type) : Type =
  | CM3 :
    ...
    identity: (x: a -> Lemma (mult unit x == x)) ->
    associativity: (x: a -> y: a -> z: a -> Lemma (mult (mult x y) z == mult x (mult y z))) ->
    commutativity: (x: a -> y: a -> Lemma (mult x y == mult y x)) -> cm3 a
