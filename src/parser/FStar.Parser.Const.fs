...
let trivial_pure_post_lid = pconst "trivial_pure_post"
...
let wp_req_ens_attr        = pconst "wp_req_ens_attr"
...
let as_requires_opaque = pconst "as_requires_opaque"
let as_ensures_opaque  = pconst "as_ensures_opaque"

let as_req_return       = pconst "as_requires_return"
let as_ens_return       = pconst "as_ensures_return"
let as_req_bind         = pconst "as_requires_bind"
let as_ens_bind         = pconst "as_ensures_bind"
let as_req_assume       = pconst "as_requires_assume"
let as_ens_assume       = pconst "as_ensures_assume"
let as_req_assert       = pconst "as_requires_assert"
let as_ens_assert       = pconst "as_ensures_assert"
let as_req_weaken       = pconst "as_requires_weaken"
let as_ens_weaken       = pconst "as_ensures_weaken"
let as_req_strengthen   = pconst "as_requires_strengthen"
let as_ens_strengthen   = pconst "as_ensures_strengthen"
let as_req_if_then_else = pconst "as_requires_if_then_else"
let as_ens_if_then_else = pconst "as_ensures_if_then_else"
let as_req_ite          = pconst "as_requires_ite"
let as_ens_ite          = pconst "as_ensures_ite"
let as_req_close        = pconst "as_requires_close"
let as_ens_close        = pconst "as_ensures_close"
let as_req_null         = pconst "as_requires_null"
let as_ens_null         = pconst "as_ensures_null"
