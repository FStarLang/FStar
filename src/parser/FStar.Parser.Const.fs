...
let as_requires_opaque = psconst "as_requires_opaque"
let as_ensures_opaque  = psconst "as_ensures_opaque"

let wp_req_ens_attr     = psconst "wp_req_ens_attr"

let as_req_return       = psconst "as_requires_return"
let as_ens_return       = psconst "as_ensures_return"
let as_req_bind         = psconst "as_requires_bind"
let as_ens_bind         = psconst "as_ensures_bind"
let as_req_assume       = psconst "as_requires_assume"
let as_ens_assume       = psconst "as_ensures_assume"
let as_req_assert       = psconst "as_requires_assert"
let as_ens_assert       = psconst "as_ensures_assert"
