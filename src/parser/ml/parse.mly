...
in
    ( x :: xs )}
| LBRACK_AT list_atomicTerm_ RBRACK list_decoration_
    {let (_10, x0, _30, xs) = ((), $2, (), $4) in
let x =
  let _3 = _30 in
  let x = x0 in
  let _1 = _10 in
...
kind_abbrev:
  KIND ident binders EQUALS kind
    {let (_1, _2, _3, _4, _5) = ((), $2, $3, (), $5) in
    (let (_1, lid, bs, _4, k) = ((), _2, _3, (), _5) in
      ( KindAbbrev(lid, bs, k) ))}
