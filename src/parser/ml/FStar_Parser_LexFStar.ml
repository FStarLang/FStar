...
and fsdoc (n, doc, kw) = lexer
 ...
 | newline "@" -> mknewline 1 lexbuf; fsdoc_kw (n,doc,kw) lexbuf
 | newline -> L.new_line lexbuf; fsdoc (n, doc^(L.lexeme lexbuf), kw) lexbuf
 | _ -> fsdoc(n, doc^(L.lexeme lexbuf), kw) lexbuf

and fsdoc_kw (n,doc,kw) = lexer
 | anywhite* -> fsdoc_kw (n,doc,kw) lexbuf
 | ['a'-'z' 'A'-'Z']+ -> fsdoc_kw_arg (n, doc, kw, L.lexeme lexbuf, "") lexbuf
