    ...
    fun x  ->
      ...
      | uu____196 ->
          ...
          (match uu____197 with
           | (ns,x1) ->
               let uu____202 = path_of_ns currentModule ns  in
               (uu____202, x1))
        ...
        | FStar_Extraction_ML_Syntax.MLE_Record (path,fields) ->
            let for1 uu____823 =
              ...
              | (name,e1) ->
                  ...
                  FStar_Format.reduce1 uu____831
               in
            let uu____836 =
        ...
        | FStar_Extraction_ML_Syntax.MLE_CTor (ctor,args) ->
            ...
            let doc1 =
              ...
              | (uu____880,uu____881) ->
                  ...
                  FStar_Format.reduce1 uu____884
               in
            ...
            let docs =
              FStar_List.map
                (fun x  ->
                   ...
                   FStar_Format.parens uu____895) es
               in
            let docs1 =
              let uu____899 =
             ...
             | (FStar_Extraction_ML_Syntax.MLE_Name
                p,{
                 ...
                 let branches =
                   ...
                   | e2 -> [(FStar_Extraction_ML_Syntax.MLP_Wild, None, e2)]
                    in
            ...
            let doc1 =
              ...
              then
                ...
                (let uu____1050 =
                   ...
                   e2 :: uu____1052  in
                 FStar_Format.reduce uu____1050)
               in
            doc1
            ...
            let ids1 =
              FStar_List.map
                (fun uu____1098  ->
                   ...
                   | ((x,uu____1104),xt) -> bvar_annot x (Some xt)) ids
               in
            let body1 =
              doc_of_expr currentModule (min_op_prec, NonAssoc) body  in
            let doc1 =
                ...
                let uu____1222 =
                  let uu____1224 =
                    let uu____1226 =
                      ...
                      FStar_Format.combine FStar_Format.hardline uu____1227
                       in
                    [uu____1226]  in
      ...
      | FStar_Extraction_ML_Syntax.MLP_Record (path,fields) ->
          let for1 uu____1303 =
            ...
            | (name,p) ->
                ...
                FStar_Format.reduce1 uu____1308
             in
          let uu____1318 =
      ...
      | (rec_,top_level,lets) ->
          let for1 uu____1446 =
            ...
            | { FStar_Extraction_ML_Syntax.mllb_name = name;
                ...
                let ids1 =
                  FStar_List.map
                    (fun uu____1466  ->
                       ...
                       | (x,uu____1470) -> FStar_Format.text x) ids
                   in
                let ty_annot =
                ...
                FStar_Format.reduce1 uu____1506
             in
          let letdoc =
                    ...
                    FStar_List.map
                      (fun x2  ->
                         let uu____1575 = FStar_Extraction_ML_Syntax.idsym x2
                            in
                         FStar_Format.text uu____1575) tparams
                     in
                  let uu____1576 =
                    FStar_Format.combine (FStar_Format.text ", ") doc1  in
                  FStar_Format.parens uu____1576
               in
            let forbody body1 =
              match body1 with
              ...
              | FStar_Extraction_ML_Syntax.MLTD_Record fields ->
                  ...
                  let uu____1602 =
                    ...
                    FStar_Format.combine (FStar_Format.text "; ") uu____1603
                     in
            ...
            (match body with
             ...
             | Some body1 ->
                 ...
                 let uu____1651 =
                   ...
                   [uu____1653; body2]  in
                 FStar_Format.combine FStar_Format.hardline uu____1651)
         in
    ...
    | FStar_Extraction_ML_Syntax.MLLib mllib ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1859  ->
                     ...
                     | (s,uu____1863) -> doc_of_sig x1 s) sigmod
                 in
                ...
                let uu____1880 =
                  ...
                  (match doc1 with
                   ...
                   | Some s -> FStar_Format.cat s FStar_Format.hardline) ::
                    uu____1882
                   in
                (FStar_Format.cat head1 FStar_Format.hardline) :: uu____1880
                 in
        ...
        and for1_mod istop uu____1887 =
          ...
          | (x,sigmod,FStar_Extraction_ML_Syntax.MLLib sub1) ->
              ...
              let doc1 =
                FStar_Option.map
                  (fun uu____1934  ->
                     ...
                     | (uu____1937,m) -> doc_of_mod x1 m) sigmod
                 in
              ...
              FStar_All.pipe_left FStar_Format.reduce uu____1958
         in
        let docs =
          FStar_List.map
            (fun uu____1990  ->
