...
let uu___is_V projectee =
  match projectee with | V v -> true | uu____382 -> false
...
let uu___is_Err projectee =
  match projectee with | Err msg -> true | uu____448 -> false
...
let raise uu____726 = failwith "Not yet implemented:raise"
...
type ('Aheap,'Aa,'Ax,'Ap,'Auu____831) all_return = 'Ap
...
let allow_inversion = ()
let invertOption uu____1093 = ()
type ('a,'b) either =
  | Inl of 'a
  | Inr of 'b
let uu___is_Inl projectee =
  match projectee with | Inl v -> true | uu____1130 -> false
let __proj__Inl__item__v projectee = match projectee with | Inl v -> v
let uu___is_Inr projectee =
  match projectee with | Inr v -> true | uu____1174 -> false
