...
(* This definition is ≡ to the one generated by F*'s extraction of the tactic
   effect.  We need it here to break a circular dependency between the compiler
   and ulib (cf. tactics meeting of 2017-08-03). *)
type 'a tactic = Prims.unit -> FStar_Tactics_Types.proofstate -> 'a __result
