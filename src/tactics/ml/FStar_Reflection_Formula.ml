...
type formula =
  ...
  FStar_Tactics_Types.term* FStar_Tactics_Types.term
  | And of FStar_Tactics_Types.term* FStar_Tactics_Types.term
  | Or of FStar_Tactics_Types.term* FStar_Tactics_Types.term
  | Not of FStar_Tactics_Types.term
  | Implies of FStar_Tactics_Types.term* FStar_Tactics_Types.term
  | Iff of FStar_Tactics_Types.term* FStar_Tactics_Types.term
  | Forall of FStar_Tactics_Types.binder* FStar_Tactics_Types.term
  | Exists of FStar_Tactics_Types.binder* FStar_Tactics_Types.term
  | App of FStar_Tactics_Types.term* FStar_Tactics_Types.term
  | Name of FStar_Tactics_Types.binder
  | FV of FStar_Tactics_Types.fv
  | IntLit of Prims.int
  | F_Unknown
let uu___is_True_: formula -> Prims.bool =
  fun projectee  -> match projectee with | True_  -> true | uu____96 -> false
let uu___is_False_: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | False_  -> true | uu____102 -> false
let uu___is_Comp: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Comp (_0,_1,_2,_3) -> true | uu____116 -> false
...
let __proj__Comp__item___2: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Comp (_0,_1,_2,_3) -> _2
let __proj__Comp__item___3: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Comp (_0,_1,_2,_3) -> _3
let uu___is_And: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | And (_0,_1) -> true | uu____190 -> false
let __proj__And__item___0: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | And (_0,_1) -> _0
let __proj__And__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | And (_0,_1) -> _1
let uu___is_Or: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Or (_0,_1) -> true | uu____224 -> false
let __proj__Or__item___0: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Or (_0,_1) -> _0
let __proj__Or__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Or (_0,_1) -> _1
let uu___is_Not: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Not _0 -> true | uu____256 -> false
let __proj__Not__item___0: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Not _0 -> _0
let uu___is_Implies: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Implies (_0,_1) -> true | uu____276 -> false
let __proj__Implies__item___0: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Implies (_0,_1) -> _0
let __proj__Implies__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Implies (_0,_1) -> _1
let uu___is_Iff: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Iff (_0,_1) -> true | uu____310 -> false
let __proj__Iff__item___0: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Iff (_0,_1) -> _0
let __proj__Iff__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Iff (_0,_1) -> _1
let uu___is_Forall: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Forall (_0,_1) -> true | uu____344 -> false
let __proj__Forall__item___0: formula -> FStar_Tactics_Types.binder =
  fun projectee  -> match projectee with | Forall (_0,_1) -> _0
let __proj__Forall__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Forall (_0,_1) -> _1
let uu___is_Exists: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Exists (_0,_1) -> true | uu____378 -> false
let __proj__Exists__item___0: formula -> FStar_Tactics_Types.binder =
  fun projectee  -> match projectee with | Exists (_0,_1) -> _0
let __proj__Exists__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | Exists (_0,_1) -> _1
let uu___is_App: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | App (_0,_1) -> true | uu____412 -> false
let __proj__App__item___0: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | App (_0,_1) -> _0
let __proj__App__item___1: formula -> FStar_Tactics_Types.term =
  fun projectee  -> match projectee with | App (_0,_1) -> _1
let uu___is_Name: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | Name _0 -> true | uu____444 -> false
let __proj__Name__item___0: formula -> FStar_Tactics_Types.binder =
  fun projectee  -> match projectee with | Name _0 -> _0
let uu___is_FV: formula -> Prims.bool =
  fun projectee  -> match projectee with | FV _0 -> true | uu____462 -> false
let __proj__FV__item___0: formula -> FStar_Tactics_Types.fv =
  fun projectee  -> match projectee with | FV _0 -> _0
let uu___is_IntLit: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | IntLit _0 -> true | uu____480 -> false
...
let uu___is_F_Unknown: formula -> Prims.bool =
  fun projectee  ->
    match projectee with | F_Unknown  -> true | uu____496 -> false
let mk_Forall:
  FStar_Tactics_Types.term -> FStar_Tactics_Types.term -> formula =
  fun typ  ->
    fun pred  ->
      Forall
...
let term_as_formula: FStar_Tactics_Types.term -> formula =
  fun t  ->
    ...
    | FStar_Reflection_Syntax.Tv_Const (FStar_Reflection_Syntax.C_Int i) ->
        IntLit i
    | FStar_Reflection_Syntax.Tv_Type _
      |FStar_Reflection_Syntax.Tv_Abs (_,_)
       |FStar_Reflection_Syntax.Tv_Refine (_,_)
        |FStar_Reflection_Syntax.Tv_Const (FStar_Reflection_Syntax.C_Unit )|_
        -> F_Unknown
...
let formula_as_term: formula -> FStar_Tactics_Types.term =
