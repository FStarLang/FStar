...
let term_as_formula': FStar_Reflection_Types.term -> formula =
  fun t  ->
    ...
    | FStar_Reflection_Syntax.Tv_Const (FStar_Reflection_Syntax.C_Int i) ->
        IntLit i
    | FStar_Reflection_Syntax.Tv_Type uu____768 -> F_Unknown
    | FStar_Reflection_Syntax.Tv_Abs (uu____769,uu____770) -> F_Unknown
    | FStar_Reflection_Syntax.Tv_Refine (uu____771,uu____772) -> F_Unknown
