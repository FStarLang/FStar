...
type formula =
  ...
  FStar_Reflection_Syntax.term* FStar_Reflection_Syntax.term
  | And of FStar_Reflection_Syntax.term* FStar_Reflection_Syntax.term
  | Or of FStar_Reflection_Syntax.term* FStar_Reflection_Syntax.term
  | Not of FStar_Reflection_Syntax.term
  | Implies of FStar_Reflection_Syntax.term* FStar_Reflection_Syntax.term
  | Iff of FStar_Reflection_Syntax.term* FStar_Reflection_Syntax.term
  | Forall of FStar_Reflection_Syntax.binder* FStar_Reflection_Syntax.term
  | Exists of FStar_Reflection_Syntax.binder* FStar_Reflection_Syntax.term
  | App of FStar_Reflection_Syntax.term* FStar_Reflection_Syntax.term
  | Name of FStar_Reflection_Syntax.binder
  | FV of FStar_Reflection_Syntax.fv
  | IntLit of Prims.int
  | F_Unknown
...
let __proj__Comp__item___2: formula -> FStar_Reflection_Syntax.term =
  fun projectee  -> match projectee with | Comp (_0,_1,_2,_3) -> _2
let __proj__Comp__item___3: formula -> FStar_Reflection_Syntax.term =
...
let term_as_formula': FStar_Reflection_Syntax.term -> formula =
  fun t  ->
...
let formula_as_term: formula -> FStar_Reflection_Syntax.term =
