...
let rev_mem l x = ()
let append_nil_l l = ()
let rec append_l_nil uu___26_187 = ()
...
let rec rev' uu___27_646 =
  match uu___27_646 with
  | [] -> []
  | hd1::tl1 -> FStar_List_Tot_Base.op_At (rev' tl1) [hd1]
let rev'T uu____662 = rev'
let rec rev_acc_rev' l acc = ()
let rev_rev' l = ()
let rec rev'_append l1 l2 = ()
let rev_append l1 l2 = ()
let rec rev'_involutive uu___28_765 = ()
let rev_involutive l = ()
let rec rev'_list_ind p uu___29_810 = ()
let rev_ind p l = ()
...
let rec sorted f uu___30_1183 =
  match uu___30_1183 with
  | [] -> true
  | uu____1189::[] -> true
