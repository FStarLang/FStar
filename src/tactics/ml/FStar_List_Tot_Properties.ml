...
let rev_mem l x = ()
let append_nil_l l = ()
let rec append_l_nil uu___35_166 = ()
...
let rec rev' uu___36_579 =
  match uu___36_579 with
  | [] -> []
  | hd1::tl1 -> FStar_List_Tot_Base.op_At (rev' tl1) [hd1]
let rev'T uu____593 = rev'
let rec rev_acc_rev' l acc = ()
let rev_rev' l = ()
let rec rev'_append l1 l2 = ()
let rev_append l1 l2 = ()
let rec rev'_involutive uu___37_683 = ()
let rev_involutive l = ()
let rec rev'_list_ind p uu___38_723 = ()
let rev_ind p l = ()
...
let rec sorted f uu___39_1066 =
  match uu___39_1066 with
  | []|_::[] -> true
