...
val refl_core_compute_term_type       : env -> term -> Core.tot_or_ghost -> tac (option typ & issues)
val refl_core_compute_term_type2      : env -> term -> tac (option (Core.tot_or_ghost & typ) & issues)
val refl_core_check_term              : env -> term -> typ -> Core.tot_or_ghost -> tac (option unit & issues)
val refl_tc_term                      : env -> term -> Core.tot_or_ghost -> tac (option (term & typ) & issues)
val refl_tc_term2                     : env -> term -> tac (option (term & (Core.tot_or_ghost & typ)) & issues)
